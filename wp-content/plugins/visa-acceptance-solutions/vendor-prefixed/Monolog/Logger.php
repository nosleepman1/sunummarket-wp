...
use DateTimeZone;
use Pymt_Vas\Dependencies\Monolog\Handler\HandlerInterface;
use Pymt_Vas\Dependencies\Psr\Log\LoggerInterface;
use Pymt_Vas\Dependencies\Psr\Log\InvalidArgumentException;
...
class Logger implements LoggerInterface, ResettableInterface
{
     ...
     *
     * @throws \Pymt_Vas\Dependencies\Psr\Log\InvalidArgumentException If level is not defined
     *
     * @phpstan-param  Level     $level

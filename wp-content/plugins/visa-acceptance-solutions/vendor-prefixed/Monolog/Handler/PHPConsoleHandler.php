 ...
 *
 *      $logger = new \Pymt_Vas\Dependencies\Monolog\Logger('all', array(new \Pymt_Vas\Dependencies\Monolog\Handler\PHPConsoleHandler()));
 *      \Pymt_Vas\Dependencies\Monolog\ErrorHandler::register($logger);
 *      echo $undefinedVar;
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    private $connector;
    /**
     * @param  array<string, mixed> $options   See \Pymt_Vas\Dependencies\Monolog\Handler\PHPConsoleHandler::$options for more details

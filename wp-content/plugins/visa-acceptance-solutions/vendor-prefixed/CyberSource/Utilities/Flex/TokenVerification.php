...
namespace Pymt_Vas\Dependencies\CyberSource\Utilities\Flex;
...
class TokenVerification
{
    ...
    public function __construct(\Pymt_Vas\Dependencies\CyberSource\Logging\LogConfiguration $logConfig = null)
    {
        if (self::$MyLogger === null) {
            self::$MyLogger = (new LogFactory())->getLogger(\Pymt_Vas\Dependencies\CyberSource\Utilities\Helpers\ClassHelper::getClassName(get_class($this)), $logConfig);
        }
    }

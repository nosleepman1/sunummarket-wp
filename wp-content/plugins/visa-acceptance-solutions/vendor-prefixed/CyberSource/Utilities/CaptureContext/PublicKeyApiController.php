...
class PublicKeyApiController
{
    ...
    public static function fetchPublicKey($kid, $runEnvironment)
    {
        ...
        $curl = curl_init();
        // Set cURL options
        curl_setopt_array($curl, [CURLOPT_URL => $url, CURLOPT_RETURNTRANSFER => true, CURLOPT_HTTPHEADER => ['Accept: application/json'], CURLOPT_CONNECTTIMEOUT => 10, CURLOPT_SSL_VERIFYPEER => true, CURLOPT_SSL_VERIFYHOST => 2]);
        // Execute the request

...
class ReportDownloadsApi
{
    ...
    public function downloadReportWithHttpInfo($reportDate, $reportName, $organizationId = null)
    {
        ...
        if (MLEUtility::checkIsMLEForAPI($this->apiClient->merchantConfig, $inboundMLEStatus, "downloadReport,downloadReportWithHttpInfo")) {
            try {
        ...
        // Response MLE check
        $isResponseMLEForAPI = MLEUtility::checkIsResponseMLEForAPI($this->apiClient->merchantConfig, "downloadReport,downloadReportWithHttpInfo");
        // make the API Call
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi($resourcePath, 'GET', $queryParams, $httpBody, $headerParams, null, '/reporting/v3/report-downloads', $isResponseMLEForAPI);

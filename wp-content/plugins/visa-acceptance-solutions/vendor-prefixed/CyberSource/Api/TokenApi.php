...
class TokenApi
{
     ...
     * @return array of \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\InlineResponse2002, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function getCardArtAssetWithHttpInfo($instrumentIdentifierId, $tokenProvider, $assetType)
    {
        ...
        // path params
        if ($tokenProvider !== null) {
            $resourcePath = str_replace("{" . "tokenProvider" . "}", $this->apiClient->getSerializer()->toPathValue($tokenProvider), $resourcePath);
        }
        // path params
        if ($assetType !== null) {
            $resourcePath = str_replace("{" . "assetType" . "}", $this->apiClient->getSerializer()->toPathValue($assetType), $resourcePath);
        }
        if ('GET' == 'POST') {
            $_tempBody = '{}';
        }
        ...
        if (MLEUtility::checkIsMLEForAPI($this->apiClient->merchantConfig, $inboundMLEStatus, "getCardArtAsset,getCardArtAssetWithHttpInfo")) {
            try {
        ...
        // make the API Call
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi($resourcePath, 'GET', $queryParams, $httpBody, $headerParams, '\Pymt_Vas\Dependencies\CyberSource\Model\InlineResponse2002', '/tms/v2/tokens/{instrumentIdentifierId}/{tokenProvider}/assets/{assetType}', $isResponseMLEForAPI);
            self::$logger->debug("Response Headers :\n" . \Pymt_Vas\Dependencies\CyberSource\Utilities\Helpers\ListHelper::toString($httpHeader));
            return [$this->apiClient->getSerializer()->deserialize($response, '\Pymt_Vas\Dependencies\CyberSource\Model\InlineResponse2002', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Pymt_Vas\Dependencies\CyberSource\Model\InlineResponse2002', $e->getResponseHeaders());
     ...
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\PostPaymentCredentialsRequest1 $postPaymentCredentialsRequest  (required)
    ...
    public function postTokenPaymentCredentialsWithHttpInfo($tokenId, $postPaymentCredentialsRequest, $profileId = null)
    {
        ...
        // path params
        if ($tokenId !== null) {
            $resourcePath = str_replace("{" . "tokenId" . "}", $this->apiClient->getSerializer()->toPathValue($tokenId), $resourcePath);
        }
        // body params
        $_tempBody = null;
        ...
        $modelClassLocation = explode('\\', '\Pymt_Vas\Dependencies\CyberSource\Model\PostPaymentCredentialsRequest1');
        ...
        // make the API Call
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi($resourcePath, 'POST', $queryParams, $httpBody, $headerParams, 'string', '/tms/v2/tokens/{tokenId}/payment-credentials', $isResponseMLEForAPI);
            self::$logger->debug("Response Headers :\n" . \Pymt_Vas\Dependencies\CyberSource\Utilities\Helpers\ListHelper::toString($httpHeader));
     ...
     *
     * @param string $tokenId The Id of a token representing a Customer, Payment Instrument or Instrument Identifier. (required)
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\PostPaymentCredentialsRequest $postPaymentCredentialsRequest  (required)
     * @param string $profileId The Id of a profile containing user specific TMS configuration. (optional)
     * @throws \Pymt_Vas\Dependencies\CyberSource\ApiException on non-2xx response
     * @return array of \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\InlineResponse2011, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function postTokenPaymentCredentialsV3WithHttpInfo($tokenId, $postPaymentCredentialsRequest, $profileId = null)
    {
        ...
        $sdkTracker = new \Pymt_Vas\Dependencies\CyberSource\Utilities\Tracking\SdkTracker();
        $modelClassLocation = explode('\\', '\Pymt_Vas\Dependencies\CyberSource\Model\PostPaymentCredentialsRequest');
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, end($modelClassLocation), $this->apiClient->merchantConfig->getRunEnvironment(), $this->apiClient->merchantConfig->getDefaultDeveloperId());
        // for model (json/xml)
        if (isset($_tempBody) and count($formParams) <= 0) {
            $httpBody = $_tempBody;
        ...
        // make the API Call
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi($resourcePath, 'POST', $queryParams, $httpBody, $headerParams, '\Pymt_Vas\Dependencies\CyberSource\Model\InlineResponse2011', '/tms/v3/tokens/{tokenId}/payment-credentials', $isResponseMLEForAPI);
            self::$logger->debug("Response Headers :\n" . \Pymt_Vas\Dependencies\CyberSource\Utilities\Helpers\ListHelper::toString($httpHeader));
            return [$this->apiClient->getSerializer()->deserialize($response, '\Pymt_Vas\Dependencies\CyberSource\Model\InlineResponse2011', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 201:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Pymt_Vas\Dependencies\CyberSource\Model\InlineResponse2011', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Pymt_Vas\Dependencies\CyberSource\Model\InlineResponse400', $e->getResponseHeaders());

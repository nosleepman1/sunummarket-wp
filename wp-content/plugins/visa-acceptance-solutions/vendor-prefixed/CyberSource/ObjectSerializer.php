    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        if (null === $data) {
            ...
            if (Configuration::getDefaultConfiguration()->getLogConfiguration()->isLoggingEnabled()) {
                $tempLogger = (new LogFactory())->getLogger(\Pymt_Vas\Dependencies\CyberSource\Utilities\Helpers\ClassHelper::getClassName(get_class($this)), Configuration::getDefaultConfiguration()->getLogConfiguration());
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\Pymt_Vas\Dependencies\CyberSource\Model\\' . $data->{$discriminator};

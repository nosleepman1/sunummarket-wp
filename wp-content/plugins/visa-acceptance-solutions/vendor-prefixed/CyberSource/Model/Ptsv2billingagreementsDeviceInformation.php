...
class Ptsv2billingagreementsDeviceInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['httpAcceptBrowserValue' => 'string', 'ipAddress' => 'string', 'userAgentBrowserValue' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['httpAcceptBrowserValue' => null, 'ipAddress' => null, 'userAgentBrowserValue' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['httpAcceptBrowserValue' => 'httpAcceptBrowserValue', 'ipAddress' => 'ipAddress', 'userAgentBrowserValue' => 'userAgentBrowserValue'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['httpAcceptBrowserValue' => 'setHttpAcceptBrowserValue', 'ipAddress' => 'setIpAddress', 'userAgentBrowserValue' => 'setUserAgentBrowserValue'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['httpAcceptBrowserValue' => 'getHttpAcceptBrowserValue', 'ipAddress' => 'getIpAddress', 'userAgentBrowserValue' => 'getUserAgentBrowserValue'];

...
class TssV2TransactionsGet200ResponseApplicationInformationApplications implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['name' => 'string', 'status' => 'string', 'reasonCode' => 'string', 'rCode' => 'string', 'rFlag' => 'string', 'reconciliationId' => 'string', 'rMessage' => 'string', 'returnCode' => 'int'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['name' => null, 'status' => null, 'reasonCode' => null, 'rCode' => null, 'rFlag' => null, 'reconciliationId' => null, 'rMessage' => null, 'returnCode' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['name' => 'name', 'status' => 'status', 'reasonCode' => 'reasonCode', 'rCode' => 'rCode', 'rFlag' => 'rFlag', 'reconciliationId' => 'reconciliationId', 'rMessage' => 'rMessage', 'returnCode' => 'returnCode'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['name' => 'setName', 'status' => 'setStatus', 'reasonCode' => 'setReasonCode', 'rCode' => 'setRCode', 'rFlag' => 'setRFlag', 'reconciliationId' => 'setReconciliationId', 'rMessage' => 'setRMessage', 'returnCode' => 'setReturnCode'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['name' => 'getName', 'status' => 'getStatus', 'reasonCode' => 'getReasonCode', 'rCode' => 'getRCode', 'rFlag' => 'getRFlag', 'reconciliationId' => 'getReconciliationId', 'rMessage' => 'getRMessage', 'returnCode' => 'getReturnCode'];

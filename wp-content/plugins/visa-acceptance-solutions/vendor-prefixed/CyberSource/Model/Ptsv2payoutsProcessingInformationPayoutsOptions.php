...
class Ptsv2payoutsProcessingInformationPayoutsOptions implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['acquirerMerchantId' => 'string', 'acquirerBin' => 'string', 'retrievalReferenceNumber' => 'string', 'accountFundingReferenceId' => 'string', 'deferredDateTime' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['acquirerMerchantId' => null, 'acquirerBin' => null, 'retrievalReferenceNumber' => null, 'accountFundingReferenceId' => null, 'deferredDateTime' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['acquirerMerchantId' => 'acquirerMerchantId', 'acquirerBin' => 'acquirerBin', 'retrievalReferenceNumber' => 'retrievalReferenceNumber', 'accountFundingReferenceId' => 'accountFundingReferenceId', 'deferredDateTime' => 'deferredDateTime'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['acquirerMerchantId' => 'setAcquirerMerchantId', 'acquirerBin' => 'setAcquirerBin', 'retrievalReferenceNumber' => 'setRetrievalReferenceNumber', 'accountFundingReferenceId' => 'setAccountFundingReferenceId', 'deferredDateTime' => 'setDeferredDateTime'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['acquirerMerchantId' => 'getAcquirerMerchantId', 'acquirerBin' => 'getAcquirerBin', 'retrievalReferenceNumber' => 'getRetrievalReferenceNumber', 'accountFundingReferenceId' => 'getAccountFundingReferenceId', 'deferredDateTime' => 'getDeferredDateTime'];

...
class TssV2TransactionsPost201ResponseEmbeddedApplicationInformationApplications implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['name' => 'string', 'reasonCode' => 'string', 'status' => 'string', 'reason' => 'string', 'rCode' => 'string', 'rFlag' => 'string', 'reconciliationId' => 'string', 'rMessage' => 'string', 'returnCode' => 'int'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['name' => null, 'reasonCode' => null, 'status' => null, 'reason' => null, 'rCode' => null, 'rFlag' => null, 'reconciliationId' => null, 'rMessage' => null, 'returnCode' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['name' => 'name', 'reasonCode' => 'reasonCode', 'status' => 'status', 'reason' => 'reason', 'rCode' => 'rCode', 'rFlag' => 'rFlag', 'reconciliationId' => 'reconciliationId', 'rMessage' => 'rMessage', 'returnCode' => 'returnCode'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['name' => 'setName', 'reasonCode' => 'setReasonCode', 'status' => 'setStatus', 'reason' => 'setReason', 'rCode' => 'setRCode', 'rFlag' => 'setRFlag', 'reconciliationId' => 'setReconciliationId', 'rMessage' => 'setRMessage', 'returnCode' => 'setReturnCode'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['name' => 'getName', 'reasonCode' => 'getReasonCode', 'status' => 'getStatus', 'reason' => 'getReason', 'rCode' => 'getRCode', 'rFlag' => 'getRFlag', 'reconciliationId' => 'getReconciliationId', 'rMessage' => 'getRMessage', 'returnCode' => 'getReturnCode'];

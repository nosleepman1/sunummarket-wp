...
use ArrayAccess;
/**
 * Ptsv1pullfundstransferSenderInformationConsumerAuthenticationStrongAuthentication Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Ptsv1pullfundstransferSenderInformationConsumerAuthenticationStrongAuthentication implements ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'ptsv1pullfundstransfer_senderInformation_consumerAuthentication_strongAuthentication';
    /**
     * Array of property to type mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerTypes = ['lowValueExemptionIndicator' => 'string', 'riskAnalysisExemptionIndicator' => 'string', 'trustedMerchantExemptionIndicator' => 'string', 'secureCorporatePaymentIndicator' => 'string', 'delegatedAuthenticationExemptionIndicator' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['lowValueExemptionIndicator' => null, 'riskAnalysisExemptionIndicator' => null, 'trustedMerchantExemptionIndicator' => null, 'secureCorporatePaymentIndicator' => null, 'delegatedAuthenticationExemptionIndicator' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['lowValueExemptionIndicator' => 'lowValueExemptionIndicator', 'riskAnalysisExemptionIndicator' => 'riskAnalysisExemptionIndicator', 'trustedMerchantExemptionIndicator' => 'trustedMerchantExemptionIndicator', 'secureCorporatePaymentIndicator' => 'secureCorporatePaymentIndicator', 'delegatedAuthenticationExemptionIndicator' => 'delegatedAuthenticationExemptionIndicator'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['lowValueExemptionIndicator' => 'setLowValueExemptionIndicator', 'riskAnalysisExemptionIndicator' => 'setRiskAnalysisExemptionIndicator', 'trustedMerchantExemptionIndicator' => 'setTrustedMerchantExemptionIndicator', 'secureCorporatePaymentIndicator' => 'setSecureCorporatePaymentIndicator', 'delegatedAuthenticationExemptionIndicator' => 'setDelegatedAuthenticationExemptionIndicator'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['lowValueExemptionIndicator' => 'getLowValueExemptionIndicator', 'riskAnalysisExemptionIndicator' => 'getRiskAnalysisExemptionIndicator', 'trustedMerchantExemptionIndicator' => 'getTrustedMerchantExemptionIndicator', 'secureCorporatePaymentIndicator' => 'getSecureCorporatePaymentIndicator', 'delegatedAuthenticationExemptionIndicator' => 'getDelegatedAuthenticationExemptionIndicator'];
     ...
     * @param string $trustedMerchantExemptionIndicator Possible values: - `0` (Trusted merchant exemption does not apply to the transaction) - `1` (Transaction exempt from SCA as it originated at a merchant trusted by the cardholder)  Only applicable for SCA participants. Only one of the SCA flags (`senderInformation.consumerAuthentication.strongAuthentication.*`) may be supplied at once.
     * @return $this
     */

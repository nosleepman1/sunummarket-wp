...
class ReportingV3NotificationofChangesGet200ResponseNotificationOfChanges implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['merchantReferenceNumber' => 'string', 'transactionReferenceNumber' => 'string', 'time' => '\DateTime', 'code' => 'string', 'accountType' => 'string', 'routingNumber' => 'string', 'accountNumber' => 'string', 'consumerName' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['merchantReferenceNumber' => null, 'transactionReferenceNumber' => null, 'time' => 'date-time', 'code' => null, 'accountType' => null, 'routingNumber' => null, 'accountNumber' => null, 'consumerName' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['merchantReferenceNumber' => 'merchantReferenceNumber', 'transactionReferenceNumber' => 'transactionReferenceNumber', 'time' => 'time', 'code' => 'code', 'accountType' => 'accountType', 'routingNumber' => 'routingNumber', 'accountNumber' => 'accountNumber', 'consumerName' => 'consumerName'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['merchantReferenceNumber' => 'setMerchantReferenceNumber', 'transactionReferenceNumber' => 'setTransactionReferenceNumber', 'time' => 'setTime', 'code' => 'setCode', 'accountType' => 'setAccountType', 'routingNumber' => 'setRoutingNumber', 'accountNumber' => 'setAccountNumber', 'consumerName' => 'setConsumerName'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['merchantReferenceNumber' => 'getMerchantReferenceNumber', 'transactionReferenceNumber' => 'getTransactionReferenceNumber', 'time' => 'getTime', 'code' => 'getCode', 'accountType' => 'getAccountType', 'routingNumber' => 'getRoutingNumber', 'accountNumber' => 'getAccountNumber', 'consumerName' => 'getConsumerName'];

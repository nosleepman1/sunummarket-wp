...
class Ptsv2paymentsMerchantInformationServiceFeeDescriptor implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['name' => 'string', 'contact' => 'string', 'state' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['name' => null, 'contact' => null, 'state' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['name' => 'name', 'contact' => 'contact', 'state' => 'state'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['name' => 'setName', 'contact' => 'setContact', 'state' => 'setState'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['name' => 'getName', 'contact' => 'getContact', 'state' => 'getState'];

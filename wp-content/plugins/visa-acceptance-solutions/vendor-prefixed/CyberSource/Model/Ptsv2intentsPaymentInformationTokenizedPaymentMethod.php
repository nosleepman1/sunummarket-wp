...
class Ptsv2intentsPaymentInformationTokenizedPaymentMethod implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['description' => 'string', 'usagePattern' => 'string', 'usageType' => 'string', 'allowMultipleTokens' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['description' => null, 'usagePattern' => null, 'usageType' => null, 'allowMultipleTokens' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['description' => 'description', 'usagePattern' => 'usagePattern', 'usageType' => 'usageType', 'allowMultipleTokens' => 'allowMultipleTokens'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['description' => 'setDescription', 'usagePattern' => 'setUsagePattern', 'usageType' => 'setUsageType', 'allowMultipleTokens' => 'setAllowMultipleTokens'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['description' => 'getDescription', 'usagePattern' => 'getUsagePattern', 'usageType' => 'getUsageType', 'allowMultipleTokens' => 'getAllowMultipleTokens'];

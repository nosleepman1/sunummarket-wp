...
class Ptsv2paymentsWatchlistScreeningInformationWeights implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['address' => 'string', 'company' => 'string', 'name' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['address' => null, 'company' => null, 'name' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['address' => 'address', 'company' => 'company', 'name' => 'name'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['address' => 'setAddress', 'company' => 'setCompany', 'name' => 'setName'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['address' => 'getAddress', 'company' => 'getCompany', 'name' => 'getName'];

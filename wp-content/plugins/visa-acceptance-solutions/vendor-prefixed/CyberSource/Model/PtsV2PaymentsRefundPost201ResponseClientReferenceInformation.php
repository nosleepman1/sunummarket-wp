...
class PtsV2PaymentsRefundPost201ResponseClientReferenceInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['code' => 'string', 'submitLocalDateTime' => 'string', 'ownerMerchantId' => 'string', 'returnReconciliationId' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['code' => null, 'submitLocalDateTime' => null, 'ownerMerchantId' => null, 'returnReconciliationId' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['code' => 'code', 'submitLocalDateTime' => 'submitLocalDateTime', 'ownerMerchantId' => 'ownerMerchantId', 'returnReconciliationId' => 'returnReconciliationId'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['code' => 'setCode', 'submitLocalDateTime' => 'setSubmitLocalDateTime', 'ownerMerchantId' => 'setOwnerMerchantId', 'returnReconciliationId' => 'setReturnReconciliationId'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['code' => 'getCode', 'submitLocalDateTime' => 'getSubmitLocalDateTime', 'ownerMerchantId' => 'getOwnerMerchantId', 'returnReconciliationId' => 'getReturnReconciliationId'];

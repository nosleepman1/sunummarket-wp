...
class PtsV2PaymentsPost201ResponseProcessorInformationRouting implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['network' => 'string', 'networkName' => 'string', 'customerSignatureRequired' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['network' => null, 'networkName' => null, 'customerSignatureRequired' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['network' => 'network', 'networkName' => 'networkName', 'customerSignatureRequired' => 'customerSignatureRequired'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['network' => 'setNetwork', 'networkName' => 'setNetworkName', 'customerSignatureRequired' => 'setCustomerSignatureRequired'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['network' => 'getNetwork', 'networkName' => 'getNetworkName', 'customerSignatureRequired' => 'getCustomerSignatureRequired'];

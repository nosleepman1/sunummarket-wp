...
class PaymentsStrongAuthIssuerInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['riskAnalysisExemptionResult' => 'string', 'trustedMerchantExemptionResult' => 'string', 'lowValueExemptionResult' => 'string', 'secureCorporatePaymentResult' => 'string', 'transactionRiskAnalysisExemptionResult' => 'string', 'delegatedAuthenticationResult' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['riskAnalysisExemptionResult' => null, 'trustedMerchantExemptionResult' => null, 'lowValueExemptionResult' => null, 'secureCorporatePaymentResult' => null, 'transactionRiskAnalysisExemptionResult' => null, 'delegatedAuthenticationResult' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['riskAnalysisExemptionResult' => 'riskAnalysisExemptionResult', 'trustedMerchantExemptionResult' => 'trustedMerchantExemptionResult', 'lowValueExemptionResult' => 'lowValueExemptionResult', 'secureCorporatePaymentResult' => 'secureCorporatePaymentResult', 'transactionRiskAnalysisExemptionResult' => 'transactionRiskAnalysisExemptionResult', 'delegatedAuthenticationResult' => 'delegatedAuthenticationResult'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['riskAnalysisExemptionResult' => 'setRiskAnalysisExemptionResult', 'trustedMerchantExemptionResult' => 'setTrustedMerchantExemptionResult', 'lowValueExemptionResult' => 'setLowValueExemptionResult', 'secureCorporatePaymentResult' => 'setSecureCorporatePaymentResult', 'transactionRiskAnalysisExemptionResult' => 'setTransactionRiskAnalysisExemptionResult', 'delegatedAuthenticationResult' => 'setDelegatedAuthenticationResult'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['riskAnalysisExemptionResult' => 'getRiskAnalysisExemptionResult', 'trustedMerchantExemptionResult' => 'getTrustedMerchantExemptionResult', 'lowValueExemptionResult' => 'getLowValueExemptionResult', 'secureCorporatePaymentResult' => 'getSecureCorporatePaymentResult', 'transactionRiskAnalysisExemptionResult' => 'getTransactionRiskAnalysisExemptionResult', 'delegatedAuthenticationResult' => 'getDelegatedAuthenticationResult'];

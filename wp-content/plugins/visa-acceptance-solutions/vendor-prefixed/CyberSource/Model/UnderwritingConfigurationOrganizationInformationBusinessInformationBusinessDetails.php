...
class UnderwritingConfigurationOrganizationInformationBusinessInformationBusinessDetails implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['customerType' => 'string', 'percentageSplitByB2B' => 'float', 'percentageSplitByB2C' => 'float', 'interactionTypes' => 'string', 'percentageSplitByF2F' => 'float', 'percentageSplitByCNP' => 'float', 'whenIsCustomerCharged' => 'string', 'whenIsCustomerChargedDescription' => 'string', 'offerSubscriptions' => 'bool', 'monthlySubscriptionPercent' => 'float', 'quarterlySubscriptionPercent' => 'float', 'semiannualSubscriptionPercent' => 'float', 'annualSubscriptionPercent' => 'float', 'currencyType' => 'string', 'estimatedMonthlySales' => 'float', 'averageOrderAmount' => 'float', 'largestExpectedOrderAmount' => 'float', 'primaryAccountUsage' => 'string', 'sourceOfFunds' => 'string', 'receiveMoney3rdParties' => 'bool', 'receiveTransactionFrequency' => 'string', 'estimatedMonthlySpend' => 'string', 'countryTransactions' => 'string[]', 'currenciesIn' => 'string[]', 'currenciesOut' => 'string[]', 'productServicesSubscription' => '\Pymt_Vas\Dependencies\CyberSource\Model\UnderwritingConfigurationOrganizationInformationBusinessInformationBusinessDetailsProductServicesSubscription[]'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['customerType' => null, 'percentageSplitByB2B' => null, 'percentageSplitByB2C' => null, 'interactionTypes' => null, 'percentageSplitByF2F' => null, 'percentageSplitByCNP' => null, 'whenIsCustomerCharged' => null, 'whenIsCustomerChargedDescription' => null, 'offerSubscriptions' => null, 'monthlySubscriptionPercent' => null, 'quarterlySubscriptionPercent' => null, 'semiannualSubscriptionPercent' => null, 'annualSubscriptionPercent' => null, 'currencyType' => null, 'estimatedMonthlySales' => null, 'averageOrderAmount' => null, 'largestExpectedOrderAmount' => null, 'primaryAccountUsage' => null, 'sourceOfFunds' => null, 'receiveMoney3rdParties' => null, 'receiveTransactionFrequency' => null, 'estimatedMonthlySpend' => null, 'countryTransactions' => null, 'currenciesIn' => null, 'currenciesOut' => null, 'productServicesSubscription' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['customerType' => 'customerType', 'percentageSplitByB2B' => 'percentageSplitByB2B', 'percentageSplitByB2C' => 'percentageSplitByB2C', 'interactionTypes' => 'interactionTypes', 'percentageSplitByF2F' => 'percentageSplitByF2F', 'percentageSplitByCNP' => 'percentageSplitByCNP', 'whenIsCustomerCharged' => 'whenIsCustomerCharged', 'whenIsCustomerChargedDescription' => 'whenIsCustomerChargedDescription', 'offerSubscriptions' => 'offerSubscriptions', 'monthlySubscriptionPercent' => 'monthlySubscriptionPercent', 'quarterlySubscriptionPercent' => 'quarterlySubscriptionPercent', 'semiannualSubscriptionPercent' => 'semiannualSubscriptionPercent', 'annualSubscriptionPercent' => 'annualSubscriptionPercent', 'currencyType' => 'currencyType', 'estimatedMonthlySales' => 'estimatedMonthlySales', 'averageOrderAmount' => 'averageOrderAmount', 'largestExpectedOrderAmount' => 'largestExpectedOrderAmount', 'primaryAccountUsage' => 'primaryAccountUsage', 'sourceOfFunds' => 'sourceOfFunds', 'receiveMoney3rdParties' => 'receiveMoney3rdParties', 'receiveTransactionFrequency' => 'receiveTransactionFrequency', 'estimatedMonthlySpend' => 'estimatedMonthlySpend', 'countryTransactions' => 'countryTransactions', 'currenciesIn' => 'currenciesIn', 'currenciesOut' => 'currenciesOut', 'productServicesSubscription' => 'productServicesSubscription'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['customerType' => 'setCustomerType', 'percentageSplitByB2B' => 'setPercentageSplitByB2B', 'percentageSplitByB2C' => 'setPercentageSplitByB2C', 'interactionTypes' => 'setInteractionTypes', 'percentageSplitByF2F' => 'setPercentageSplitByF2F', 'percentageSplitByCNP' => 'setPercentageSplitByCNP', 'whenIsCustomerCharged' => 'setWhenIsCustomerCharged', 'whenIsCustomerChargedDescription' => 'setWhenIsCustomerChargedDescription', 'offerSubscriptions' => 'setOfferSubscriptions', 'monthlySubscriptionPercent' => 'setMonthlySubscriptionPercent', 'quarterlySubscriptionPercent' => 'setQuarterlySubscriptionPercent', 'semiannualSubscriptionPercent' => 'setSemiannualSubscriptionPercent', 'annualSubscriptionPercent' => 'setAnnualSubscriptionPercent', 'currencyType' => 'setCurrencyType', 'estimatedMonthlySales' => 'setEstimatedMonthlySales', 'averageOrderAmount' => 'setAverageOrderAmount', 'largestExpectedOrderAmount' => 'setLargestExpectedOrderAmount', 'primaryAccountUsage' => 'setPrimaryAccountUsage', 'sourceOfFunds' => 'setSourceOfFunds', 'receiveMoney3rdParties' => 'setReceiveMoney3rdParties', 'receiveTransactionFrequency' => 'setReceiveTransactionFrequency', 'estimatedMonthlySpend' => 'setEstimatedMonthlySpend', 'countryTransactions' => 'setCountryTransactions', 'currenciesIn' => 'setCurrenciesIn', 'currenciesOut' => 'setCurrenciesOut', 'productServicesSubscription' => 'setProductServicesSubscription'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['customerType' => 'getCustomerType', 'percentageSplitByB2B' => 'getPercentageSplitByB2B', 'percentageSplitByB2C' => 'getPercentageSplitByB2C', 'interactionTypes' => 'getInteractionTypes', 'percentageSplitByF2F' => 'getPercentageSplitByF2F', 'percentageSplitByCNP' => 'getPercentageSplitByCNP', 'whenIsCustomerCharged' => 'getWhenIsCustomerCharged', 'whenIsCustomerChargedDescription' => 'getWhenIsCustomerChargedDescription', 'offerSubscriptions' => 'getOfferSubscriptions', 'monthlySubscriptionPercent' => 'getMonthlySubscriptionPercent', 'quarterlySubscriptionPercent' => 'getQuarterlySubscriptionPercent', 'semiannualSubscriptionPercent' => 'getSemiannualSubscriptionPercent', 'annualSubscriptionPercent' => 'getAnnualSubscriptionPercent', 'currencyType' => 'getCurrencyType', 'estimatedMonthlySales' => 'getEstimatedMonthlySales', 'averageOrderAmount' => 'getAverageOrderAmount', 'largestExpectedOrderAmount' => 'getLargestExpectedOrderAmount', 'primaryAccountUsage' => 'getPrimaryAccountUsage', 'sourceOfFunds' => 'getSourceOfFunds', 'receiveMoney3rdParties' => 'getReceiveMoney3rdParties', 'receiveTransactionFrequency' => 'getReceiveTransactionFrequency', 'estimatedMonthlySpend' => 'getEstimatedMonthlySpend', 'countryTransactions' => 'getCountryTransactions', 'currenciesIn' => 'getCurrenciesIn', 'currenciesOut' => 'getCurrenciesOut', 'productServicesSubscription' => 'getProductServicesSubscription'];
     ...
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\UnderwritingConfigurationOrganizationInformationBusinessInformationBusinessDetailsProductServicesSubscription[]
     */
     ...
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\UnderwritingConfigurationOrganizationInformationBusinessInformationBusinessDetailsProductServicesSubscription[] $productServicesSubscription
     * @return $this
     */

...
class Ptsv2paymentsidrefundsProcessingInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['actionList' => 'string[]', 'paymentSolution' => 'string', 'reconciliationId' => 'string', 'linkId' => 'string', 'reportGroup' => 'string', 'visaCheckoutId' => 'string', 'purchaseLevel' => 'string', 'recurringOptions' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsidrefundsProcessingInformationRecurringOptions', 'industryDataType' => 'string', 'paymentType' => 'string', 'refundOptions' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsidrefundsProcessingInformationRefundOptions', 'transactionTypeIndicator' => 'string', 'merchantVerificationValue' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['actionList' => null, 'paymentSolution' => null, 'reconciliationId' => null, 'linkId' => null, 'reportGroup' => null, 'visaCheckoutId' => null, 'purchaseLevel' => null, 'recurringOptions' => null, 'industryDataType' => null, 'paymentType' => null, 'refundOptions' => null, 'transactionTypeIndicator' => null, 'merchantVerificationValue' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['actionList' => 'actionList', 'paymentSolution' => 'paymentSolution', 'reconciliationId' => 'reconciliationId', 'linkId' => 'linkId', 'reportGroup' => 'reportGroup', 'visaCheckoutId' => 'visaCheckoutId', 'purchaseLevel' => 'purchaseLevel', 'recurringOptions' => 'recurringOptions', 'industryDataType' => 'industryDataType', 'paymentType' => 'paymentType', 'refundOptions' => 'refundOptions', 'transactionTypeIndicator' => 'transactionTypeIndicator', 'merchantVerificationValue' => 'merchantVerificationValue'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['actionList' => 'setActionList', 'paymentSolution' => 'setPaymentSolution', 'reconciliationId' => 'setReconciliationId', 'linkId' => 'setLinkId', 'reportGroup' => 'setReportGroup', 'visaCheckoutId' => 'setVisaCheckoutId', 'purchaseLevel' => 'setPurchaseLevel', 'recurringOptions' => 'setRecurringOptions', 'industryDataType' => 'setIndustryDataType', 'paymentType' => 'setPaymentType', 'refundOptions' => 'setRefundOptions', 'transactionTypeIndicator' => 'setTransactionTypeIndicator', 'merchantVerificationValue' => 'setMerchantVerificationValue'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['actionList' => 'getActionList', 'paymentSolution' => 'getPaymentSolution', 'reconciliationId' => 'getReconciliationId', 'linkId' => 'getLinkId', 'reportGroup' => 'getReportGroup', 'visaCheckoutId' => 'getVisaCheckoutId', 'purchaseLevel' => 'getPurchaseLevel', 'recurringOptions' => 'getRecurringOptions', 'industryDataType' => 'getIndustryDataType', 'paymentType' => 'getPaymentType', 'refundOptions' => 'getRefundOptions', 'transactionTypeIndicator' => 'getTransactionTypeIndicator', 'merchantVerificationValue' => 'getMerchantVerificationValue'];
    ...
    /**
     * Gets refundOptions
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsidrefundsProcessingInformationRefundOptions
     */
    ...
    /**
     * Sets refundOptions
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsidrefundsProcessingInformationRefundOptions $refundOptions
     * @return $this
     */

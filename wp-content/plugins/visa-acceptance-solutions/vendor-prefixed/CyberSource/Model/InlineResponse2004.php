...
class InlineResponse2004 implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['id' => 'int', 'fieldType' => 'string', 'label' => 'string', 'customerVisible' => 'bool', 'textMinLength' => 'int', 'textMaxLength' => 'int', 'possibleValues' => 'string', 'textDefaultValue' => 'string', 'merchantId' => 'string', 'referenceType' => 'string', 'readOnly' => 'bool', 'merchantDefinedDataIndex' => 'int'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['id' => 'int64', 'fieldType' => null, 'label' => null, 'customerVisible' => null, 'textMinLength' => 'int32', 'textMaxLength' => 'int32', 'possibleValues' => null, 'textDefaultValue' => null, 'merchantId' => null, 'referenceType' => null, 'readOnly' => null, 'merchantDefinedDataIndex' => 'int32'];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['id' => 'id', 'fieldType' => 'fieldType', 'label' => 'label', 'customerVisible' => 'customerVisible', 'textMinLength' => 'textMinLength', 'textMaxLength' => 'textMaxLength', 'possibleValues' => 'possibleValues', 'textDefaultValue' => 'textDefaultValue', 'merchantId' => 'merchantId', 'referenceType' => 'referenceType', 'readOnly' => 'readOnly', 'merchantDefinedDataIndex' => 'merchantDefinedDataIndex'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['id' => 'setId', 'fieldType' => 'setFieldType', 'label' => 'setLabel', 'customerVisible' => 'setCustomerVisible', 'textMinLength' => 'setTextMinLength', 'textMaxLength' => 'setTextMaxLength', 'possibleValues' => 'setPossibleValues', 'textDefaultValue' => 'setTextDefaultValue', 'merchantId' => 'setMerchantId', 'referenceType' => 'setReferenceType', 'readOnly' => 'setReadOnly', 'merchantDefinedDataIndex' => 'setMerchantDefinedDataIndex'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['id' => 'getId', 'fieldType' => 'getFieldType', 'label' => 'getLabel', 'customerVisible' => 'getCustomerVisible', 'textMinLength' => 'getTextMinLength', 'textMaxLength' => 'getTextMaxLength', 'possibleValues' => 'getPossibleValues', 'textDefaultValue' => 'getTextDefaultValue', 'merchantId' => 'getMerchantId', 'referenceType' => 'getReferenceType', 'readOnly' => 'getReadOnly', 'merchantDefinedDataIndex' => 'getMerchantDefinedDataIndex'];

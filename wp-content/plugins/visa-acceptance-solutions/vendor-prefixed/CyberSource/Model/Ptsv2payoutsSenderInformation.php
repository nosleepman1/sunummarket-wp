...
class Ptsv2payoutsSenderInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['referenceNumber' => 'string', 'account' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2payoutsSenderInformationAccount', 'firstName' => 'string', 'middleInitial' => 'string', 'middleName' => 'string', 'lastName' => 'string', 'name' => 'string', 'address1' => 'string', 'locality' => 'string', 'administrativeArea' => 'string', 'countryCode' => 'string', 'postalCode' => 'string', 'phoneNumber' => 'string', 'dateOfBirth' => 'string', 'vatRegistrationNumber' => 'string', 'personalIdType' => 'string', 'type' => 'string', 'identificationNumber' => 'string', 'aliasName' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['referenceNumber' => null, 'account' => null, 'firstName' => null, 'middleInitial' => null, 'middleName' => null, 'lastName' => null, 'name' => null, 'address1' => null, 'locality' => null, 'administrativeArea' => null, 'countryCode' => null, 'postalCode' => null, 'phoneNumber' => null, 'dateOfBirth' => null, 'vatRegistrationNumber' => null, 'personalIdType' => null, 'type' => null, 'identificationNumber' => null, 'aliasName' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['referenceNumber' => 'referenceNumber', 'account' => 'account', 'firstName' => 'firstName', 'middleInitial' => 'middleInitial', 'middleName' => 'middleName', 'lastName' => 'lastName', 'name' => 'name', 'address1' => 'address1', 'locality' => 'locality', 'administrativeArea' => 'administrativeArea', 'countryCode' => 'countryCode', 'postalCode' => 'postalCode', 'phoneNumber' => 'phoneNumber', 'dateOfBirth' => 'dateOfBirth', 'vatRegistrationNumber' => 'vatRegistrationNumber', 'personalIdType' => 'personalIdType', 'type' => 'type', 'identificationNumber' => 'identificationNumber', 'aliasName' => 'aliasName'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['referenceNumber' => 'setReferenceNumber', 'account' => 'setAccount', 'firstName' => 'setFirstName', 'middleInitial' => 'setMiddleInitial', 'middleName' => 'setMiddleName', 'lastName' => 'setLastName', 'name' => 'setName', 'address1' => 'setAddress1', 'locality' => 'setLocality', 'administrativeArea' => 'setAdministrativeArea', 'countryCode' => 'setCountryCode', 'postalCode' => 'setPostalCode', 'phoneNumber' => 'setPhoneNumber', 'dateOfBirth' => 'setDateOfBirth', 'vatRegistrationNumber' => 'setVatRegistrationNumber', 'personalIdType' => 'setPersonalIdType', 'type' => 'setType', 'identificationNumber' => 'setIdentificationNumber', 'aliasName' => 'setAliasName'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['referenceNumber' => 'getReferenceNumber', 'account' => 'getAccount', 'firstName' => 'getFirstName', 'middleInitial' => 'getMiddleInitial', 'middleName' => 'getMiddleName', 'lastName' => 'getLastName', 'name' => 'getName', 'address1' => 'getAddress1', 'locality' => 'getLocality', 'administrativeArea' => 'getAdministrativeArea', 'countryCode' => 'getCountryCode', 'postalCode' => 'getPostalCode', 'phoneNumber' => 'getPhoneNumber', 'dateOfBirth' => 'getDateOfBirth', 'vatRegistrationNumber' => 'getVatRegistrationNumber', 'personalIdType' => 'getPersonalIdType', 'type' => 'getType', 'identificationNumber' => 'getIdentificationNumber', 'aliasName' => 'getAliasName'];
    ...
    /**
     * Gets account
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2payoutsSenderInformationAccount
     */
    ...
    /**
     * Sets account
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2payoutsSenderInformationAccount $account
     * @return $this
     */

...
class CardProcessingConfigCommonProcessors implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['batchGroup' => 'string', 'businessApplicationId' => 'string', 'merchantVerificationValue' => 'string', 'abaNumber' => 'string', 'acquirer' => '\Pymt_Vas\Dependencies\CyberSource\Model\CardProcessingConfigCommonAcquirer', 'acquirers' => 'map[string,\Pymt_Vas\Dependencies\CyberSource\Model\CardProcessingConfigCommonAcquirers]', 'merchantId' => 'string', 'terminalId' => 'string', 'paymentTypes' => 'map[string,\Pymt_Vas\Dependencies\CyberSource\Model\CardProcessingConfigCommonPaymentTypes]', 'currencies' => 'map[string,\Pymt_Vas\Dependencies\CyberSource\Model\CardProcessingConfigCommonCurrencies1]', 'visaAggregatorId' => 'string', 'amexAggregatorId' => 'string', 'masterCardAggregatorId' => 'string', 'sicCode' => 'string', 'allowMultipleBills' => 'bool', 'allowMerchantDescriptorOverride' => 'bool', 'enhancedData' => 'string', 'fireSafetyIndicator' => 'bool', 'quasiCash' => 'bool', 'acquirerMerchantId' => 'string', 'avsFormat' => 'string', 'enableLongTransRefNo' => 'bool', 'enableLevel2' => 'bool', 'enableMultipleTransactionAdviceAddendum' => 'bool', 'amexTransactionAdviceAddendum1' => 'string', 'enableMultiLineItems' => 'bool', 'enableTransactionReferenceNumber' => 'bool', 'enableAutoAuthReversalAfterVoid' => 'bool', 'enableExpresspayPanTranslation' => 'bool', 'enableCreditAuth' => 'bool', 'industryCode' => 'string', 'sendAmexLevel2Data' => 'bool', 'softDescriptorType' => 'string', 'vitalNumber' => 'string', 'bankNumber' => 'string', 'chainNumber' => 'string', 'merchantBinNumber' => 'string', 'merchantLocationNumber' => 'string', 'storeID' => 'string', 'travelAgencyCode' => 'string', 'travelAgencyName' => 'string', 'settlementCurrency' => 'string', 'enableLeastCostRouting' => 'bool', 'enableCVVResponseIndicator' => 'bool', 'enableMultiCurrencyProcessing' => 'string', 'enablePosNetworkSwitching' => 'bool', 'enableDynamicCurrencyConversion' => 'bool', 'merchantTier' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['batchGroup' => null, 'businessApplicationId' => null, 'merchantVerificationValue' => null, 'abaNumber' => null, 'acquirer' => null, 'acquirers' => null, 'merchantId' => null, 'terminalId' => null, 'paymentTypes' => null, 'currencies' => null, 'visaAggregatorId' => null, 'amexAggregatorId' => null, 'masterCardAggregatorId' => null, 'sicCode' => null, 'allowMultipleBills' => null, 'allowMerchantDescriptorOverride' => null, 'enhancedData' => null, 'fireSafetyIndicator' => null, 'quasiCash' => null, 'acquirerMerchantId' => null, 'avsFormat' => null, 'enableLongTransRefNo' => null, 'enableLevel2' => null, 'enableMultipleTransactionAdviceAddendum' => null, 'amexTransactionAdviceAddendum1' => null, 'enableMultiLineItems' => null, 'enableTransactionReferenceNumber' => null, 'enableAutoAuthReversalAfterVoid' => null, 'enableExpresspayPanTranslation' => null, 'enableCreditAuth' => null, 'industryCode' => null, 'sendAmexLevel2Data' => null, 'softDescriptorType' => null, 'vitalNumber' => null, 'bankNumber' => null, 'chainNumber' => null, 'merchantBinNumber' => null, 'merchantLocationNumber' => null, 'storeID' => null, 'travelAgencyCode' => null, 'travelAgencyName' => null, 'settlementCurrency' => null, 'enableLeastCostRouting' => null, 'enableCVVResponseIndicator' => null, 'enableMultiCurrencyProcessing' => null, 'enablePosNetworkSwitching' => null, 'enableDynamicCurrencyConversion' => null, 'merchantTier' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['batchGroup' => 'batchGroup', 'businessApplicationId' => 'businessApplicationId', 'merchantVerificationValue' => 'merchantVerificationValue', 'abaNumber' => 'abaNumber', 'acquirer' => 'acquirer', 'acquirers' => 'acquirers', 'merchantId' => 'merchantId', 'terminalId' => 'terminalId', 'paymentTypes' => 'paymentTypes', 'currencies' => 'currencies', 'visaAggregatorId' => 'visaAggregatorId', 'amexAggregatorId' => 'amexAggregatorId', 'masterCardAggregatorId' => 'masterCardAggregatorId', 'sicCode' => 'sicCode', 'allowMultipleBills' => 'allowMultipleBills', 'allowMerchantDescriptorOverride' => 'allowMerchantDescriptorOverride', 'enhancedData' => 'enhancedData', 'fireSafetyIndicator' => 'fireSafetyIndicator', 'quasiCash' => 'quasiCash', 'acquirerMerchantId' => 'acquirerMerchantId', 'avsFormat' => 'avsFormat', 'enableLongTransRefNo' => 'enableLongTransRefNo', 'enableLevel2' => 'enableLevel2', 'enableMultipleTransactionAdviceAddendum' => 'enableMultipleTransactionAdviceAddendum', 'amexTransactionAdviceAddendum1' => 'amexTransactionAdviceAddendum1', 'enableMultiLineItems' => 'enableMultiLineItems', 'enableTransactionReferenceNumber' => 'enableTransactionReferenceNumber', 'enableAutoAuthReversalAfterVoid' => 'enableAutoAuthReversalAfterVoid', 'enableExpresspayPanTranslation' => 'enableExpresspayPanTranslation', 'enableCreditAuth' => 'enableCreditAuth', 'industryCode' => 'industryCode', 'sendAmexLevel2Data' => 'sendAmexLevel2Data', 'softDescriptorType' => 'softDescriptorType', 'vitalNumber' => 'vitalNumber', 'bankNumber' => 'bankNumber', 'chainNumber' => 'chainNumber', 'merchantBinNumber' => 'merchantBinNumber', 'merchantLocationNumber' => 'merchantLocationNumber', 'storeID' => 'storeID', 'travelAgencyCode' => 'travelAgencyCode', 'travelAgencyName' => 'travelAgencyName', 'settlementCurrency' => 'settlementCurrency', 'enableLeastCostRouting' => 'enableLeastCostRouting', 'enableCVVResponseIndicator' => 'enableCVVResponseIndicator', 'enableMultiCurrencyProcessing' => 'enableMultiCurrencyProcessing', 'enablePosNetworkSwitching' => 'enablePosNetworkSwitching', 'enableDynamicCurrencyConversion' => 'enableDynamicCurrencyConversion', 'merchantTier' => 'merchantTier'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['batchGroup' => 'setBatchGroup', 'businessApplicationId' => 'setBusinessApplicationId', 'merchantVerificationValue' => 'setMerchantVerificationValue', 'abaNumber' => 'setAbaNumber', 'acquirer' => 'setAcquirer', 'acquirers' => 'setAcquirers', 'merchantId' => 'setMerchantId', 'terminalId' => 'setTerminalId', 'paymentTypes' => 'setPaymentTypes', 'currencies' => 'setCurrencies', 'visaAggregatorId' => 'setVisaAggregatorId', 'amexAggregatorId' => 'setAmexAggregatorId', 'masterCardAggregatorId' => 'setMasterCardAggregatorId', 'sicCode' => 'setSicCode', 'allowMultipleBills' => 'setAllowMultipleBills', 'allowMerchantDescriptorOverride' => 'setAllowMerchantDescriptorOverride', 'enhancedData' => 'setEnhancedData', 'fireSafetyIndicator' => 'setFireSafetyIndicator', 'quasiCash' => 'setQuasiCash', 'acquirerMerchantId' => 'setAcquirerMerchantId', 'avsFormat' => 'setAvsFormat', 'enableLongTransRefNo' => 'setEnableLongTransRefNo', 'enableLevel2' => 'setEnableLevel2', 'enableMultipleTransactionAdviceAddendum' => 'setEnableMultipleTransactionAdviceAddendum', 'amexTransactionAdviceAddendum1' => 'setAmexTransactionAdviceAddendum1', 'enableMultiLineItems' => 'setEnableMultiLineItems', 'enableTransactionReferenceNumber' => 'setEnableTransactionReferenceNumber', 'enableAutoAuthReversalAfterVoid' => 'setEnableAutoAuthReversalAfterVoid', 'enableExpresspayPanTranslation' => 'setEnableExpresspayPanTranslation', 'enableCreditAuth' => 'setEnableCreditAuth', 'industryCode' => 'setIndustryCode', 'sendAmexLevel2Data' => 'setSendAmexLevel2Data', 'softDescriptorType' => 'setSoftDescriptorType', 'vitalNumber' => 'setVitalNumber', 'bankNumber' => 'setBankNumber', 'chainNumber' => 'setChainNumber', 'merchantBinNumber' => 'setMerchantBinNumber', 'merchantLocationNumber' => 'setMerchantLocationNumber', 'storeID' => 'setStoreID', 'travelAgencyCode' => 'setTravelAgencyCode', 'travelAgencyName' => 'setTravelAgencyName', 'settlementCurrency' => 'setSettlementCurrency', 'enableLeastCostRouting' => 'setEnableLeastCostRouting', 'enableCVVResponseIndicator' => 'setEnableCVVResponseIndicator', 'enableMultiCurrencyProcessing' => 'setEnableMultiCurrencyProcessing', 'enablePosNetworkSwitching' => 'setEnablePosNetworkSwitching', 'enableDynamicCurrencyConversion' => 'setEnableDynamicCurrencyConversion', 'merchantTier' => 'setMerchantTier'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['batchGroup' => 'getBatchGroup', 'businessApplicationId' => 'getBusinessApplicationId', 'merchantVerificationValue' => 'getMerchantVerificationValue', 'abaNumber' => 'getAbaNumber', 'acquirer' => 'getAcquirer', 'acquirers' => 'getAcquirers', 'merchantId' => 'getMerchantId', 'terminalId' => 'getTerminalId', 'paymentTypes' => 'getPaymentTypes', 'currencies' => 'getCurrencies', 'visaAggregatorId' => 'getVisaAggregatorId', 'amexAggregatorId' => 'getAmexAggregatorId', 'masterCardAggregatorId' => 'getMasterCardAggregatorId', 'sicCode' => 'getSicCode', 'allowMultipleBills' => 'getAllowMultipleBills', 'allowMerchantDescriptorOverride' => 'getAllowMerchantDescriptorOverride', 'enhancedData' => 'getEnhancedData', 'fireSafetyIndicator' => 'getFireSafetyIndicator', 'quasiCash' => 'getQuasiCash', 'acquirerMerchantId' => 'getAcquirerMerchantId', 'avsFormat' => 'getAvsFormat', 'enableLongTransRefNo' => 'getEnableLongTransRefNo', 'enableLevel2' => 'getEnableLevel2', 'enableMultipleTransactionAdviceAddendum' => 'getEnableMultipleTransactionAdviceAddendum', 'amexTransactionAdviceAddendum1' => 'getAmexTransactionAdviceAddendum1', 'enableMultiLineItems' => 'getEnableMultiLineItems', 'enableTransactionReferenceNumber' => 'getEnableTransactionReferenceNumber', 'enableAutoAuthReversalAfterVoid' => 'getEnableAutoAuthReversalAfterVoid', 'enableExpresspayPanTranslation' => 'getEnableExpresspayPanTranslation', 'enableCreditAuth' => 'getEnableCreditAuth', 'industryCode' => 'getIndustryCode', 'sendAmexLevel2Data' => 'getSendAmexLevel2Data', 'softDescriptorType' => 'getSoftDescriptorType', 'vitalNumber' => 'getVitalNumber', 'bankNumber' => 'getBankNumber', 'chainNumber' => 'getChainNumber', 'merchantBinNumber' => 'getMerchantBinNumber', 'merchantLocationNumber' => 'getMerchantLocationNumber', 'storeID' => 'getStoreID', 'travelAgencyCode' => 'getTravelAgencyCode', 'travelAgencyName' => 'getTravelAgencyName', 'settlementCurrency' => 'getSettlementCurrency', 'enableLeastCostRouting' => 'getEnableLeastCostRouting', 'enableCVVResponseIndicator' => 'getEnableCVVResponseIndicator', 'enableMultiCurrencyProcessing' => 'getEnableMultiCurrencyProcessing', 'enablePosNetworkSwitching' => 'getEnablePosNetworkSwitching', 'enableDynamicCurrencyConversion' => 'getEnableDynamicCurrencyConversion', 'merchantTier' => 'getMerchantTier'];
    ...
    /**
     * Gets acquirer
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\CardProcessingConfigCommonAcquirer
     */
    ...
    /**
     * Sets acquirer
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\CardProcessingConfigCommonAcquirer $acquirer
     * @return $this
     */
    ...
    /**
     * Gets acquirers
     * @return map[string,\Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\CardProcessingConfigCommonAcquirers]
     */
    ...
    /**
     * Sets acquirers
     * @param map[string,\Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\CardProcessingConfigCommonAcquirers] $acquirers Identifies the financial institution acting as the acquirer of this customer transaction. The acquirer is the member or system user that signed the merchant.
     * @return $this
     */
    ...
    /**
     * Gets paymentTypes
     * @return map[string,\Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\CardProcessingConfigCommonPaymentTypes]
     */
    ...
    /**
     * Sets paymentTypes
     * @param map[string,\Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\CardProcessingConfigCommonPaymentTypes] $paymentTypes Valid values are: * VISA * MASTERCARD * AMERICAN_EXPRESS * CUP * EFTPOS * DINERS_CLUB * DISCOVER * JCB
     * @return $this
     */
    ...
    /**
     * Gets currencies
     * @return map[string,\Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\CardProcessingConfigCommonCurrencies1]
     */
    ...
    /**
     * Sets currencies
     * @param map[string,\Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\CardProcessingConfigCommonCurrencies1] $currencies Three-character [ISO 4217 ALPHA-3 Standard Currency Codes.](http://apps.cybersource.com/library/documentation/sbc/quickref/currencies.pdf)
     * @return $this
     */

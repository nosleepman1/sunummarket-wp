...
class TssV2TransactionsPost201ResponseEmbeddedProcessingInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['paymentSolution' => 'string', 'businessApplicationId' => 'string', 'commerceIndicator' => 'string', 'commerceIndicatorLabel' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['paymentSolution' => null, 'businessApplicationId' => null, 'commerceIndicator' => null, 'commerceIndicatorLabel' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['paymentSolution' => 'paymentSolution', 'businessApplicationId' => 'businessApplicationId', 'commerceIndicator' => 'commerceIndicator', 'commerceIndicatorLabel' => 'commerceIndicatorLabel'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['paymentSolution' => 'setPaymentSolution', 'businessApplicationId' => 'setBusinessApplicationId', 'commerceIndicator' => 'setCommerceIndicator', 'commerceIndicatorLabel' => 'setCommerceIndicatorLabel'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['paymentSolution' => 'getPaymentSolution', 'businessApplicationId' => 'getBusinessApplicationId', 'commerceIndicator' => 'getCommerceIndicator', 'commerceIndicatorLabel' => 'getCommerceIndicatorLabel'];

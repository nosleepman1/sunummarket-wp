...
class Riskv1addressverificationsOrderInformationLineItems implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['unitPrice' => 'string', 'quantity' => 'int', 'productSKU' => 'string', 'productRisk' => 'string', 'productName' => 'string', 'productCode' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['unitPrice' => null, 'quantity' => null, 'productSKU' => null, 'productRisk' => null, 'productName' => null, 'productCode' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['unitPrice' => 'unitPrice', 'quantity' => 'quantity', 'productSKU' => 'productSKU', 'productRisk' => 'productRisk', 'productName' => 'productName', 'productCode' => 'productCode'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['unitPrice' => 'setUnitPrice', 'quantity' => 'setQuantity', 'productSKU' => 'setProductSKU', 'productRisk' => 'setProductRisk', 'productName' => 'setProductName', 'productCode' => 'setProductCode'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['unitPrice' => 'getUnitPrice', 'quantity' => 'getQuantity', 'productSKU' => 'getProductSKU', 'productRisk' => 'getProductRisk', 'productName' => 'getProductName', 'productCode' => 'getProductCode'];

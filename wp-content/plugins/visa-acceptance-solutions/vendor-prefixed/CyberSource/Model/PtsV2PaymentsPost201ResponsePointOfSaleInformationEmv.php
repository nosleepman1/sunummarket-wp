...
class PtsV2PaymentsPost201ResponsePointOfSaleInformationEmv implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['tags' => 'string', 'chipValidationType' => 'string', 'chipValidationResult' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['tags' => null, 'chipValidationType' => null, 'chipValidationResult' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['tags' => 'tags', 'chipValidationType' => 'chipValidationType', 'chipValidationResult' => 'chipValidationResult'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['tags' => 'setTags', 'chipValidationType' => 'setChipValidationType', 'chipValidationResult' => 'setChipValidationResult'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['tags' => 'getTags', 'chipValidationType' => 'getChipValidationType', 'chipValidationResult' => 'getChipValidationResult'];

...
class Ptsv2paymentsMerchantInformationMerchantDescriptor implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['name' => 'string', 'alternateName' => 'string', 'contact' => 'string', 'address1' => 'string', 'locality' => 'string', 'country' => 'string', 'postalCode' => 'string', 'administrativeArea' => 'string', 'phone' => 'string', 'url' => 'string', 'countryOfOrigin' => 'string', 'storeId' => 'string', 'storeName' => 'string', 'customerServicePhoneNumber' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['name' => null, 'alternateName' => null, 'contact' => null, 'address1' => null, 'locality' => null, 'country' => null, 'postalCode' => null, 'administrativeArea' => null, 'phone' => null, 'url' => null, 'countryOfOrigin' => null, 'storeId' => null, 'storeName' => null, 'customerServicePhoneNumber' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['name' => 'name', 'alternateName' => 'alternateName', 'contact' => 'contact', 'address1' => 'address1', 'locality' => 'locality', 'country' => 'country', 'postalCode' => 'postalCode', 'administrativeArea' => 'administrativeArea', 'phone' => 'phone', 'url' => 'url', 'countryOfOrigin' => 'countryOfOrigin', 'storeId' => 'storeId', 'storeName' => 'storeName', 'customerServicePhoneNumber' => 'customerServicePhoneNumber'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['name' => 'setName', 'alternateName' => 'setAlternateName', 'contact' => 'setContact', 'address1' => 'setAddress1', 'locality' => 'setLocality', 'country' => 'setCountry', 'postalCode' => 'setPostalCode', 'administrativeArea' => 'setAdministrativeArea', 'phone' => 'setPhone', 'url' => 'setUrl', 'countryOfOrigin' => 'setCountryOfOrigin', 'storeId' => 'setStoreId', 'storeName' => 'setStoreName', 'customerServicePhoneNumber' => 'setCustomerServicePhoneNumber'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['name' => 'getName', 'alternateName' => 'getAlternateName', 'contact' => 'getContact', 'address1' => 'getAddress1', 'locality' => 'getLocality', 'country' => 'getCountry', 'postalCode' => 'getPostalCode', 'administrativeArea' => 'getAdministrativeArea', 'phone' => 'getPhone', 'url' => 'getUrl', 'countryOfOrigin' => 'getCountryOfOrigin', 'storeId' => 'getStoreId', 'storeName' => 'getStoreName', 'customerServicePhoneNumber' => 'getCustomerServicePhoneNumber'];

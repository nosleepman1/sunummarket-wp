...
class Boardingv1registrationsRegistrationInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['boardingRegistrationId' => 'string', 'submitTimeUtc' => '\DateTime', 'status' => 'string', 'boardingPackageId' => 'string', 'boardingFlow' => 'string', 'mode' => 'string', 'salesRepId' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['boardingRegistrationId' => null, 'submitTimeUtc' => 'date-time', 'status' => null, 'boardingPackageId' => null, 'boardingFlow' => null, 'mode' => null, 'salesRepId' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['boardingRegistrationId' => 'boardingRegistrationId', 'submitTimeUtc' => 'submitTimeUtc', 'status' => 'status', 'boardingPackageId' => 'boardingPackageId', 'boardingFlow' => 'boardingFlow', 'mode' => 'mode', 'salesRepId' => 'salesRepId'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['boardingRegistrationId' => 'setBoardingRegistrationId', 'submitTimeUtc' => 'setSubmitTimeUtc', 'status' => 'setStatus', 'boardingPackageId' => 'setBoardingPackageId', 'boardingFlow' => 'setBoardingFlow', 'mode' => 'setMode', 'salesRepId' => 'setSalesRepId'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['boardingRegistrationId' => 'getBoardingRegistrationId', 'submitTimeUtc' => 'getSubmitTimeUtc', 'status' => 'getStatus', 'boardingPackageId' => 'getBoardingPackageId', 'boardingFlow' => 'getBoardingFlow', 'mode' => 'getMode', 'salesRepId' => 'getSalesRepId'];

...
class Ptsv2paymentsidcapturesOrderInformationAmountDetails implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['totalAmount' => 'string', 'currency' => 'string', 'discountAmount' => 'string', 'dutyAmount' => 'string', 'gratuityAmount' => 'string', 'taxAmount' => 'string', 'nationalTaxIncluded' => 'string', 'taxAppliedAfterDiscount' => 'string', 'taxAppliedLevel' => 'string', 'taxTypeCode' => 'string', 'freightAmount' => 'string', 'foreignAmount' => 'string', 'foreignCurrency' => 'string', 'exchangeRate' => 'string', 'exchangeRateTimeStamp' => 'string', 'amexAdditionalAmounts' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsOrderInformationAmountDetailsAmexAdditionalAmounts[]', 'taxDetails' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsOrderInformationAmountDetailsTaxDetails[]', 'serviceFeeAmount' => 'string', 'originalCurrency' => 'string', 'cashbackAmount' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['totalAmount' => null, 'currency' => null, 'discountAmount' => null, 'dutyAmount' => null, 'gratuityAmount' => null, 'taxAmount' => null, 'nationalTaxIncluded' => null, 'taxAppliedAfterDiscount' => null, 'taxAppliedLevel' => null, 'taxTypeCode' => null, 'freightAmount' => null, 'foreignAmount' => null, 'foreignCurrency' => null, 'exchangeRate' => null, 'exchangeRateTimeStamp' => null, 'amexAdditionalAmounts' => null, 'taxDetails' => null, 'serviceFeeAmount' => null, 'originalCurrency' => null, 'cashbackAmount' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['totalAmount' => 'totalAmount', 'currency' => 'currency', 'discountAmount' => 'discountAmount', 'dutyAmount' => 'dutyAmount', 'gratuityAmount' => 'gratuityAmount', 'taxAmount' => 'taxAmount', 'nationalTaxIncluded' => 'nationalTaxIncluded', 'taxAppliedAfterDiscount' => 'taxAppliedAfterDiscount', 'taxAppliedLevel' => 'taxAppliedLevel', 'taxTypeCode' => 'taxTypeCode', 'freightAmount' => 'freightAmount', 'foreignAmount' => 'foreignAmount', 'foreignCurrency' => 'foreignCurrency', 'exchangeRate' => 'exchangeRate', 'exchangeRateTimeStamp' => 'exchangeRateTimeStamp', 'amexAdditionalAmounts' => 'amexAdditionalAmounts', 'taxDetails' => 'taxDetails', 'serviceFeeAmount' => 'serviceFeeAmount', 'originalCurrency' => 'originalCurrency', 'cashbackAmount' => 'cashbackAmount'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['totalAmount' => 'setTotalAmount', 'currency' => 'setCurrency', 'discountAmount' => 'setDiscountAmount', 'dutyAmount' => 'setDutyAmount', 'gratuityAmount' => 'setGratuityAmount', 'taxAmount' => 'setTaxAmount', 'nationalTaxIncluded' => 'setNationalTaxIncluded', 'taxAppliedAfterDiscount' => 'setTaxAppliedAfterDiscount', 'taxAppliedLevel' => 'setTaxAppliedLevel', 'taxTypeCode' => 'setTaxTypeCode', 'freightAmount' => 'setFreightAmount', 'foreignAmount' => 'setForeignAmount', 'foreignCurrency' => 'setForeignCurrency', 'exchangeRate' => 'setExchangeRate', 'exchangeRateTimeStamp' => 'setExchangeRateTimeStamp', 'amexAdditionalAmounts' => 'setAmexAdditionalAmounts', 'taxDetails' => 'setTaxDetails', 'serviceFeeAmount' => 'setServiceFeeAmount', 'originalCurrency' => 'setOriginalCurrency', 'cashbackAmount' => 'setCashbackAmount'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['totalAmount' => 'getTotalAmount', 'currency' => 'getCurrency', 'discountAmount' => 'getDiscountAmount', 'dutyAmount' => 'getDutyAmount', 'gratuityAmount' => 'getGratuityAmount', 'taxAmount' => 'getTaxAmount', 'nationalTaxIncluded' => 'getNationalTaxIncluded', 'taxAppliedAfterDiscount' => 'getTaxAppliedAfterDiscount', 'taxAppliedLevel' => 'getTaxAppliedLevel', 'taxTypeCode' => 'getTaxTypeCode', 'freightAmount' => 'getFreightAmount', 'foreignAmount' => 'getForeignAmount', 'foreignCurrency' => 'getForeignCurrency', 'exchangeRate' => 'getExchangeRate', 'exchangeRateTimeStamp' => 'getExchangeRateTimeStamp', 'amexAdditionalAmounts' => 'getAmexAdditionalAmounts', 'taxDetails' => 'getTaxDetails', 'serviceFeeAmount' => 'getServiceFeeAmount', 'originalCurrency' => 'getOriginalCurrency', 'cashbackAmount' => 'getCashbackAmount'];

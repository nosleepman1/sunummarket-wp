...
class PtsV2PaymentsPost201ResponseClientReferenceInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['code' => 'string', 'submitLocalDateTime' => 'string', 'ownerMerchantId' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['code' => null, 'submitLocalDateTime' => null, 'ownerMerchantId' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['code' => 'code', 'submitLocalDateTime' => 'submitLocalDateTime', 'ownerMerchantId' => 'ownerMerchantId'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['code' => 'setCode', 'submitLocalDateTime' => 'setSubmitLocalDateTime', 'ownerMerchantId' => 'setOwnerMerchantId'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['code' => 'getCode', 'submitLocalDateTime' => 'getSubmitLocalDateTime', 'ownerMerchantId' => 'getOwnerMerchantId'];

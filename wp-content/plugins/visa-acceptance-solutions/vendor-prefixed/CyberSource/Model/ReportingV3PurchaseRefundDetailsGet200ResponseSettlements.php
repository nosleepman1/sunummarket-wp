...
class ReportingV3PurchaseRefundDetailsGet200ResponseSettlements implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['requestId' => 'string', 'transactionType' => 'string', 'submissionTime' => '\DateTime', 'amount' => 'string', 'currencyCode' => 'string', 'paymentMethod' => 'string', 'walletType' => 'string', 'paymentType' => 'string', 'accountSuffix' => 'string', 'cybersourceBatchTime' => '\DateTime', 'cybersourceBatchId' => 'string', 'cardType' => 'string', 'debitNetwork' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['requestId' => null, 'transactionType' => null, 'submissionTime' => 'date-time', 'amount' => null, 'currencyCode' => null, 'paymentMethod' => null, 'walletType' => null, 'paymentType' => null, 'accountSuffix' => null, 'cybersourceBatchTime' => 'date-time', 'cybersourceBatchId' => null, 'cardType' => null, 'debitNetwork' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['requestId' => 'requestId', 'transactionType' => 'transactionType', 'submissionTime' => 'submissionTime', 'amount' => 'amount', 'currencyCode' => 'currencyCode', 'paymentMethod' => 'paymentMethod', 'walletType' => 'walletType', 'paymentType' => 'paymentType', 'accountSuffix' => 'accountSuffix', 'cybersourceBatchTime' => 'cybersourceBatchTime', 'cybersourceBatchId' => 'cybersourceBatchId', 'cardType' => 'cardType', 'debitNetwork' => 'debitNetwork'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['requestId' => 'setRequestId', 'transactionType' => 'setTransactionType', 'submissionTime' => 'setSubmissionTime', 'amount' => 'setAmount', 'currencyCode' => 'setCurrencyCode', 'paymentMethod' => 'setPaymentMethod', 'walletType' => 'setWalletType', 'paymentType' => 'setPaymentType', 'accountSuffix' => 'setAccountSuffix', 'cybersourceBatchTime' => 'setCybersourceBatchTime', 'cybersourceBatchId' => 'setCybersourceBatchId', 'cardType' => 'setCardType', 'debitNetwork' => 'setDebitNetwork'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['requestId' => 'getRequestId', 'transactionType' => 'getTransactionType', 'submissionTime' => 'getSubmissionTime', 'amount' => 'getAmount', 'currencyCode' => 'getCurrencyCode', 'paymentMethod' => 'getPaymentMethod', 'walletType' => 'getWalletType', 'paymentType' => 'getPaymentType', 'accountSuffix' => 'getAccountSuffix', 'cybersourceBatchTime' => 'getCybersourceBatchTime', 'cybersourceBatchId' => 'getCybersourceBatchId', 'cardType' => 'getCardType', 'debitNetwork' => 'getDebitNetwork'];

...
class Ptsv2paymentsPointOfSaleInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['terminalId' => 'string', 'terminalSerialNumber' => 'string', 'cardholderVerificationMethodUsed' => 'int', 'laneNumber' => 'string', 'catLevel' => 'int', 'entryMode' => 'string', 'terminalCapability' => 'int', 'operatingEnvironment' => 'string', 'emv' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsPointOfSaleInformationEmv', 'amexCapnData' => 'string', 'trackData' => 'string', 'storeAndForwardIndicator' => 'string', 'cardholderVerificationMethod' => 'string[]', 'terminalCategory' => 'string', 'terminalInputCapability' => 'string[]', 'terminalCardCaptureCapability' => 'string', 'terminalOutputCapability' => 'string', 'terminalPinCapability' => 'int', 'pinEntrySolution' => 'string', 'deviceId' => 'string', 'pinBlockEncodingFormat' => 'int', 'encryptedPin' => 'string', 'encryptedKeySerialNumber' => 'string', 'partnerSdkVersion' => 'string', 'emvApplicationIdentifierAndDedicatedFileName' => 'string', 'terminalCompliance' => 'string', 'isDedicatedHardwareTerminal' => 'string', 'terminalModel' => 'string', 'terminalMake' => 'string', 'serviceCode' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['terminalId' => null, 'terminalSerialNumber' => null, 'cardholderVerificationMethodUsed' => null, 'laneNumber' => null, 'catLevel' => null, 'entryMode' => null, 'terminalCapability' => null, 'operatingEnvironment' => null, 'emv' => null, 'amexCapnData' => null, 'trackData' => null, 'storeAndForwardIndicator' => null, 'cardholderVerificationMethod' => null, 'terminalCategory' => null, 'terminalInputCapability' => null, 'terminalCardCaptureCapability' => null, 'terminalOutputCapability' => null, 'terminalPinCapability' => null, 'pinEntrySolution' => null, 'deviceId' => null, 'pinBlockEncodingFormat' => null, 'encryptedPin' => null, 'encryptedKeySerialNumber' => null, 'partnerSdkVersion' => null, 'emvApplicationIdentifierAndDedicatedFileName' => null, 'terminalCompliance' => null, 'isDedicatedHardwareTerminal' => null, 'terminalModel' => null, 'terminalMake' => null, 'serviceCode' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['terminalId' => 'terminalId', 'terminalSerialNumber' => 'terminalSerialNumber', 'cardholderVerificationMethodUsed' => 'cardholderVerificationMethodUsed', 'laneNumber' => 'laneNumber', 'catLevel' => 'catLevel', 'entryMode' => 'entryMode', 'terminalCapability' => 'terminalCapability', 'operatingEnvironment' => 'operatingEnvironment', 'emv' => 'emv', 'amexCapnData' => 'amexCapnData', 'trackData' => 'trackData', 'storeAndForwardIndicator' => 'storeAndForwardIndicator', 'cardholderVerificationMethod' => 'cardholderVerificationMethod', 'terminalCategory' => 'terminalCategory', 'terminalInputCapability' => 'terminalInputCapability', 'terminalCardCaptureCapability' => 'terminalCardCaptureCapability', 'terminalOutputCapability' => 'terminalOutputCapability', 'terminalPinCapability' => 'terminalPinCapability', 'pinEntrySolution' => 'pinEntrySolution', 'deviceId' => 'deviceId', 'pinBlockEncodingFormat' => 'pinBlockEncodingFormat', 'encryptedPin' => 'encryptedPin', 'encryptedKeySerialNumber' => 'encryptedKeySerialNumber', 'partnerSdkVersion' => 'partnerSdkVersion', 'emvApplicationIdentifierAndDedicatedFileName' => 'emvApplicationIdentifierAndDedicatedFileName', 'terminalCompliance' => 'terminalCompliance', 'isDedicatedHardwareTerminal' => 'isDedicatedHardwareTerminal', 'terminalModel' => 'terminalModel', 'terminalMake' => 'terminalMake', 'serviceCode' => 'serviceCode'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['terminalId' => 'setTerminalId', 'terminalSerialNumber' => 'setTerminalSerialNumber', 'cardholderVerificationMethodUsed' => 'setCardholderVerificationMethodUsed', 'laneNumber' => 'setLaneNumber', 'catLevel' => 'setCatLevel', 'entryMode' => 'setEntryMode', 'terminalCapability' => 'setTerminalCapability', 'operatingEnvironment' => 'setOperatingEnvironment', 'emv' => 'setEmv', 'amexCapnData' => 'setAmexCapnData', 'trackData' => 'setTrackData', 'storeAndForwardIndicator' => 'setStoreAndForwardIndicator', 'cardholderVerificationMethod' => 'setCardholderVerificationMethod', 'terminalCategory' => 'setTerminalCategory', 'terminalInputCapability' => 'setTerminalInputCapability', 'terminalCardCaptureCapability' => 'setTerminalCardCaptureCapability', 'terminalOutputCapability' => 'setTerminalOutputCapability', 'terminalPinCapability' => 'setTerminalPinCapability', 'pinEntrySolution' => 'setPinEntrySolution', 'deviceId' => 'setDeviceId', 'pinBlockEncodingFormat' => 'setPinBlockEncodingFormat', 'encryptedPin' => 'setEncryptedPin', 'encryptedKeySerialNumber' => 'setEncryptedKeySerialNumber', 'partnerSdkVersion' => 'setPartnerSdkVersion', 'emvApplicationIdentifierAndDedicatedFileName' => 'setEmvApplicationIdentifierAndDedicatedFileName', 'terminalCompliance' => 'setTerminalCompliance', 'isDedicatedHardwareTerminal' => 'setIsDedicatedHardwareTerminal', 'terminalModel' => 'setTerminalModel', 'terminalMake' => 'setTerminalMake', 'serviceCode' => 'setServiceCode'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['terminalId' => 'getTerminalId', 'terminalSerialNumber' => 'getTerminalSerialNumber', 'cardholderVerificationMethodUsed' => 'getCardholderVerificationMethodUsed', 'laneNumber' => 'getLaneNumber', 'catLevel' => 'getCatLevel', 'entryMode' => 'getEntryMode', 'terminalCapability' => 'getTerminalCapability', 'operatingEnvironment' => 'getOperatingEnvironment', 'emv' => 'getEmv', 'amexCapnData' => 'getAmexCapnData', 'trackData' => 'getTrackData', 'storeAndForwardIndicator' => 'getStoreAndForwardIndicator', 'cardholderVerificationMethod' => 'getCardholderVerificationMethod', 'terminalCategory' => 'getTerminalCategory', 'terminalInputCapability' => 'getTerminalInputCapability', 'terminalCardCaptureCapability' => 'getTerminalCardCaptureCapability', 'terminalOutputCapability' => 'getTerminalOutputCapability', 'terminalPinCapability' => 'getTerminalPinCapability', 'pinEntrySolution' => 'getPinEntrySolution', 'deviceId' => 'getDeviceId', 'pinBlockEncodingFormat' => 'getPinBlockEncodingFormat', 'encryptedPin' => 'getEncryptedPin', 'encryptedKeySerialNumber' => 'getEncryptedKeySerialNumber', 'partnerSdkVersion' => 'getPartnerSdkVersion', 'emvApplicationIdentifierAndDedicatedFileName' => 'getEmvApplicationIdentifierAndDedicatedFileName', 'terminalCompliance' => 'getTerminalCompliance', 'isDedicatedHardwareTerminal' => 'getIsDedicatedHardwareTerminal', 'terminalModel' => 'getTerminalModel', 'terminalMake' => 'getTerminalMake', 'serviceCode' => 'getServiceCode'];
    ...
    /**
     * Gets emv
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsPointOfSaleInformationEmv
     */
    ...
    /**
     * Sets emv
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsPointOfSaleInformationEmv $emv
     * @return $this
     */

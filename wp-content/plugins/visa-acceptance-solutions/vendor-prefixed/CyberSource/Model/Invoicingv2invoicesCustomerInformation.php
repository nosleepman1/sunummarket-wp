...
class Invoicingv2invoicesCustomerInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['name' => 'string', 'email' => 'string', 'merchantCustomerId' => 'string', 'company' => '\Pymt_Vas\Dependencies\CyberSource\Model\Invoicingv2invoicesCustomerInformationCompany'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['name' => null, 'email' => null, 'merchantCustomerId' => null, 'company' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['name' => 'name', 'email' => 'email', 'merchantCustomerId' => 'merchantCustomerId', 'company' => 'company'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['name' => 'setName', 'email' => 'setEmail', 'merchantCustomerId' => 'setMerchantCustomerId', 'company' => 'setCompany'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['name' => 'getName', 'email' => 'getEmail', 'merchantCustomerId' => 'getMerchantCustomerId', 'company' => 'getCompany'];
    ...
    /**
     * Gets company
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Invoicingv2invoicesCustomerInformationCompany
     */
    ...
    /**
     * Sets company
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Invoicingv2invoicesCustomerInformationCompany $company
     * @return $this
     */

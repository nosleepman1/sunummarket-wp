...
class Ptsv2paymentsClientReferenceInformationPartner implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['originalTransactionId' => 'string', 'developerId' => 'string', 'solutionId' => 'string', 'thirdPartyCertificationNumber' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['originalTransactionId' => null, 'developerId' => null, 'solutionId' => null, 'thirdPartyCertificationNumber' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['originalTransactionId' => 'originalTransactionId', 'developerId' => 'developerId', 'solutionId' => 'solutionId', 'thirdPartyCertificationNumber' => 'thirdPartyCertificationNumber'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['originalTransactionId' => 'setOriginalTransactionId', 'developerId' => 'setDeveloperId', 'solutionId' => 'setSolutionId', 'thirdPartyCertificationNumber' => 'setThirdPartyCertificationNumber'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['originalTransactionId' => 'getOriginalTransactionId', 'developerId' => 'getDeveloperId', 'solutionId' => 'getSolutionId', 'thirdPartyCertificationNumber' => 'getThirdPartyCertificationNumber'];

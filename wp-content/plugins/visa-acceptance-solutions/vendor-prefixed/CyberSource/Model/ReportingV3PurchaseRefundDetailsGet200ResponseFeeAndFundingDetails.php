...
class ReportingV3PurchaseRefundDetailsGet200ResponseFeeAndFundingDetails implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['requestId' => 'string', 'interchangePerItemFee' => 'string', 'interchangeDescription' => 'string', 'interchangePercentage' => 'string', 'interchangePercentageAmount' => 'string', 'discountPercentage' => 'string', 'discountAmount' => 'string', 'discountPerItemFee' => 'string', 'totalFee' => 'string', 'feeCurrency' => 'string', 'duesAssessments' => 'string', 'fundingAmount' => 'string', 'fundingCurrency' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['requestId' => null, 'interchangePerItemFee' => null, 'interchangeDescription' => null, 'interchangePercentage' => null, 'interchangePercentageAmount' => null, 'discountPercentage' => null, 'discountAmount' => null, 'discountPerItemFee' => null, 'totalFee' => null, 'feeCurrency' => null, 'duesAssessments' => null, 'fundingAmount' => null, 'fundingCurrency' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['requestId' => 'requestId', 'interchangePerItemFee' => 'interchangePerItemFee', 'interchangeDescription' => 'interchangeDescription', 'interchangePercentage' => 'interchangePercentage', 'interchangePercentageAmount' => 'interchangePercentageAmount', 'discountPercentage' => 'discountPercentage', 'discountAmount' => 'discountAmount', 'discountPerItemFee' => 'discountPerItemFee', 'totalFee' => 'totalFee', 'feeCurrency' => 'feeCurrency', 'duesAssessments' => 'duesAssessments', 'fundingAmount' => 'fundingAmount', 'fundingCurrency' => 'fundingCurrency'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['requestId' => 'setRequestId', 'interchangePerItemFee' => 'setInterchangePerItemFee', 'interchangeDescription' => 'setInterchangeDescription', 'interchangePercentage' => 'setInterchangePercentage', 'interchangePercentageAmount' => 'setInterchangePercentageAmount', 'discountPercentage' => 'setDiscountPercentage', 'discountAmount' => 'setDiscountAmount', 'discountPerItemFee' => 'setDiscountPerItemFee', 'totalFee' => 'setTotalFee', 'feeCurrency' => 'setFeeCurrency', 'duesAssessments' => 'setDuesAssessments', 'fundingAmount' => 'setFundingAmount', 'fundingCurrency' => 'setFundingCurrency'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['requestId' => 'getRequestId', 'interchangePerItemFee' => 'getInterchangePerItemFee', 'interchangeDescription' => 'getInterchangeDescription', 'interchangePercentage' => 'getInterchangePercentage', 'interchangePercentageAmount' => 'getInterchangePercentageAmount', 'discountPercentage' => 'getDiscountPercentage', 'discountAmount' => 'getDiscountAmount', 'discountPerItemFee' => 'getDiscountPerItemFee', 'totalFee' => 'getTotalFee', 'feeCurrency' => 'getFeeCurrency', 'duesAssessments' => 'getDuesAssessments', 'fundingAmount' => 'getFundingAmount', 'fundingCurrency' => 'getFundingCurrency'];

...
class CardProcessingConfigFeaturesCardNotPresent implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['processors' => 'map[string,\Pymt_Vas\Dependencies\CyberSource\Model\CardProcessingConfigFeaturesCardNotPresentProcessors]', 'ignoreAddressVerificationSystem' => 'bool', 'visaStraightThroughProcessingOnly' => 'bool', 'amexTransactionAdviceAddendum1' => 'string', 'installment' => '\Pymt_Vas\Dependencies\CyberSource\Model\CardProcessingConfigFeaturesCardNotPresentInstallment'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['processors' => null, 'ignoreAddressVerificationSystem' => null, 'visaStraightThroughProcessingOnly' => null, 'amexTransactionAdviceAddendum1' => null, 'installment' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['processors' => 'processors', 'ignoreAddressVerificationSystem' => 'ignoreAddressVerificationSystem', 'visaStraightThroughProcessingOnly' => 'visaStraightThroughProcessingOnly', 'amexTransactionAdviceAddendum1' => 'amexTransactionAdviceAddendum1', 'installment' => 'installment'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['processors' => 'setProcessors', 'ignoreAddressVerificationSystem' => 'setIgnoreAddressVerificationSystem', 'visaStraightThroughProcessingOnly' => 'setVisaStraightThroughProcessingOnly', 'amexTransactionAdviceAddendum1' => 'setAmexTransactionAdviceAddendum1', 'installment' => 'setInstallment'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['processors' => 'getProcessors', 'ignoreAddressVerificationSystem' => 'getIgnoreAddressVerificationSystem', 'visaStraightThroughProcessingOnly' => 'getVisaStraightThroughProcessingOnly', 'amexTransactionAdviceAddendum1' => 'getAmexTransactionAdviceAddendum1', 'installment' => 'getInstallment'];
    ...
    /**
     * Gets processors
     * @return map[string,\Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\CardProcessingConfigFeaturesCardNotPresentProcessors]
     */
    ...
    /**
     * Sets processors
     * @param map[string,\Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\CardProcessingConfigFeaturesCardNotPresentProcessors] $processors e.g. * amexdirect * barclays2 * CUP * EFTPOS * fdiglobal * gpx * smartfdc * tsys * vero * VPC  For VPC, CUP and EFTPOS processors, replace the processor name from VPC or CUP or EFTPOS to the actual processor name in the sample request. e.g. replace VPC with &lt;your vpc processor&gt;
     * @return $this
     */
    ...
    /**
     * Gets installment
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\CardProcessingConfigFeaturesCardNotPresentInstallment
     */
    ...
    /**
     * Sets installment
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\CardProcessingConfigFeaturesCardNotPresentInstallment $installment
     * @return $this
     */

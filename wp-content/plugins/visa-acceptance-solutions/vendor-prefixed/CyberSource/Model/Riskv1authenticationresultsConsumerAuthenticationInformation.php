...
class Riskv1authenticationresultsConsumerAuthenticationInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['authenticationTransactionId' => 'string', 'authenticationTransactionContext' => 'string', 'otpToken' => 'string', 'responseAccessToken' => 'string', 'signedParesStatusReason' => 'string', 'signedPares' => 'string', 'whiteListStatus' => 'string', 'credentialEncrypted' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['authenticationTransactionId' => null, 'authenticationTransactionContext' => null, 'otpToken' => null, 'responseAccessToken' => null, 'signedParesStatusReason' => null, 'signedPares' => null, 'whiteListStatus' => null, 'credentialEncrypted' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['authenticationTransactionId' => 'authenticationTransactionId', 'authenticationTransactionContext' => 'authenticationTransactionContext', 'otpToken' => 'otpToken', 'responseAccessToken' => 'responseAccessToken', 'signedParesStatusReason' => 'signedParesStatusReason', 'signedPares' => 'signedPares', 'whiteListStatus' => 'whiteListStatus', 'credentialEncrypted' => 'credentialEncrypted'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['authenticationTransactionId' => 'setAuthenticationTransactionId', 'authenticationTransactionContext' => 'setAuthenticationTransactionContext', 'otpToken' => 'setOtpToken', 'responseAccessToken' => 'setResponseAccessToken', 'signedParesStatusReason' => 'setSignedParesStatusReason', 'signedPares' => 'setSignedPares', 'whiteListStatus' => 'setWhiteListStatus', 'credentialEncrypted' => 'setCredentialEncrypted'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['authenticationTransactionId' => 'getAuthenticationTransactionId', 'authenticationTransactionContext' => 'getAuthenticationTransactionContext', 'otpToken' => 'getOtpToken', 'responseAccessToken' => 'getResponseAccessToken', 'signedParesStatusReason' => 'getSignedParesStatusReason', 'signedPares' => 'getSignedPares', 'whiteListStatus' => 'getWhiteListStatus', 'credentialEncrypted' => 'getCredentialEncrypted'];

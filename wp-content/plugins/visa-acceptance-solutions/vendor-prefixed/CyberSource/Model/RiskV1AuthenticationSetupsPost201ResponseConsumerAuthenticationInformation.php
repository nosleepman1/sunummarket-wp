...
class RiskV1AuthenticationSetupsPost201ResponseConsumerAuthenticationInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['accessToken' => 'string', 'referenceId' => 'string', 'deviceDataCollectionUrl' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['accessToken' => null, 'referenceId' => null, 'deviceDataCollectionUrl' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['accessToken' => 'accessToken', 'referenceId' => 'referenceId', 'deviceDataCollectionUrl' => 'deviceDataCollectionUrl'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['accessToken' => 'setAccessToken', 'referenceId' => 'setReferenceId', 'deviceDataCollectionUrl' => 'setDeviceDataCollectionUrl'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['accessToken' => 'getAccessToken', 'referenceId' => 'getReferenceId', 'deviceDataCollectionUrl' => 'getDeviceDataCollectionUrl'];

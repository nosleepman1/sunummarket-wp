...
class Ptsv2billingagreementsMerchantInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['merchantDescriptor' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2billingagreementsMerchantInformationMerchantDescriptor', 'categoryCode' => 'int', 'administrativeArea' => 'string', 'transactionLocalDateTime' => 'string', 'cancelUrl' => 'string', 'successUrl' => 'string', 'failureUrl' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['merchantDescriptor' => null, 'categoryCode' => null, 'administrativeArea' => null, 'transactionLocalDateTime' => null, 'cancelUrl' => null, 'successUrl' => null, 'failureUrl' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['merchantDescriptor' => 'merchantDescriptor', 'categoryCode' => 'categoryCode', 'administrativeArea' => 'administrativeArea', 'transactionLocalDateTime' => 'transactionLocalDateTime', 'cancelUrl' => 'cancelUrl', 'successUrl' => 'successUrl', 'failureUrl' => 'failureUrl'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['merchantDescriptor' => 'setMerchantDescriptor', 'categoryCode' => 'setCategoryCode', 'administrativeArea' => 'setAdministrativeArea', 'transactionLocalDateTime' => 'setTransactionLocalDateTime', 'cancelUrl' => 'setCancelUrl', 'successUrl' => 'setSuccessUrl', 'failureUrl' => 'setFailureUrl'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['merchantDescriptor' => 'getMerchantDescriptor', 'categoryCode' => 'getCategoryCode', 'administrativeArea' => 'getAdministrativeArea', 'transactionLocalDateTime' => 'getTransactionLocalDateTime', 'cancelUrl' => 'getCancelUrl', 'successUrl' => 'getSuccessUrl', 'failureUrl' => 'getFailureUrl'];
     ...
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2billingagreementsMerchantInformationMerchantDescriptor
     */
     ...
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2billingagreementsMerchantInformationMerchantDescriptor $merchantDescriptor
     * @return $this
     */

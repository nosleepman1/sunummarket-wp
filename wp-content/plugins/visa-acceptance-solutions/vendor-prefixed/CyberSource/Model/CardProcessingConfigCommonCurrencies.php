...
use ArrayAccess;
/**
 * CardProcessingConfigCommonCurrencies Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CardProcessingConfigCommonCurrencies implements ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'CardProcessingConfig_common_currencies';
    /**
     * Array of property to type mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerTypes = ['enabled' => 'bool', 'enabledCardPresent' => 'bool', 'enabledCardNotPresent' => 'bool', 'merchantId' => 'string', 'terminalId' => 'string', 'terminalIds' => 'string[]', 'serviceEnablementNumber' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['enabled' => null, 'enabledCardPresent' => null, 'enabledCardNotPresent' => null, 'merchantId' => null, 'terminalId' => null, 'terminalIds' => null, 'serviceEnablementNumber' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['enabled' => 'enabled', 'enabledCardPresent' => 'enabledCardPresent', 'enabledCardNotPresent' => 'enabledCardNotPresent', 'merchantId' => 'merchantId', 'terminalId' => 'terminalId', 'terminalIds' => 'terminalIds', 'serviceEnablementNumber' => 'serviceEnablementNumber'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['enabled' => 'setEnabled', 'enabledCardPresent' => 'setEnabledCardPresent', 'enabledCardNotPresent' => 'setEnabledCardNotPresent', 'merchantId' => 'setMerchantId', 'terminalId' => 'setTerminalId', 'terminalIds' => 'setTerminalIds', 'serviceEnablementNumber' => 'setServiceEnablementNumber'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['enabled' => 'getEnabled', 'enabledCardPresent' => 'getEnabledCardPresent', 'enabledCardNotPresent' => 'getEnabledCardNotPresent', 'merchantId' => 'getMerchantId', 'terminalId' => 'getTerminalId', 'terminalIds' => 'getTerminalIds', 'serviceEnablementNumber' => 'getServiceEnablementNumber'];
     ...
     * @param bool $enabledCardNotPresent Indicates whether the card-not-present transaction is activated for the selected currency. If both enabledCardPresent and enabledCardNotPresent are set to null, then enabledCardNotPresent will have the value of enabled.
     * @return $this
     */
    ...
    /**
     * Sets merchantId
     * @param string $merchantId Merchant ID assigned by an acquirer or a processor. Should not be overridden by any other party.
     * @return $this
     */

...
class Ptsv2paymentsProcessingInformationBankTransferOptions implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['declineAvsFlags' => 'string', 'secCode' => 'string', 'terminalCity' => 'string', 'terminalState' => 'string', 'effectiveDate' => 'string', 'partialPaymentId' => 'string', 'customerMemo' => 'string', 'paymentCategoryCode' => 'string', 'settlementMethod' => 'string', 'fraudScreeningLevel' => 'string', 'customerPresent' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['declineAvsFlags' => null, 'secCode' => null, 'terminalCity' => null, 'terminalState' => null, 'effectiveDate' => null, 'partialPaymentId' => null, 'customerMemo' => null, 'paymentCategoryCode' => null, 'settlementMethod' => null, 'fraudScreeningLevel' => null, 'customerPresent' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['declineAvsFlags' => 'declineAvsFlags', 'secCode' => 'secCode', 'terminalCity' => 'terminalCity', 'terminalState' => 'terminalState', 'effectiveDate' => 'effectiveDate', 'partialPaymentId' => 'partialPaymentId', 'customerMemo' => 'customerMemo', 'paymentCategoryCode' => 'paymentCategoryCode', 'settlementMethod' => 'settlementMethod', 'fraudScreeningLevel' => 'fraudScreeningLevel', 'customerPresent' => 'customerPresent'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['declineAvsFlags' => 'setDeclineAvsFlags', 'secCode' => 'setSecCode', 'terminalCity' => 'setTerminalCity', 'terminalState' => 'setTerminalState', 'effectiveDate' => 'setEffectiveDate', 'partialPaymentId' => 'setPartialPaymentId', 'customerMemo' => 'setCustomerMemo', 'paymentCategoryCode' => 'setPaymentCategoryCode', 'settlementMethod' => 'setSettlementMethod', 'fraudScreeningLevel' => 'setFraudScreeningLevel', 'customerPresent' => 'setCustomerPresent'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['declineAvsFlags' => 'getDeclineAvsFlags', 'secCode' => 'getSecCode', 'terminalCity' => 'getTerminalCity', 'terminalState' => 'getTerminalState', 'effectiveDate' => 'getEffectiveDate', 'partialPaymentId' => 'getPartialPaymentId', 'customerMemo' => 'getCustomerMemo', 'paymentCategoryCode' => 'getPaymentCategoryCode', 'settlementMethod' => 'getSettlementMethod', 'fraudScreeningLevel' => 'getFraudScreeningLevel', 'customerPresent' => 'getCustomerPresent'];
     ...
     * @param string $fraudScreeningLevel Level of fraud screening.  Possible values: - `1`: Validation — default if the field has not already been configured for your merchant ID - `2`: Verification
     * @return $this
     */

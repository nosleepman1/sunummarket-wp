...
class Ptsv2paymentsConsumerAuthenticationInformationStrongAuthentication implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['issuerInformation' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsConsumerAuthenticationInformationStrongAuthenticationIssuerInformation', 'lowValueExemptionIndicator' => 'string', 'riskAnalysisExemptionIndicator' => 'string', 'trustedMerchantExemptionIndicator' => 'string', 'secureCorporatePaymentIndicator' => 'string', 'delegatedAuthenticationExemptionIndicator' => 'string', 'outageExemptionIndicator' => 'string', 'authenticationIndicator' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['issuerInformation' => null, 'lowValueExemptionIndicator' => null, 'riskAnalysisExemptionIndicator' => null, 'trustedMerchantExemptionIndicator' => null, 'secureCorporatePaymentIndicator' => null, 'delegatedAuthenticationExemptionIndicator' => null, 'outageExemptionIndicator' => null, 'authenticationIndicator' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['issuerInformation' => 'issuerInformation', 'lowValueExemptionIndicator' => 'lowValueExemptionIndicator', 'riskAnalysisExemptionIndicator' => 'riskAnalysisExemptionIndicator', 'trustedMerchantExemptionIndicator' => 'trustedMerchantExemptionIndicator', 'secureCorporatePaymentIndicator' => 'secureCorporatePaymentIndicator', 'delegatedAuthenticationExemptionIndicator' => 'delegatedAuthenticationExemptionIndicator', 'outageExemptionIndicator' => 'outageExemptionIndicator', 'authenticationIndicator' => 'authenticationIndicator'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['issuerInformation' => 'setIssuerInformation', 'lowValueExemptionIndicator' => 'setLowValueExemptionIndicator', 'riskAnalysisExemptionIndicator' => 'setRiskAnalysisExemptionIndicator', 'trustedMerchantExemptionIndicator' => 'setTrustedMerchantExemptionIndicator', 'secureCorporatePaymentIndicator' => 'setSecureCorporatePaymentIndicator', 'delegatedAuthenticationExemptionIndicator' => 'setDelegatedAuthenticationExemptionIndicator', 'outageExemptionIndicator' => 'setOutageExemptionIndicator', 'authenticationIndicator' => 'setAuthenticationIndicator'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['issuerInformation' => 'getIssuerInformation', 'lowValueExemptionIndicator' => 'getLowValueExemptionIndicator', 'riskAnalysisExemptionIndicator' => 'getRiskAnalysisExemptionIndicator', 'trustedMerchantExemptionIndicator' => 'getTrustedMerchantExemptionIndicator', 'secureCorporatePaymentIndicator' => 'getSecureCorporatePaymentIndicator', 'delegatedAuthenticationExemptionIndicator' => 'getDelegatedAuthenticationExemptionIndicator', 'outageExemptionIndicator' => 'getOutageExemptionIndicator', 'authenticationIndicator' => 'getAuthenticationIndicator'];
     ...
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsConsumerAuthenticationInformationStrongAuthenticationIssuerInformation
     */
     ...
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsConsumerAuthenticationInformationStrongAuthenticationIssuerInformation $issuerInformation
     * @return $this
     */

...
class Ptsv2paymentsTravelInformationAutoRentalReturnAddress implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['city' => 'string', 'state' => 'string', 'country' => 'string', 'locationId' => 'string', 'address1' => 'string', 'postalCode' => 'string', 'location' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['city' => null, 'state' => null, 'country' => null, 'locationId' => null, 'address1' => null, 'postalCode' => null, 'location' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['city' => 'city', 'state' => 'state', 'country' => 'country', 'locationId' => 'locationId', 'address1' => 'address1', 'postalCode' => 'postalCode', 'location' => 'location'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['city' => 'setCity', 'state' => 'setState', 'country' => 'setCountry', 'locationId' => 'setLocationId', 'address1' => 'setAddress1', 'postalCode' => 'setPostalCode', 'location' => 'setLocation'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['city' => 'getCity', 'state' => 'getState', 'country' => 'getCountry', 'locationId' => 'getLocationId', 'address1' => 'getAddress1', 'postalCode' => 'getPostalCode', 'location' => 'getLocation'];

...
use ArrayAccess;
/**
 * Ptsv2paymentsidrefundsPaymentInformationBankAccount Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Ptsv2paymentsidrefundsPaymentInformationBankAccount implements ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'ptsv2paymentsidrefunds_paymentInformation_bank_account';
    /**
     * Array of property to type mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerTypes = ['type' => 'string', 'number' => 'string', 'encoderId' => 'string', 'checkNumber' => 'string', 'checkImageReferenceNumber' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['type' => null, 'number' => null, 'encoderId' => null, 'checkNumber' => null, 'checkImageReferenceNumber' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['type' => 'type', 'number' => 'number', 'encoderId' => 'encoderId', 'checkNumber' => 'checkNumber', 'checkImageReferenceNumber' => 'checkImageReferenceNumber'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['type' => 'setType', 'number' => 'setNumber', 'encoderId' => 'setEncoderId', 'checkNumber' => 'setCheckNumber', 'checkImageReferenceNumber' => 'setCheckImageReferenceNumber'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['type' => 'getType', 'number' => 'getNumber', 'encoderId' => 'getEncoderId', 'checkNumber' => 'getCheckNumber', 'checkImageReferenceNumber' => 'getCheckImageReferenceNumber'];

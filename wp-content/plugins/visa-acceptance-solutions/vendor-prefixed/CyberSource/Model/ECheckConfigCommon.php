...
class ECheckConfigCommon implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['processors' => 'map[string,\Pymt_Vas\Dependencies\CyberSource\Model\ECheckConfigCommonProcessors]', 'internalOnly' => '\Pymt_Vas\Dependencies\CyberSource\Model\ECheckConfigCommonInternalOnly', 'accountHolderName' => 'string', 'accountType' => 'string', 'accountRoutingNumber' => 'string', 'accountNumber' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['processors' => null, 'internalOnly' => null, 'accountHolderName' => null, 'accountType' => null, 'accountRoutingNumber' => null, 'accountNumber' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['processors' => 'processors', 'internalOnly' => 'internalOnly', 'accountHolderName' => 'accountHolderName', 'accountType' => 'accountType', 'accountRoutingNumber' => 'accountRoutingNumber', 'accountNumber' => 'accountNumber'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['processors' => 'setProcessors', 'internalOnly' => 'setInternalOnly', 'accountHolderName' => 'setAccountHolderName', 'accountType' => 'setAccountType', 'accountRoutingNumber' => 'setAccountRoutingNumber', 'accountNumber' => 'setAccountNumber'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['processors' => 'getProcessors', 'internalOnly' => 'getInternalOnly', 'accountHolderName' => 'getAccountHolderName', 'accountType' => 'getAccountType', 'accountRoutingNumber' => 'getAccountRoutingNumber', 'accountNumber' => 'getAccountNumber'];
    ...
    /**
     * Gets processors
     * @return map[string,\Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\ECheckConfigCommonProcessors]
     */
    ...
    /**
     * Sets processors
     * @param map[string,\Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\ECheckConfigCommonProcessors] $processors
     * @return $this
     */
    ...
    /**
     * Gets internalOnly
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\ECheckConfigCommonInternalOnly
     */
    ...
    /**
     * Sets internalOnly
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\ECheckConfigCommonInternalOnly $internalOnly
     * @return $this
     */

...
class PtsV1TransactionBatchesIdGet200Response implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['id' => 'string', 'uploadDate' => 'string', 'completionDate' => 'string', 'transactionCount' => 'int', 'acceptedTransactionCount' => 'int', 'rejectedTransactionCount' => 'string', 'status' => 'string', 'links' => '\Pymt_Vas\Dependencies\CyberSource\Model\PtsV1TransactionBatchesIdGet200ResponseLinks'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['id' => null, 'uploadDate' => null, 'completionDate' => null, 'transactionCount' => null, 'acceptedTransactionCount' => null, 'rejectedTransactionCount' => null, 'status' => null, 'links' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['id' => 'id', 'uploadDate' => 'uploadDate', 'completionDate' => 'completionDate', 'transactionCount' => 'transactionCount', 'acceptedTransactionCount' => 'acceptedTransactionCount', 'rejectedTransactionCount' => 'rejectedTransactionCount', 'status' => 'status', 'links' => '_links'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['id' => 'setId', 'uploadDate' => 'setUploadDate', 'completionDate' => 'setCompletionDate', 'transactionCount' => 'setTransactionCount', 'acceptedTransactionCount' => 'setAcceptedTransactionCount', 'rejectedTransactionCount' => 'setRejectedTransactionCount', 'status' => 'setStatus', 'links' => 'setLinks'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['id' => 'getId', 'uploadDate' => 'getUploadDate', 'completionDate' => 'getCompletionDate', 'transactionCount' => 'getTransactionCount', 'acceptedTransactionCount' => 'getAcceptedTransactionCount', 'rejectedTransactionCount' => 'getRejectedTransactionCount', 'status' => 'getStatus', 'links' => 'getLinks'];
    ...
    /**
     * Gets links
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\PtsV1TransactionBatchesIdGet200ResponseLinks
     */
    ...
    /**
     * Sets links
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\PtsV1TransactionBatchesIdGet200ResponseLinks $links
     * @return $this
     */

...
class TssV2TransactionsGet200ResponseProcessingInformationJapanPaymentOptions implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['paymentMethod' => 'string', 'terminalId' => 'string', 'businessName' => 'string', 'businessNameKatakana' => 'string', 'businessNameEnglish' => 'string', 'bonuses' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsProcessingInformationJapanPaymentOptionsBonuses[]', 'firstBillingMonth' => 'string', 'numberOfInstallments' => 'string', 'preApprovalType' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['paymentMethod' => null, 'terminalId' => null, 'businessName' => null, 'businessNameKatakana' => null, 'businessNameEnglish' => null, 'bonuses' => null, 'firstBillingMonth' => null, 'numberOfInstallments' => null, 'preApprovalType' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['paymentMethod' => 'paymentMethod', 'terminalId' => 'terminalId', 'businessName' => 'businessName', 'businessNameKatakana' => 'businessNameKatakana', 'businessNameEnglish' => 'businessNameEnglish', 'bonuses' => 'bonuses', 'firstBillingMonth' => 'firstBillingMonth', 'numberOfInstallments' => 'numberOfInstallments', 'preApprovalType' => 'preApprovalType'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['paymentMethod' => 'setPaymentMethod', 'terminalId' => 'setTerminalId', 'businessName' => 'setBusinessName', 'businessNameKatakana' => 'setBusinessNameKatakana', 'businessNameEnglish' => 'setBusinessNameEnglish', 'bonuses' => 'setBonuses', 'firstBillingMonth' => 'setFirstBillingMonth', 'numberOfInstallments' => 'setNumberOfInstallments', 'preApprovalType' => 'setPreApprovalType'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['paymentMethod' => 'getPaymentMethod', 'terminalId' => 'getTerminalId', 'businessName' => 'getBusinessName', 'businessNameKatakana' => 'getBusinessNameKatakana', 'businessNameEnglish' => 'getBusinessNameEnglish', 'bonuses' => 'getBonuses', 'firstBillingMonth' => 'getFirstBillingMonth', 'numberOfInstallments' => 'getNumberOfInstallments', 'preApprovalType' => 'getPreApprovalType'];

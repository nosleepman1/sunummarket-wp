...
class Ptsv2paymentsTravelInformationTransitAirlineLegs implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['carrierCode' => 'string', 'flightNumber' => 'string', 'originatingAirportCode' => 'string', 'class' => 'string', 'stopoverIndicator' => 'int', 'departureDate' => 'int', 'destinationAirportCode' => 'string', 'fareBasis' => 'string', 'departTaxAmount' => 'string', 'conjunctionTicket' => 'string', 'exchangeTicketNumber' => 'string', 'couponNumber' => 'string', 'departureTime' => 'int', 'departureTimeMeridian' => 'string', 'arrivalTime' => 'int', 'arrivalTimeMeridian' => 'string', 'endorsementsRestrictions' => 'string', 'totalFareAmount' => 'string', 'feeAmount' => 'string', 'taxAmount' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['carrierCode' => null, 'flightNumber' => null, 'originatingAirportCode' => null, 'class' => null, 'stopoverIndicator' => null, 'departureDate' => null, 'destinationAirportCode' => null, 'fareBasis' => null, 'departTaxAmount' => null, 'conjunctionTicket' => null, 'exchangeTicketNumber' => null, 'couponNumber' => null, 'departureTime' => null, 'departureTimeMeridian' => null, 'arrivalTime' => null, 'arrivalTimeMeridian' => null, 'endorsementsRestrictions' => null, 'totalFareAmount' => null, 'feeAmount' => null, 'taxAmount' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['carrierCode' => 'carrierCode', 'flightNumber' => 'flightNumber', 'originatingAirportCode' => 'originatingAirportCode', 'class' => 'class', 'stopoverIndicator' => 'stopoverIndicator', 'departureDate' => 'departureDate', 'destinationAirportCode' => 'destinationAirportCode', 'fareBasis' => 'fareBasis', 'departTaxAmount' => 'departTaxAmount', 'conjunctionTicket' => 'conjunctionTicket', 'exchangeTicketNumber' => 'exchangeTicketNumber', 'couponNumber' => 'couponNumber', 'departureTime' => 'departureTime', 'departureTimeMeridian' => 'departureTimeMeridian', 'arrivalTime' => 'arrivalTime', 'arrivalTimeMeridian' => 'arrivalTimeMeridian', 'endorsementsRestrictions' => 'endorsementsRestrictions', 'totalFareAmount' => 'totalFareAmount', 'feeAmount' => 'feeAmount', 'taxAmount' => 'taxAmount'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['carrierCode' => 'setCarrierCode', 'flightNumber' => 'setFlightNumber', 'originatingAirportCode' => 'setOriginatingAirportCode', 'class' => 'setClass', 'stopoverIndicator' => 'setStopoverIndicator', 'departureDate' => 'setDepartureDate', 'destinationAirportCode' => 'setDestinationAirportCode', 'fareBasis' => 'setFareBasis', 'departTaxAmount' => 'setDepartTaxAmount', 'conjunctionTicket' => 'setConjunctionTicket', 'exchangeTicketNumber' => 'setExchangeTicketNumber', 'couponNumber' => 'setCouponNumber', 'departureTime' => 'setDepartureTime', 'departureTimeMeridian' => 'setDepartureTimeMeridian', 'arrivalTime' => 'setArrivalTime', 'arrivalTimeMeridian' => 'setArrivalTimeMeridian', 'endorsementsRestrictions' => 'setEndorsementsRestrictions', 'totalFareAmount' => 'setTotalFareAmount', 'feeAmount' => 'setFeeAmount', 'taxAmount' => 'setTaxAmount'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['carrierCode' => 'getCarrierCode', 'flightNumber' => 'getFlightNumber', 'originatingAirportCode' => 'getOriginatingAirportCode', 'class' => 'getClass', 'stopoverIndicator' => 'getStopoverIndicator', 'departureDate' => 'getDepartureDate', 'destinationAirportCode' => 'getDestinationAirportCode', 'fareBasis' => 'getFareBasis', 'departTaxAmount' => 'getDepartTaxAmount', 'conjunctionTicket' => 'getConjunctionTicket', 'exchangeTicketNumber' => 'getExchangeTicketNumber', 'couponNumber' => 'getCouponNumber', 'departureTime' => 'getDepartureTime', 'departureTimeMeridian' => 'getDepartureTimeMeridian', 'arrivalTime' => 'getArrivalTime', 'arrivalTimeMeridian' => 'getArrivalTimeMeridian', 'endorsementsRestrictions' => 'getEndorsementsRestrictions', 'totalFareAmount' => 'getTotalFareAmount', 'feeAmount' => 'getFeeAmount', 'taxAmount' => 'getTaxAmount'];

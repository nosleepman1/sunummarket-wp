...
class Ptsv2paymentsOrderInformationShipTo implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['title' => 'string', 'firstName' => 'string', 'middleName' => 'string', 'lastName' => 'string', 'address1' => 'string', 'address2' => 'string', 'locality' => 'string', 'administrativeArea' => 'string', 'postalCode' => 'string', 'county' => 'string', 'country' => 'string', 'district' => 'string', 'buildingNumber' => 'string', 'phoneNumber' => 'string', 'email' => 'string', 'company' => 'string', 'destinationTypes' => 'string', 'destinationCode' => 'int', 'method' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['title' => null, 'firstName' => null, 'middleName' => null, 'lastName' => null, 'address1' => null, 'address2' => null, 'locality' => null, 'administrativeArea' => null, 'postalCode' => null, 'county' => null, 'country' => null, 'district' => null, 'buildingNumber' => null, 'phoneNumber' => null, 'email' => null, 'company' => null, 'destinationTypes' => null, 'destinationCode' => null, 'method' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['title' => 'title', 'firstName' => 'firstName', 'middleName' => 'middleName', 'lastName' => 'lastName', 'address1' => 'address1', 'address2' => 'address2', 'locality' => 'locality', 'administrativeArea' => 'administrativeArea', 'postalCode' => 'postalCode', 'county' => 'county', 'country' => 'country', 'district' => 'district', 'buildingNumber' => 'buildingNumber', 'phoneNumber' => 'phoneNumber', 'email' => 'email', 'company' => 'company', 'destinationTypes' => 'destinationTypes', 'destinationCode' => 'destinationCode', 'method' => 'method'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['title' => 'setTitle', 'firstName' => 'setFirstName', 'middleName' => 'setMiddleName', 'lastName' => 'setLastName', 'address1' => 'setAddress1', 'address2' => 'setAddress2', 'locality' => 'setLocality', 'administrativeArea' => 'setAdministrativeArea', 'postalCode' => 'setPostalCode', 'county' => 'setCounty', 'country' => 'setCountry', 'district' => 'setDistrict', 'buildingNumber' => 'setBuildingNumber', 'phoneNumber' => 'setPhoneNumber', 'email' => 'setEmail', 'company' => 'setCompany', 'destinationTypes' => 'setDestinationTypes', 'destinationCode' => 'setDestinationCode', 'method' => 'setMethod'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['title' => 'getTitle', 'firstName' => 'getFirstName', 'middleName' => 'getMiddleName', 'lastName' => 'getLastName', 'address1' => 'getAddress1', 'address2' => 'getAddress2', 'locality' => 'getLocality', 'administrativeArea' => 'getAdministrativeArea', 'postalCode' => 'getPostalCode', 'county' => 'getCounty', 'country' => 'getCountry', 'district' => 'getDistrict', 'buildingNumber' => 'getBuildingNumber', 'phoneNumber' => 'getPhoneNumber', 'email' => 'getEmail', 'company' => 'getCompany', 'destinationTypes' => 'getDestinationTypes', 'destinationCode' => 'getDestinationCode', 'method' => 'getMethod'];

...
class PtsV2CreditsPost201Response1ProcessorInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['approvalCode' => 'string', 'responseCode' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['approvalCode' => null, 'responseCode' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['approvalCode' => 'approvalCode', 'responseCode' => 'responseCode'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['approvalCode' => 'setApprovalCode', 'responseCode' => 'setResponseCode'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['approvalCode' => 'getApprovalCode', 'responseCode' => 'getResponseCode'];

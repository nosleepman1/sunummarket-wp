...
class Upv1capturecontextsOrderInformationBillTo implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['address1' => 'string', 'address2' => 'string', 'address3' => 'string', 'address4' => 'string', 'administrativeArea' => 'string', 'buildingNumber' => 'string', 'country' => 'string', 'district' => 'string', 'locality' => 'string', 'postalCode' => 'string', 'company' => '\Pymt_Vas\Dependencies\CyberSource\Model\Upv1capturecontextsOrderInformationBillToCompany', 'email' => 'string', 'firstName' => 'string', 'lastName' => 'string', 'middleName' => 'string', 'nameSuffix' => 'string', 'title' => 'string', 'phoneNumber' => 'string', 'phoneType' => 'string'];
    /**
    ...
    /**
     * Gets company
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Upv1capturecontextsOrderInformationBillToCompany
     */
    ...
    /**
     * Sets company
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Upv1capturecontextsOrderInformationBillToCompany $company
     * @return $this
     */

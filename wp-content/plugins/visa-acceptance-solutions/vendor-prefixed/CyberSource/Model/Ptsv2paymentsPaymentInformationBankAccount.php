...
class Ptsv2paymentsPaymentInformationBankAccount implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['type' => 'string', 'number' => 'string', 'encoderId' => 'string', 'checkNumber' => 'string', 'checkImageReferenceNumber' => 'string', 'iban' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['type' => null, 'number' => null, 'encoderId' => null, 'checkNumber' => null, 'checkImageReferenceNumber' => null, 'iban' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['type' => 'type', 'number' => 'number', 'encoderId' => 'encoderId', 'checkNumber' => 'checkNumber', 'checkImageReferenceNumber' => 'checkImageReferenceNumber', 'iban' => 'iban'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['type' => 'setType', 'number' => 'setNumber', 'encoderId' => 'setEncoderId', 'checkNumber' => 'setCheckNumber', 'checkImageReferenceNumber' => 'setCheckImageReferenceNumber', 'iban' => 'setIban'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['type' => 'getType', 'number' => 'getNumber', 'encoderId' => 'getEncoderId', 'checkNumber' => 'getCheckNumber', 'checkImageReferenceNumber' => 'getCheckImageReferenceNumber', 'iban' => 'getIban'];

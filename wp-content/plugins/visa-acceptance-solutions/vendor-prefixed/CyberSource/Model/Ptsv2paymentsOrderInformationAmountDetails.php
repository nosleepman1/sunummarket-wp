...
class Ptsv2paymentsOrderInformationAmountDetails implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['refundBalance' => 'string', 'giftWrapAmount' => 'string', 'invoiceAmount' => 'string', 'totalAmount' => 'string', 'subTotalAmount' => 'string', 'currency' => 'string', 'discountAmount' => 'string', 'dutyAmount' => 'string', 'gratuityAmount' => 'string', 'taxAmount' => 'string', 'nationalTaxIncluded' => 'string', 'taxAppliedAfterDiscount' => 'string', 'taxAppliedLevel' => 'string', 'taxTypeCode' => 'string', 'freightAmount' => 'string', 'foreignAmount' => 'string', 'foreignCurrency' => 'string', 'exchangeRate' => 'string', 'exchangeRateTimeStamp' => 'string', 'surcharge' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsOrderInformationAmountDetailsSurcharge', 'settlementAmount' => 'string', 'settlementCurrency' => 'string', 'amexAdditionalAmounts' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsOrderInformationAmountDetailsAmexAdditionalAmounts[]', 'taxDetails' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsOrderInformationAmountDetailsTaxDetails[]', 'serviceFeeAmount' => 'string', 'originalAmount' => 'string', 'originalCurrency' => 'string', 'cashbackAmount' => 'string', 'currencyConversion' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsOrderInformationAmountDetailsCurrencyConversion', 'octSurcharge' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsOrderInformationAmountDetailsOctsurcharge', 'order' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsOrderInformationAmountDetailsOrder', 'anticipatedAmount' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['refundBalance' => null, 'giftWrapAmount' => null, 'invoiceAmount' => null, 'totalAmount' => null, 'subTotalAmount' => null, 'currency' => null, 'discountAmount' => null, 'dutyAmount' => null, 'gratuityAmount' => null, 'taxAmount' => null, 'nationalTaxIncluded' => null, 'taxAppliedAfterDiscount' => null, 'taxAppliedLevel' => null, 'taxTypeCode' => null, 'freightAmount' => null, 'foreignAmount' => null, 'foreignCurrency' => null, 'exchangeRate' => null, 'exchangeRateTimeStamp' => null, 'surcharge' => null, 'settlementAmount' => null, 'settlementCurrency' => null, 'amexAdditionalAmounts' => null, 'taxDetails' => null, 'serviceFeeAmount' => null, 'originalAmount' => null, 'originalCurrency' => null, 'cashbackAmount' => null, 'currencyConversion' => null, 'octSurcharge' => null, 'order' => null, 'anticipatedAmount' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['refundBalance' => 'refundBalance', 'giftWrapAmount' => 'giftWrapAmount', 'invoiceAmount' => 'invoiceAmount', 'totalAmount' => 'totalAmount', 'subTotalAmount' => 'subTotalAmount', 'currency' => 'currency', 'discountAmount' => 'discountAmount', 'dutyAmount' => 'dutyAmount', 'gratuityAmount' => 'gratuityAmount', 'taxAmount' => 'taxAmount', 'nationalTaxIncluded' => 'nationalTaxIncluded', 'taxAppliedAfterDiscount' => 'taxAppliedAfterDiscount', 'taxAppliedLevel' => 'taxAppliedLevel', 'taxTypeCode' => 'taxTypeCode', 'freightAmount' => 'freightAmount', 'foreignAmount' => 'foreignAmount', 'foreignCurrency' => 'foreignCurrency', 'exchangeRate' => 'exchangeRate', 'exchangeRateTimeStamp' => 'exchangeRateTimeStamp', 'surcharge' => 'surcharge', 'settlementAmount' => 'settlementAmount', 'settlementCurrency' => 'settlementCurrency', 'amexAdditionalAmounts' => 'amexAdditionalAmounts', 'taxDetails' => 'taxDetails', 'serviceFeeAmount' => 'serviceFeeAmount', 'originalAmount' => 'originalAmount', 'originalCurrency' => 'originalCurrency', 'cashbackAmount' => 'cashbackAmount', 'currencyConversion' => 'currencyConversion', 'octSurcharge' => 'oct-surcharge', 'order' => 'order', 'anticipatedAmount' => 'anticipatedAmount'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['refundBalance' => 'setRefundBalance', 'giftWrapAmount' => 'setGiftWrapAmount', 'invoiceAmount' => 'setInvoiceAmount', 'totalAmount' => 'setTotalAmount', 'subTotalAmount' => 'setSubTotalAmount', 'currency' => 'setCurrency', 'discountAmount' => 'setDiscountAmount', 'dutyAmount' => 'setDutyAmount', 'gratuityAmount' => 'setGratuityAmount', 'taxAmount' => 'setTaxAmount', 'nationalTaxIncluded' => 'setNationalTaxIncluded', 'taxAppliedAfterDiscount' => 'setTaxAppliedAfterDiscount', 'taxAppliedLevel' => 'setTaxAppliedLevel', 'taxTypeCode' => 'setTaxTypeCode', 'freightAmount' => 'setFreightAmount', 'foreignAmount' => 'setForeignAmount', 'foreignCurrency' => 'setForeignCurrency', 'exchangeRate' => 'setExchangeRate', 'exchangeRateTimeStamp' => 'setExchangeRateTimeStamp', 'surcharge' => 'setSurcharge', 'settlementAmount' => 'setSettlementAmount', 'settlementCurrency' => 'setSettlementCurrency', 'amexAdditionalAmounts' => 'setAmexAdditionalAmounts', 'taxDetails' => 'setTaxDetails', 'serviceFeeAmount' => 'setServiceFeeAmount', 'originalAmount' => 'setOriginalAmount', 'originalCurrency' => 'setOriginalCurrency', 'cashbackAmount' => 'setCashbackAmount', 'currencyConversion' => 'setCurrencyConversion', 'octSurcharge' => 'setOctSurcharge', 'order' => 'setOrder', 'anticipatedAmount' => 'setAnticipatedAmount'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['refundBalance' => 'getRefundBalance', 'giftWrapAmount' => 'getGiftWrapAmount', 'invoiceAmount' => 'getInvoiceAmount', 'totalAmount' => 'getTotalAmount', 'subTotalAmount' => 'getSubTotalAmount', 'currency' => 'getCurrency', 'discountAmount' => 'getDiscountAmount', 'dutyAmount' => 'getDutyAmount', 'gratuityAmount' => 'getGratuityAmount', 'taxAmount' => 'getTaxAmount', 'nationalTaxIncluded' => 'getNationalTaxIncluded', 'taxAppliedAfterDiscount' => 'getTaxAppliedAfterDiscount', 'taxAppliedLevel' => 'getTaxAppliedLevel', 'taxTypeCode' => 'getTaxTypeCode', 'freightAmount' => 'getFreightAmount', 'foreignAmount' => 'getForeignAmount', 'foreignCurrency' => 'getForeignCurrency', 'exchangeRate' => 'getExchangeRate', 'exchangeRateTimeStamp' => 'getExchangeRateTimeStamp', 'surcharge' => 'getSurcharge', 'settlementAmount' => 'getSettlementAmount', 'settlementCurrency' => 'getSettlementCurrency', 'amexAdditionalAmounts' => 'getAmexAdditionalAmounts', 'taxDetails' => 'getTaxDetails', 'serviceFeeAmount' => 'getServiceFeeAmount', 'originalAmount' => 'getOriginalAmount', 'originalCurrency' => 'getOriginalCurrency', 'cashbackAmount' => 'getCashbackAmount', 'currencyConversion' => 'getCurrencyConversion', 'octSurcharge' => 'getOctSurcharge', 'order' => 'getOrder', 'anticipatedAmount' => 'getAnticipatedAmount'];
    ...
    /**
     * Gets surcharge
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsOrderInformationAmountDetailsSurcharge
     */
    ...
    /**
     * Sets surcharge
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsOrderInformationAmountDetailsSurcharge $surcharge
     * @return $this
     */
     ...
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsOrderInformationAmountDetailsAmexAdditionalAmounts[]
     */
     ...
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsOrderInformationAmountDetailsAmexAdditionalAmounts[] $amexAdditionalAmounts
     * @return $this
     */
    ...
    /**
     * Gets taxDetails
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsOrderInformationAmountDetailsTaxDetails[]
     */
    ...
    /**
     * Sets taxDetails
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsOrderInformationAmountDetailsTaxDetails[] $taxDetails
     * @return $this
     */
     ...
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsOrderInformationAmountDetailsCurrencyConversion
     */
     ...
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsOrderInformationAmountDetailsCurrencyConversion $currencyConversion
     * @return $this
     */
    ...
    /**
     * Sets octSurcharge
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsOrderInformationAmountDetailsOctsurcharge $octSurcharge
     * @return $this
     */
    ...
    /**
     * Gets order
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsOrderInformationAmountDetailsOrder
     */
    ...
    /**
     * Sets order
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsOrderInformationAmountDetailsOrder $order
     * @return $this
     */

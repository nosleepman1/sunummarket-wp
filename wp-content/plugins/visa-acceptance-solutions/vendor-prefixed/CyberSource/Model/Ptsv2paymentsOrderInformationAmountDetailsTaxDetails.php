...
class Ptsv2paymentsOrderInformationAmountDetailsTaxDetails implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['type' => 'string', 'amount' => 'string', 'rate' => 'string', 'code' => 'string', 'taxId' => 'string', 'applied' => 'bool', 'exemptionCode' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['type' => null, 'amount' => null, 'rate' => null, 'code' => null, 'taxId' => null, 'applied' => null, 'exemptionCode' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['type' => 'type', 'amount' => 'amount', 'rate' => 'rate', 'code' => 'code', 'taxId' => 'taxId', 'applied' => 'applied', 'exemptionCode' => 'exemptionCode'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['type' => 'setType', 'amount' => 'setAmount', 'rate' => 'setRate', 'code' => 'setCode', 'taxId' => 'setTaxId', 'applied' => 'setApplied', 'exemptionCode' => 'setExemptionCode'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['type' => 'getType', 'amount' => 'getAmount', 'rate' => 'getRate', 'code' => 'getCode', 'taxId' => 'getTaxId', 'applied' => 'getApplied', 'exemptionCode' => 'getExemptionCode'];
    ...
    /**
     * Sets type
     * @param string $type Indicates the type of tax data for the _taxDetails_ object.  Possible values:  - `alternate` - `local` - `national` - `vat` - `other` - `green`
     * @return $this
     */
    ...
    /**
     * Sets code
     * @param string $code Type of tax being applied to the item.  #### FDC Nashville Global - `alternate_tax_type_applied` - `alternate_tax_type_identifier`  #### Worldpay VAP - `alternate_tax_type_identifier`  #### RBS WorldPay Atlanta - `tax_type_applied`  #### TSYS Acquiring Solutions - `tax_type_applied` - `local_tax_indicator`  #### Chase Paymentech Solutions - `tax_type_applied`  #### Elavon Americas - `local_tax_indicator`  #### FDC Compass - `tax_type_applied`  #### OmniPay Direct - `local_tax_indicator`
     * @return $this
     */
    ...
    /**
     * Sets applied
     * @param bool $applied Flag that indicates whether the alternate tax amount (`orderInformation.amountDetails.taxDetails[].amount`) is included in the request.  Possible values: - `false`: alternate tax amount is not included in the request. - `true`: alternate tax amount is included in the request.
     * @return $this
     */

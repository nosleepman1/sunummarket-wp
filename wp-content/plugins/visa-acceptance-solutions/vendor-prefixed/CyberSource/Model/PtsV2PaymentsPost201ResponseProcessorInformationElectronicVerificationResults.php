...
class PtsV2PaymentsPost201ResponseProcessorInformationElectronicVerificationResults implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['code' => 'string', 'codeRaw' => 'string', 'email' => 'string', 'emailRaw' => 'string', 'phoneNumber' => 'string', 'phoneNumberRaw' => 'string', 'postalCode' => 'string', 'postalCodeRaw' => 'string', 'street' => 'string', 'streetRaw' => 'string', 'name' => 'string', 'nameRaw' => 'string', 'firstNameRaw' => 'string', 'firstName' => 'string', 'middleNameRaw' => 'string', 'middleName' => 'string', 'lastNameRaw' => 'string', 'lastName' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['code' => null, 'codeRaw' => null, 'email' => null, 'emailRaw' => null, 'phoneNumber' => null, 'phoneNumberRaw' => null, 'postalCode' => null, 'postalCodeRaw' => null, 'street' => null, 'streetRaw' => null, 'name' => null, 'nameRaw' => null, 'firstNameRaw' => null, 'firstName' => null, 'middleNameRaw' => null, 'middleName' => null, 'lastNameRaw' => null, 'lastName' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['code' => 'code', 'codeRaw' => 'codeRaw', 'email' => 'email', 'emailRaw' => 'emailRaw', 'phoneNumber' => 'phoneNumber', 'phoneNumberRaw' => 'phoneNumberRaw', 'postalCode' => 'postalCode', 'postalCodeRaw' => 'postalCodeRaw', 'street' => 'street', 'streetRaw' => 'streetRaw', 'name' => 'name', 'nameRaw' => 'nameRaw', 'firstNameRaw' => 'firstNameRaw', 'firstName' => 'firstName', 'middleNameRaw' => 'middleNameRaw', 'middleName' => 'middleName', 'lastNameRaw' => 'lastNameRaw', 'lastName' => 'lastName'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['code' => 'setCode', 'codeRaw' => 'setCodeRaw', 'email' => 'setEmail', 'emailRaw' => 'setEmailRaw', 'phoneNumber' => 'setPhoneNumber', 'phoneNumberRaw' => 'setPhoneNumberRaw', 'postalCode' => 'setPostalCode', 'postalCodeRaw' => 'setPostalCodeRaw', 'street' => 'setStreet', 'streetRaw' => 'setStreetRaw', 'name' => 'setName', 'nameRaw' => 'setNameRaw', 'firstNameRaw' => 'setFirstNameRaw', 'firstName' => 'setFirstName', 'middleNameRaw' => 'setMiddleNameRaw', 'middleName' => 'setMiddleName', 'lastNameRaw' => 'setLastNameRaw', 'lastName' => 'setLastName'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['code' => 'getCode', 'codeRaw' => 'getCodeRaw', 'email' => 'getEmail', 'emailRaw' => 'getEmailRaw', 'phoneNumber' => 'getPhoneNumber', 'phoneNumberRaw' => 'getPhoneNumberRaw', 'postalCode' => 'getPostalCode', 'postalCodeRaw' => 'getPostalCodeRaw', 'street' => 'getStreet', 'streetRaw' => 'getStreetRaw', 'name' => 'getName', 'nameRaw' => 'getNameRaw', 'firstNameRaw' => 'getFirstNameRaw', 'firstName' => 'getFirstName', 'middleNameRaw' => 'getMiddleNameRaw', 'middleName' => 'getMiddleName', 'lastNameRaw' => 'getLastNameRaw', 'lastName' => 'getLastName'];

...
class TmsBusinessInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['name' => 'string', 'doingBusinessAs' => 'string', 'address' => '\Pymt_Vas\Dependencies\CyberSource\Model\TmsBusinessInformationAddress', 'websiteUrl' => 'string', 'businessIdentificationType' => 'string', 'businessIdentificationValue' => 'string', 'acquirer' => '\Pymt_Vas\Dependencies\CyberSource\Model\TmsBusinessInformationAcquirer'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['name' => null, 'doingBusinessAs' => null, 'address' => null, 'websiteUrl' => null, 'businessIdentificationType' => null, 'businessIdentificationValue' => null, 'acquirer' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['name' => 'name', 'doingBusinessAs' => 'doingBusinessAs', 'address' => 'address', 'websiteUrl' => 'websiteUrl', 'businessIdentificationType' => 'businessIdentificationType', 'businessIdentificationValue' => 'businessIdentificationValue', 'acquirer' => 'acquirer'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['name' => 'setName', 'doingBusinessAs' => 'setDoingBusinessAs', 'address' => 'setAddress', 'websiteUrl' => 'setWebsiteUrl', 'businessIdentificationType' => 'setBusinessIdentificationType', 'businessIdentificationValue' => 'setBusinessIdentificationValue', 'acquirer' => 'setAcquirer'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['name' => 'getName', 'doingBusinessAs' => 'getDoingBusinessAs', 'address' => 'getAddress', 'websiteUrl' => 'getWebsiteUrl', 'businessIdentificationType' => 'getBusinessIdentificationType', 'businessIdentificationValue' => 'getBusinessIdentificationValue', 'acquirer' => 'getAcquirer'];
    ...
    /**
     * Gets address
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\TmsBusinessInformationAddress
     */
    ...
    /**
     * Sets address
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\TmsBusinessInformationAddress $address
     * @return $this
     */
    ...
    /**
     * Gets acquirer
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\TmsBusinessInformationAcquirer
     */
    ...
    /**
     * Sets acquirer
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\TmsBusinessInformationAcquirer $acquirer
     * @return $this
     */

...
class Ptsv2intentsProcessingInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['processingInstruction' => 'string', 'authorizationOptions' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2intentsProcessingInformationAuthorizationOptions', 'actionList' => 'string[]', 'highRiskTransactionFlag' => 'string', 'transactionRetry' => 'string', 'lastOneHrTransactionCount' => 'string', 'lastOneDayTransactionCount' => 'string', 'lastThreeMonthsTxnCount' => 'string', 'totalTransactionCount' => 'string', 'pinVerification' => 'string', 'faceIdVerification' => 'string', 'userPassedVerification' => 'string', 'ipAddress' => 'string', 'transactionDate' => 'string', 'tangible' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['processingInstruction' => null, 'authorizationOptions' => null, 'actionList' => null, 'highRiskTransactionFlag' => null, 'transactionRetry' => null, 'lastOneHrTransactionCount' => null, 'lastOneDayTransactionCount' => null, 'lastThreeMonthsTxnCount' => null, 'totalTransactionCount' => null, 'pinVerification' => null, 'faceIdVerification' => null, 'userPassedVerification' => null, 'ipAddress' => null, 'transactionDate' => null, 'tangible' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['processingInstruction' => 'processingInstruction', 'authorizationOptions' => 'authorizationOptions', 'actionList' => 'actionList', 'highRiskTransactionFlag' => 'highRiskTransactionFlag', 'transactionRetry' => 'transactionRetry', 'lastOneHrTransactionCount' => 'lastOneHrTransactionCount', 'lastOneDayTransactionCount' => 'lastOneDayTransactionCount', 'lastThreeMonthsTxnCount' => 'lastThreeMonthsTxnCount', 'totalTransactionCount' => 'totalTransactionCount', 'pinVerification' => 'pinVerification', 'faceIdVerification' => 'faceIdVerification', 'userPassedVerification' => 'userPassedVerification', 'ipAddress' => 'ipAddress', 'transactionDate' => 'transactionDate', 'tangible' => 'tangible'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['processingInstruction' => 'setProcessingInstruction', 'authorizationOptions' => 'setAuthorizationOptions', 'actionList' => 'setActionList', 'highRiskTransactionFlag' => 'setHighRiskTransactionFlag', 'transactionRetry' => 'setTransactionRetry', 'lastOneHrTransactionCount' => 'setLastOneHrTransactionCount', 'lastOneDayTransactionCount' => 'setLastOneDayTransactionCount', 'lastThreeMonthsTxnCount' => 'setLastThreeMonthsTxnCount', 'totalTransactionCount' => 'setTotalTransactionCount', 'pinVerification' => 'setPinVerification', 'faceIdVerification' => 'setFaceIdVerification', 'userPassedVerification' => 'setUserPassedVerification', 'ipAddress' => 'setIpAddress', 'transactionDate' => 'setTransactionDate', 'tangible' => 'setTangible'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['processingInstruction' => 'getProcessingInstruction', 'authorizationOptions' => 'getAuthorizationOptions', 'actionList' => 'getActionList', 'highRiskTransactionFlag' => 'getHighRiskTransactionFlag', 'transactionRetry' => 'getTransactionRetry', 'lastOneHrTransactionCount' => 'getLastOneHrTransactionCount', 'lastOneDayTransactionCount' => 'getLastOneDayTransactionCount', 'lastThreeMonthsTxnCount' => 'getLastThreeMonthsTxnCount', 'totalTransactionCount' => 'getTotalTransactionCount', 'pinVerification' => 'getPinVerification', 'faceIdVerification' => 'getFaceIdVerification', 'userPassedVerification' => 'getUserPassedVerification', 'ipAddress' => 'getIpAddress', 'transactionDate' => 'getTransactionDate', 'tangible' => 'getTangible'];
     ...
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2intentsProcessingInformationAuthorizationOptions
     */
     ...
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2intentsProcessingInformationAuthorizationOptions $authorizationOptions
     * @return $this
     */

...
class Ptsv2paymentsOrderInformationLineItems implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['productCode' => 'string', 'productName' => 'string', 'productSku' => 'string', 'quantity' => 'int', 'unitPrice' => 'string', 'unitOfMeasure' => 'string', 'totalAmount' => 'string', 'taxAmount' => 'string', 'taxRate' => 'string', 'taxAppliedAfterDiscount' => 'string', 'taxStatusIndicator' => 'string', 'taxTypeCode' => 'string', 'amountIncludesTax' => 'bool', 'typeOfSupply' => 'string', 'commodityCode' => 'string', 'discountAmount' => 'string', 'discountApplied' => 'bool', 'discountRate' => 'string', 'invoiceNumber' => 'string', 'taxDetails' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsOrderInformationAmountDetailsTaxDetails[]', 'fulfillmentType' => 'string', 'weight' => 'string', 'weightIdentifier' => 'string', 'weightUnit' => 'string', 'referenceDataCode' => 'string', 'referenceDataNumber' => 'string', 'unitTaxAmount' => 'string', 'measurement' => 'string', 'productDescription' => 'string', 'giftCardCurrency' => 'int', 'shippingDestinationTypes' => 'string', 'gift' => 'bool', 'passenger' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsOrderInformationPassenger', 'allowedExportCountries' => 'string[]', 'restrictedExportCountries' => 'string[]'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['productCode' => null, 'productName' => null, 'productSku' => null, 'quantity' => null, 'unitPrice' => null, 'unitOfMeasure' => null, 'totalAmount' => null, 'taxAmount' => null, 'taxRate' => null, 'taxAppliedAfterDiscount' => null, 'taxStatusIndicator' => null, 'taxTypeCode' => null, 'amountIncludesTax' => null, 'typeOfSupply' => null, 'commodityCode' => null, 'discountAmount' => null, 'discountApplied' => null, 'discountRate' => null, 'invoiceNumber' => null, 'taxDetails' => null, 'fulfillmentType' => null, 'weight' => null, 'weightIdentifier' => null, 'weightUnit' => null, 'referenceDataCode' => null, 'referenceDataNumber' => null, 'unitTaxAmount' => null, 'measurement' => null, 'productDescription' => null, 'giftCardCurrency' => null, 'shippingDestinationTypes' => null, 'gift' => null, 'passenger' => null, 'allowedExportCountries' => null, 'restrictedExportCountries' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['productCode' => 'productCode', 'productName' => 'productName', 'productSku' => 'productSku', 'quantity' => 'quantity', 'unitPrice' => 'unitPrice', 'unitOfMeasure' => 'unitOfMeasure', 'totalAmount' => 'totalAmount', 'taxAmount' => 'taxAmount', 'taxRate' => 'taxRate', 'taxAppliedAfterDiscount' => 'taxAppliedAfterDiscount', 'taxStatusIndicator' => 'taxStatusIndicator', 'taxTypeCode' => 'taxTypeCode', 'amountIncludesTax' => 'amountIncludesTax', 'typeOfSupply' => 'typeOfSupply', 'commodityCode' => 'commodityCode', 'discountAmount' => 'discountAmount', 'discountApplied' => 'discountApplied', 'discountRate' => 'discountRate', 'invoiceNumber' => 'invoiceNumber', 'taxDetails' => 'taxDetails', 'fulfillmentType' => 'fulfillmentType', 'weight' => 'weight', 'weightIdentifier' => 'weightIdentifier', 'weightUnit' => 'weightUnit', 'referenceDataCode' => 'referenceDataCode', 'referenceDataNumber' => 'referenceDataNumber', 'unitTaxAmount' => 'unitTaxAmount', 'measurement' => 'measurement', 'productDescription' => 'productDescription', 'giftCardCurrency' => 'giftCardCurrency', 'shippingDestinationTypes' => 'shippingDestinationTypes', 'gift' => 'gift', 'passenger' => 'passenger', 'allowedExportCountries' => 'allowedExportCountries', 'restrictedExportCountries' => 'restrictedExportCountries'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['productCode' => 'setProductCode', 'productName' => 'setProductName', 'productSku' => 'setProductSku', 'quantity' => 'setQuantity', 'unitPrice' => 'setUnitPrice', 'unitOfMeasure' => 'setUnitOfMeasure', 'totalAmount' => 'setTotalAmount', 'taxAmount' => 'setTaxAmount', 'taxRate' => 'setTaxRate', 'taxAppliedAfterDiscount' => 'setTaxAppliedAfterDiscount', 'taxStatusIndicator' => 'setTaxStatusIndicator', 'taxTypeCode' => 'setTaxTypeCode', 'amountIncludesTax' => 'setAmountIncludesTax', 'typeOfSupply' => 'setTypeOfSupply', 'commodityCode' => 'setCommodityCode', 'discountAmount' => 'setDiscountAmount', 'discountApplied' => 'setDiscountApplied', 'discountRate' => 'setDiscountRate', 'invoiceNumber' => 'setInvoiceNumber', 'taxDetails' => 'setTaxDetails', 'fulfillmentType' => 'setFulfillmentType', 'weight' => 'setWeight', 'weightIdentifier' => 'setWeightIdentifier', 'weightUnit' => 'setWeightUnit', 'referenceDataCode' => 'setReferenceDataCode', 'referenceDataNumber' => 'setReferenceDataNumber', 'unitTaxAmount' => 'setUnitTaxAmount', 'measurement' => 'setMeasurement', 'productDescription' => 'setProductDescription', 'giftCardCurrency' => 'setGiftCardCurrency', 'shippingDestinationTypes' => 'setShippingDestinationTypes', 'gift' => 'setGift', 'passenger' => 'setPassenger', 'allowedExportCountries' => 'setAllowedExportCountries', 'restrictedExportCountries' => 'setRestrictedExportCountries'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['productCode' => 'getProductCode', 'productName' => 'getProductName', 'productSku' => 'getProductSku', 'quantity' => 'getQuantity', 'unitPrice' => 'getUnitPrice', 'unitOfMeasure' => 'getUnitOfMeasure', 'totalAmount' => 'getTotalAmount', 'taxAmount' => 'getTaxAmount', 'taxRate' => 'getTaxRate', 'taxAppliedAfterDiscount' => 'getTaxAppliedAfterDiscount', 'taxStatusIndicator' => 'getTaxStatusIndicator', 'taxTypeCode' => 'getTaxTypeCode', 'amountIncludesTax' => 'getAmountIncludesTax', 'typeOfSupply' => 'getTypeOfSupply', 'commodityCode' => 'getCommodityCode', 'discountAmount' => 'getDiscountAmount', 'discountApplied' => 'getDiscountApplied', 'discountRate' => 'getDiscountRate', 'invoiceNumber' => 'getInvoiceNumber', 'taxDetails' => 'getTaxDetails', 'fulfillmentType' => 'getFulfillmentType', 'weight' => 'getWeight', 'weightIdentifier' => 'getWeightIdentifier', 'weightUnit' => 'getWeightUnit', 'referenceDataCode' => 'getReferenceDataCode', 'referenceDataNumber' => 'getReferenceDataNumber', 'unitTaxAmount' => 'getUnitTaxAmount', 'measurement' => 'getMeasurement', 'productDescription' => 'getProductDescription', 'giftCardCurrency' => 'getGiftCardCurrency', 'shippingDestinationTypes' => 'getShippingDestinationTypes', 'gift' => 'getGift', 'passenger' => 'getPassenger', 'allowedExportCountries' => 'getAllowedExportCountries', 'restrictedExportCountries' => 'getRestrictedExportCountries'];
    ...
    /**
     * Gets passenger
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsOrderInformationPassenger
     */
    ...
    /**
     * Sets passenger
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsOrderInformationPassenger $passenger
     * @return $this
     */

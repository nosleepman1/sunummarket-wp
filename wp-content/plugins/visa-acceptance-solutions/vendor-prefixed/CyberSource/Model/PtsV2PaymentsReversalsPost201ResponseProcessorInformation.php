...
class PtsV2PaymentsReversalsPost201ResponseProcessorInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['transactionId' => 'string', 'responseCode' => 'string', 'networkTransactionId' => 'string', 'responseCategoryCode' => 'string', 'forwardedAcquirerCode' => 'string', 'masterCardServiceCode' => 'string', 'masterCardServiceReplyCode' => 'string', 'responseDetails' => 'string', 'providerResponse' => 'string', 'network' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsProcessorInformationReversalNetwork'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['transactionId' => null, 'responseCode' => null, 'networkTransactionId' => null, 'responseCategoryCode' => null, 'forwardedAcquirerCode' => null, 'masterCardServiceCode' => null, 'masterCardServiceReplyCode' => null, 'responseDetails' => null, 'providerResponse' => null, 'network' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['transactionId' => 'transactionId', 'responseCode' => 'responseCode', 'networkTransactionId' => 'networkTransactionId', 'responseCategoryCode' => 'responseCategoryCode', 'forwardedAcquirerCode' => 'forwardedAcquirerCode', 'masterCardServiceCode' => 'masterCardServiceCode', 'masterCardServiceReplyCode' => 'masterCardServiceReplyCode', 'responseDetails' => 'responseDetails', 'providerResponse' => 'providerResponse', 'network' => 'network'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['transactionId' => 'setTransactionId', 'responseCode' => 'setResponseCode', 'networkTransactionId' => 'setNetworkTransactionId', 'responseCategoryCode' => 'setResponseCategoryCode', 'forwardedAcquirerCode' => 'setForwardedAcquirerCode', 'masterCardServiceCode' => 'setMasterCardServiceCode', 'masterCardServiceReplyCode' => 'setMasterCardServiceReplyCode', 'responseDetails' => 'setResponseDetails', 'providerResponse' => 'setProviderResponse', 'network' => 'setNetwork'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['transactionId' => 'getTransactionId', 'responseCode' => 'getResponseCode', 'networkTransactionId' => 'getNetworkTransactionId', 'responseCategoryCode' => 'getResponseCategoryCode', 'forwardedAcquirerCode' => 'getForwardedAcquirerCode', 'masterCardServiceCode' => 'getMasterCardServiceCode', 'masterCardServiceReplyCode' => 'getMasterCardServiceReplyCode', 'responseDetails' => 'getResponseDetails', 'providerResponse' => 'getProviderResponse', 'network' => 'getNetwork'];

...
class ReportingV3InterchangeClearingLevelDetailsGet200ResponseInterchangeClearingLevelDetails implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['requestId' => 'string', 'organizationId' => 'string', 'accountId' => 'string', 'processorMerchantId' => 'string', 'transactionReferenceNumber' => 'string', 'merchantReferenceNumber' => 'string', 'accountSuffix' => 'string', 'paymentSubType' => 'string', 'paymentSubTypeDescription' => 'string', 'transactionTime' => '\DateTime', 'processedTime' => '\DateTime', 'transactionType' => 'string', 'amount' => 'string', 'currencyCode' => 'string', 'priceType' => 'string', 'priceAmountOne' => 'string', 'priceAmountTwo' => 'string', 'reClass' => 'string', 'settlementTime' => '\DateTime', 'settlementProcessor' => 'string', 'merchantBatchNumber' => 'string', 'clearedLevel' => 'string', 'billbackReasonCode' => 'string', 'billbackReasonDescription' => 'string', 'merchantPricedLevel' => 'string', 'discountRate' => 'string', 'discountAmount' => 'string', 'clearingRateAmountOne' => 'string', 'clearingRateAmountTwo' => 'string', 'clearingRateAmountThree' => 'string', 'clearingRateCurrencyCode' => 'string', 'interchangeAmount' => 'string', 'billbackAmount' => 'string', 'settlementAmount' => 'string', 'settlementCurrencyCode' => 'string', 'conversionRate' => 'string', 'deltaCost' => 'string', 'surchargeAmount' => 'string', 'percentRateCharged' => 'string', 'perTransactionCharged' => 'string', 'downgradeReasonCode' => 'string', 'processTime' => '\DateTime', 'authCode' => 'string', 'batchTime' => '\DateTime', 'processorBatchNumber' => 'string', 'cardIndicator' => 'string', 'minimumUnit' => 'int', 'minimumUnitCurrencyCode' => 'string', 'creditDeltaIndicator' => 'string', 'feeCategory' => 'string', 'applicationName' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['requestId' => null, 'organizationId' => null, 'accountId' => null, 'processorMerchantId' => null, 'transactionReferenceNumber' => null, 'merchantReferenceNumber' => null, 'accountSuffix' => null, 'paymentSubType' => null, 'paymentSubTypeDescription' => null, 'transactionTime' => 'date-time', 'processedTime' => 'date-time', 'transactionType' => null, 'amount' => null, 'currencyCode' => null, 'priceType' => null, 'priceAmountOne' => null, 'priceAmountTwo' => null, 'reClass' => null, 'settlementTime' => 'date-time', 'settlementProcessor' => null, 'merchantBatchNumber' => null, 'clearedLevel' => null, 'billbackReasonCode' => null, 'billbackReasonDescription' => null, 'merchantPricedLevel' => null, 'discountRate' => null, 'discountAmount' => null, 'clearingRateAmountOne' => null, 'clearingRateAmountTwo' => null, 'clearingRateAmountThree' => null, 'clearingRateCurrencyCode' => null, 'interchangeAmount' => null, 'billbackAmount' => null, 'settlementAmount' => null, 'settlementCurrencyCode' => null, 'conversionRate' => null, 'deltaCost' => null, 'surchargeAmount' => null, 'percentRateCharged' => null, 'perTransactionCharged' => null, 'downgradeReasonCode' => null, 'processTime' => 'date-time', 'authCode' => null, 'batchTime' => 'date-time', 'processorBatchNumber' => null, 'cardIndicator' => null, 'minimumUnit' => null, 'minimumUnitCurrencyCode' => null, 'creditDeltaIndicator' => null, 'feeCategory' => null, 'applicationName' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['requestId' => 'requestId', 'organizationId' => 'organizationId', 'accountId' => 'accountId', 'processorMerchantId' => 'processorMerchantId', 'transactionReferenceNumber' => 'transactionReferenceNumber', 'merchantReferenceNumber' => 'merchantReferenceNumber', 'accountSuffix' => 'accountSuffix', 'paymentSubType' => 'paymentSubType', 'paymentSubTypeDescription' => 'paymentSubTypeDescription', 'transactionTime' => 'transactionTime', 'processedTime' => 'processedTime', 'transactionType' => 'transactionType', 'amount' => 'amount', 'currencyCode' => 'currencyCode', 'priceType' => 'priceType', 'priceAmountOne' => 'priceAmountOne', 'priceAmountTwo' => 'priceAmountTwo', 'reClass' => 'reClass', 'settlementTime' => 'settlementTime', 'settlementProcessor' => 'settlementProcessor', 'merchantBatchNumber' => 'merchantBatchNumber', 'clearedLevel' => 'clearedLevel', 'billbackReasonCode' => 'billbackReasonCode', 'billbackReasonDescription' => 'billbackReasonDescription', 'merchantPricedLevel' => 'merchantPricedLevel', 'discountRate' => 'discountRate', 'discountAmount' => 'discountAmount', 'clearingRateAmountOne' => 'clearingRateAmountOne', 'clearingRateAmountTwo' => 'clearingRateAmountTwo', 'clearingRateAmountThree' => 'clearingRateAmountThree', 'clearingRateCurrencyCode' => 'clearingRateCurrencyCode', 'interchangeAmount' => 'interchangeAmount', 'billbackAmount' => 'billbackAmount', 'settlementAmount' => 'settlementAmount', 'settlementCurrencyCode' => 'settlementCurrencyCode', 'conversionRate' => 'conversionRate', 'deltaCost' => 'deltaCost', 'surchargeAmount' => 'surchargeAmount', 'percentRateCharged' => 'percentRateCharged', 'perTransactionCharged' => 'perTransactionCharged', 'downgradeReasonCode' => 'downgradeReasonCode', 'processTime' => 'processTime', 'authCode' => 'authCode', 'batchTime' => 'batchTime', 'processorBatchNumber' => 'processorBatchNumber', 'cardIndicator' => 'cardIndicator', 'minimumUnit' => 'minimumUnit', 'minimumUnitCurrencyCode' => 'minimumUnitCurrencyCode', 'creditDeltaIndicator' => 'creditDeltaIndicator', 'feeCategory' => 'feeCategory', 'applicationName' => 'applicationName'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['requestId' => 'setRequestId', 'organizationId' => 'setOrganizationId', 'accountId' => 'setAccountId', 'processorMerchantId' => 'setProcessorMerchantId', 'transactionReferenceNumber' => 'setTransactionReferenceNumber', 'merchantReferenceNumber' => 'setMerchantReferenceNumber', 'accountSuffix' => 'setAccountSuffix', 'paymentSubType' => 'setPaymentSubType', 'paymentSubTypeDescription' => 'setPaymentSubTypeDescription', 'transactionTime' => 'setTransactionTime', 'processedTime' => 'setProcessedTime', 'transactionType' => 'setTransactionType', 'amount' => 'setAmount', 'currencyCode' => 'setCurrencyCode', 'priceType' => 'setPriceType', 'priceAmountOne' => 'setPriceAmountOne', 'priceAmountTwo' => 'setPriceAmountTwo', 'reClass' => 'setReClass', 'settlementTime' => 'setSettlementTime', 'settlementProcessor' => 'setSettlementProcessor', 'merchantBatchNumber' => 'setMerchantBatchNumber', 'clearedLevel' => 'setClearedLevel', 'billbackReasonCode' => 'setBillbackReasonCode', 'billbackReasonDescription' => 'setBillbackReasonDescription', 'merchantPricedLevel' => 'setMerchantPricedLevel', 'discountRate' => 'setDiscountRate', 'discountAmount' => 'setDiscountAmount', 'clearingRateAmountOne' => 'setClearingRateAmountOne', 'clearingRateAmountTwo' => 'setClearingRateAmountTwo', 'clearingRateAmountThree' => 'setClearingRateAmountThree', 'clearingRateCurrencyCode' => 'setClearingRateCurrencyCode', 'interchangeAmount' => 'setInterchangeAmount', 'billbackAmount' => 'setBillbackAmount', 'settlementAmount' => 'setSettlementAmount', 'settlementCurrencyCode' => 'setSettlementCurrencyCode', 'conversionRate' => 'setConversionRate', 'deltaCost' => 'setDeltaCost', 'surchargeAmount' => 'setSurchargeAmount', 'percentRateCharged' => 'setPercentRateCharged', 'perTransactionCharged' => 'setPerTransactionCharged', 'downgradeReasonCode' => 'setDowngradeReasonCode', 'processTime' => 'setProcessTime', 'authCode' => 'setAuthCode', 'batchTime' => 'setBatchTime', 'processorBatchNumber' => 'setProcessorBatchNumber', 'cardIndicator' => 'setCardIndicator', 'minimumUnit' => 'setMinimumUnit', 'minimumUnitCurrencyCode' => 'setMinimumUnitCurrencyCode', 'creditDeltaIndicator' => 'setCreditDeltaIndicator', 'feeCategory' => 'setFeeCategory', 'applicationName' => 'setApplicationName'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['requestId' => 'getRequestId', 'organizationId' => 'getOrganizationId', 'accountId' => 'getAccountId', 'processorMerchantId' => 'getProcessorMerchantId', 'transactionReferenceNumber' => 'getTransactionReferenceNumber', 'merchantReferenceNumber' => 'getMerchantReferenceNumber', 'accountSuffix' => 'getAccountSuffix', 'paymentSubType' => 'getPaymentSubType', 'paymentSubTypeDescription' => 'getPaymentSubTypeDescription', 'transactionTime' => 'getTransactionTime', 'processedTime' => 'getProcessedTime', 'transactionType' => 'getTransactionType', 'amount' => 'getAmount', 'currencyCode' => 'getCurrencyCode', 'priceType' => 'getPriceType', 'priceAmountOne' => 'getPriceAmountOne', 'priceAmountTwo' => 'getPriceAmountTwo', 'reClass' => 'getReClass', 'settlementTime' => 'getSettlementTime', 'settlementProcessor' => 'getSettlementProcessor', 'merchantBatchNumber' => 'getMerchantBatchNumber', 'clearedLevel' => 'getClearedLevel', 'billbackReasonCode' => 'getBillbackReasonCode', 'billbackReasonDescription' => 'getBillbackReasonDescription', 'merchantPricedLevel' => 'getMerchantPricedLevel', 'discountRate' => 'getDiscountRate', 'discountAmount' => 'getDiscountAmount', 'clearingRateAmountOne' => 'getClearingRateAmountOne', 'clearingRateAmountTwo' => 'getClearingRateAmountTwo', 'clearingRateAmountThree' => 'getClearingRateAmountThree', 'clearingRateCurrencyCode' => 'getClearingRateCurrencyCode', 'interchangeAmount' => 'getInterchangeAmount', 'billbackAmount' => 'getBillbackAmount', 'settlementAmount' => 'getSettlementAmount', 'settlementCurrencyCode' => 'getSettlementCurrencyCode', 'conversionRate' => 'getConversionRate', 'deltaCost' => 'getDeltaCost', 'surchargeAmount' => 'getSurchargeAmount', 'percentRateCharged' => 'getPercentRateCharged', 'perTransactionCharged' => 'getPerTransactionCharged', 'downgradeReasonCode' => 'getDowngradeReasonCode', 'processTime' => 'getProcessTime', 'authCode' => 'getAuthCode', 'batchTime' => 'getBatchTime', 'processorBatchNumber' => 'getProcessorBatchNumber', 'cardIndicator' => 'getCardIndicator', 'minimumUnit' => 'getMinimumUnit', 'minimumUnitCurrencyCode' => 'getMinimumUnitCurrencyCode', 'creditDeltaIndicator' => 'getCreditDeltaIndicator', 'feeCategory' => 'getFeeCategory', 'applicationName' => 'getApplicationName'];

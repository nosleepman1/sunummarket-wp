...
class Riskv1decisionsPaymentInformationTokenizedCard implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['transactionType' => 'string', 'type' => 'string', 'number' => 'string', 'expirationMonth' => 'string', 'expirationYear' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['transactionType' => null, 'type' => null, 'number' => null, 'expirationMonth' => null, 'expirationYear' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['transactionType' => 'transactionType', 'type' => 'type', 'number' => 'number', 'expirationMonth' => 'expirationMonth', 'expirationYear' => 'expirationYear'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['transactionType' => 'setTransactionType', 'type' => 'setType', 'number' => 'setNumber', 'expirationMonth' => 'setExpirationMonth', 'expirationYear' => 'setExpirationYear'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['transactionType' => 'getTransactionType', 'type' => 'getType', 'number' => 'getNumber', 'expirationMonth' => 'getExpirationMonth', 'expirationYear' => 'getExpirationYear'];

...
class Binv1binlookupProcessingInformationPayoutOptions implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['payoutInquiry' => 'bool', 'networkId' => 'string', 'acquirerBin' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['payoutInquiry' => null, 'networkId' => null, 'acquirerBin' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['payoutInquiry' => 'payoutInquiry', 'networkId' => 'networkId', 'acquirerBin' => 'acquirerBin'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['payoutInquiry' => 'setPayoutInquiry', 'networkId' => 'setNetworkId', 'acquirerBin' => 'setAcquirerBin'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['payoutInquiry' => 'getPayoutInquiry', 'networkId' => 'getNetworkId', 'acquirerBin' => 'getAcquirerBin'];

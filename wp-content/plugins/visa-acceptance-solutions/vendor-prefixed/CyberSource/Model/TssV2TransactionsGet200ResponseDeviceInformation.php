...
class TssV2TransactionsGet200ResponseDeviceInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['ipAddress' => 'string', 'hostName' => 'string', 'cookiesAccepted' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['ipAddress' => null, 'hostName' => null, 'cookiesAccepted' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['ipAddress' => 'ipAddress', 'hostName' => 'hostName', 'cookiesAccepted' => 'cookiesAccepted'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['ipAddress' => 'setIpAddress', 'hostName' => 'setHostName', 'cookiesAccepted' => 'setCookiesAccepted'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['ipAddress' => 'getIpAddress', 'hostName' => 'getHostName', 'cookiesAccepted' => 'getCookiesAccepted'];

...
class Ptsv2paymentsTravelInformationAutoRental implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['noShowIndicator' => 'bool', 'customerName' => 'string', 'vehicleClass' => 'string', 'distanceTravelled' => 'string', 'distanceUnit' => 'string', 'returnDateTime' => 'string', 'rentalDateTime' => 'string', 'maxFreeDistance' => 'string', 'insuranceIndicator' => 'bool', 'programCode' => 'string', 'returnAddress' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsTravelInformationAutoRentalReturnAddress', 'rentalAddress' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsTravelInformationAutoRentalRentalAddress', 'agreementNumber' => 'string', 'odometerReading' => 'string', 'vehicleIdentificationNumber' => 'string', 'companyId' => 'string', 'numberOfAdditionalDrivers' => 'string', 'driverAge' => 'string', 'specialProgramCode' => 'string', 'vehicleMake' => 'string', 'vehicleModel' => 'string', 'timePeriod' => 'string', 'commodityCode' => 'string', 'customerServicePhoneNumber' => 'string', 'taxDetails' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsTravelInformationAutoRentalTaxDetails', 'insuranceAmount' => 'string', 'oneWayDropOffAmount' => 'string', 'adjustedAmountIndicator' => 'string', 'adjustedAmount' => 'string', 'fuelCharges' => 'string', 'weeklyRentalRate' => 'string', 'dailyRentalRate' => 'string', 'ratePerMile' => 'string', 'mileageCharge' => 'string', 'extraMileageCharge' => 'string', 'lateFeeAmount' => 'string', 'towingCharge' => 'string', 'extraCharge' => 'string', 'gpsCharge' => 'string', 'phoneCharge' => 'string', 'parkingViolationCharge' => 'string', 'otherCharges' => 'string', 'companyName' => 'string', 'affiliateName' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['noShowIndicator' => null, 'customerName' => null, 'vehicleClass' => null, 'distanceTravelled' => null, 'distanceUnit' => null, 'returnDateTime' => null, 'rentalDateTime' => null, 'maxFreeDistance' => null, 'insuranceIndicator' => null, 'programCode' => null, 'returnAddress' => null, 'rentalAddress' => null, 'agreementNumber' => null, 'odometerReading' => null, 'vehicleIdentificationNumber' => null, 'companyId' => null, 'numberOfAdditionalDrivers' => null, 'driverAge' => null, 'specialProgramCode' => null, 'vehicleMake' => null, 'vehicleModel' => null, 'timePeriod' => null, 'commodityCode' => null, 'customerServicePhoneNumber' => null, 'taxDetails' => null, 'insuranceAmount' => null, 'oneWayDropOffAmount' => null, 'adjustedAmountIndicator' => null, 'adjustedAmount' => null, 'fuelCharges' => null, 'weeklyRentalRate' => null, 'dailyRentalRate' => null, 'ratePerMile' => null, 'mileageCharge' => null, 'extraMileageCharge' => null, 'lateFeeAmount' => null, 'towingCharge' => null, 'extraCharge' => null, 'gpsCharge' => null, 'phoneCharge' => null, 'parkingViolationCharge' => null, 'otherCharges' => null, 'companyName' => null, 'affiliateName' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['noShowIndicator' => 'noShowIndicator', 'customerName' => 'customerName', 'vehicleClass' => 'vehicleClass', 'distanceTravelled' => 'distanceTravelled', 'distanceUnit' => 'distanceUnit', 'returnDateTime' => 'returnDateTime', 'rentalDateTime' => 'rentalDateTime', 'maxFreeDistance' => 'maxFreeDistance', 'insuranceIndicator' => 'insuranceIndicator', 'programCode' => 'programCode', 'returnAddress' => 'returnAddress', 'rentalAddress' => 'rentalAddress', 'agreementNumber' => 'agreementNumber', 'odometerReading' => 'odometerReading', 'vehicleIdentificationNumber' => 'vehicleIdentificationNumber', 'companyId' => 'companyId', 'numberOfAdditionalDrivers' => 'numberOfAdditionalDrivers', 'driverAge' => 'driverAge', 'specialProgramCode' => 'specialProgramCode', 'vehicleMake' => 'vehicleMake', 'vehicleModel' => 'vehicleModel', 'timePeriod' => 'timePeriod', 'commodityCode' => 'commodityCode', 'customerServicePhoneNumber' => 'customerServicePhoneNumber', 'taxDetails' => 'taxDetails', 'insuranceAmount' => 'insuranceAmount', 'oneWayDropOffAmount' => 'oneWayDropOffAmount', 'adjustedAmountIndicator' => 'adjustedAmountIndicator', 'adjustedAmount' => 'adjustedAmount', 'fuelCharges' => 'fuelCharges', 'weeklyRentalRate' => 'weeklyRentalRate', 'dailyRentalRate' => 'dailyRentalRate', 'ratePerMile' => 'ratePerMile', 'mileageCharge' => 'mileageCharge', 'extraMileageCharge' => 'extraMileageCharge', 'lateFeeAmount' => 'lateFeeAmount', 'towingCharge' => 'towingCharge', 'extraCharge' => 'extraCharge', 'gpsCharge' => 'gpsCharge', 'phoneCharge' => 'phoneCharge', 'parkingViolationCharge' => 'parkingViolationCharge', 'otherCharges' => 'otherCharges', 'companyName' => 'companyName', 'affiliateName' => 'affiliateName'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['noShowIndicator' => 'setNoShowIndicator', 'customerName' => 'setCustomerName', 'vehicleClass' => 'setVehicleClass', 'distanceTravelled' => 'setDistanceTravelled', 'distanceUnit' => 'setDistanceUnit', 'returnDateTime' => 'setReturnDateTime', 'rentalDateTime' => 'setRentalDateTime', 'maxFreeDistance' => 'setMaxFreeDistance', 'insuranceIndicator' => 'setInsuranceIndicator', 'programCode' => 'setProgramCode', 'returnAddress' => 'setReturnAddress', 'rentalAddress' => 'setRentalAddress', 'agreementNumber' => 'setAgreementNumber', 'odometerReading' => 'setOdometerReading', 'vehicleIdentificationNumber' => 'setVehicleIdentificationNumber', 'companyId' => 'setCompanyId', 'numberOfAdditionalDrivers' => 'setNumberOfAdditionalDrivers', 'driverAge' => 'setDriverAge', 'specialProgramCode' => 'setSpecialProgramCode', 'vehicleMake' => 'setVehicleMake', 'vehicleModel' => 'setVehicleModel', 'timePeriod' => 'setTimePeriod', 'commodityCode' => 'setCommodityCode', 'customerServicePhoneNumber' => 'setCustomerServicePhoneNumber', 'taxDetails' => 'setTaxDetails', 'insuranceAmount' => 'setInsuranceAmount', 'oneWayDropOffAmount' => 'setOneWayDropOffAmount', 'adjustedAmountIndicator' => 'setAdjustedAmountIndicator', 'adjustedAmount' => 'setAdjustedAmount', 'fuelCharges' => 'setFuelCharges', 'weeklyRentalRate' => 'setWeeklyRentalRate', 'dailyRentalRate' => 'setDailyRentalRate', 'ratePerMile' => 'setRatePerMile', 'mileageCharge' => 'setMileageCharge', 'extraMileageCharge' => 'setExtraMileageCharge', 'lateFeeAmount' => 'setLateFeeAmount', 'towingCharge' => 'setTowingCharge', 'extraCharge' => 'setExtraCharge', 'gpsCharge' => 'setGpsCharge', 'phoneCharge' => 'setPhoneCharge', 'parkingViolationCharge' => 'setParkingViolationCharge', 'otherCharges' => 'setOtherCharges', 'companyName' => 'setCompanyName', 'affiliateName' => 'setAffiliateName'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['noShowIndicator' => 'getNoShowIndicator', 'customerName' => 'getCustomerName', 'vehicleClass' => 'getVehicleClass', 'distanceTravelled' => 'getDistanceTravelled', 'distanceUnit' => 'getDistanceUnit', 'returnDateTime' => 'getReturnDateTime', 'rentalDateTime' => 'getRentalDateTime', 'maxFreeDistance' => 'getMaxFreeDistance', 'insuranceIndicator' => 'getInsuranceIndicator', 'programCode' => 'getProgramCode', 'returnAddress' => 'getReturnAddress', 'rentalAddress' => 'getRentalAddress', 'agreementNumber' => 'getAgreementNumber', 'odometerReading' => 'getOdometerReading', 'vehicleIdentificationNumber' => 'getVehicleIdentificationNumber', 'companyId' => 'getCompanyId', 'numberOfAdditionalDrivers' => 'getNumberOfAdditionalDrivers', 'driverAge' => 'getDriverAge', 'specialProgramCode' => 'getSpecialProgramCode', 'vehicleMake' => 'getVehicleMake', 'vehicleModel' => 'getVehicleModel', 'timePeriod' => 'getTimePeriod', 'commodityCode' => 'getCommodityCode', 'customerServicePhoneNumber' => 'getCustomerServicePhoneNumber', 'taxDetails' => 'getTaxDetails', 'insuranceAmount' => 'getInsuranceAmount', 'oneWayDropOffAmount' => 'getOneWayDropOffAmount', 'adjustedAmountIndicator' => 'getAdjustedAmountIndicator', 'adjustedAmount' => 'getAdjustedAmount', 'fuelCharges' => 'getFuelCharges', 'weeklyRentalRate' => 'getWeeklyRentalRate', 'dailyRentalRate' => 'getDailyRentalRate', 'ratePerMile' => 'getRatePerMile', 'mileageCharge' => 'getMileageCharge', 'extraMileageCharge' => 'getExtraMileageCharge', 'lateFeeAmount' => 'getLateFeeAmount', 'towingCharge' => 'getTowingCharge', 'extraCharge' => 'getExtraCharge', 'gpsCharge' => 'getGpsCharge', 'phoneCharge' => 'getPhoneCharge', 'parkingViolationCharge' => 'getParkingViolationCharge', 'otherCharges' => 'getOtherCharges', 'companyName' => 'getCompanyName', 'affiliateName' => 'getAffiliateName'];
    ...
    /**
     * Gets returnAddress
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsTravelInformationAutoRentalReturnAddress
     */
    ...
    /**
     * Sets returnAddress
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsTravelInformationAutoRentalReturnAddress $returnAddress
     * @return $this
     */
    ...
    /**
     * Gets rentalAddress
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsTravelInformationAutoRentalRentalAddress
     */
    ...
    /**
     * Sets rentalAddress
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsTravelInformationAutoRentalRentalAddress $rentalAddress
     * @return $this
     */
    ...
    /**
     * Gets taxDetails
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsTravelInformationAutoRentalTaxDetails
     */
    ...
    /**
     * Sets taxDetails
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsTravelInformationAutoRentalTaxDetails $taxDetails
     * @return $this
     */

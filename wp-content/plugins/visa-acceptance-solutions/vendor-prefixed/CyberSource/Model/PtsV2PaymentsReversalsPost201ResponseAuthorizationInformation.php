...
class PtsV2PaymentsReversalsPost201ResponseAuthorizationInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['approvalCode' => 'string', 'reasonCode' => 'string', 'reversalSubmitted' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['approvalCode' => null, 'reasonCode' => null, 'reversalSubmitted' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['approvalCode' => 'approvalCode', 'reasonCode' => 'reasonCode', 'reversalSubmitted' => 'reversalSubmitted'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['approvalCode' => 'setApprovalCode', 'reasonCode' => 'setReasonCode', 'reversalSubmitted' => 'setReversalSubmitted'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['approvalCode' => 'getApprovalCode', 'reasonCode' => 'getReasonCode', 'reversalSubmitted' => 'getReversalSubmitted'];

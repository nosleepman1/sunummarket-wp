...
class TssV2TransactionsGet200ResponsePayoutOptions implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['payoutInquiry' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['payoutInquiry' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['payoutInquiry' => 'payoutInquiry'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['payoutInquiry' => 'setPayoutInquiry'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['payoutInquiry' => 'getPayoutInquiry'];

...
class TssV2TransactionsPost201ResponseEmbeddedClientReferenceInformationPartner implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['solutionId' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['solutionId' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['solutionId' => 'solutionId'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['solutionId' => 'setSolutionId'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['solutionId' => 'getSolutionId'];

...
class CardProcessingConfigCommonAcquirers implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['institutionId' => 'string', 'interbankCardAssociationId' => 'string', 'discoverInstitutionId' => 'string', 'countryCode' => 'string', 'fileDestinationBin' => 'string', 'merchantVerificationValue' => 'string', 'merchantId' => 'string', 'terminalId' => 'string', 'allowMultipleBills' => 'bool', 'enableTransactionReferenceNumber' => 'bool', 'paymentTypes' => 'map[string,\Pymt_Vas\Dependencies\CyberSource\Model\CardProcessingConfigCommonPaymentTypes]', 'currencies' => 'map[string,\Pymt_Vas\Dependencies\CyberSource\Model\CardProcessingConfigCommonCurrencies]'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['institutionId' => null, 'interbankCardAssociationId' => null, 'discoverInstitutionId' => null, 'countryCode' => null, 'fileDestinationBin' => null, 'merchantVerificationValue' => null, 'merchantId' => null, 'terminalId' => null, 'allowMultipleBills' => null, 'enableTransactionReferenceNumber' => null, 'paymentTypes' => null, 'currencies' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['institutionId' => 'institutionId', 'interbankCardAssociationId' => 'interbankCardAssociationId', 'discoverInstitutionId' => 'discoverInstitutionId', 'countryCode' => 'countryCode', 'fileDestinationBin' => 'fileDestinationBin', 'merchantVerificationValue' => 'merchantVerificationValue', 'merchantId' => 'merchantId', 'terminalId' => 'terminalId', 'allowMultipleBills' => 'allowMultipleBills', 'enableTransactionReferenceNumber' => 'enableTransactionReferenceNumber', 'paymentTypes' => 'paymentTypes', 'currencies' => 'currencies'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['institutionId' => 'setInstitutionId', 'interbankCardAssociationId' => 'setInterbankCardAssociationId', 'discoverInstitutionId' => 'setDiscoverInstitutionId', 'countryCode' => 'setCountryCode', 'fileDestinationBin' => 'setFileDestinationBin', 'merchantVerificationValue' => 'setMerchantVerificationValue', 'merchantId' => 'setMerchantId', 'terminalId' => 'setTerminalId', 'allowMultipleBills' => 'setAllowMultipleBills', 'enableTransactionReferenceNumber' => 'setEnableTransactionReferenceNumber', 'paymentTypes' => 'setPaymentTypes', 'currencies' => 'setCurrencies'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['institutionId' => 'getInstitutionId', 'interbankCardAssociationId' => 'getInterbankCardAssociationId', 'discoverInstitutionId' => 'getDiscoverInstitutionId', 'countryCode' => 'getCountryCode', 'fileDestinationBin' => 'getFileDestinationBin', 'merchantVerificationValue' => 'getMerchantVerificationValue', 'merchantId' => 'getMerchantId', 'terminalId' => 'getTerminalId', 'allowMultipleBills' => 'getAllowMultipleBills', 'enableTransactionReferenceNumber' => 'getEnableTransactionReferenceNumber', 'paymentTypes' => 'getPaymentTypes', 'currencies' => 'getCurrencies'];
    ...
    /**
     * Gets currencies
     * @return map[string,\Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\CardProcessingConfigCommonCurrencies]
     */
    ...
    /**
     * Sets currencies
     * @param map[string,\Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\CardProcessingConfigCommonCurrencies] $currencies Three-character [ISO 4217 ALPHA-3 Standard Currency Codes.](http://apps.cybersource.com/library/documentation/sbc/quickref/currencies.pdf)
     * @return $this
     */

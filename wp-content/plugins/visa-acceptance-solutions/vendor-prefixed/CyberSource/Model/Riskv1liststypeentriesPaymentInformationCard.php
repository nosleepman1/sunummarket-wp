...
class Riskv1liststypeentriesPaymentInformationCard implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['number' => 'string', 'type' => 'string', 'bin' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['number' => null, 'type' => null, 'bin' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['number' => 'number', 'type' => 'type', 'bin' => 'bin'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['number' => 'setNumber', 'type' => 'setType', 'bin' => 'setBin'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['number' => 'getNumber', 'type' => 'getType', 'bin' => 'getBin'];

...
class Ptsv2paymentsProcessingInformationCaptureOptions implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['captureSequenceNumber' => 'int', 'totalCaptureCount' => 'int', 'dateToCapture' => 'string', 'isFinal' => 'string', 'notes' => 'string', 'reconciliationId' => 'string', 'reconciliationIdAlternate' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['captureSequenceNumber' => null, 'totalCaptureCount' => null, 'dateToCapture' => null, 'isFinal' => null, 'notes' => null, 'reconciliationId' => null, 'reconciliationIdAlternate' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['captureSequenceNumber' => 'captureSequenceNumber', 'totalCaptureCount' => 'totalCaptureCount', 'dateToCapture' => 'dateToCapture', 'isFinal' => 'isFinal', 'notes' => 'notes', 'reconciliationId' => 'reconciliationId', 'reconciliationIdAlternate' => 'reconciliationIdAlternate'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['captureSequenceNumber' => 'setCaptureSequenceNumber', 'totalCaptureCount' => 'setTotalCaptureCount', 'dateToCapture' => 'setDateToCapture', 'isFinal' => 'setIsFinal', 'notes' => 'setNotes', 'reconciliationId' => 'setReconciliationId', 'reconciliationIdAlternate' => 'setReconciliationIdAlternate'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['captureSequenceNumber' => 'getCaptureSequenceNumber', 'totalCaptureCount' => 'getTotalCaptureCount', 'dateToCapture' => 'getDateToCapture', 'isFinal' => 'getIsFinal', 'notes' => 'getNotes', 'reconciliationId' => 'getReconciliationId', 'reconciliationIdAlternate' => 'getReconciliationIdAlternate'];

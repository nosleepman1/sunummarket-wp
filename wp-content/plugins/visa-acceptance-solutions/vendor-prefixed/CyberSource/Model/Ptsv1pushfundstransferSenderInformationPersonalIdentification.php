...
class Ptsv1pushfundstransferSenderInformationPersonalIdentification implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['id' => 'string', 'personalIdType' => 'string', 'type' => 'string', 'issuingCountry' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['id' => null, 'personalIdType' => null, 'type' => null, 'issuingCountry' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['id' => 'id', 'personalIdType' => 'personalIdType', 'type' => 'type', 'issuingCountry' => 'issuingCountry'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['id' => 'setId', 'personalIdType' => 'setPersonalIdType', 'type' => 'setType', 'issuingCountry' => 'setIssuingCountry'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['id' => 'getId', 'personalIdType' => 'getPersonalIdType', 'type' => 'getType', 'issuingCountry' => 'getIssuingCountry'];

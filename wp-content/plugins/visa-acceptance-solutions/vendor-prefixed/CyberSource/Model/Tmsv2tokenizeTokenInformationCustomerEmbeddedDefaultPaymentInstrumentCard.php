...
use ArrayAccess;
/**
 * Tmsv2tokenizeTokenInformationCustomerEmbeddedDefaultPaymentInstrumentCard Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Tmsv2tokenizeTokenInformationCustomerEmbeddedDefaultPaymentInstrumentCard implements ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'tmsv2tokenize_tokenInformation_customer__embedded_defaultPaymentInstrument_card';
    /**
     * Array of property to type mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerTypes = ['expirationMonth' => 'string', 'expirationYear' => 'string', 'type' => 'string', 'issueNumber' => 'string', 'startMonth' => 'string', 'startYear' => 'string', 'useAs' => 'string', 'hash' => 'string', 'tokenizedInformation' => '\Pymt_Vas\Dependencies\CyberSource\Model\Tmsv2tokenizeTokenInformationCustomerEmbeddedDefaultPaymentInstrumentCardTokenizedInformation'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['expirationMonth' => null, 'expirationYear' => null, 'type' => null, 'issueNumber' => null, 'startMonth' => null, 'startYear' => null, 'useAs' => null, 'hash' => null, 'tokenizedInformation' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['expirationMonth' => 'expirationMonth', 'expirationYear' => 'expirationYear', 'type' => 'type', 'issueNumber' => 'issueNumber', 'startMonth' => 'startMonth', 'startYear' => 'startYear', 'useAs' => 'useAs', 'hash' => 'hash', 'tokenizedInformation' => 'tokenizedInformation'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['expirationMonth' => 'setExpirationMonth', 'expirationYear' => 'setExpirationYear', 'type' => 'setType', 'issueNumber' => 'setIssueNumber', 'startMonth' => 'setStartMonth', 'startYear' => 'setStartYear', 'useAs' => 'setUseAs', 'hash' => 'setHash', 'tokenizedInformation' => 'setTokenizedInformation'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['expirationMonth' => 'getExpirationMonth', 'expirationYear' => 'getExpirationYear', 'type' => 'getType', 'issueNumber' => 'getIssueNumber', 'startMonth' => 'getStartMonth', 'startYear' => 'getStartYear', 'useAs' => 'getUseAs', 'hash' => 'getHash', 'tokenizedInformation' => 'getTokenizedInformation'];
     ...
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Tmsv2tokenizeTokenInformationCustomerEmbeddedDefaultPaymentInstrumentCardTokenizedInformation
     */
     ...
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Tmsv2tokenizeTokenInformationCustomerEmbeddedDefaultPaymentInstrumentCardTokenizedInformation $tokenizedInformation
     * @return $this
     */

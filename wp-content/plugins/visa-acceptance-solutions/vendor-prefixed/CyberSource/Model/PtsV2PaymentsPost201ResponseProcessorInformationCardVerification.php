...
class PtsV2PaymentsPost201ResponseProcessorInformationCardVerification implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['resultCode' => 'string', 'resultCodeRaw' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['resultCode' => null, 'resultCodeRaw' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['resultCode' => 'resultCode', 'resultCodeRaw' => 'resultCodeRaw'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['resultCode' => 'setResultCode', 'resultCodeRaw' => 'setResultCodeRaw'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['resultCode' => 'getResultCode', 'resultCodeRaw' => 'getResultCodeRaw'];

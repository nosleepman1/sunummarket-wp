...
class GenerateUnifiedCheckoutCaptureContextRequest implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['clientVersion' => 'string', 'targetOrigins' => 'string[]', 'allowedCardNetworks' => 'string[]', 'allowedPaymentTypes' => 'string[]', 'country' => 'string', 'locale' => 'string', 'buttonType' => 'string', 'captureMandate' => '\Pymt_Vas\Dependencies\CyberSource\Model\Upv1capturecontextsCaptureMandate', 'completeMandate' => '\Pymt_Vas\Dependencies\CyberSource\Model\Upv1capturecontextsCompleteMandate', 'transientTokenResponseOptions' => '\Pymt_Vas\Dependencies\CyberSource\Model\Microformv2sessionsTransientTokenResponseOptions', 'data' => '\Pymt_Vas\Dependencies\CyberSource\Model\Upv1capturecontextsData', 'orderInformation' => '\Pymt_Vas\Dependencies\CyberSource\Model\Upv1capturecontextsOrderInformation'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['clientVersion' => null, 'targetOrigins' => null, 'allowedCardNetworks' => null, 'allowedPaymentTypes' => null, 'country' => null, 'locale' => null, 'buttonType' => null, 'captureMandate' => null, 'completeMandate' => null, 'transientTokenResponseOptions' => null, 'data' => null, 'orderInformation' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['clientVersion' => 'clientVersion', 'targetOrigins' => 'targetOrigins', 'allowedCardNetworks' => 'allowedCardNetworks', 'allowedPaymentTypes' => 'allowedPaymentTypes', 'country' => 'country', 'locale' => 'locale', 'buttonType' => 'buttonType', 'captureMandate' => 'captureMandate', 'completeMandate' => 'completeMandate', 'transientTokenResponseOptions' => 'transientTokenResponseOptions', 'data' => 'data', 'orderInformation' => 'orderInformation'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['clientVersion' => 'setClientVersion', 'targetOrigins' => 'setTargetOrigins', 'allowedCardNetworks' => 'setAllowedCardNetworks', 'allowedPaymentTypes' => 'setAllowedPaymentTypes', 'country' => 'setCountry', 'locale' => 'setLocale', 'buttonType' => 'setButtonType', 'captureMandate' => 'setCaptureMandate', 'completeMandate' => 'setCompleteMandate', 'transientTokenResponseOptions' => 'setTransientTokenResponseOptions', 'data' => 'setData', 'orderInformation' => 'setOrderInformation'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['clientVersion' => 'getClientVersion', 'targetOrigins' => 'getTargetOrigins', 'allowedCardNetworks' => 'getAllowedCardNetworks', 'allowedPaymentTypes' => 'getAllowedPaymentTypes', 'country' => 'getCountry', 'locale' => 'getLocale', 'buttonType' => 'getButtonType', 'captureMandate' => 'getCaptureMandate', 'completeMandate' => 'getCompleteMandate', 'transientTokenResponseOptions' => 'getTransientTokenResponseOptions', 'data' => 'getData', 'orderInformation' => 'getOrderInformation'];
    ...
    /**
     * Gets captureMandate
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Upv1capturecontextsCaptureMandate
     */
    ...
    /**
     * Sets captureMandate
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Upv1capturecontextsCaptureMandate $captureMandate
     * @return $this
     */
     ...
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Upv1capturecontextsCompleteMandate
     */
     ...
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Upv1capturecontextsCompleteMandate $completeMandate
     * @return $this
     */
     ...
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Microformv2sessionsTransientTokenResponseOptions
     */
     ...
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Microformv2sessionsTransientTokenResponseOptions $transientTokenResponseOptions
     * @return $this
     */
    ...
    /**
     * Gets data
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Upv1capturecontextsData
     */
    ...
    /**
     * Sets data
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Upv1capturecontextsData $data
     * @return $this
     */
     ...
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Upv1capturecontextsOrderInformation
     */
     ...
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Upv1capturecontextsOrderInformation $orderInformation
     * @return $this
     */

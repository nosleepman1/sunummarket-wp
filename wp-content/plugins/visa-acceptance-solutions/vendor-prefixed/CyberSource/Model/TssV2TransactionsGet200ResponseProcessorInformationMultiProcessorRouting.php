...
use ArrayAccess;
/**
 * TssV2TransactionsGet200ResponseProcessorInformationMultiProcessorRouting Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class TssV2TransactionsGet200ResponseProcessorInformationMultiProcessorRouting implements ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'tssV2TransactionsGet200Response_processorInformation_multiProcessorRouting';
    /**
     * Array of property to type mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerTypes = ['name' => 'string', 'responseCode' => 'string', 'reasonCode' => 'string', 'sequence' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['name' => null, 'responseCode' => null, 'reasonCode' => null, 'sequence' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['name' => 'name', 'responseCode' => 'responseCode', 'reasonCode' => 'reasonCode', 'sequence' => 'sequence'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['name' => 'setName', 'responseCode' => 'setResponseCode', 'reasonCode' => 'setReasonCode', 'sequence' => 'setSequence'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['name' => 'getName', 'responseCode' => 'getResponseCode', 'reasonCode' => 'getReasonCode', 'sequence' => 'getSequence'];
    ...
    /**
     * Sets sequence
     * @param string $sequence The order in which the transaction was routed to the processor
     * @return $this
     */

...
class SAConfigService implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['decisionManagerVerboseEnabled' => 'bool', 'declinedRetryLimit' => 'float', 'decisionManagerEnabled' => 'bool', 'tokenizationEnabled' => 'bool', 'reverseAuthOnAddressVerificationSystemFailure' => 'bool', 'deviceFingerprintEnabled' => 'bool', 'reverseAuthOnCardVerificationNumberFailure' => 'bool'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['decisionManagerVerboseEnabled' => null, 'declinedRetryLimit' => null, 'decisionManagerEnabled' => null, 'tokenizationEnabled' => null, 'reverseAuthOnAddressVerificationSystemFailure' => null, 'deviceFingerprintEnabled' => null, 'reverseAuthOnCardVerificationNumberFailure' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['decisionManagerVerboseEnabled' => 'decisionManagerVerboseEnabled', 'declinedRetryLimit' => 'declinedRetryLimit', 'decisionManagerEnabled' => 'decisionManagerEnabled', 'tokenizationEnabled' => 'tokenizationEnabled', 'reverseAuthOnAddressVerificationSystemFailure' => 'reverseAuthOnAddressVerificationSystemFailure', 'deviceFingerprintEnabled' => 'deviceFingerprintEnabled', 'reverseAuthOnCardVerificationNumberFailure' => 'reverseAuthOnCardVerificationNumberFailure'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['decisionManagerVerboseEnabled' => 'setDecisionManagerVerboseEnabled', 'declinedRetryLimit' => 'setDeclinedRetryLimit', 'decisionManagerEnabled' => 'setDecisionManagerEnabled', 'tokenizationEnabled' => 'setTokenizationEnabled', 'reverseAuthOnAddressVerificationSystemFailure' => 'setReverseAuthOnAddressVerificationSystemFailure', 'deviceFingerprintEnabled' => 'setDeviceFingerprintEnabled', 'reverseAuthOnCardVerificationNumberFailure' => 'setReverseAuthOnCardVerificationNumberFailure'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['decisionManagerVerboseEnabled' => 'getDecisionManagerVerboseEnabled', 'declinedRetryLimit' => 'getDeclinedRetryLimit', 'decisionManagerEnabled' => 'getDecisionManagerEnabled', 'tokenizationEnabled' => 'getTokenizationEnabled', 'reverseAuthOnAddressVerificationSystemFailure' => 'getReverseAuthOnAddressVerificationSystemFailure', 'deviceFingerprintEnabled' => 'getDeviceFingerprintEnabled', 'reverseAuthOnCardVerificationNumberFailure' => 'getReverseAuthOnCardVerificationNumberFailure'];

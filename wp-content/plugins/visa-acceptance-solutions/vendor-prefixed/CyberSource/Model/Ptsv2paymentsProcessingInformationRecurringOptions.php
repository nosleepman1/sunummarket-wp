...
class Ptsv2paymentsProcessingInformationRecurringOptions implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['loanPayment' => 'bool', 'firstRecurringPayment' => 'bool'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['loanPayment' => null, 'firstRecurringPayment' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['loanPayment' => 'loanPayment', 'firstRecurringPayment' => 'firstRecurringPayment'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['loanPayment' => 'setLoanPayment', 'firstRecurringPayment' => 'setFirstRecurringPayment'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['loanPayment' => 'getLoanPayment', 'firstRecurringPayment' => 'getFirstRecurringPayment'];
    ...
    /**
     * Sets loanPayment
     * @param bool $loanPayment Flag that indicates whether this is a payment towards an existing contractual loan.  Possible values: - `true`: Loan payment - `false`: (default) Not a loan payment
     * @return $this
     */

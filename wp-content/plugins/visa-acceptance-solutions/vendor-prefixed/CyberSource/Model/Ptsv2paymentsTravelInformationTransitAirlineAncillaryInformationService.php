...
class Ptsv2paymentsTravelInformationTransitAirlineAncillaryInformationService implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['categoryCode' => 'string', 'subCategoryCode' => 'string', 'feeAmount' => 'string', 'feeCode' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['categoryCode' => null, 'subCategoryCode' => null, 'feeAmount' => null, 'feeCode' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['categoryCode' => 'categoryCode', 'subCategoryCode' => 'subCategoryCode', 'feeAmount' => 'feeAmount', 'feeCode' => 'feeCode'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['categoryCode' => 'setCategoryCode', 'subCategoryCode' => 'setSubCategoryCode', 'feeAmount' => 'setFeeAmount', 'feeCode' => 'setFeeCode'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['categoryCode' => 'getCategoryCode', 'subCategoryCode' => 'getSubCategoryCode', 'feeAmount' => 'getFeeAmount', 'feeCode' => 'getFeeCode'];

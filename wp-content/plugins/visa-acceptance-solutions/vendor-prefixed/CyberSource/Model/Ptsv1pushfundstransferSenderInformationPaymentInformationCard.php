...
class Ptsv1pushfundstransferSenderInformationPaymentInformationCard implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['type' => 'string', 'securityCode' => 'string', 'sourceAccountType' => 'string', 'number' => 'string', 'expirationMonth' => 'string', 'expirationYear' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['type' => null, 'securityCode' => null, 'sourceAccountType' => null, 'number' => null, 'expirationMonth' => null, 'expirationYear' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['type' => 'type', 'securityCode' => 'securityCode', 'sourceAccountType' => 'sourceAccountType', 'number' => 'number', 'expirationMonth' => 'expirationMonth', 'expirationYear' => 'expirationYear'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['type' => 'setType', 'securityCode' => 'setSecurityCode', 'sourceAccountType' => 'setSourceAccountType', 'number' => 'setNumber', 'expirationMonth' => 'setExpirationMonth', 'expirationYear' => 'setExpirationYear'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['type' => 'getType', 'securityCode' => 'getSecurityCode', 'sourceAccountType' => 'getSourceAccountType', 'number' => 'getNumber', 'expirationMonth' => 'getExpirationMonth', 'expirationYear' => 'getExpirationYear'];

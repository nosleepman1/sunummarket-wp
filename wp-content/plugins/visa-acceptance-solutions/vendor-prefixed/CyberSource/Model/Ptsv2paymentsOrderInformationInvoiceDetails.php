...
class Ptsv2paymentsOrderInformationInvoiceDetails implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['invoiceNumber' => 'string', 'barcodeNumber' => 'string', 'expirationDate' => 'string', 'purchaseOrderNumber' => 'string', 'purchaseOrderDate' => 'string', 'purchaseContactName' => 'string', 'taxable' => 'bool', 'vatInvoiceReferenceNumber' => 'string', 'commodityCode' => 'string', 'merchandiseCode' => 'int', 'transactionAdviceAddendum' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsOrderInformationInvoiceDetailsTransactionAdviceAddendum[]', 'referenceDataCode' => 'string', 'referenceDataNumber' => 'string', 'salesSlipNumber' => 'int', 'invoiceDate' => 'string', 'costCenter' => 'string', 'issuerMessage' => 'string', 'productDescription' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['invoiceNumber' => null, 'barcodeNumber' => null, 'expirationDate' => null, 'purchaseOrderNumber' => null, 'purchaseOrderDate' => null, 'purchaseContactName' => null, 'taxable' => null, 'vatInvoiceReferenceNumber' => null, 'commodityCode' => null, 'merchandiseCode' => null, 'transactionAdviceAddendum' => null, 'referenceDataCode' => null, 'referenceDataNumber' => null, 'salesSlipNumber' => null, 'invoiceDate' => null, 'costCenter' => null, 'issuerMessage' => null, 'productDescription' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['invoiceNumber' => 'invoiceNumber', 'barcodeNumber' => 'barcodeNumber', 'expirationDate' => 'expirationDate', 'purchaseOrderNumber' => 'purchaseOrderNumber', 'purchaseOrderDate' => 'purchaseOrderDate', 'purchaseContactName' => 'purchaseContactName', 'taxable' => 'taxable', 'vatInvoiceReferenceNumber' => 'vatInvoiceReferenceNumber', 'commodityCode' => 'commodityCode', 'merchandiseCode' => 'merchandiseCode', 'transactionAdviceAddendum' => 'transactionAdviceAddendum', 'referenceDataCode' => 'referenceDataCode', 'referenceDataNumber' => 'referenceDataNumber', 'salesSlipNumber' => 'salesSlipNumber', 'invoiceDate' => 'invoiceDate', 'costCenter' => 'costCenter', 'issuerMessage' => 'issuerMessage', 'productDescription' => 'productDescription'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['invoiceNumber' => 'setInvoiceNumber', 'barcodeNumber' => 'setBarcodeNumber', 'expirationDate' => 'setExpirationDate', 'purchaseOrderNumber' => 'setPurchaseOrderNumber', 'purchaseOrderDate' => 'setPurchaseOrderDate', 'purchaseContactName' => 'setPurchaseContactName', 'taxable' => 'setTaxable', 'vatInvoiceReferenceNumber' => 'setVatInvoiceReferenceNumber', 'commodityCode' => 'setCommodityCode', 'merchandiseCode' => 'setMerchandiseCode', 'transactionAdviceAddendum' => 'setTransactionAdviceAddendum', 'referenceDataCode' => 'setReferenceDataCode', 'referenceDataNumber' => 'setReferenceDataNumber', 'salesSlipNumber' => 'setSalesSlipNumber', 'invoiceDate' => 'setInvoiceDate', 'costCenter' => 'setCostCenter', 'issuerMessage' => 'setIssuerMessage', 'productDescription' => 'setProductDescription'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['invoiceNumber' => 'getInvoiceNumber', 'barcodeNumber' => 'getBarcodeNumber', 'expirationDate' => 'getExpirationDate', 'purchaseOrderNumber' => 'getPurchaseOrderNumber', 'purchaseOrderDate' => 'getPurchaseOrderDate', 'purchaseContactName' => 'getPurchaseContactName', 'taxable' => 'getTaxable', 'vatInvoiceReferenceNumber' => 'getVatInvoiceReferenceNumber', 'commodityCode' => 'getCommodityCode', 'merchandiseCode' => 'getMerchandiseCode', 'transactionAdviceAddendum' => 'getTransactionAdviceAddendum', 'referenceDataCode' => 'getReferenceDataCode', 'referenceDataNumber' => 'getReferenceDataNumber', 'salesSlipNumber' => 'getSalesSlipNumber', 'invoiceDate' => 'getInvoiceDate', 'costCenter' => 'getCostCenter', 'issuerMessage' => 'getIssuerMessage', 'productDescription' => 'getProductDescription'];
     ...
     * @param string $purchaseOrderNumber Value used by your customer to identify the order. This value is typically a purchase order number. CyberSource recommends that you do not populate the field with all zeros or nines.
     * @return $this
     */
     ...
     * @param string $purchaseOrderDate Date the order was processed. `Format: YYYY-MM-DD`.
     * @return $this
     */
     ...
     * @param string $purchaseContactName The name of the individual or the company contacted for company authorized purchases.
     * @return $this
     */
     ...
     * @param string $vatInvoiceReferenceNumber VAT invoice number associated with the transaction.
     * @return $this
     */
    ...
    /**
     * Sets commodityCode
     * @param string $commodityCode International description code of the overall order's goods or services or the Categorizes purchases for VAT reporting. Contact your acquirer for a list of codes.
     * @return $this
     */
     ...
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsOrderInformationInvoiceDetailsTransactionAdviceAddendum[]
     */
     ...
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsOrderInformationInvoiceDetailsTransactionAdviceAddendum[] $transactionAdviceAddendum
     * @return $this
     */
     ...
     * @param string $referenceDataCode Code that identifies the value of the `referenceDataNumber` field.  This field is a pass-through, which means that CyberSource does not verify the value or modify it in any way before sending it to the processor.
     * @return $this
     */

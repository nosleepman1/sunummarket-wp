...
class ReportingV3ReportsIdGet200Response implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['organizationId' => 'string', 'reportId' => 'string', 'reportDefinitionId' => 'string', 'reportName' => 'string', 'reportMimeType' => 'string', 'reportFrequency' => 'string', 'reportFields' => 'string[]', 'reportStatus' => 'string', 'reportStartTime' => '\DateTime', 'reportEndTime' => '\DateTime', 'timezone' => 'string', 'reportFilters' => 'map[string,string[]]', 'reportPreferences' => '\Pymt_Vas\Dependencies\CyberSource\Model\Reportingv3reportsReportPreferences', 'groupId' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['organizationId' => null, 'reportId' => null, 'reportDefinitionId' => null, 'reportName' => null, 'reportMimeType' => null, 'reportFrequency' => null, 'reportFields' => null, 'reportStatus' => null, 'reportStartTime' => 'date-time', 'reportEndTime' => 'date-time', 'timezone' => null, 'reportFilters' => null, 'reportPreferences' => null, 'groupId' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['organizationId' => 'organizationId', 'reportId' => 'reportId', 'reportDefinitionId' => 'reportDefinitionId', 'reportName' => 'reportName', 'reportMimeType' => 'reportMimeType', 'reportFrequency' => 'reportFrequency', 'reportFields' => 'reportFields', 'reportStatus' => 'reportStatus', 'reportStartTime' => 'reportStartTime', 'reportEndTime' => 'reportEndTime', 'timezone' => 'timezone', 'reportFilters' => 'reportFilters', 'reportPreferences' => 'reportPreferences', 'groupId' => 'groupId'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['organizationId' => 'setOrganizationId', 'reportId' => 'setReportId', 'reportDefinitionId' => 'setReportDefinitionId', 'reportName' => 'setReportName', 'reportMimeType' => 'setReportMimeType', 'reportFrequency' => 'setReportFrequency', 'reportFields' => 'setReportFields', 'reportStatus' => 'setReportStatus', 'reportStartTime' => 'setReportStartTime', 'reportEndTime' => 'setReportEndTime', 'timezone' => 'setTimezone', 'reportFilters' => 'setReportFilters', 'reportPreferences' => 'setReportPreferences', 'groupId' => 'setGroupId'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['organizationId' => 'getOrganizationId', 'reportId' => 'getReportId', 'reportDefinitionId' => 'getReportDefinitionId', 'reportName' => 'getReportName', 'reportMimeType' => 'getReportMimeType', 'reportFrequency' => 'getReportFrequency', 'reportFields' => 'getReportFields', 'reportStatus' => 'getReportStatus', 'reportStartTime' => 'getReportStartTime', 'reportEndTime' => 'getReportEndTime', 'timezone' => 'getTimezone', 'reportFilters' => 'getReportFilters', 'reportPreferences' => 'getReportPreferences', 'groupId' => 'getGroupId'];

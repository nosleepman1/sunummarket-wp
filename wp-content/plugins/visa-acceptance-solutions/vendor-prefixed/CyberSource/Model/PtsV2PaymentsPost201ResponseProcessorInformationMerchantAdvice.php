...
class PtsV2PaymentsPost201ResponseProcessorInformationMerchantAdvice implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['code' => 'string', 'codeRaw' => 'string', 'nameMatch' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['code' => null, 'codeRaw' => null, 'nameMatch' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['code' => 'code', 'codeRaw' => 'codeRaw', 'nameMatch' => 'nameMatch'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['code' => 'setCode', 'codeRaw' => 'setCodeRaw', 'nameMatch' => 'setNameMatch'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['code' => 'getCode', 'codeRaw' => 'getCodeRaw', 'nameMatch' => 'getNameMatch'];

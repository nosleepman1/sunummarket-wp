...
class Ptsv2paymentsTokenInformationTokenProvisioningInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['consumerConsentObtained' => 'bool', 'multiFactorAuthenticated' => 'bool'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['consumerConsentObtained' => null, 'multiFactorAuthenticated' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['consumerConsentObtained' => 'consumerConsentObtained', 'multiFactorAuthenticated' => 'multiFactorAuthenticated'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['consumerConsentObtained' => 'setConsumerConsentObtained', 'multiFactorAuthenticated' => 'setMultiFactorAuthenticated'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['consumerConsentObtained' => 'getConsumerConsentObtained', 'multiFactorAuthenticated' => 'getMultiFactorAuthenticated'];

...
class CardProcessingConfigFeaturesCardNotPresentProcessors implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['relaxAddressVerificationSystem' => 'bool', 'relaxAddressVerificationSystemAllowZipWithoutCountry' => 'bool', 'relaxAddressVerificationSystemAllowExpiredCard' => 'bool', 'enableEmsTransactionRiskScore' => 'bool', 'prestigiousPropertyIndicator' => 'string', 'payouts' => '\Pymt_Vas\Dependencies\CyberSource\Model\CardProcessingConfigFeaturesCardNotPresentPayouts'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['relaxAddressVerificationSystem' => null, 'relaxAddressVerificationSystemAllowZipWithoutCountry' => null, 'relaxAddressVerificationSystemAllowExpiredCard' => null, 'enableEmsTransactionRiskScore' => null, 'prestigiousPropertyIndicator' => null, 'payouts' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['relaxAddressVerificationSystem' => 'relaxAddressVerificationSystem', 'relaxAddressVerificationSystemAllowZipWithoutCountry' => 'relaxAddressVerificationSystemAllowZipWithoutCountry', 'relaxAddressVerificationSystemAllowExpiredCard' => 'relaxAddressVerificationSystemAllowExpiredCard', 'enableEmsTransactionRiskScore' => 'enableEmsTransactionRiskScore', 'prestigiousPropertyIndicator' => 'prestigiousPropertyIndicator', 'payouts' => 'payouts'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['relaxAddressVerificationSystem' => 'setRelaxAddressVerificationSystem', 'relaxAddressVerificationSystemAllowZipWithoutCountry' => 'setRelaxAddressVerificationSystemAllowZipWithoutCountry', 'relaxAddressVerificationSystemAllowExpiredCard' => 'setRelaxAddressVerificationSystemAllowExpiredCard', 'enableEmsTransactionRiskScore' => 'setEnableEmsTransactionRiskScore', 'prestigiousPropertyIndicator' => 'setPrestigiousPropertyIndicator', 'payouts' => 'setPayouts'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['relaxAddressVerificationSystem' => 'getRelaxAddressVerificationSystem', 'relaxAddressVerificationSystemAllowZipWithoutCountry' => 'getRelaxAddressVerificationSystemAllowZipWithoutCountry', 'relaxAddressVerificationSystemAllowExpiredCard' => 'getRelaxAddressVerificationSystemAllowExpiredCard', 'enableEmsTransactionRiskScore' => 'getEnableEmsTransactionRiskScore', 'prestigiousPropertyIndicator' => 'getPrestigiousPropertyIndicator', 'payouts' => 'getPayouts'];
    ...
    /**
     * Gets payouts
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\CardProcessingConfigFeaturesCardNotPresentPayouts
     */
    ...
    /**
     * Sets payouts
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\CardProcessingConfigFeaturesCardNotPresentPayouts $payouts
     * @return $this
     */

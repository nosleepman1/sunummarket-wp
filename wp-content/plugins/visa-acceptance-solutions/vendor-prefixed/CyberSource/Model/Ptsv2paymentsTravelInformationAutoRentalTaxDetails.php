...
class Ptsv2paymentsTravelInformationAutoRentalTaxDetails implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['amount' => 'string', 'rate' => 'string', 'applied' => 'bool', 'exemptionCode' => 'string', 'taxType' => 'string', 'taxSummary' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['amount' => null, 'rate' => null, 'applied' => null, 'exemptionCode' => null, 'taxType' => null, 'taxSummary' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['amount' => 'amount', 'rate' => 'rate', 'applied' => 'applied', 'exemptionCode' => 'exemptionCode', 'taxType' => 'taxType', 'taxSummary' => 'taxSummary'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['amount' => 'setAmount', 'rate' => 'setRate', 'applied' => 'setApplied', 'exemptionCode' => 'setExemptionCode', 'taxType' => 'setTaxType', 'taxSummary' => 'setTaxSummary'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['amount' => 'getAmount', 'rate' => 'getRate', 'applied' => 'getApplied', 'exemptionCode' => 'getExemptionCode', 'taxType' => 'getTaxType', 'taxSummary' => 'getTaxSummary'];

...
class Boardingv1registrationsOrganizationInformationKYCDepositBankAccount implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['accountHolderName' => 'string', 'accountType' => 'string', 'accountRoutingNumber' => 'string', 'accountNumber' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['accountHolderName' => null, 'accountType' => null, 'accountRoutingNumber' => null, 'accountNumber' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['accountHolderName' => 'accountHolderName', 'accountType' => 'accountType', 'accountRoutingNumber' => 'accountRoutingNumber', 'accountNumber' => 'accountNumber'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['accountHolderName' => 'setAccountHolderName', 'accountType' => 'setAccountType', 'accountRoutingNumber' => 'setAccountRoutingNumber', 'accountNumber' => 'setAccountNumber'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['accountHolderName' => 'getAccountHolderName', 'accountType' => 'getAccountType', 'accountRoutingNumber' => 'getAccountRoutingNumber', 'accountNumber' => 'getAccountNumber'];

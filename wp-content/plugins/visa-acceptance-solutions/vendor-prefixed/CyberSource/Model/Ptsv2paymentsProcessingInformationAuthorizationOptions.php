...
class Ptsv2paymentsProcessingInformationAuthorizationOptions implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['authType' => 'string', 'panReturnIndicator' => 'string', 'verbalAuthCode' => 'string', 'verbalAuthTransactionId' => 'string', 'authIndicator' => 'string', 'partialAuthIndicator' => 'bool', 'extendAuthIndicator' => 'string', 'balanceInquiry' => 'bool', 'ignoreAvsResult' => 'bool', 'declineAvsFlags' => 'string[]', 'ignoreCvResult' => 'bool', 'initiator' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsProcessingInformationAuthorizationOptionsInitiator', 'billPayment' => 'bool', 'billPaymentType' => 'string', 'redemptionInquiry' => 'bool', 'transportationMode' => 'string', 'aggregatedAuthIndicator' => 'string', 'debtRecoveryIndicator' => 'string', 'deferredAuthIndicator' => 'bool', 'cashAdvanceIndicator' => 'bool', 'splitPaymentTransaction' => 'bool', 'cardVerificationIndicator' => 'bool', 'transactionMode' => 'string', 'aftIndicator' => 'bool', 'serviceType' => 'string', 'balanceUpdate' => 'bool', 'moneyLoad' => 'bool'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['authType' => null, 'panReturnIndicator' => null, 'verbalAuthCode' => null, 'verbalAuthTransactionId' => null, 'authIndicator' => null, 'partialAuthIndicator' => null, 'extendAuthIndicator' => null, 'balanceInquiry' => null, 'ignoreAvsResult' => null, 'declineAvsFlags' => null, 'ignoreCvResult' => null, 'initiator' => null, 'billPayment' => null, 'billPaymentType' => null, 'redemptionInquiry' => null, 'transportationMode' => null, 'aggregatedAuthIndicator' => null, 'debtRecoveryIndicator' => null, 'deferredAuthIndicator' => null, 'cashAdvanceIndicator' => null, 'splitPaymentTransaction' => null, 'cardVerificationIndicator' => null, 'transactionMode' => null, 'aftIndicator' => null, 'serviceType' => null, 'balanceUpdate' => null, 'moneyLoad' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['authType' => 'authType', 'panReturnIndicator' => 'panReturnIndicator', 'verbalAuthCode' => 'verbalAuthCode', 'verbalAuthTransactionId' => 'verbalAuthTransactionId', 'authIndicator' => 'authIndicator', 'partialAuthIndicator' => 'partialAuthIndicator', 'extendAuthIndicator' => 'extendAuthIndicator', 'balanceInquiry' => 'balanceInquiry', 'ignoreAvsResult' => 'ignoreAvsResult', 'declineAvsFlags' => 'declineAvsFlags', 'ignoreCvResult' => 'ignoreCvResult', 'initiator' => 'initiator', 'billPayment' => 'billPayment', 'billPaymentType' => 'billPaymentType', 'redemptionInquiry' => 'redemptionInquiry', 'transportationMode' => 'transportationMode', 'aggregatedAuthIndicator' => 'aggregatedAuthIndicator', 'debtRecoveryIndicator' => 'debtRecoveryIndicator', 'deferredAuthIndicator' => 'deferredAuthIndicator', 'cashAdvanceIndicator' => 'cashAdvanceIndicator', 'splitPaymentTransaction' => 'splitPaymentTransaction', 'cardVerificationIndicator' => 'cardVerificationIndicator', 'transactionMode' => 'transactionMode', 'aftIndicator' => 'aftIndicator', 'serviceType' => 'serviceType', 'balanceUpdate' => 'balanceUpdate', 'moneyLoad' => 'moneyLoad'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['authType' => 'setAuthType', 'panReturnIndicator' => 'setPanReturnIndicator', 'verbalAuthCode' => 'setVerbalAuthCode', 'verbalAuthTransactionId' => 'setVerbalAuthTransactionId', 'authIndicator' => 'setAuthIndicator', 'partialAuthIndicator' => 'setPartialAuthIndicator', 'extendAuthIndicator' => 'setExtendAuthIndicator', 'balanceInquiry' => 'setBalanceInquiry', 'ignoreAvsResult' => 'setIgnoreAvsResult', 'declineAvsFlags' => 'setDeclineAvsFlags', 'ignoreCvResult' => 'setIgnoreCvResult', 'initiator' => 'setInitiator', 'billPayment' => 'setBillPayment', 'billPaymentType' => 'setBillPaymentType', 'redemptionInquiry' => 'setRedemptionInquiry', 'transportationMode' => 'setTransportationMode', 'aggregatedAuthIndicator' => 'setAggregatedAuthIndicator', 'debtRecoveryIndicator' => 'setDebtRecoveryIndicator', 'deferredAuthIndicator' => 'setDeferredAuthIndicator', 'cashAdvanceIndicator' => 'setCashAdvanceIndicator', 'splitPaymentTransaction' => 'setSplitPaymentTransaction', 'cardVerificationIndicator' => 'setCardVerificationIndicator', 'transactionMode' => 'setTransactionMode', 'aftIndicator' => 'setAftIndicator', 'serviceType' => 'setServiceType', 'balanceUpdate' => 'setBalanceUpdate', 'moneyLoad' => 'setMoneyLoad'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['authType' => 'getAuthType', 'panReturnIndicator' => 'getPanReturnIndicator', 'verbalAuthCode' => 'getVerbalAuthCode', 'verbalAuthTransactionId' => 'getVerbalAuthTransactionId', 'authIndicator' => 'getAuthIndicator', 'partialAuthIndicator' => 'getPartialAuthIndicator', 'extendAuthIndicator' => 'getExtendAuthIndicator', 'balanceInquiry' => 'getBalanceInquiry', 'ignoreAvsResult' => 'getIgnoreAvsResult', 'declineAvsFlags' => 'getDeclineAvsFlags', 'ignoreCvResult' => 'getIgnoreCvResult', 'initiator' => 'getInitiator', 'billPayment' => 'getBillPayment', 'billPaymentType' => 'getBillPaymentType', 'redemptionInquiry' => 'getRedemptionInquiry', 'transportationMode' => 'getTransportationMode', 'aggregatedAuthIndicator' => 'getAggregatedAuthIndicator', 'debtRecoveryIndicator' => 'getDebtRecoveryIndicator', 'deferredAuthIndicator' => 'getDeferredAuthIndicator', 'cashAdvanceIndicator' => 'getCashAdvanceIndicator', 'splitPaymentTransaction' => 'getSplitPaymentTransaction', 'cardVerificationIndicator' => 'getCardVerificationIndicator', 'transactionMode' => 'getTransactionMode', 'aftIndicator' => 'getAftIndicator', 'serviceType' => 'getServiceType', 'balanceUpdate' => 'getBalanceUpdate', 'moneyLoad' => 'getMoneyLoad'];
    ...
    /**
     * Gets initiator
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsProcessingInformationAuthorizationOptionsInitiator
     */
    ...
    /**
     * Sets initiator
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsProcessingInformationAuthorizationOptionsInitiator $initiator
     * @return $this
     */

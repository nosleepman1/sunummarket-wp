...
class Riskv1decisionsTravelInformationLegs implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['origination' => 'string', 'destination' => 'string', 'carrierCode' => 'string', 'departureDate' => 'string', 'departureTime' => 'int'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['origination' => null, 'destination' => null, 'carrierCode' => null, 'departureDate' => null, 'departureTime' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['origination' => 'origination', 'destination' => 'destination', 'carrierCode' => 'carrierCode', 'departureDate' => 'departureDate', 'departureTime' => 'departureTime'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['origination' => 'setOrigination', 'destination' => 'setDestination', 'carrierCode' => 'setCarrierCode', 'departureDate' => 'setDepartureDate', 'departureTime' => 'setDepartureTime'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['origination' => 'getOrigination', 'destination' => 'getDestination', 'carrierCode' => 'getCarrierCode', 'departureDate' => 'getDepartureDate', 'departureTime' => 'getDepartureTime'];

...
class Ptsv2paymentsAggregatorInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['aggregatorId' => 'string', 'name' => 'string', 'subMerchant' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsAggregatorInformationSubMerchant', 'streetAddress' => 'string', 'city' => 'string', 'state' => 'string', 'postalCode' => 'string', 'country' => 'string', 'serviceProvidername' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['aggregatorId' => null, 'name' => null, 'subMerchant' => null, 'streetAddress' => null, 'city' => null, 'state' => null, 'postalCode' => null, 'country' => null, 'serviceProvidername' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['aggregatorId' => 'aggregatorId', 'name' => 'name', 'subMerchant' => 'subMerchant', 'streetAddress' => 'streetAddress', 'city' => 'city', 'state' => 'state', 'postalCode' => 'postalCode', 'country' => 'country', 'serviceProvidername' => 'serviceProvidername'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['aggregatorId' => 'setAggregatorId', 'name' => 'setName', 'subMerchant' => 'setSubMerchant', 'streetAddress' => 'setStreetAddress', 'city' => 'setCity', 'state' => 'setState', 'postalCode' => 'setPostalCode', 'country' => 'setCountry', 'serviceProvidername' => 'setServiceProvidername'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['aggregatorId' => 'getAggregatorId', 'name' => 'getName', 'subMerchant' => 'getSubMerchant', 'streetAddress' => 'getStreetAddress', 'city' => 'getCity', 'state' => 'getState', 'postalCode' => 'getPostalCode', 'country' => 'getCountry', 'serviceProvidername' => 'getServiceProvidername'];
    ...
    /**
     * Gets subMerchant
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsAggregatorInformationSubMerchant
     */
    ...
    /**
     * Sets subMerchant
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsAggregatorInformationSubMerchant $subMerchant
     * @return $this
     */

...
class Riskv1authenticationsPaymentInformationTokenizedCard implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['transactionType' => 'string', 'type' => 'string', 'expirationMonth' => 'string', 'expirationYear' => 'string', 'cryptogram' => 'string', 'securityCode' => 'string', 'number' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['transactionType' => null, 'type' => null, 'expirationMonth' => null, 'expirationYear' => null, 'cryptogram' => null, 'securityCode' => null, 'number' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['transactionType' => 'transactionType', 'type' => 'type', 'expirationMonth' => 'expirationMonth', 'expirationYear' => 'expirationYear', 'cryptogram' => 'cryptogram', 'securityCode' => 'securityCode', 'number' => 'number'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['transactionType' => 'setTransactionType', 'type' => 'setType', 'expirationMonth' => 'setExpirationMonth', 'expirationYear' => 'setExpirationYear', 'cryptogram' => 'setCryptogram', 'securityCode' => 'setSecurityCode', 'number' => 'setNumber'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['transactionType' => 'getTransactionType', 'type' => 'getType', 'expirationMonth' => 'getExpirationMonth', 'expirationYear' => 'getExpirationYear', 'cryptogram' => 'getCryptogram', 'securityCode' => 'getSecurityCode', 'number' => 'getNumber'];

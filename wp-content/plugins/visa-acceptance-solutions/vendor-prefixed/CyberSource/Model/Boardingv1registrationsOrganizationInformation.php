...
class Boardingv1registrationsOrganizationInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['organizationId' => 'string', 'parentOrganizationId' => 'string', 'childOrganizations' => 'string[]', 'type' => 'string', 'status' => 'string', 'configurable' => 'bool', 'businessInformation' => '\Pymt_Vas\Dependencies\CyberSource\Model\Boardingv1registrationsOrganizationInformationBusinessInformation', 'kYC' => '\Pymt_Vas\Dependencies\CyberSource\Model\Boardingv1registrationsOrganizationInformationKYC', 'owners' => '\Pymt_Vas\Dependencies\CyberSource\Model\Boardingv1registrationsOrganizationInformationOwners[]'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['organizationId' => null, 'parentOrganizationId' => null, 'childOrganizations' => null, 'type' => null, 'status' => null, 'configurable' => null, 'businessInformation' => null, 'kYC' => null, 'owners' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['organizationId' => 'organizationId', 'parentOrganizationId' => 'parentOrganizationId', 'childOrganizations' => 'childOrganizations', 'type' => 'type', 'status' => 'status', 'configurable' => 'configurable', 'businessInformation' => 'businessInformation', 'kYC' => 'KYC', 'owners' => 'owners'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['organizationId' => 'setOrganizationId', 'parentOrganizationId' => 'setParentOrganizationId', 'childOrganizations' => 'setChildOrganizations', 'type' => 'setType', 'status' => 'setStatus', 'configurable' => 'setConfigurable', 'businessInformation' => 'setBusinessInformation', 'kYC' => 'setKYC', 'owners' => 'setOwners'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['organizationId' => 'getOrganizationId', 'parentOrganizationId' => 'getParentOrganizationId', 'childOrganizations' => 'getChildOrganizations', 'type' => 'getType', 'status' => 'getStatus', 'configurable' => 'getConfigurable', 'businessInformation' => 'getBusinessInformation', 'kYC' => 'getKYC', 'owners' => 'getOwners'];
     ...
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Boardingv1registrationsOrganizationInformationBusinessInformation
     */
     ...
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Boardingv1registrationsOrganizationInformationBusinessInformation $businessInformation
     * @return $this
     */
    ...
    /**
     * Gets kYC
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Boardingv1registrationsOrganizationInformationKYC
     */
    ...
    /**
     * Sets kYC
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Boardingv1registrationsOrganizationInformationKYC $kYC
     * @return $this
     */
    ...
    /**
     * Gets owners
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Boardingv1registrationsOrganizationInformationOwners[]
     */
    ...
    /**
     * Sets owners
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Boardingv1registrationsOrganizationInformationOwners[] $owners
     * @return $this
     */

...
use ArrayAccess;
/**
 * Ptsv2billingagreementsPaymentInformationTokenizedCard Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Ptsv2billingagreementsPaymentInformationTokenizedCard implements ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'ptsv2billingagreements_paymentInformation_tokenizedCard';
    /**
     * Array of property to type mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerTypes = ['cryptogram' => 'string', 'expirationMonth' => 'string', 'expirationYear' => 'string', 'number' => 'string', 'transactionType' => 'string', 'type' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['cryptogram' => null, 'expirationMonth' => null, 'expirationYear' => null, 'number' => null, 'transactionType' => null, 'type' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['cryptogram' => 'cryptogram', 'expirationMonth' => 'expirationMonth', 'expirationYear' => 'expirationYear', 'number' => 'number', 'transactionType' => 'transactionType', 'type' => 'type'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['cryptogram' => 'setCryptogram', 'expirationMonth' => 'setExpirationMonth', 'expirationYear' => 'setExpirationYear', 'number' => 'setNumber', 'transactionType' => 'setTransactionType', 'type' => 'setType'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['cryptogram' => 'getCryptogram', 'expirationMonth' => 'getExpirationMonth', 'expirationYear' => 'getExpirationYear', 'number' => 'getNumber', 'transactionType' => 'getTransactionType', 'type' => 'getType'];

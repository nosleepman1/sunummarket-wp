...
class RiskV1AuthenticationResultsPost201ResponseConsumerAuthenticationInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['acsRenderingType' => 'string', 'acsReferenceNumber' => 'string', 'acsTransactionId' => 'string', 'acsOperatorID' => 'string', 'authenticationResult' => 'string', 'authenticationType' => 'string', 'authenticationStatusMsg' => 'string', 'authenticationTransactionId' => 'string', 'authenticationTransactionContextId' => 'string', 'transactionToken' => 'string', 'authorizationPayload' => 'string', 'cavv' => 'string', 'cavvAlgorithm' => 'string', 'challengeCancelCode' => 'string', 'directoryServerErrorCode' => 'string', 'directoryServerErrorDescription' => 'string', 'effectiveAuthenticationType' => 'string', 'indicator' => 'string', 'interactionCounter' => 'string', 'eci' => 'string', 'eciRaw' => 'string', 'paresStatus' => 'string', 'sdkTransactionId' => 'string', 'specificationVersion' => 'string', 'threeDSServerTransactionId' => 'string', 'ucafAuthenticationData' => 'string', 'ucafCollectionIndicator' => 'string', 'whiteListStatus' => 'string', 'whiteListStatusSource' => 'string', 'xid' => 'string', 'directoryServerTransactionId' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['acsRenderingType' => null, 'acsReferenceNumber' => null, 'acsTransactionId' => null, 'acsOperatorID' => null, 'authenticationResult' => null, 'authenticationType' => null, 'authenticationStatusMsg' => null, 'authenticationTransactionId' => null, 'authenticationTransactionContextId' => null, 'transactionToken' => null, 'authorizationPayload' => null, 'cavv' => null, 'cavvAlgorithm' => null, 'challengeCancelCode' => null, 'directoryServerErrorCode' => null, 'directoryServerErrorDescription' => null, 'effectiveAuthenticationType' => null, 'indicator' => null, 'interactionCounter' => null, 'eci' => null, 'eciRaw' => null, 'paresStatus' => null, 'sdkTransactionId' => null, 'specificationVersion' => null, 'threeDSServerTransactionId' => null, 'ucafAuthenticationData' => null, 'ucafCollectionIndicator' => null, 'whiteListStatus' => null, 'whiteListStatusSource' => null, 'xid' => null, 'directoryServerTransactionId' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['acsRenderingType' => 'acsRenderingType', 'acsReferenceNumber' => 'acsReferenceNumber', 'acsTransactionId' => 'acsTransactionId', 'acsOperatorID' => 'acsOperatorID', 'authenticationResult' => 'authenticationResult', 'authenticationType' => 'authenticationType', 'authenticationStatusMsg' => 'authenticationStatusMsg', 'authenticationTransactionId' => 'authenticationTransactionId', 'authenticationTransactionContextId' => 'authenticationTransactionContextId', 'transactionToken' => 'transactionToken', 'authorizationPayload' => 'authorizationPayload', 'cavv' => 'cavv', 'cavvAlgorithm' => 'cavvAlgorithm', 'challengeCancelCode' => 'challengeCancelCode', 'directoryServerErrorCode' => 'directoryServerErrorCode', 'directoryServerErrorDescription' => 'directoryServerErrorDescription', 'effectiveAuthenticationType' => 'effectiveAuthenticationType', 'indicator' => 'indicator', 'interactionCounter' => 'interactionCounter', 'eci' => 'eci', 'eciRaw' => 'eciRaw', 'paresStatus' => 'paresStatus', 'sdkTransactionId' => 'sdkTransactionId', 'specificationVersion' => 'specificationVersion', 'threeDSServerTransactionId' => 'threeDSServerTransactionId', 'ucafAuthenticationData' => 'ucafAuthenticationData', 'ucafCollectionIndicator' => 'ucafCollectionIndicator', 'whiteListStatus' => 'whiteListStatus', 'whiteListStatusSource' => 'whiteListStatusSource', 'xid' => 'xid', 'directoryServerTransactionId' => 'directoryServerTransactionId'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['acsRenderingType' => 'setAcsRenderingType', 'acsReferenceNumber' => 'setAcsReferenceNumber', 'acsTransactionId' => 'setAcsTransactionId', 'acsOperatorID' => 'setAcsOperatorID', 'authenticationResult' => 'setAuthenticationResult', 'authenticationType' => 'setAuthenticationType', 'authenticationStatusMsg' => 'setAuthenticationStatusMsg', 'authenticationTransactionId' => 'setAuthenticationTransactionId', 'authenticationTransactionContextId' => 'setAuthenticationTransactionContextId', 'transactionToken' => 'setTransactionToken', 'authorizationPayload' => 'setAuthorizationPayload', 'cavv' => 'setCavv', 'cavvAlgorithm' => 'setCavvAlgorithm', 'challengeCancelCode' => 'setChallengeCancelCode', 'directoryServerErrorCode' => 'setDirectoryServerErrorCode', 'directoryServerErrorDescription' => 'setDirectoryServerErrorDescription', 'effectiveAuthenticationType' => 'setEffectiveAuthenticationType', 'indicator' => 'setIndicator', 'interactionCounter' => 'setInteractionCounter', 'eci' => 'setEci', 'eciRaw' => 'setEciRaw', 'paresStatus' => 'setParesStatus', 'sdkTransactionId' => 'setSdkTransactionId', 'specificationVersion' => 'setSpecificationVersion', 'threeDSServerTransactionId' => 'setThreeDSServerTransactionId', 'ucafAuthenticationData' => 'setUcafAuthenticationData', 'ucafCollectionIndicator' => 'setUcafCollectionIndicator', 'whiteListStatus' => 'setWhiteListStatus', 'whiteListStatusSource' => 'setWhiteListStatusSource', 'xid' => 'setXid', 'directoryServerTransactionId' => 'setDirectoryServerTransactionId'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['acsRenderingType' => 'getAcsRenderingType', 'acsReferenceNumber' => 'getAcsReferenceNumber', 'acsTransactionId' => 'getAcsTransactionId', 'acsOperatorID' => 'getAcsOperatorID', 'authenticationResult' => 'getAuthenticationResult', 'authenticationType' => 'getAuthenticationType', 'authenticationStatusMsg' => 'getAuthenticationStatusMsg', 'authenticationTransactionId' => 'getAuthenticationTransactionId', 'authenticationTransactionContextId' => 'getAuthenticationTransactionContextId', 'transactionToken' => 'getTransactionToken', 'authorizationPayload' => 'getAuthorizationPayload', 'cavv' => 'getCavv', 'cavvAlgorithm' => 'getCavvAlgorithm', 'challengeCancelCode' => 'getChallengeCancelCode', 'directoryServerErrorCode' => 'getDirectoryServerErrorCode', 'directoryServerErrorDescription' => 'getDirectoryServerErrorDescription', 'effectiveAuthenticationType' => 'getEffectiveAuthenticationType', 'indicator' => 'getIndicator', 'interactionCounter' => 'getInteractionCounter', 'eci' => 'getEci', 'eciRaw' => 'getEciRaw', 'paresStatus' => 'getParesStatus', 'sdkTransactionId' => 'getSdkTransactionId', 'specificationVersion' => 'getSpecificationVersion', 'threeDSServerTransactionId' => 'getThreeDSServerTransactionId', 'ucafAuthenticationData' => 'getUcafAuthenticationData', 'ucafCollectionIndicator' => 'getUcafCollectionIndicator', 'whiteListStatus' => 'getWhiteListStatus', 'whiteListStatusSource' => 'getWhiteListStatusSource', 'xid' => 'getXid', 'directoryServerTransactionId' => 'getDirectoryServerTransactionId'];

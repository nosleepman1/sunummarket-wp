...
class Ptsv2paymentsidcapturesBuyerInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['merchantCustomerId' => 'string', 'vatRegistrationNumber' => 'string', 'dateOfBirth' => 'string', 'gender' => 'string', 'language' => 'string', 'personalIdentification' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsidcapturesBuyerInformationPersonalIdentification[]'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['merchantCustomerId' => null, 'vatRegistrationNumber' => null, 'dateOfBirth' => null, 'gender' => null, 'language' => null, 'personalIdentification' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['merchantCustomerId' => 'merchantCustomerId', 'vatRegistrationNumber' => 'vatRegistrationNumber', 'dateOfBirth' => 'dateOfBirth', 'gender' => 'gender', 'language' => 'language', 'personalIdentification' => 'personalIdentification'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['merchantCustomerId' => 'setMerchantCustomerId', 'vatRegistrationNumber' => 'setVatRegistrationNumber', 'dateOfBirth' => 'setDateOfBirth', 'gender' => 'setGender', 'language' => 'setLanguage', 'personalIdentification' => 'setPersonalIdentification'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['merchantCustomerId' => 'getMerchantCustomerId', 'vatRegistrationNumber' => 'getVatRegistrationNumber', 'dateOfBirth' => 'getDateOfBirth', 'gender' => 'getGender', 'language' => 'getLanguage', 'personalIdentification' => 'getPersonalIdentification'];
     ...
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsidcapturesBuyerInformationPersonalIdentification[]
     */
     ...
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsidcapturesBuyerInformationPersonalIdentification[] $personalIdentification
     * @return $this
     */

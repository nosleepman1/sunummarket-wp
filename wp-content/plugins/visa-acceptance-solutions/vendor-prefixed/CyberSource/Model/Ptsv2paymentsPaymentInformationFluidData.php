...
class Ptsv2paymentsPaymentInformationFluidData implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['keySerialNumber' => 'string', 'descriptor' => 'string', 'value' => 'string', 'encoding' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['keySerialNumber' => null, 'descriptor' => null, 'value' => null, 'encoding' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['keySerialNumber' => 'keySerialNumber', 'descriptor' => 'descriptor', 'value' => 'value', 'encoding' => 'encoding'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['keySerialNumber' => 'setKeySerialNumber', 'descriptor' => 'setDescriptor', 'value' => 'setValue', 'encoding' => 'setEncoding'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['keySerialNumber' => 'getKeySerialNumber', 'descriptor' => 'getDescriptor', 'value' => 'getValue', 'encoding' => 'getEncoding'];

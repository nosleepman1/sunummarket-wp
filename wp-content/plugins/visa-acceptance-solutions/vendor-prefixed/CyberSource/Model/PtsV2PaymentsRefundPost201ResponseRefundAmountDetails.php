...
class PtsV2PaymentsRefundPost201ResponseRefundAmountDetails implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['refundAmount' => 'string', 'creditAmount' => 'string', 'currency' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['refundAmount' => null, 'creditAmount' => null, 'currency' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['refundAmount' => 'refundAmount', 'creditAmount' => 'creditAmount', 'currency' => 'currency'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['refundAmount' => 'setRefundAmount', 'creditAmount' => 'setCreditAmount', 'currency' => 'setCurrency'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['refundAmount' => 'getRefundAmount', 'creditAmount' => 'getCreditAmount', 'currency' => 'getCurrency'];

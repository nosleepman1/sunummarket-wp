...
class VasV2PaymentsPost201ResponseOrderInformationJurisdiction implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['type' => 'string', 'taxName' => 'string', 'taxAmount' => 'string', 'taxable' => 'string', 'name' => 'string', 'code' => 'string', 'rate' => 'string', 'region' => 'string', 'country' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['type' => null, 'taxName' => null, 'taxAmount' => null, 'taxable' => null, 'name' => null, 'code' => null, 'rate' => null, 'region' => null, 'country' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['type' => 'type', 'taxName' => 'taxName', 'taxAmount' => 'taxAmount', 'taxable' => 'taxable', 'name' => 'name', 'code' => 'code', 'rate' => 'rate', 'region' => 'region', 'country' => 'country'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['type' => 'setType', 'taxName' => 'setTaxName', 'taxAmount' => 'setTaxAmount', 'taxable' => 'setTaxable', 'name' => 'setName', 'code' => 'setCode', 'rate' => 'setRate', 'region' => 'setRegion', 'country' => 'setCountry'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['type' => 'getType', 'taxName' => 'getTaxName', 'taxAmount' => 'getTaxAmount', 'taxable' => 'getTaxable', 'name' => 'getName', 'code' => 'getCode', 'rate' => 'getRate', 'region' => 'getRegion', 'country' => 'getCountry'];

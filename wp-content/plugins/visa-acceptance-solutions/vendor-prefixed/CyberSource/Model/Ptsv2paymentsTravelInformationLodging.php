...
class Ptsv2paymentsTravelInformationLodging implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['checkInDate' => 'string', 'checkOutDate' => 'string', 'room' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsTravelInformationLodgingRoom[]', 'smokingPreference' => 'string', 'numberOfRooms' => 'int', 'numberOfGuests' => 'int', 'roomBedType' => 'string', 'roomTaxType' => 'string', 'roomRateType' => 'string', 'guestName' => 'string', 'customerServicePhoneNumber' => 'string', 'corporateClientCode' => 'string', 'additionalDiscountAmount' => 'string', 'roomLocation' => 'string', 'specialProgramCode' => 'string', 'totalTaxAmount' => 'string', 'prepaidCost' => 'string', 'foodAndBeverageCost' => 'string', 'roomTaxAmount' => 'string', 'adjustmentAmount' => 'string', 'phoneCost' => 'string', 'restaurantCost' => 'string', 'roomServiceCost' => 'string', 'miniBarCost' => 'string', 'laundryCost' => 'string', 'miscellaneousCost' => 'string', 'giftShopCost' => 'string', 'movieCost' => 'string', 'healthClubCost' => 'string', 'valetParkingCost' => 'string', 'cashDisbursementCost' => 'string', 'nonRoomCost' => 'string', 'businessCenterCost' => 'string', 'loungeBarCost' => 'string', 'transportationCost' => 'string', 'gratuityAmount' => 'string', 'conferenceRoomCost' => 'string', 'audioVisualCost' => 'string', 'banquestCost' => 'string', 'nonRoomTaxAmount' => 'string', 'earlyCheckOutCost' => 'string', 'internetAccessCost' => 'string', 'name' => 'string', 'hotelName' => 'string', 'checkInDateTime' => 'string', 'checkOutDateTime' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['checkInDate' => null, 'checkOutDate' => null, 'room' => null, 'smokingPreference' => null, 'numberOfRooms' => null, 'numberOfGuests' => null, 'roomBedType' => null, 'roomTaxType' => null, 'roomRateType' => null, 'guestName' => null, 'customerServicePhoneNumber' => null, 'corporateClientCode' => null, 'additionalDiscountAmount' => null, 'roomLocation' => null, 'specialProgramCode' => null, 'totalTaxAmount' => null, 'prepaidCost' => null, 'foodAndBeverageCost' => null, 'roomTaxAmount' => null, 'adjustmentAmount' => null, 'phoneCost' => null, 'restaurantCost' => null, 'roomServiceCost' => null, 'miniBarCost' => null, 'laundryCost' => null, 'miscellaneousCost' => null, 'giftShopCost' => null, 'movieCost' => null, 'healthClubCost' => null, 'valetParkingCost' => null, 'cashDisbursementCost' => null, 'nonRoomCost' => null, 'businessCenterCost' => null, 'loungeBarCost' => null, 'transportationCost' => null, 'gratuityAmount' => null, 'conferenceRoomCost' => null, 'audioVisualCost' => null, 'banquestCost' => null, 'nonRoomTaxAmount' => null, 'earlyCheckOutCost' => null, 'internetAccessCost' => null, 'name' => null, 'hotelName' => null, 'checkInDateTime' => null, 'checkOutDateTime' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['checkInDate' => 'checkInDate', 'checkOutDate' => 'checkOutDate', 'room' => 'room', 'smokingPreference' => 'smokingPreference', 'numberOfRooms' => 'numberOfRooms', 'numberOfGuests' => 'numberOfGuests', 'roomBedType' => 'roomBedType', 'roomTaxType' => 'roomTaxType', 'roomRateType' => 'roomRateType', 'guestName' => 'guestName', 'customerServicePhoneNumber' => 'customerServicePhoneNumber', 'corporateClientCode' => 'corporateClientCode', 'additionalDiscountAmount' => 'additionalDiscountAmount', 'roomLocation' => 'roomLocation', 'specialProgramCode' => 'specialProgramCode', 'totalTaxAmount' => 'totalTaxAmount', 'prepaidCost' => 'prepaidCost', 'foodAndBeverageCost' => 'foodAndBeverageCost', 'roomTaxAmount' => 'roomTaxAmount', 'adjustmentAmount' => 'adjustmentAmount', 'phoneCost' => 'phoneCost', 'restaurantCost' => 'restaurantCost', 'roomServiceCost' => 'roomServiceCost', 'miniBarCost' => 'miniBarCost', 'laundryCost' => 'laundryCost', 'miscellaneousCost' => 'miscellaneousCost', 'giftShopCost' => 'giftShopCost', 'movieCost' => 'movieCost', 'healthClubCost' => 'healthClubCost', 'valetParkingCost' => 'valetParkingCost', 'cashDisbursementCost' => 'cashDisbursementCost', 'nonRoomCost' => 'nonRoomCost', 'businessCenterCost' => 'businessCenterCost', 'loungeBarCost' => 'loungeBarCost', 'transportationCost' => 'transportationCost', 'gratuityAmount' => 'gratuityAmount', 'conferenceRoomCost' => 'conferenceRoomCost', 'audioVisualCost' => 'audioVisualCost', 'banquestCost' => 'banquestCost', 'nonRoomTaxAmount' => 'nonRoomTaxAmount', 'earlyCheckOutCost' => 'earlyCheckOutCost', 'internetAccessCost' => 'internetAccessCost', 'name' => 'name', 'hotelName' => 'hotelName', 'checkInDateTime' => 'checkInDateTime', 'checkOutDateTime' => 'checkOutDateTime'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['checkInDate' => 'setCheckInDate', 'checkOutDate' => 'setCheckOutDate', 'room' => 'setRoom', 'smokingPreference' => 'setSmokingPreference', 'numberOfRooms' => 'setNumberOfRooms', 'numberOfGuests' => 'setNumberOfGuests', 'roomBedType' => 'setRoomBedType', 'roomTaxType' => 'setRoomTaxType', 'roomRateType' => 'setRoomRateType', 'guestName' => 'setGuestName', 'customerServicePhoneNumber' => 'setCustomerServicePhoneNumber', 'corporateClientCode' => 'setCorporateClientCode', 'additionalDiscountAmount' => 'setAdditionalDiscountAmount', 'roomLocation' => 'setRoomLocation', 'specialProgramCode' => 'setSpecialProgramCode', 'totalTaxAmount' => 'setTotalTaxAmount', 'prepaidCost' => 'setPrepaidCost', 'foodAndBeverageCost' => 'setFoodAndBeverageCost', 'roomTaxAmount' => 'setRoomTaxAmount', 'adjustmentAmount' => 'setAdjustmentAmount', 'phoneCost' => 'setPhoneCost', 'restaurantCost' => 'setRestaurantCost', 'roomServiceCost' => 'setRoomServiceCost', 'miniBarCost' => 'setMiniBarCost', 'laundryCost' => 'setLaundryCost', 'miscellaneousCost' => 'setMiscellaneousCost', 'giftShopCost' => 'setGiftShopCost', 'movieCost' => 'setMovieCost', 'healthClubCost' => 'setHealthClubCost', 'valetParkingCost' => 'setValetParkingCost', 'cashDisbursementCost' => 'setCashDisbursementCost', 'nonRoomCost' => 'setNonRoomCost', 'businessCenterCost' => 'setBusinessCenterCost', 'loungeBarCost' => 'setLoungeBarCost', 'transportationCost' => 'setTransportationCost', 'gratuityAmount' => 'setGratuityAmount', 'conferenceRoomCost' => 'setConferenceRoomCost', 'audioVisualCost' => 'setAudioVisualCost', 'banquestCost' => 'setBanquestCost', 'nonRoomTaxAmount' => 'setNonRoomTaxAmount', 'earlyCheckOutCost' => 'setEarlyCheckOutCost', 'internetAccessCost' => 'setInternetAccessCost', 'name' => 'setName', 'hotelName' => 'setHotelName', 'checkInDateTime' => 'setCheckInDateTime', 'checkOutDateTime' => 'setCheckOutDateTime'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['checkInDate' => 'getCheckInDate', 'checkOutDate' => 'getCheckOutDate', 'room' => 'getRoom', 'smokingPreference' => 'getSmokingPreference', 'numberOfRooms' => 'getNumberOfRooms', 'numberOfGuests' => 'getNumberOfGuests', 'roomBedType' => 'getRoomBedType', 'roomTaxType' => 'getRoomTaxType', 'roomRateType' => 'getRoomRateType', 'guestName' => 'getGuestName', 'customerServicePhoneNumber' => 'getCustomerServicePhoneNumber', 'corporateClientCode' => 'getCorporateClientCode', 'additionalDiscountAmount' => 'getAdditionalDiscountAmount', 'roomLocation' => 'getRoomLocation', 'specialProgramCode' => 'getSpecialProgramCode', 'totalTaxAmount' => 'getTotalTaxAmount', 'prepaidCost' => 'getPrepaidCost', 'foodAndBeverageCost' => 'getFoodAndBeverageCost', 'roomTaxAmount' => 'getRoomTaxAmount', 'adjustmentAmount' => 'getAdjustmentAmount', 'phoneCost' => 'getPhoneCost', 'restaurantCost' => 'getRestaurantCost', 'roomServiceCost' => 'getRoomServiceCost', 'miniBarCost' => 'getMiniBarCost', 'laundryCost' => 'getLaundryCost', 'miscellaneousCost' => 'getMiscellaneousCost', 'giftShopCost' => 'getGiftShopCost', 'movieCost' => 'getMovieCost', 'healthClubCost' => 'getHealthClubCost', 'valetParkingCost' => 'getValetParkingCost', 'cashDisbursementCost' => 'getCashDisbursementCost', 'nonRoomCost' => 'getNonRoomCost', 'businessCenterCost' => 'getBusinessCenterCost', 'loungeBarCost' => 'getLoungeBarCost', 'transportationCost' => 'getTransportationCost', 'gratuityAmount' => 'getGratuityAmount', 'conferenceRoomCost' => 'getConferenceRoomCost', 'audioVisualCost' => 'getAudioVisualCost', 'banquestCost' => 'getBanquestCost', 'nonRoomTaxAmount' => 'getNonRoomTaxAmount', 'earlyCheckOutCost' => 'getEarlyCheckOutCost', 'internetAccessCost' => 'getInternetAccessCost', 'name' => 'getName', 'hotelName' => 'getHotelName', 'checkInDateTime' => 'getCheckInDateTime', 'checkOutDateTime' => 'getCheckOutDateTime'];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['hotelName'] = isset($data['hotelName']) ? $data['hotelName'] : null;
        $this->container['checkInDateTime'] = isset($data['checkInDateTime']) ? $data['checkInDateTime'] : null;
        $this->container['checkOutDateTime'] = isset($data['checkOutDateTime']) ? $data['checkOutDateTime'] : null;
    }
    /**
    ...
    /**
     * Gets room
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsTravelInformationLodgingRoom[]
     */
    ...
    /**
     * Sets room
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsTravelInformationLodgingRoom[] $room The object containing the number of nights and the daily rate that applies for that no of nights.
     * @return $this
     */
    ...
    /**
     * Sets name
     * @param string $name Name of the hotel for which the reservation is for. Mandatory in case the merchant's business type is Hotel.
     * @return $this
     */
    ...
    /**
     * Sets hotelName
     * @param string $hotelName The name of the hotel for which the reservation was made.
     * @return $this
     */
    ...
    /**
     * Gets checkInDateTime
     * @return string
     */
    public function getCheckInDateTime()
    {
        return $this->container['checkInDateTime'];
    }
    /**
     * Sets checkInDateTime
     * @param string $checkInDateTime The date of the check-in in GMT+8 offset.
     * @return $this
     */
    public function setCheckInDateTime($checkInDateTime)
    {
        $this->container['checkInDateTime'] = $checkInDateTime;
        return $this;
    }
    /**
     * Gets checkOutDateTime
     * @return string
     */
    public function getCheckOutDateTime()
    {
        return $this->container['checkOutDateTime'];
    }
    /**
     * Sets checkOutDateTime
     * @param string $checkOutDateTime The date of the check-out in GMT+8 offset.
     * @return $this
     */
    public function setCheckOutDateTime($checkOutDateTime)
    {
        $this->container['checkOutDateTime'] = $checkOutDateTime;
        return $this;
    }
    /**

...
class Ptsv2paymentsTravelInformationLodgingRoom implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['dailyRate' => 'string', 'numberOfNights' => 'int'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['dailyRate' => null, 'numberOfNights' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['dailyRate' => 'dailyRate', 'numberOfNights' => 'numberOfNights'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['dailyRate' => 'setDailyRate', 'numberOfNights' => 'setNumberOfNights'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['dailyRate' => 'getDailyRate', 'numberOfNights' => 'getNumberOfNights'];

...
class PtsV2IncrementalAuthorizationPatch201ResponseProcessorInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['approvalCode' => 'string', 'transactionId' => 'string', 'networkTransactionId' => 'string', 'responseCode' => 'string', 'systemTraceAuditNumber' => 'string', 'responseDetails' => 'string', 'merchantAdvice' => '\Pymt_Vas\Dependencies\CyberSource\Model\PtsV2PaymentsPost201ResponseProcessorInformationMerchantAdvice', 'merchantRiskPrediction' => 'string', 'sellerProtection' => '\Pymt_Vas\Dependencies\CyberSource\Model\PtsV2PaymentsPost201ResponseProcessorInformationSellerProtection', 'network' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsProcessorInformationReversalNetwork'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['approvalCode' => null, 'transactionId' => null, 'networkTransactionId' => null, 'responseCode' => null, 'systemTraceAuditNumber' => null, 'responseDetails' => null, 'merchantAdvice' => null, 'merchantRiskPrediction' => null, 'sellerProtection' => null, 'network' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['approvalCode' => 'approvalCode', 'transactionId' => 'transactionId', 'networkTransactionId' => 'networkTransactionId', 'responseCode' => 'responseCode', 'systemTraceAuditNumber' => 'systemTraceAuditNumber', 'responseDetails' => 'responseDetails', 'merchantAdvice' => 'merchantAdvice', 'merchantRiskPrediction' => 'merchantRiskPrediction', 'sellerProtection' => 'sellerProtection', 'network' => 'network'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['approvalCode' => 'setApprovalCode', 'transactionId' => 'setTransactionId', 'networkTransactionId' => 'setNetworkTransactionId', 'responseCode' => 'setResponseCode', 'systemTraceAuditNumber' => 'setSystemTraceAuditNumber', 'responseDetails' => 'setResponseDetails', 'merchantAdvice' => 'setMerchantAdvice', 'merchantRiskPrediction' => 'setMerchantRiskPrediction', 'sellerProtection' => 'setSellerProtection', 'network' => 'setNetwork'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['approvalCode' => 'getApprovalCode', 'transactionId' => 'getTransactionId', 'networkTransactionId' => 'getNetworkTransactionId', 'responseCode' => 'getResponseCode', 'systemTraceAuditNumber' => 'getSystemTraceAuditNumber', 'responseDetails' => 'getResponseDetails', 'merchantAdvice' => 'getMerchantAdvice', 'merchantRiskPrediction' => 'getMerchantRiskPrediction', 'sellerProtection' => 'getSellerProtection', 'network' => 'getNetwork'];

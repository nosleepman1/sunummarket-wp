...
use ArrayAccess;
/**
 * InlineResponse20011Devices Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse20011Devices implements ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'inline_response_200_11_devices';
    /**
     * Array of property to type mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerTypes = ['readerId' => 'string', 'serialNumber' => 'string', 'model' => 'string', 'make' => 'string', 'hardwareRevision' => 'string', 'status' => 'string', 'statusChangeReason' => 'string', 'merchantId' => 'string', 'accountId' => 'string', 'terminalCreationDate' => '\DateTime', 'terminalUpdationDate' => '\DateTime', 'paymentProcessorToTerminalMap' => '\Pymt_Vas\Dependencies\CyberSource\Model\InlineResponse20011PaymentProcessorToTerminalMap'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['readerId' => null, 'serialNumber' => null, 'model' => null, 'make' => null, 'hardwareRevision' => null, 'status' => null, 'statusChangeReason' => null, 'merchantId' => null, 'accountId' => null, 'terminalCreationDate' => 'date-time', 'terminalUpdationDate' => 'date-time', 'paymentProcessorToTerminalMap' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['readerId' => 'readerId', 'serialNumber' => 'serialNumber', 'model' => 'model', 'make' => 'make', 'hardwareRevision' => 'hardwareRevision', 'status' => 'status', 'statusChangeReason' => 'statusChangeReason', 'merchantId' => 'merchantId', 'accountId' => 'accountId', 'terminalCreationDate' => 'terminalCreationDate', 'terminalUpdationDate' => 'terminalUpdationDate', 'paymentProcessorToTerminalMap' => 'paymentProcessorToTerminalMap'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['readerId' => 'setReaderId', 'serialNumber' => 'setSerialNumber', 'model' => 'setModel', 'make' => 'setMake', 'hardwareRevision' => 'setHardwareRevision', 'status' => 'setStatus', 'statusChangeReason' => 'setStatusChangeReason', 'merchantId' => 'setMerchantId', 'accountId' => 'setAccountId', 'terminalCreationDate' => 'setTerminalCreationDate', 'terminalUpdationDate' => 'setTerminalUpdationDate', 'paymentProcessorToTerminalMap' => 'setPaymentProcessorToTerminalMap'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['readerId' => 'getReaderId', 'serialNumber' => 'getSerialNumber', 'model' => 'getModel', 'make' => 'getMake', 'hardwareRevision' => 'getHardwareRevision', 'status' => 'getStatus', 'statusChangeReason' => 'getStatusChangeReason', 'merchantId' => 'getMerchantId', 'accountId' => 'getAccountId', 'terminalCreationDate' => 'getTerminalCreationDate', 'terminalUpdationDate' => 'getTerminalUpdationDate', 'paymentProcessorToTerminalMap' => 'getPaymentProcessorToTerminalMap'];
     ...
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\InlineResponse20011PaymentProcessorToTerminalMap
     */
     ...
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\InlineResponse20011PaymentProcessorToTerminalMap $paymentProcessorToTerminalMap
     * @return $this
     */

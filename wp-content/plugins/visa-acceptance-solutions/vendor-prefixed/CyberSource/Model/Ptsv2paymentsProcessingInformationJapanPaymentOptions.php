...
class Ptsv2paymentsProcessingInformationJapanPaymentOptions implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['paymentMethod' => 'string', 'bonuses' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsProcessingInformationJapanPaymentOptionsBonuses[]', 'preapprovalType' => 'string', 'installments' => 'string', 'terminalId' => 'string', 'firstBillingMonth' => 'string', 'businessName' => 'string', 'businessNameKatakana' => 'string', 'jis2TrackData' => 'string', 'businessNameAlphaNumeric' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['paymentMethod' => null, 'bonuses' => null, 'preapprovalType' => null, 'installments' => null, 'terminalId' => null, 'firstBillingMonth' => null, 'businessName' => null, 'businessNameKatakana' => null, 'jis2TrackData' => null, 'businessNameAlphaNumeric' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['paymentMethod' => 'paymentMethod', 'bonuses' => 'bonuses', 'preapprovalType' => 'preapprovalType', 'installments' => 'installments', 'terminalId' => 'terminalId', 'firstBillingMonth' => 'firstBillingMonth', 'businessName' => 'businessName', 'businessNameKatakana' => 'businessNameKatakana', 'jis2TrackData' => 'jis2TrackData', 'businessNameAlphaNumeric' => 'businessNameAlphaNumeric'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['paymentMethod' => 'setPaymentMethod', 'bonuses' => 'setBonuses', 'preapprovalType' => 'setPreapprovalType', 'installments' => 'setInstallments', 'terminalId' => 'setTerminalId', 'firstBillingMonth' => 'setFirstBillingMonth', 'businessName' => 'setBusinessName', 'businessNameKatakana' => 'setBusinessNameKatakana', 'jis2TrackData' => 'setJis2TrackData', 'businessNameAlphaNumeric' => 'setBusinessNameAlphaNumeric'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['paymentMethod' => 'getPaymentMethod', 'bonuses' => 'getBonuses', 'preapprovalType' => 'getPreapprovalType', 'installments' => 'getInstallments', 'terminalId' => 'getTerminalId', 'firstBillingMonth' => 'getFirstBillingMonth', 'businessName' => 'getBusinessName', 'businessNameKatakana' => 'getBusinessNameKatakana', 'jis2TrackData' => 'getJis2TrackData', 'businessNameAlphaNumeric' => 'getBusinessNameAlphaNumeric'];
    ...
    /**
     * Gets bonuses
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsProcessingInformationJapanPaymentOptionsBonuses[]
     */
    ...
    /**
     * Sets bonuses
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsProcessingInformationJapanPaymentOptionsBonuses[] $bonuses An array of objects, each of which contains a bonus month and bonus amount.  Length of bonuses array is equal to the number of bonuses.  Max length = 6.  In case of bonus month and amount not specified, null objects to be returned in the array. Example: bonuses : [ {\"month\": \"1\",\"amount\": \"200\"}, {\"month\": \"3\",\"amount\": \"2500\"}, null]
     * @return $this
     */

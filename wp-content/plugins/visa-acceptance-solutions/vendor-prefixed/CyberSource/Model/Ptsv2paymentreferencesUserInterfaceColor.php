...
class Ptsv2paymentreferencesUserInterfaceColor implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['border' => 'string', 'borderSelected' => 'string', 'button' => 'string', 'buttonText' => 'string', 'checkbox' => 'string', 'checkboxCheckMark' => 'string', 'header' => 'string', 'link' => 'string', 'text' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['border' => null, 'borderSelected' => null, 'button' => null, 'buttonText' => null, 'checkbox' => null, 'checkboxCheckMark' => null, 'header' => null, 'link' => null, 'text' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['border' => 'border', 'borderSelected' => 'borderSelected', 'button' => 'button', 'buttonText' => 'buttonText', 'checkbox' => 'checkbox', 'checkboxCheckMark' => 'checkboxCheckMark', 'header' => 'header', 'link' => 'link', 'text' => 'text'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['border' => 'setBorder', 'borderSelected' => 'setBorderSelected', 'button' => 'setButton', 'buttonText' => 'setButtonText', 'checkbox' => 'setCheckbox', 'checkboxCheckMark' => 'setCheckboxCheckMark', 'header' => 'setHeader', 'link' => 'setLink', 'text' => 'setText'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['border' => 'getBorder', 'borderSelected' => 'getBorderSelected', 'button' => 'getButton', 'buttonText' => 'getButtonText', 'checkbox' => 'getCheckbox', 'checkboxCheckMark' => 'getCheckboxCheckMark', 'header' => 'getHeader', 'link' => 'getLink', 'text' => 'getText'];

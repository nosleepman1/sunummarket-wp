...
class Ptsv1pushfundstransferMerchantInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['categoryCode' => 'int', 'merchantDescriptor' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv1pushfundstransferMerchantInformationMerchantDescriptor'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['categoryCode' => null, 'merchantDescriptor' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['categoryCode' => 'categoryCode', 'merchantDescriptor' => 'merchantDescriptor'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['categoryCode' => 'setCategoryCode', 'merchantDescriptor' => 'setMerchantDescriptor'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['categoryCode' => 'getCategoryCode', 'merchantDescriptor' => 'getMerchantDescriptor'];
     ...
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv1pushfundstransferMerchantInformationMerchantDescriptor
     */
     ...
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv1pushfundstransferMerchantInformationMerchantDescriptor $merchantDescriptor
     * @return $this
     */

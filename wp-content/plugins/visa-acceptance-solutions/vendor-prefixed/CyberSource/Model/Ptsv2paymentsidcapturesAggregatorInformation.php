...
class Ptsv2paymentsidcapturesAggregatorInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['aggregatorId' => 'string', 'name' => 'string', 'subMerchant' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsidcapturesAggregatorInformationSubMerchant'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['aggregatorId' => null, 'name' => null, 'subMerchant' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['aggregatorId' => 'aggregatorId', 'name' => 'name', 'subMerchant' => 'subMerchant'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['aggregatorId' => 'setAggregatorId', 'name' => 'setName', 'subMerchant' => 'setSubMerchant'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['aggregatorId' => 'getAggregatorId', 'name' => 'getName', 'subMerchant' => 'getSubMerchant'];
    ...
    /**
     * Gets subMerchant
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsidcapturesAggregatorInformationSubMerchant
     */
    ...
    /**
     * Sets subMerchant
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsidcapturesAggregatorInformationSubMerchant $subMerchant
     * @return $this
     */

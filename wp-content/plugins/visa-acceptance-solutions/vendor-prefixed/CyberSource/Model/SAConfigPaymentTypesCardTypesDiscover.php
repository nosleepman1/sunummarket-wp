...
class SAConfigPaymentTypesCardTypesDiscover implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['cardVerificationNumberSupported' => 'bool', 'cardVerificationNumberDisplay' => 'bool', 'payerAuthenticationSupported' => 'bool', 'supportedCurrencies' => 'string[]', 'method' => 'string', 'cardVerificationNumberRequired' => 'bool', 'payerAuthenticationEnabled' => 'bool'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['cardVerificationNumberSupported' => null, 'cardVerificationNumberDisplay' => null, 'payerAuthenticationSupported' => null, 'supportedCurrencies' => null, 'method' => null, 'cardVerificationNumberRequired' => null, 'payerAuthenticationEnabled' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['cardVerificationNumberSupported' => 'cardVerificationNumberSupported', 'cardVerificationNumberDisplay' => 'cardVerificationNumberDisplay', 'payerAuthenticationSupported' => 'payerAuthenticationSupported', 'supportedCurrencies' => 'supportedCurrencies', 'method' => 'method', 'cardVerificationNumberRequired' => 'cardVerificationNumberRequired', 'payerAuthenticationEnabled' => 'payerAuthenticationEnabled'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['cardVerificationNumberSupported' => 'setCardVerificationNumberSupported', 'cardVerificationNumberDisplay' => 'setCardVerificationNumberDisplay', 'payerAuthenticationSupported' => 'setPayerAuthenticationSupported', 'supportedCurrencies' => 'setSupportedCurrencies', 'method' => 'setMethod', 'cardVerificationNumberRequired' => 'setCardVerificationNumberRequired', 'payerAuthenticationEnabled' => 'setPayerAuthenticationEnabled'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['cardVerificationNumberSupported' => 'getCardVerificationNumberSupported', 'cardVerificationNumberDisplay' => 'getCardVerificationNumberDisplay', 'payerAuthenticationSupported' => 'getPayerAuthenticationSupported', 'supportedCurrencies' => 'getSupportedCurrencies', 'method' => 'getMethod', 'cardVerificationNumberRequired' => 'getCardVerificationNumberRequired', 'payerAuthenticationEnabled' => 'getPayerAuthenticationEnabled'];

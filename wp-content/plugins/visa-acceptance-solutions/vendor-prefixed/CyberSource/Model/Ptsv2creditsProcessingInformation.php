...
class Ptsv2creditsProcessingInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['actionList' => 'string[]', 'commerceIndicator' => 'string', 'processorId' => 'string', 'paymentSolution' => 'string', 'reconciliationId' => 'string', 'linkId' => 'string', 'reportGroup' => 'string', 'visaCheckoutId' => 'string', 'purchaseLevel' => 'string', 'industryDataType' => 'string', 'walletType' => 'string', 'nationalNetDomesticData' => 'string', 'networkRoutingOrder' => 'string', 'recurringOptions' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsidrefundsProcessingInformationRecurringOptions', 'bankTransferOptions' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2creditsProcessingInformationBankTransferOptions', 'purchaseOptions' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2creditsProcessingInformationPurchaseOptions', 'electronicBenefitsTransfer' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2creditsProcessingInformationElectronicBenefitsTransfer', 'loanOptions' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsProcessingInformationLoanOptions', 'japanPaymentOptions' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2creditsProcessingInformationJapanPaymentOptions', 'refundOptions' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2creditsProcessingInformationRefundOptions', 'merchantVerificationValue' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['actionList' => null, 'commerceIndicator' => null, 'processorId' => null, 'paymentSolution' => null, 'reconciliationId' => null, 'linkId' => null, 'reportGroup' => null, 'visaCheckoutId' => null, 'purchaseLevel' => null, 'industryDataType' => null, 'walletType' => null, 'nationalNetDomesticData' => null, 'networkRoutingOrder' => null, 'recurringOptions' => null, 'bankTransferOptions' => null, 'purchaseOptions' => null, 'electronicBenefitsTransfer' => null, 'loanOptions' => null, 'japanPaymentOptions' => null, 'refundOptions' => null, 'merchantVerificationValue' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['actionList' => 'actionList', 'commerceIndicator' => 'commerceIndicator', 'processorId' => 'processorId', 'paymentSolution' => 'paymentSolution', 'reconciliationId' => 'reconciliationId', 'linkId' => 'linkId', 'reportGroup' => 'reportGroup', 'visaCheckoutId' => 'visaCheckoutId', 'purchaseLevel' => 'purchaseLevel', 'industryDataType' => 'industryDataType', 'walletType' => 'walletType', 'nationalNetDomesticData' => 'nationalNetDomesticData', 'networkRoutingOrder' => 'networkRoutingOrder', 'recurringOptions' => 'recurringOptions', 'bankTransferOptions' => 'bankTransferOptions', 'purchaseOptions' => 'purchaseOptions', 'electronicBenefitsTransfer' => 'electronicBenefitsTransfer', 'loanOptions' => 'loanOptions', 'japanPaymentOptions' => 'japanPaymentOptions', 'refundOptions' => 'refundOptions', 'merchantVerificationValue' => 'merchantVerificationValue'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['actionList' => 'setActionList', 'commerceIndicator' => 'setCommerceIndicator', 'processorId' => 'setProcessorId', 'paymentSolution' => 'setPaymentSolution', 'reconciliationId' => 'setReconciliationId', 'linkId' => 'setLinkId', 'reportGroup' => 'setReportGroup', 'visaCheckoutId' => 'setVisaCheckoutId', 'purchaseLevel' => 'setPurchaseLevel', 'industryDataType' => 'setIndustryDataType', 'walletType' => 'setWalletType', 'nationalNetDomesticData' => 'setNationalNetDomesticData', 'networkRoutingOrder' => 'setNetworkRoutingOrder', 'recurringOptions' => 'setRecurringOptions', 'bankTransferOptions' => 'setBankTransferOptions', 'purchaseOptions' => 'setPurchaseOptions', 'electronicBenefitsTransfer' => 'setElectronicBenefitsTransfer', 'loanOptions' => 'setLoanOptions', 'japanPaymentOptions' => 'setJapanPaymentOptions', 'refundOptions' => 'setRefundOptions', 'merchantVerificationValue' => 'setMerchantVerificationValue'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['actionList' => 'getActionList', 'commerceIndicator' => 'getCommerceIndicator', 'processorId' => 'getProcessorId', 'paymentSolution' => 'getPaymentSolution', 'reconciliationId' => 'getReconciliationId', 'linkId' => 'getLinkId', 'reportGroup' => 'getReportGroup', 'visaCheckoutId' => 'getVisaCheckoutId', 'purchaseLevel' => 'getPurchaseLevel', 'industryDataType' => 'getIndustryDataType', 'walletType' => 'getWalletType', 'nationalNetDomesticData' => 'getNationalNetDomesticData', 'networkRoutingOrder' => 'getNetworkRoutingOrder', 'recurringOptions' => 'getRecurringOptions', 'bankTransferOptions' => 'getBankTransferOptions', 'purchaseOptions' => 'getPurchaseOptions', 'electronicBenefitsTransfer' => 'getElectronicBenefitsTransfer', 'loanOptions' => 'getLoanOptions', 'japanPaymentOptions' => 'getJapanPaymentOptions', 'refundOptions' => 'getRefundOptions', 'merchantVerificationValue' => 'getMerchantVerificationValue'];
     ...
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsidrefundsProcessingInformationRecurringOptions
     */
     ...
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsidrefundsProcessingInformationRecurringOptions $recurringOptions
     * @return $this
     */
     ...
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2creditsProcessingInformationBankTransferOptions
     */
     ...
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2creditsProcessingInformationBankTransferOptions $bankTransferOptions
     * @return $this
     */
     ...
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2creditsProcessingInformationPurchaseOptions
     */
     ...
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2creditsProcessingInformationPurchaseOptions $purchaseOptions
     * @return $this
     */
     ...
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2creditsProcessingInformationElectronicBenefitsTransfer
     */
     ...
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2creditsProcessingInformationElectronicBenefitsTransfer $electronicBenefitsTransfer
     * @return $this
     */
     ...
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2creditsProcessingInformationJapanPaymentOptions
     */
     ...
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2creditsProcessingInformationJapanPaymentOptions $japanPaymentOptions
     * @return $this
     */
    ...
    /**
     * Gets refundOptions
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2creditsProcessingInformationRefundOptions
     */
    ...
    /**
     * Sets refundOptions
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2creditsProcessingInformationRefundOptions $refundOptions
     * @return $this
     */

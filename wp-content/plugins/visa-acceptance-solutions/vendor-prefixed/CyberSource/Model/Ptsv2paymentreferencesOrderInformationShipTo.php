...
class Ptsv2paymentreferencesOrderInformationShipTo implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['email' => 'string', 'title' => 'string', 'firstName' => 'string', 'middleName' => 'string', 'lastName' => 'string', 'company' => 'string', 'address1' => 'string', 'address2' => 'string', 'district' => 'string', 'locality' => 'string', 'administrativeArea' => 'string', 'postalCode' => 'string', 'country' => 'string', 'buildingNumber' => 'string', 'phoneNumber' => 'string', 'immutable' => 'string', 'notApplicable' => 'string', 'county' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['email' => null, 'title' => null, 'firstName' => null, 'middleName' => null, 'lastName' => null, 'company' => null, 'address1' => null, 'address2' => null, 'district' => null, 'locality' => null, 'administrativeArea' => null, 'postalCode' => null, 'country' => null, 'buildingNumber' => null, 'phoneNumber' => null, 'immutable' => null, 'notApplicable' => null, 'county' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['email' => 'email', 'title' => 'title', 'firstName' => 'firstName', 'middleName' => 'middleName', 'lastName' => 'lastName', 'company' => 'company', 'address1' => 'address1', 'address2' => 'address2', 'district' => 'district', 'locality' => 'locality', 'administrativeArea' => 'administrativeArea', 'postalCode' => 'postalCode', 'country' => 'country', 'buildingNumber' => 'buildingNumber', 'phoneNumber' => 'phoneNumber', 'immutable' => 'immutable', 'notApplicable' => 'notApplicable', 'county' => 'county'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['email' => 'setEmail', 'title' => 'setTitle', 'firstName' => 'setFirstName', 'middleName' => 'setMiddleName', 'lastName' => 'setLastName', 'company' => 'setCompany', 'address1' => 'setAddress1', 'address2' => 'setAddress2', 'district' => 'setDistrict', 'locality' => 'setLocality', 'administrativeArea' => 'setAdministrativeArea', 'postalCode' => 'setPostalCode', 'country' => 'setCountry', 'buildingNumber' => 'setBuildingNumber', 'phoneNumber' => 'setPhoneNumber', 'immutable' => 'setImmutable', 'notApplicable' => 'setNotApplicable', 'county' => 'setCounty'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['email' => 'getEmail', 'title' => 'getTitle', 'firstName' => 'getFirstName', 'middleName' => 'getMiddleName', 'lastName' => 'getLastName', 'company' => 'getCompany', 'address1' => 'getAddress1', 'address2' => 'getAddress2', 'district' => 'getDistrict', 'locality' => 'getLocality', 'administrativeArea' => 'getAdministrativeArea', 'postalCode' => 'getPostalCode', 'country' => 'getCountry', 'buildingNumber' => 'getBuildingNumber', 'phoneNumber' => 'getPhoneNumber', 'immutable' => 'getImmutable', 'notApplicable' => 'getNotApplicable', 'county' => 'getCounty'];

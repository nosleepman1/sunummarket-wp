...
class ReportingV3PurchaseRefundDetailsGet200ResponseSettlementStatuses implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['requestId' => 'string', 'status' => 'string', 'settlementTime' => '\DateTime', 'reasonCode' => 'string', 'errorText' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['requestId' => null, 'status' => null, 'settlementTime' => 'date-time', 'reasonCode' => null, 'errorText' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['requestId' => 'requestId', 'status' => 'status', 'settlementTime' => 'settlementTime', 'reasonCode' => 'reasonCode', 'errorText' => 'errorText'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['requestId' => 'setRequestId', 'status' => 'setStatus', 'settlementTime' => 'setSettlementTime', 'reasonCode' => 'setReasonCode', 'errorText' => 'setErrorText'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['requestId' => 'getRequestId', 'status' => 'getStatus', 'settlementTime' => 'getSettlementTime', 'reasonCode' => 'getReasonCode', 'errorText' => 'getErrorText'];

...
class Ptsv1pushfundstransferRecipientInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['paymentInformation' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv1pushfundstransferRecipientInformationPaymentInformation', 'address1' => 'string', 'address2' => 'string', 'locality' => 'string', 'postalCode' => 'string', 'administrativeArea' => 'string', 'country' => 'string', 'firstName' => 'string', 'middleName' => 'string', 'lastName' => 'string', 'phoneNumber' => 'string', 'email' => 'string', 'personalIdentification' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv1pushfundstransferRecipientInformationPersonalIdentification', 'buildingNumber' => 'string', 'streetName' => 'string', 'type' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['paymentInformation' => null, 'address1' => null, 'address2' => null, 'locality' => null, 'postalCode' => null, 'administrativeArea' => null, 'country' => null, 'firstName' => null, 'middleName' => null, 'lastName' => null, 'phoneNumber' => null, 'email' => null, 'personalIdentification' => null, 'buildingNumber' => null, 'streetName' => null, 'type' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['paymentInformation' => 'paymentInformation', 'address1' => 'address1', 'address2' => 'address2', 'locality' => 'locality', 'postalCode' => 'postalCode', 'administrativeArea' => 'administrativeArea', 'country' => 'country', 'firstName' => 'firstName', 'middleName' => 'middleName', 'lastName' => 'lastName', 'phoneNumber' => 'phoneNumber', 'email' => 'email', 'personalIdentification' => 'personalIdentification', 'buildingNumber' => 'buildingNumber', 'streetName' => 'streetName', 'type' => 'type'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['paymentInformation' => 'setPaymentInformation', 'address1' => 'setAddress1', 'address2' => 'setAddress2', 'locality' => 'setLocality', 'postalCode' => 'setPostalCode', 'administrativeArea' => 'setAdministrativeArea', 'country' => 'setCountry', 'firstName' => 'setFirstName', 'middleName' => 'setMiddleName', 'lastName' => 'setLastName', 'phoneNumber' => 'setPhoneNumber', 'email' => 'setEmail', 'personalIdentification' => 'setPersonalIdentification', 'buildingNumber' => 'setBuildingNumber', 'streetName' => 'setStreetName', 'type' => 'setType'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['paymentInformation' => 'getPaymentInformation', 'address1' => 'getAddress1', 'address2' => 'getAddress2', 'locality' => 'getLocality', 'postalCode' => 'getPostalCode', 'administrativeArea' => 'getAdministrativeArea', 'country' => 'getCountry', 'firstName' => 'getFirstName', 'middleName' => 'getMiddleName', 'lastName' => 'getLastName', 'phoneNumber' => 'getPhoneNumber', 'email' => 'getEmail', 'personalIdentification' => 'getPersonalIdentification', 'buildingNumber' => 'getBuildingNumber', 'streetName' => 'getStreetName', 'type' => 'getType'];
     ...
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv1pushfundstransferRecipientInformationPaymentInformation
     */
     ...
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv1pushfundstransferRecipientInformationPaymentInformation $paymentInformation
     * @return $this
     */
     ...
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv1pushfundstransferRecipientInformationPersonalIdentification
     */
     ...
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv1pushfundstransferRecipientInformationPersonalIdentification $personalIdentification
     * @return $this
     */

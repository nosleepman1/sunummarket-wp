...
class Vasv2taxOrderInformationLineItems implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['productSKU' => 'string', 'productCode' => 'string', 'quantity' => 'int', 'productName' => 'string', 'unitPrice' => 'string', 'taxAmount' => 'string', 'orderAcceptance' => '\Pymt_Vas\Dependencies\CyberSource\Model\Vasv2taxOrderInformationOrderAcceptance', 'orderOrigin' => '\Pymt_Vas\Dependencies\CyberSource\Model\Vasv2taxOrderInformationOrderOrigin', 'shipFromCountry' => 'string', 'shipFromAdministrativeArea' => 'string', 'shipFromLocality' => 'string', 'shipFromPostalCode' => 'string', 'buyerVatRegistrationNumber' => 'string', 'sellerVatRegistrationNumber' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['productSKU' => null, 'productCode' => null, 'quantity' => null, 'productName' => null, 'unitPrice' => null, 'taxAmount' => null, 'orderAcceptance' => null, 'orderOrigin' => null, 'shipFromCountry' => null, 'shipFromAdministrativeArea' => null, 'shipFromLocality' => null, 'shipFromPostalCode' => null, 'buyerVatRegistrationNumber' => null, 'sellerVatRegistrationNumber' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['productSKU' => 'productSKU', 'productCode' => 'productCode', 'quantity' => 'quantity', 'productName' => 'productName', 'unitPrice' => 'unitPrice', 'taxAmount' => 'taxAmount', 'orderAcceptance' => 'orderAcceptance', 'orderOrigin' => 'orderOrigin', 'shipFromCountry' => 'shipFromCountry', 'shipFromAdministrativeArea' => 'shipFromAdministrativeArea', 'shipFromLocality' => 'shipFromLocality', 'shipFromPostalCode' => 'shipFromPostalCode', 'buyerVatRegistrationNumber' => 'buyerVatRegistrationNumber', 'sellerVatRegistrationNumber' => 'sellerVatRegistrationNumber'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['productSKU' => 'setProductSKU', 'productCode' => 'setProductCode', 'quantity' => 'setQuantity', 'productName' => 'setProductName', 'unitPrice' => 'setUnitPrice', 'taxAmount' => 'setTaxAmount', 'orderAcceptance' => 'setOrderAcceptance', 'orderOrigin' => 'setOrderOrigin', 'shipFromCountry' => 'setShipFromCountry', 'shipFromAdministrativeArea' => 'setShipFromAdministrativeArea', 'shipFromLocality' => 'setShipFromLocality', 'shipFromPostalCode' => 'setShipFromPostalCode', 'buyerVatRegistrationNumber' => 'setBuyerVatRegistrationNumber', 'sellerVatRegistrationNumber' => 'setSellerVatRegistrationNumber'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['productSKU' => 'getProductSKU', 'productCode' => 'getProductCode', 'quantity' => 'getQuantity', 'productName' => 'getProductName', 'unitPrice' => 'getUnitPrice', 'taxAmount' => 'getTaxAmount', 'orderAcceptance' => 'getOrderAcceptance', 'orderOrigin' => 'getOrderOrigin', 'shipFromCountry' => 'getShipFromCountry', 'shipFromAdministrativeArea' => 'getShipFromAdministrativeArea', 'shipFromLocality' => 'getShipFromLocality', 'shipFromPostalCode' => 'getShipFromPostalCode', 'buyerVatRegistrationNumber' => 'getBuyerVatRegistrationNumber', 'sellerVatRegistrationNumber' => 'getSellerVatRegistrationNumber'];

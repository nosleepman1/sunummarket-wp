...
use ArrayAccess;
/**
 * MerchantInitiatedTransactionObject Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class MerchantInitiatedTransactionObject implements ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'merchantInitiatedTransactionObject';
    /**
     * Array of property to type mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerTypes = ['reason' => 'string', 'previousTransactionId' => 'string', 'originalAuthorizedAmount' => 'string', 'agreementId' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['reason' => null, 'previousTransactionId' => null, 'originalAuthorizedAmount' => null, 'agreementId' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['reason' => 'reason', 'previousTransactionId' => 'previousTransactionId', 'originalAuthorizedAmount' => 'originalAuthorizedAmount', 'agreementId' => 'agreementId'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['reason' => 'setReason', 'previousTransactionId' => 'setPreviousTransactionId', 'originalAuthorizedAmount' => 'setOriginalAuthorizedAmount', 'agreementId' => 'setAgreementId'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['reason' => 'getReason', 'previousTransactionId' => 'getPreviousTransactionId', 'originalAuthorizedAmount' => 'getOriginalAuthorizedAmount', 'agreementId' => 'getAgreementId'];
    ...
    /**
     * Sets agreementId
     * @param string $agreementId This field contains the predetermined agrement id with the merchant
     * @return $this
     */

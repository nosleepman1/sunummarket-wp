...
class Ptsv2creditsSenderInformationAccount implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['number' => 'string', 'fundsSource' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['number' => null, 'fundsSource' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['number' => 'number', 'fundsSource' => 'fundsSource'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['number' => 'setNumber', 'fundsSource' => 'setFundsSource'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['number' => 'getNumber', 'fundsSource' => 'getFundsSource'];

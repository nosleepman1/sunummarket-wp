...
use ArrayAccess;
/**
 * InvoicingV2InvoicesAllGet200ResponseCustomerInformation Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class InvoicingV2InvoicesAllGet200ResponseCustomerInformation implements ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'invoicingV2InvoicesAllGet200Response_customerInformation';
    /**
     * Array of property to type mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerTypes = ['name' => 'string', 'merchantCustomerId' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['name' => null, 'merchantCustomerId' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['name' => 'name', 'merchantCustomerId' => 'merchantCustomerId'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['name' => 'setName', 'merchantCustomerId' => 'setMerchantCustomerId'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['name' => 'getName', 'merchantCustomerId' => 'getMerchantCustomerId'];

...
class Riskv1exportcomplianceinquiriesExportComplianceInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['addressOperator' => 'string', 'weights' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsWatchlistScreeningInformationWeights', 'sanctionLists' => 'string[]'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['addressOperator' => null, 'weights' => null, 'sanctionLists' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['addressOperator' => 'addressOperator', 'weights' => 'weights', 'sanctionLists' => 'sanctionLists'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['addressOperator' => 'setAddressOperator', 'weights' => 'setWeights', 'sanctionLists' => 'setSanctionLists'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['addressOperator' => 'getAddressOperator', 'weights' => 'getWeights', 'sanctionLists' => 'getSanctionLists'];

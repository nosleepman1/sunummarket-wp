...
class ReportingV3ReportSubscriptionsGet200ResponseSubscriptions implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['organizationId' => 'string', 'reportDefinitionId' => 'string', 'reportDefinitionName' => 'string', 'reportMimeType' => 'string', 'reportFrequency' => 'string', 'reportInterval' => 'string', 'reportName' => 'string', 'timezone' => 'string', 'startTime' => '\DateTime', 'startDay' => 'int', 'reportFields' => 'string[]', 'reportFilters' => 'map[string,string[]]', 'reportPreferences' => '\Pymt_Vas\Dependencies\CyberSource\Model\Reportingv3reportsReportPreferences', 'groupId' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['organizationId' => null, 'reportDefinitionId' => null, 'reportDefinitionName' => null, 'reportMimeType' => null, 'reportFrequency' => null, 'reportInterval' => null, 'reportName' => null, 'timezone' => null, 'startTime' => 'date-time', 'startDay' => 'int32', 'reportFields' => null, 'reportFilters' => null, 'reportPreferences' => null, 'groupId' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['organizationId' => 'organizationId', 'reportDefinitionId' => 'reportDefinitionId', 'reportDefinitionName' => 'reportDefinitionName', 'reportMimeType' => 'reportMimeType', 'reportFrequency' => 'reportFrequency', 'reportInterval' => 'reportInterval', 'reportName' => 'reportName', 'timezone' => 'timezone', 'startTime' => 'startTime', 'startDay' => 'startDay', 'reportFields' => 'reportFields', 'reportFilters' => 'reportFilters', 'reportPreferences' => 'reportPreferences', 'groupId' => 'groupId'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['organizationId' => 'setOrganizationId', 'reportDefinitionId' => 'setReportDefinitionId', 'reportDefinitionName' => 'setReportDefinitionName', 'reportMimeType' => 'setReportMimeType', 'reportFrequency' => 'setReportFrequency', 'reportInterval' => 'setReportInterval', 'reportName' => 'setReportName', 'timezone' => 'setTimezone', 'startTime' => 'setStartTime', 'startDay' => 'setStartDay', 'reportFields' => 'setReportFields', 'reportFilters' => 'setReportFilters', 'reportPreferences' => 'setReportPreferences', 'groupId' => 'setGroupId'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['organizationId' => 'getOrganizationId', 'reportDefinitionId' => 'getReportDefinitionId', 'reportDefinitionName' => 'getReportDefinitionName', 'reportMimeType' => 'getReportMimeType', 'reportFrequency' => 'getReportFrequency', 'reportInterval' => 'getReportInterval', 'reportName' => 'getReportName', 'timezone' => 'getTimezone', 'startTime' => 'getStartTime', 'startDay' => 'getStartDay', 'reportFields' => 'getReportFields', 'reportFilters' => 'getReportFilters', 'reportPreferences' => 'getReportPreferences', 'groupId' => 'getGroupId'];
     ...
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Reportingv3reportsReportPreferences
     */
     ...
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Reportingv3reportsReportPreferences $reportPreferences
     * @return $this
     */

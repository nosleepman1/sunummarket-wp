...
class TssV2TransactionsGet200ResponsePaymentInformationBankAccount implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['suffix' => 'string', 'prefix' => 'string', 'checkNumber' => 'string', 'type' => 'string', 'name' => 'string', 'checkDigit' => 'string', 'encoderId' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['suffix' => null, 'prefix' => null, 'checkNumber' => null, 'type' => null, 'name' => null, 'checkDigit' => null, 'encoderId' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['suffix' => 'suffix', 'prefix' => 'prefix', 'checkNumber' => 'checkNumber', 'type' => 'type', 'name' => 'name', 'checkDigit' => 'checkDigit', 'encoderId' => 'encoderId'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['suffix' => 'setSuffix', 'prefix' => 'setPrefix', 'checkNumber' => 'setCheckNumber', 'type' => 'setType', 'name' => 'setName', 'checkDigit' => 'setCheckDigit', 'encoderId' => 'setEncoderId'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['suffix' => 'getSuffix', 'prefix' => 'getPrefix', 'checkNumber' => 'getCheckNumber', 'type' => 'getType', 'name' => 'getName', 'checkDigit' => 'getCheckDigit', 'encoderId' => 'getEncoderId'];
    ...
    /**
     * Sets checkDigit
     * @param string $checkDigit Code used to validate the customer's account number. Required for some countries if you do not or are not allowed to provide the IBAN instead. You may use this field only when scoring a direct debit transaction.
     * @return $this
     */

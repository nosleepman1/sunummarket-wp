...
class Ptsv2paymentsBuyerInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['merchantCustomerId' => 'string', 'dateOfBirth' => 'string', 'vatRegistrationNumber' => 'string', 'companyTaxId' => 'string', 'personalIdentification' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsBuyerInformationPersonalIdentification[]', 'hashedPassword' => 'string', 'gender' => 'string', 'language' => 'string', 'noteToSeller' => 'string', 'mobilePhone' => 'int', 'walletId' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['merchantCustomerId' => null, 'dateOfBirth' => null, 'vatRegistrationNumber' => null, 'companyTaxId' => null, 'personalIdentification' => null, 'hashedPassword' => null, 'gender' => null, 'language' => null, 'noteToSeller' => null, 'mobilePhone' => null, 'walletId' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['merchantCustomerId' => 'merchantCustomerId', 'dateOfBirth' => 'dateOfBirth', 'vatRegistrationNumber' => 'vatRegistrationNumber', 'companyTaxId' => 'companyTaxId', 'personalIdentification' => 'personalIdentification', 'hashedPassword' => 'hashedPassword', 'gender' => 'gender', 'language' => 'language', 'noteToSeller' => 'noteToSeller', 'mobilePhone' => 'mobilePhone', 'walletId' => 'walletId'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['merchantCustomerId' => 'setMerchantCustomerId', 'dateOfBirth' => 'setDateOfBirth', 'vatRegistrationNumber' => 'setVatRegistrationNumber', 'companyTaxId' => 'setCompanyTaxId', 'personalIdentification' => 'setPersonalIdentification', 'hashedPassword' => 'setHashedPassword', 'gender' => 'setGender', 'language' => 'setLanguage', 'noteToSeller' => 'setNoteToSeller', 'mobilePhone' => 'setMobilePhone', 'walletId' => 'setWalletId'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['merchantCustomerId' => 'getMerchantCustomerId', 'dateOfBirth' => 'getDateOfBirth', 'vatRegistrationNumber' => 'getVatRegistrationNumber', 'companyTaxId' => 'getCompanyTaxId', 'personalIdentification' => 'getPersonalIdentification', 'hashedPassword' => 'getHashedPassword', 'gender' => 'getGender', 'language' => 'getLanguage', 'noteToSeller' => 'getNoteToSeller', 'mobilePhone' => 'getMobilePhone', 'walletId' => 'getWalletId'];
     ...
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsBuyerInformationPersonalIdentification[]
     */
     ...
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsBuyerInformationPersonalIdentification[] $personalIdentification
     * @return $this
     */
    ...
    /**
     * Sets hashedPassword
     * @param string $hashedPassword The merchant's password that CyberSource hashes and stores as a hashed password.
     * @return $this
     */

...
class VTConfigCardNotPresentGlobalPaymentInformationBasicInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['defaultStandardEntryClassCode' => 'string', 'defaultCountryCode' => 'string', 'defaultCurrencyCode' => 'string', 'defaultTransactionType' => 'string', 'defaultPaymentType' => 'string', 'defaultTransactionSource' => 'string', 'displayRetail' => 'bool', 'displayMoto' => 'bool', 'displayInternet' => 'bool'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['defaultStandardEntryClassCode' => null, 'defaultCountryCode' => null, 'defaultCurrencyCode' => null, 'defaultTransactionType' => null, 'defaultPaymentType' => null, 'defaultTransactionSource' => null, 'displayRetail' => null, 'displayMoto' => null, 'displayInternet' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['defaultStandardEntryClassCode' => 'defaultStandardEntryClassCode', 'defaultCountryCode' => 'defaultCountryCode', 'defaultCurrencyCode' => 'defaultCurrencyCode', 'defaultTransactionType' => 'defaultTransactionType', 'defaultPaymentType' => 'defaultPaymentType', 'defaultTransactionSource' => 'defaultTransactionSource', 'displayRetail' => 'displayRetail', 'displayMoto' => 'displayMoto', 'displayInternet' => 'displayInternet'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['defaultStandardEntryClassCode' => 'setDefaultStandardEntryClassCode', 'defaultCountryCode' => 'setDefaultCountryCode', 'defaultCurrencyCode' => 'setDefaultCurrencyCode', 'defaultTransactionType' => 'setDefaultTransactionType', 'defaultPaymentType' => 'setDefaultPaymentType', 'defaultTransactionSource' => 'setDefaultTransactionSource', 'displayRetail' => 'setDisplayRetail', 'displayMoto' => 'setDisplayMoto', 'displayInternet' => 'setDisplayInternet'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['defaultStandardEntryClassCode' => 'getDefaultStandardEntryClassCode', 'defaultCountryCode' => 'getDefaultCountryCode', 'defaultCurrencyCode' => 'getDefaultCurrencyCode', 'defaultTransactionType' => 'getDefaultTransactionType', 'defaultPaymentType' => 'getDefaultPaymentType', 'defaultTransactionSource' => 'getDefaultTransactionSource', 'displayRetail' => 'getDisplayRetail', 'displayMoto' => 'getDisplayMoto', 'displayInternet' => 'getDisplayInternet'];

...
class ReportingV3ConversionDetailsGet200ResponseConversionDetails implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['merchantReferenceNumber' => 'string', 'conversionTime' => '\DateTime', 'requestId' => 'string', 'originalDecision' => 'string', 'newDecision' => 'string', 'reviewer' => 'string', 'reviewerComments' => 'string', 'queue' => 'string', 'profile' => 'string', 'notes' => '\Pymt_Vas\Dependencies\CyberSource\Model\ReportingV3ConversionDetailsGet200ResponseNotes[]'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['merchantReferenceNumber' => null, 'conversionTime' => 'date-time', 'requestId' => null, 'originalDecision' => null, 'newDecision' => null, 'reviewer' => null, 'reviewerComments' => null, 'queue' => null, 'profile' => null, 'notes' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['merchantReferenceNumber' => 'merchantReferenceNumber', 'conversionTime' => 'conversionTime', 'requestId' => 'requestId', 'originalDecision' => 'originalDecision', 'newDecision' => 'newDecision', 'reviewer' => 'reviewer', 'reviewerComments' => 'reviewerComments', 'queue' => 'queue', 'profile' => 'profile', 'notes' => 'notes'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['merchantReferenceNumber' => 'setMerchantReferenceNumber', 'conversionTime' => 'setConversionTime', 'requestId' => 'setRequestId', 'originalDecision' => 'setOriginalDecision', 'newDecision' => 'setNewDecision', 'reviewer' => 'setReviewer', 'reviewerComments' => 'setReviewerComments', 'queue' => 'setQueue', 'profile' => 'setProfile', 'notes' => 'setNotes'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['merchantReferenceNumber' => 'getMerchantReferenceNumber', 'conversionTime' => 'getConversionTime', 'requestId' => 'getRequestId', 'originalDecision' => 'getOriginalDecision', 'newDecision' => 'getNewDecision', 'reviewer' => 'getReviewer', 'reviewerComments' => 'getReviewerComments', 'queue' => 'getQueue', 'profile' => 'getProfile', 'notes' => 'getNotes'];
    ...
    /**
     * Gets notes
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\ReportingV3ConversionDetailsGet200ResponseNotes[]
     */
    ...
    /**
     * Sets notes
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\ReportingV3ConversionDetailsGet200ResponseNotes[] $notes
     * @return $this
     */

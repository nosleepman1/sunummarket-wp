...
class PtsV2PaymentsPost201ResponseOrderInformationAmountDetails implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['totalAmount' => 'string', 'authorizedAmount' => 'string', 'cashbackAmount' => 'string', 'currency' => 'string', 'settlementAmount' => 'string', 'settlementCurrency' => 'string', 'originalAmount' => 'string', 'originalCurrency' => 'string', 'processorTransactionFee' => 'string', 'exchangeRate' => 'string', 'foreignCurrency' => 'string', 'foreignAmount' => 'string', 'discountAmount' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['totalAmount' => null, 'authorizedAmount' => null, 'cashbackAmount' => null, 'currency' => null, 'settlementAmount' => null, 'settlementCurrency' => null, 'originalAmount' => null, 'originalCurrency' => null, 'processorTransactionFee' => null, 'exchangeRate' => null, 'foreignCurrency' => null, 'foreignAmount' => null, 'discountAmount' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['totalAmount' => 'totalAmount', 'authorizedAmount' => 'authorizedAmount', 'cashbackAmount' => 'cashbackAmount', 'currency' => 'currency', 'settlementAmount' => 'settlementAmount', 'settlementCurrency' => 'settlementCurrency', 'originalAmount' => 'originalAmount', 'originalCurrency' => 'originalCurrency', 'processorTransactionFee' => 'processorTransactionFee', 'exchangeRate' => 'exchangeRate', 'foreignCurrency' => 'foreignCurrency', 'foreignAmount' => 'foreignAmount', 'discountAmount' => 'discountAmount'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['totalAmount' => 'setTotalAmount', 'authorizedAmount' => 'setAuthorizedAmount', 'cashbackAmount' => 'setCashbackAmount', 'currency' => 'setCurrency', 'settlementAmount' => 'setSettlementAmount', 'settlementCurrency' => 'setSettlementCurrency', 'originalAmount' => 'setOriginalAmount', 'originalCurrency' => 'setOriginalCurrency', 'processorTransactionFee' => 'setProcessorTransactionFee', 'exchangeRate' => 'setExchangeRate', 'foreignCurrency' => 'setForeignCurrency', 'foreignAmount' => 'setForeignAmount', 'discountAmount' => 'setDiscountAmount'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['totalAmount' => 'getTotalAmount', 'authorizedAmount' => 'getAuthorizedAmount', 'cashbackAmount' => 'getCashbackAmount', 'currency' => 'getCurrency', 'settlementAmount' => 'getSettlementAmount', 'settlementCurrency' => 'getSettlementCurrency', 'originalAmount' => 'getOriginalAmount', 'originalCurrency' => 'getOriginalCurrency', 'processorTransactionFee' => 'getProcessorTransactionFee', 'exchangeRate' => 'getExchangeRate', 'foreignCurrency' => 'getForeignCurrency', 'foreignAmount' => 'getForeignAmount', 'discountAmount' => 'getDiscountAmount'];

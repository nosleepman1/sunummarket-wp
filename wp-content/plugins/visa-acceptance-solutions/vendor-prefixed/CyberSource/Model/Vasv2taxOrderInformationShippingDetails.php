...
class Vasv2taxOrderInformationShippingDetails implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['shipFromLocality' => 'string', 'shipFromCountry' => 'string', 'shipFromPostalCode' => 'string', 'shipFromAdministrativeArea' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['shipFromLocality' => null, 'shipFromCountry' => null, 'shipFromPostalCode' => null, 'shipFromAdministrativeArea' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['shipFromLocality' => 'shipFromLocality', 'shipFromCountry' => 'shipFromCountry', 'shipFromPostalCode' => 'shipFromPostalCode', 'shipFromAdministrativeArea' => 'shipFromAdministrativeArea'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['shipFromLocality' => 'setShipFromLocality', 'shipFromCountry' => 'setShipFromCountry', 'shipFromPostalCode' => 'setShipFromPostalCode', 'shipFromAdministrativeArea' => 'setShipFromAdministrativeArea'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['shipFromLocality' => 'getShipFromLocality', 'shipFromCountry' => 'getShipFromCountry', 'shipFromPostalCode' => 'getShipFromPostalCode', 'shipFromAdministrativeArea' => 'getShipFromAdministrativeArea'];

...
class Ptsv2billingagreementsMerchantInformationMerchantDescriptor implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['postalCode' => 'string', 'contact' => 'string', 'locality' => 'string', 'name' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['postalCode' => null, 'contact' => null, 'locality' => null, 'name' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['postalCode' => 'postalCode', 'contact' => 'contact', 'locality' => 'locality', 'name' => 'name'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['postalCode' => 'setPostalCode', 'contact' => 'setContact', 'locality' => 'setLocality', 'name' => 'setName'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['postalCode' => 'getPostalCode', 'contact' => 'getContact', 'locality' => 'getLocality', 'name' => 'getName'];

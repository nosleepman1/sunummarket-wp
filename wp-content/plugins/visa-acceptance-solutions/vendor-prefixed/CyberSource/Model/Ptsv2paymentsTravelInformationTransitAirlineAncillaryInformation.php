...
class Ptsv2paymentsTravelInformationTransitAirlineAncillaryInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['ticketNumber' => 'string', 'passengerName' => 'string', 'connectedTicketNumber' => 'string', 'creditReasonIndicator' => 'string', 'service' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsTravelInformationTransitAirlineAncillaryInformationService[]', 'feeDescription' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['ticketNumber' => null, 'passengerName' => null, 'connectedTicketNumber' => null, 'creditReasonIndicator' => null, 'service' => null, 'feeDescription' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['ticketNumber' => 'ticketNumber', 'passengerName' => 'passengerName', 'connectedTicketNumber' => 'connectedTicketNumber', 'creditReasonIndicator' => 'creditReasonIndicator', 'service' => 'service', 'feeDescription' => 'feeDescription'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['ticketNumber' => 'setTicketNumber', 'passengerName' => 'setPassengerName', 'connectedTicketNumber' => 'setConnectedTicketNumber', 'creditReasonIndicator' => 'setCreditReasonIndicator', 'service' => 'setService', 'feeDescription' => 'setFeeDescription'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['ticketNumber' => 'getTicketNumber', 'passengerName' => 'getPassengerName', 'connectedTicketNumber' => 'getConnectedTicketNumber', 'creditReasonIndicator' => 'getCreditReasonIndicator', 'service' => 'getService', 'feeDescription' => 'getFeeDescription'];
    ...
    /**
     * Gets service
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsTravelInformationTransitAirlineAncillaryInformationService[]
     */
    ...
    /**
     * Sets service
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsTravelInformationTransitAirlineAncillaryInformationService[] $service
     * @return $this
     */

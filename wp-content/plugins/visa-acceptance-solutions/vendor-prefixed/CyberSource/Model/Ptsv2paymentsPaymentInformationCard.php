...
class Ptsv2paymentsPaymentInformationCard implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['number' => 'string', 'expirationMonth' => 'string', 'expirationYear' => 'string', 'type' => 'string', 'useAs' => 'string', 'sourceAccountType' => 'string', 'sourceAccountTypeDetails' => 'string', 'securityCode' => 'string', 'securityCodeIndicator' => 'string', 'accountEncoderId' => 'string', 'issueNumber' => 'string', 'startMonth' => 'string', 'startYear' => 'string', 'productName' => 'string', 'productSubtype' => 'string', 'typeSelectionIndicator' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['number' => null, 'expirationMonth' => null, 'expirationYear' => null, 'type' => null, 'useAs' => null, 'sourceAccountType' => null, 'sourceAccountTypeDetails' => null, 'securityCode' => null, 'securityCodeIndicator' => null, 'accountEncoderId' => null, 'issueNumber' => null, 'startMonth' => null, 'startYear' => null, 'productName' => null, 'productSubtype' => null, 'typeSelectionIndicator' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['number' => 'number', 'expirationMonth' => 'expirationMonth', 'expirationYear' => 'expirationYear', 'type' => 'type', 'useAs' => 'useAs', 'sourceAccountType' => 'sourceAccountType', 'sourceAccountTypeDetails' => 'sourceAccountTypeDetails', 'securityCode' => 'securityCode', 'securityCodeIndicator' => 'securityCodeIndicator', 'accountEncoderId' => 'accountEncoderId', 'issueNumber' => 'issueNumber', 'startMonth' => 'startMonth', 'startYear' => 'startYear', 'productName' => 'productName', 'productSubtype' => 'productSubtype', 'typeSelectionIndicator' => 'typeSelectionIndicator'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['number' => 'setNumber', 'expirationMonth' => 'setExpirationMonth', 'expirationYear' => 'setExpirationYear', 'type' => 'setType', 'useAs' => 'setUseAs', 'sourceAccountType' => 'setSourceAccountType', 'sourceAccountTypeDetails' => 'setSourceAccountTypeDetails', 'securityCode' => 'setSecurityCode', 'securityCodeIndicator' => 'setSecurityCodeIndicator', 'accountEncoderId' => 'setAccountEncoderId', 'issueNumber' => 'setIssueNumber', 'startMonth' => 'setStartMonth', 'startYear' => 'setStartYear', 'productName' => 'setProductName', 'productSubtype' => 'setProductSubtype', 'typeSelectionIndicator' => 'setTypeSelectionIndicator'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['number' => 'getNumber', 'expirationMonth' => 'getExpirationMonth', 'expirationYear' => 'getExpirationYear', 'type' => 'getType', 'useAs' => 'getUseAs', 'sourceAccountType' => 'getSourceAccountType', 'sourceAccountTypeDetails' => 'getSourceAccountTypeDetails', 'securityCode' => 'getSecurityCode', 'securityCodeIndicator' => 'getSecurityCodeIndicator', 'accountEncoderId' => 'getAccountEncoderId', 'issueNumber' => 'getIssueNumber', 'startMonth' => 'getStartMonth', 'startYear' => 'getStartYear', 'productName' => 'getProductName', 'productSubtype' => 'getProductSubtype', 'typeSelectionIndicator' => 'getTypeSelectionIndicator'];

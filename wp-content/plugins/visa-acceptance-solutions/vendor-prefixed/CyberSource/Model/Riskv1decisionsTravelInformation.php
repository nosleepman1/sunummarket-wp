...
class Riskv1decisionsTravelInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['actualFinalDestination' => 'string', 'completeRoute' => 'string', 'departureTime' => 'string', 'journeyType' => 'string', 'legs' => '\Pymt_Vas\Dependencies\CyberSource\Model\Riskv1decisionsTravelInformationLegs[]', 'numberOfPassengers' => 'int', 'passengers' => '\Pymt_Vas\Dependencies\CyberSource\Model\Riskv1decisionsTravelInformationPassengers[]'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['actualFinalDestination' => null, 'completeRoute' => null, 'departureTime' => null, 'journeyType' => null, 'legs' => null, 'numberOfPassengers' => null, 'passengers' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['actualFinalDestination' => 'actualFinalDestination', 'completeRoute' => 'completeRoute', 'departureTime' => 'departureTime', 'journeyType' => 'journeyType', 'legs' => 'legs', 'numberOfPassengers' => 'numberOfPassengers', 'passengers' => 'passengers'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['actualFinalDestination' => 'setActualFinalDestination', 'completeRoute' => 'setCompleteRoute', 'departureTime' => 'setDepartureTime', 'journeyType' => 'setJourneyType', 'legs' => 'setLegs', 'numberOfPassengers' => 'setNumberOfPassengers', 'passengers' => 'setPassengers'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['actualFinalDestination' => 'getActualFinalDestination', 'completeRoute' => 'getCompleteRoute', 'departureTime' => 'getDepartureTime', 'journeyType' => 'getJourneyType', 'legs' => 'getLegs', 'numberOfPassengers' => 'getNumberOfPassengers', 'passengers' => 'getPassengers'];
    ...
    /**
     * Gets legs
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Riskv1decisionsTravelInformationLegs[]
     */
    ...
    /**
     * Sets legs
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Riskv1decisionsTravelInformationLegs[] $legs
     * @return $this
     */
    ...
    /**
     * Gets passengers
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Riskv1decisionsTravelInformationPassengers[]
     */
    ...
    /**
     * Sets passengers
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Riskv1decisionsTravelInformationPassengers[] $passengers
     * @return $this
     */

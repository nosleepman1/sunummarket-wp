...
class Ptsv2paymentreferencesDeviceInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['ipAddress' => 'string', 'deviceType' => 'string', 'id' => 'string', 'userAgent' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['ipAddress' => null, 'deviceType' => null, 'id' => null, 'userAgent' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['ipAddress' => 'ipAddress', 'deviceType' => 'deviceType', 'id' => 'id', 'userAgent' => 'userAgent'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['ipAddress' => 'setIpAddress', 'deviceType' => 'setDeviceType', 'id' => 'setId', 'userAgent' => 'setUserAgent'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['ipAddress' => 'getIpAddress', 'deviceType' => 'getDeviceType', 'id' => 'getId', 'userAgent' => 'getUserAgent'];

...
use ArrayAccess;
/**
 * Ptsv2paymentsidrefundsTravelInformationTransitAirlineAncillaryInformationService Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Ptsv2paymentsidrefundsTravelInformationTransitAirlineAncillaryInformationService implements ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'ptsv2paymentsidrefunds_travelInformation_transit_airline_ancillaryInformation_service';
    /**
     * Array of property to type mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerTypes = ['categoryCode' => 'string', 'subCategoryCode' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['categoryCode' => null, 'subCategoryCode' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['categoryCode' => 'categoryCode', 'subCategoryCode' => 'subCategoryCode'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['categoryCode' => 'setCategoryCode', 'subCategoryCode' => 'setSubCategoryCode'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['categoryCode' => 'getCategoryCode', 'subCategoryCode' => 'getSubCategoryCode'];

...
class TssV2TransactionsGet200ResponsePaymentInformationAccountFeatures implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['balanceAmount' => 'string', 'previousBalanceAmount' => 'string', 'currency' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['balanceAmount' => null, 'previousBalanceAmount' => null, 'currency' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['balanceAmount' => 'balanceAmount', 'previousBalanceAmount' => 'previousBalanceAmount', 'currency' => 'currency'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['balanceAmount' => 'setBalanceAmount', 'previousBalanceAmount' => 'setPreviousBalanceAmount', 'currency' => 'setCurrency'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['balanceAmount' => 'getBalanceAmount', 'previousBalanceAmount' => 'getPreviousBalanceAmount', 'currency' => 'getCurrency'];

...
class Ptsv2billingagreementsConsumerAuthenticationInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['authenticationTransactionContextId' => 'string', 'cavv' => 'string', 'transactionToken' => 'string', 'xid' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['authenticationTransactionContextId' => null, 'cavv' => null, 'transactionToken' => null, 'xid' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['authenticationTransactionContextId' => 'authenticationTransactionContextId', 'cavv' => 'cavv', 'transactionToken' => 'transactionToken', 'xid' => 'xid'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['authenticationTransactionContextId' => 'setAuthenticationTransactionContextId', 'cavv' => 'setCavv', 'transactionToken' => 'setTransactionToken', 'xid' => 'setXid'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['authenticationTransactionContextId' => 'getAuthenticationTransactionContextId', 'cavv' => 'getCavv', 'transactionToken' => 'getTransactionToken', 'xid' => 'getXid'];

...
use ArrayAccess;
/**
 * Ptsv1pushfundstransferRecipientInformationPersonalIdentification Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Ptsv1pushfundstransferRecipientInformationPersonalIdentification implements ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'ptsv1pushfundstransfer_recipientInformation_personalIdentification';
    /**
     * Array of property to type mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerTypes = ['id' => 'string', 'type' => 'string', 'issuingCountry' => 'string', 'personalIdType' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['id' => null, 'type' => null, 'issuingCountry' => null, 'personalIdType' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['id' => 'id', 'type' => 'type', 'issuingCountry' => 'issuingCountry', 'personalIdType' => 'personalIdType'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['id' => 'setId', 'type' => 'setType', 'issuingCountry' => 'setIssuingCountry', 'personalIdType' => 'setPersonalIdType'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['id' => 'getId', 'type' => 'getType', 'issuingCountry' => 'getIssuingCountry', 'personalIdType' => 'getPersonalIdType'];

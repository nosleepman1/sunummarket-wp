...
class Riskv1decisionsOrderInformationLineItems implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['totalAmount' => 'string', 'unitPrice' => 'string', 'quantity' => 'int', 'giftCardCurrency' => 'int', 'productSKU' => 'string', 'productRisk' => 'string', 'productDescription' => 'string', 'productName' => 'string', 'productCode' => 'string', 'gift' => 'bool', 'distributorProductSku' => 'string', 'passenger' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsOrderInformationPassenger', 'shippingDestinationTypes' => 'string', 'taxAmount' => 'string', 'allowedExportCountries' => 'string[]', 'restrictedExportCountries' => 'string[]'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['totalAmount' => null, 'unitPrice' => null, 'quantity' => null, 'giftCardCurrency' => null, 'productSKU' => null, 'productRisk' => null, 'productDescription' => null, 'productName' => null, 'productCode' => null, 'gift' => null, 'distributorProductSku' => null, 'passenger' => null, 'shippingDestinationTypes' => null, 'taxAmount' => null, 'allowedExportCountries' => null, 'restrictedExportCountries' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['totalAmount' => 'totalAmount', 'unitPrice' => 'unitPrice', 'quantity' => 'quantity', 'giftCardCurrency' => 'giftCardCurrency', 'productSKU' => 'productSKU', 'productRisk' => 'productRisk', 'productDescription' => 'productDescription', 'productName' => 'productName', 'productCode' => 'productCode', 'gift' => 'gift', 'distributorProductSku' => 'distributorProductSku', 'passenger' => 'passenger', 'shippingDestinationTypes' => 'shippingDestinationTypes', 'taxAmount' => 'taxAmount', 'allowedExportCountries' => 'allowedExportCountries', 'restrictedExportCountries' => 'restrictedExportCountries'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['totalAmount' => 'setTotalAmount', 'unitPrice' => 'setUnitPrice', 'quantity' => 'setQuantity', 'giftCardCurrency' => 'setGiftCardCurrency', 'productSKU' => 'setProductSKU', 'productRisk' => 'setProductRisk', 'productDescription' => 'setProductDescription', 'productName' => 'setProductName', 'productCode' => 'setProductCode', 'gift' => 'setGift', 'distributorProductSku' => 'setDistributorProductSku', 'passenger' => 'setPassenger', 'shippingDestinationTypes' => 'setShippingDestinationTypes', 'taxAmount' => 'setTaxAmount', 'allowedExportCountries' => 'setAllowedExportCountries', 'restrictedExportCountries' => 'setRestrictedExportCountries'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['totalAmount' => 'getTotalAmount', 'unitPrice' => 'getUnitPrice', 'quantity' => 'getQuantity', 'giftCardCurrency' => 'getGiftCardCurrency', 'productSKU' => 'getProductSKU', 'productRisk' => 'getProductRisk', 'productDescription' => 'getProductDescription', 'productName' => 'getProductName', 'productCode' => 'getProductCode', 'gift' => 'getGift', 'distributorProductSku' => 'getDistributorProductSku', 'passenger' => 'getPassenger', 'shippingDestinationTypes' => 'getShippingDestinationTypes', 'taxAmount' => 'getTaxAmount', 'allowedExportCountries' => 'getAllowedExportCountries', 'restrictedExportCountries' => 'getRestrictedExportCountries'];
    ...
    /**
     * Sets unitPrice
     * @param string $unitPrice Per-item price of the product. If line items are present in the request, the unit price is a mandatory field.
     * @return $this
     */

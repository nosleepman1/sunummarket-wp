...
class RiskV1AddressVerificationsPost201ResponseAddressVerificationInformationBarCode implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['value' => 'string', 'checkDigit' => 'float'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['value' => null, 'checkDigit' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['value' => 'value', 'checkDigit' => 'checkDigit'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['value' => 'setValue', 'checkDigit' => 'setCheckDigit'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['value' => 'getValue', 'checkDigit' => 'getCheckDigit'];

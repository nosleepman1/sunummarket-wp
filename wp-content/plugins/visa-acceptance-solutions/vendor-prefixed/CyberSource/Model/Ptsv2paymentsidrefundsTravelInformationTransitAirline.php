...
use ArrayAccess;
/**
 * Ptsv2paymentsidrefundsTravelInformationTransitAirline Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Ptsv2paymentsidrefundsTravelInformationTransitAirline implements ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'ptsv2paymentsidrefunds_travelInformation_transit_airline';
    /**
     * Array of property to type mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerTypes = ['isDomestic' => 'string', 'bookingReferenceNumber' => 'string', 'carrierName' => 'string', 'ticketIssuer' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsTravelInformationTransitAirlineTicketIssuer', 'ticketNumber' => 'string', 'checkDigit' => 'string', 'restrictedTicketIndicator' => 'int', 'transactionType' => 'int', 'extendedPaymentCode' => 'string', 'passengerName' => 'string', 'customerCode' => 'string', 'documentType' => 'string', 'documentNumber' => 'string', 'documentNumberOfParts' => 'int', 'invoiceNumber' => 'string', 'invoiceDate' => 'int', 'additionalCharges' => 'string', 'totalFeeAmount' => 'string', 'clearingSequence' => 'string', 'clearingCount' => 'string', 'totalClearingAmount' => 'string', 'numberOfPassengers' => 'int', 'reservationSystemCode' => 'string', 'processIdentifier' => 'string', 'ticketIssueDate' => 'string', 'electronicTicketIndicator' => 'bool', 'originalTicketNumber' => 'string', 'purchaseType' => 'string', 'creditReasonIndicator' => 'string', 'ticketChangeIndicator' => 'string', 'planNumber' => 'string', 'arrivalDate' => 'string', 'restrictedTicketDesciption' => 'string', 'exchangeTicketAmount' => 'string', 'exchangeTicketFeeAmount' => 'string', 'reservationType' => 'string', 'boardingFeeAmount' => 'string', 'legs' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsTravelInformationTransitAirlineLegs[]', 'ancillaryInformation' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsidrefundsTravelInformationTransitAirlineAncillaryInformation', 'flightType' => 'string', 'insuranceAmount' => 'string', 'frequentFlyerNumber' => 'string', 'thirdPartyStatus' => 'string', 'passengerType' => 'string', 'totalInsuranceAmount' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['isDomestic' => null, 'bookingReferenceNumber' => null, 'carrierName' => null, 'ticketIssuer' => null, 'ticketNumber' => null, 'checkDigit' => null, 'restrictedTicketIndicator' => null, 'transactionType' => null, 'extendedPaymentCode' => null, 'passengerName' => null, 'customerCode' => null, 'documentType' => null, 'documentNumber' => null, 'documentNumberOfParts' => null, 'invoiceNumber' => null, 'invoiceDate' => null, 'additionalCharges' => null, 'totalFeeAmount' => null, 'clearingSequence' => null, 'clearingCount' => null, 'totalClearingAmount' => null, 'numberOfPassengers' => null, 'reservationSystemCode' => null, 'processIdentifier' => null, 'ticketIssueDate' => null, 'electronicTicketIndicator' => null, 'originalTicketNumber' => null, 'purchaseType' => null, 'creditReasonIndicator' => null, 'ticketChangeIndicator' => null, 'planNumber' => null, 'arrivalDate' => null, 'restrictedTicketDesciption' => null, 'exchangeTicketAmount' => null, 'exchangeTicketFeeAmount' => null, 'reservationType' => null, 'boardingFeeAmount' => null, 'legs' => null, 'ancillaryInformation' => null, 'flightType' => null, 'insuranceAmount' => null, 'frequentFlyerNumber' => null, 'thirdPartyStatus' => null, 'passengerType' => null, 'totalInsuranceAmount' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['isDomestic' => 'isDomestic', 'bookingReferenceNumber' => 'bookingReferenceNumber', 'carrierName' => 'carrierName', 'ticketIssuer' => 'ticketIssuer', 'ticketNumber' => 'ticketNumber', 'checkDigit' => 'checkDigit', 'restrictedTicketIndicator' => 'restrictedTicketIndicator', 'transactionType' => 'transactionType', 'extendedPaymentCode' => 'extendedPaymentCode', 'passengerName' => 'passengerName', 'customerCode' => 'customerCode', 'documentType' => 'documentType', 'documentNumber' => 'documentNumber', 'documentNumberOfParts' => 'documentNumberOfParts', 'invoiceNumber' => 'invoiceNumber', 'invoiceDate' => 'invoiceDate', 'additionalCharges' => 'additionalCharges', 'totalFeeAmount' => 'totalFeeAmount', 'clearingSequence' => 'clearingSequence', 'clearingCount' => 'clearingCount', 'totalClearingAmount' => 'totalClearingAmount', 'numberOfPassengers' => 'numberOfPassengers', 'reservationSystemCode' => 'reservationSystemCode', 'processIdentifier' => 'processIdentifier', 'ticketIssueDate' => 'ticketIssueDate', 'electronicTicketIndicator' => 'electronicTicketIndicator', 'originalTicketNumber' => 'originalTicketNumber', 'purchaseType' => 'purchaseType', 'creditReasonIndicator' => 'creditReasonIndicator', 'ticketChangeIndicator' => 'ticketChangeIndicator', 'planNumber' => 'planNumber', 'arrivalDate' => 'arrivalDate', 'restrictedTicketDesciption' => 'restrictedTicketDesciption', 'exchangeTicketAmount' => 'exchangeTicketAmount', 'exchangeTicketFeeAmount' => 'exchangeTicketFeeAmount', 'reservationType' => 'reservationType', 'boardingFeeAmount' => 'boardingFeeAmount', 'legs' => 'legs', 'ancillaryInformation' => 'ancillaryInformation', 'flightType' => 'flightType', 'insuranceAmount' => 'insuranceAmount', 'frequentFlyerNumber' => 'frequentFlyerNumber', 'thirdPartyStatus' => 'thirdPartyStatus', 'passengerType' => 'passengerType', 'totalInsuranceAmount' => 'totalInsuranceAmount'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['isDomestic' => 'setIsDomestic', 'bookingReferenceNumber' => 'setBookingReferenceNumber', 'carrierName' => 'setCarrierName', 'ticketIssuer' => 'setTicketIssuer', 'ticketNumber' => 'setTicketNumber', 'checkDigit' => 'setCheckDigit', 'restrictedTicketIndicator' => 'setRestrictedTicketIndicator', 'transactionType' => 'setTransactionType', 'extendedPaymentCode' => 'setExtendedPaymentCode', 'passengerName' => 'setPassengerName', 'customerCode' => 'setCustomerCode', 'documentType' => 'setDocumentType', 'documentNumber' => 'setDocumentNumber', 'documentNumberOfParts' => 'setDocumentNumberOfParts', 'invoiceNumber' => 'setInvoiceNumber', 'invoiceDate' => 'setInvoiceDate', 'additionalCharges' => 'setAdditionalCharges', 'totalFeeAmount' => 'setTotalFeeAmount', 'clearingSequence' => 'setClearingSequence', 'clearingCount' => 'setClearingCount', 'totalClearingAmount' => 'setTotalClearingAmount', 'numberOfPassengers' => 'setNumberOfPassengers', 'reservationSystemCode' => 'setReservationSystemCode', 'processIdentifier' => 'setProcessIdentifier', 'ticketIssueDate' => 'setTicketIssueDate', 'electronicTicketIndicator' => 'setElectronicTicketIndicator', 'originalTicketNumber' => 'setOriginalTicketNumber', 'purchaseType' => 'setPurchaseType', 'creditReasonIndicator' => 'setCreditReasonIndicator', 'ticketChangeIndicator' => 'setTicketChangeIndicator', 'planNumber' => 'setPlanNumber', 'arrivalDate' => 'setArrivalDate', 'restrictedTicketDesciption' => 'setRestrictedTicketDesciption', 'exchangeTicketAmount' => 'setExchangeTicketAmount', 'exchangeTicketFeeAmount' => 'setExchangeTicketFeeAmount', 'reservationType' => 'setReservationType', 'boardingFeeAmount' => 'setBoardingFeeAmount', 'legs' => 'setLegs', 'ancillaryInformation' => 'setAncillaryInformation', 'flightType' => 'setFlightType', 'insuranceAmount' => 'setInsuranceAmount', 'frequentFlyerNumber' => 'setFrequentFlyerNumber', 'thirdPartyStatus' => 'setThirdPartyStatus', 'passengerType' => 'setPassengerType', 'totalInsuranceAmount' => 'setTotalInsuranceAmount'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['isDomestic' => 'getIsDomestic', 'bookingReferenceNumber' => 'getBookingReferenceNumber', 'carrierName' => 'getCarrierName', 'ticketIssuer' => 'getTicketIssuer', 'ticketNumber' => 'getTicketNumber', 'checkDigit' => 'getCheckDigit', 'restrictedTicketIndicator' => 'getRestrictedTicketIndicator', 'transactionType' => 'getTransactionType', 'extendedPaymentCode' => 'getExtendedPaymentCode', 'passengerName' => 'getPassengerName', 'customerCode' => 'getCustomerCode', 'documentType' => 'getDocumentType', 'documentNumber' => 'getDocumentNumber', 'documentNumberOfParts' => 'getDocumentNumberOfParts', 'invoiceNumber' => 'getInvoiceNumber', 'invoiceDate' => 'getInvoiceDate', 'additionalCharges' => 'getAdditionalCharges', 'totalFeeAmount' => 'getTotalFeeAmount', 'clearingSequence' => 'getClearingSequence', 'clearingCount' => 'getClearingCount', 'totalClearingAmount' => 'getTotalClearingAmount', 'numberOfPassengers' => 'getNumberOfPassengers', 'reservationSystemCode' => 'getReservationSystemCode', 'processIdentifier' => 'getProcessIdentifier', 'ticketIssueDate' => 'getTicketIssueDate', 'electronicTicketIndicator' => 'getElectronicTicketIndicator', 'originalTicketNumber' => 'getOriginalTicketNumber', 'purchaseType' => 'getPurchaseType', 'creditReasonIndicator' => 'getCreditReasonIndicator', 'ticketChangeIndicator' => 'getTicketChangeIndicator', 'planNumber' => 'getPlanNumber', 'arrivalDate' => 'getArrivalDate', 'restrictedTicketDesciption' => 'getRestrictedTicketDesciption', 'exchangeTicketAmount' => 'getExchangeTicketAmount', 'exchangeTicketFeeAmount' => 'getExchangeTicketFeeAmount', 'reservationType' => 'getReservationType', 'boardingFeeAmount' => 'getBoardingFeeAmount', 'legs' => 'getLegs', 'ancillaryInformation' => 'getAncillaryInformation', 'flightType' => 'getFlightType', 'insuranceAmount' => 'getInsuranceAmount', 'frequentFlyerNumber' => 'getFrequentFlyerNumber', 'thirdPartyStatus' => 'getThirdPartyStatus', 'passengerType' => 'getPassengerType', 'totalInsuranceAmount' => 'getTotalInsuranceAmount'];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['flightType'] = isset($data['flightType']) ? $data['flightType'] : null;
        $this->container['insuranceAmount'] = isset($data['insuranceAmount']) ? $data['insuranceAmount'] : null;
        $this->container['frequentFlyerNumber'] = isset($data['frequentFlyerNumber']) ? $data['frequentFlyerNumber'] : null;
        $this->container['thirdPartyStatus'] = isset($data['thirdPartyStatus']) ? $data['thirdPartyStatus'] : null;
        $this->container['passengerType'] = isset($data['passengerType']) ? $data['passengerType'] : null;
        $this->container['totalInsuranceAmount'] = isset($data['totalInsuranceAmount']) ? $data['totalInsuranceAmount'] : null;
    }
    /**
    ...
    {
        return $this->container['isDomestic'];
    }
    /**
     * Sets isDomestic
     * @param string $isDomestic Specifies if the flight is: Domestic (01) International (02) If Y then 01 else 02
     * @return $this
     */
    public function setIsDomestic($isDomestic)
    {
        $this->container['isDomestic'] = $isDomestic;
        return $this;
    }
    /**
    ...
    /**
     * Gets ticketIssuer
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsTravelInformationTransitAirlineTicketIssuer
     */
    ...
    /**
     * Sets ticketIssuer
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsTravelInformationTransitAirlineTicketIssuer $ticketIssuer
     * @return $this
     */
    ...
    /**
     * Gets legs
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsTravelInformationTransitAirlineLegs[]
     */
    ...
    /**
     * Sets legs
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsTravelInformationTransitAirlineLegs[] $legs
     * @return $this
     */
     ...
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsidrefundsTravelInformationTransitAirlineAncillaryInformation
     */
     ...
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsidrefundsTravelInformationTransitAirlineAncillaryInformation $ancillaryInformation
     * @return $this
     */
    ...
    {
        return $this->container['flightType'];
    }
    /**
     * Sets flightType
     * @param string $flightType Specifies the type of flight. One way (0) Return (1) Transit (2) Transit & Return (3) Multi-City (4)
     * @return $this
     */
    public function setFlightType($flightType)
    {
        $this->container['flightType'] = $flightType;
        return $this;
    }
    /**
     ...
     * @param string $insuranceAmount The total cost of the flight insurance. Example: 10000.00
     * @return $this
     */
    ...
    /**
     * Gets frequentFlyerNumber
     * @return string
     */
    public function getFrequentFlyerNumber()
    {
        return $this->container['frequentFlyerNumber'];
    }
    /**
     * Sets frequentFlyerNumber
     * @param string $frequentFlyerNumber The consumer's frequent flyer number. Leave 0 if there is no frequent flyer number
     * @return $this
     */
    public function setFrequentFlyerNumber($frequentFlyerNumber)
    {
        $this->container['frequentFlyerNumber'] = $frequentFlyerNumber;
        return $this;
    }
    /**
     * Gets thirdPartyStatus
     * @return string
     */
    public function getThirdPartyStatus()
    {
        return $this->container['thirdPartyStatus'];
    }
    /**
     * Sets thirdPartyStatus
     * @param string $thirdPartyStatus Specifies if the travel agent joins the flight (0) or not (1)
     * @return $this
     */
    public function setThirdPartyStatus($thirdPartyStatus)
    {
        $this->container['thirdPartyStatus'] = $thirdPartyStatus;
        return $this;
    }
    /**
     * Gets passengerType
    ...
    {
        return $this->container['passengerType'];
    }
    /**
     * Sets passengerType
     * @param string $passengerType List of passenger types in a booking code: A (Adult) C (Child) Comma separated values for total number of passenger
     * @return $this
     */
    public function setPassengerType($passengerType)
    {
        $this->container['passengerType'] = $passengerType;
        return $this;
    }
    /**
     * Gets totalInsuranceAmount
     * @return string
     */
    public function getTotalInsuranceAmount()
    {
        return $this->container['totalInsuranceAmount'];
    }
    /**
     * Sets totalInsuranceAmount
     * @param string $totalInsuranceAmount Total insurance amount. We have per leg and not total
     * @return $this
     */
    public function setTotalInsuranceAmount($totalInsuranceAmount)
    {
        $this->container['totalInsuranceAmount'] = $totalInsuranceAmount;
        return $this;
    }
    /**

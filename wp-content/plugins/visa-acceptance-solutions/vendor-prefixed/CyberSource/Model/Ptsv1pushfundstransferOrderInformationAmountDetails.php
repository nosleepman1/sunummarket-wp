...
use ArrayAccess;
/**
 * Ptsv1pushfundstransferOrderInformationAmountDetails Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Ptsv1pushfundstransferOrderInformationAmountDetails implements ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'ptsv1pushfundstransfer_orderInformation_amountDetails';
    /**
     * Array of property to type mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerTypes = ['totalAmount' => 'string', 'currency' => 'string', 'sourceCurrency' => 'string', 'destinationCurrency' => 'string', 'surcharge' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsOrderInformationAmountDetailsOctsurcharge'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['totalAmount' => null, 'currency' => null, 'sourceCurrency' => null, 'destinationCurrency' => null, 'surcharge' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['totalAmount' => 'totalAmount', 'currency' => 'currency', 'sourceCurrency' => 'sourceCurrency', 'destinationCurrency' => 'destinationCurrency', 'surcharge' => 'surcharge'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['totalAmount' => 'setTotalAmount', 'currency' => 'setCurrency', 'sourceCurrency' => 'setSourceCurrency', 'destinationCurrency' => 'setDestinationCurrency', 'surcharge' => 'setSurcharge'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['totalAmount' => 'getTotalAmount', 'currency' => 'getCurrency', 'sourceCurrency' => 'getSourceCurrency', 'destinationCurrency' => 'getDestinationCurrency', 'surcharge' => 'getSurcharge'];

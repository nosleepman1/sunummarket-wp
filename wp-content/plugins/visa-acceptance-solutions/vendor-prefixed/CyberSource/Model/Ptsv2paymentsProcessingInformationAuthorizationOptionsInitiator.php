...
class Ptsv2paymentsProcessingInformationAuthorizationOptionsInitiator implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['type' => 'string', 'credentialStoredOnFile' => 'bool', 'storedCredentialUsed' => 'bool', 'merchantInitiatedTransaction' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsProcessingInformationAuthorizationOptionsInitiatorMerchantInitiatedTransaction'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['type' => null, 'credentialStoredOnFile' => null, 'storedCredentialUsed' => null, 'merchantInitiatedTransaction' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['type' => 'type', 'credentialStoredOnFile' => 'credentialStoredOnFile', 'storedCredentialUsed' => 'storedCredentialUsed', 'merchantInitiatedTransaction' => 'merchantInitiatedTransaction'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['type' => 'setType', 'credentialStoredOnFile' => 'setCredentialStoredOnFile', 'storedCredentialUsed' => 'setStoredCredentialUsed', 'merchantInitiatedTransaction' => 'setMerchantInitiatedTransaction'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['type' => 'getType', 'credentialStoredOnFile' => 'getCredentialStoredOnFile', 'storedCredentialUsed' => 'getStoredCredentialUsed', 'merchantInitiatedTransaction' => 'getMerchantInitiatedTransaction'];
     ...
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsProcessingInformationAuthorizationOptionsInitiatorMerchantInitiatedTransaction
     */
     ...
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsProcessingInformationAuthorizationOptionsInitiatorMerchantInitiatedTransaction $merchantInitiatedTransaction
     * @return $this
     */

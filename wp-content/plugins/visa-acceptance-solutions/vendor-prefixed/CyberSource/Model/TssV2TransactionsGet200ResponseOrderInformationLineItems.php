...
class TssV2TransactionsGet200ResponseOrderInformationLineItems implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['productCode' => 'string', 'productName' => 'string', 'productSku' => 'string', 'taxAmount' => 'string', 'quantity' => 'int', 'unitPrice' => 'string', 'fulfillmentType' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['productCode' => null, 'productName' => null, 'productSku' => null, 'taxAmount' => null, 'quantity' => null, 'unitPrice' => null, 'fulfillmentType' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['productCode' => 'productCode', 'productName' => 'productName', 'productSku' => 'productSku', 'taxAmount' => 'taxAmount', 'quantity' => 'quantity', 'unitPrice' => 'unitPrice', 'fulfillmentType' => 'fulfillmentType'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['productCode' => 'setProductCode', 'productName' => 'setProductName', 'productSku' => 'setProductSku', 'taxAmount' => 'setTaxAmount', 'quantity' => 'setQuantity', 'unitPrice' => 'setUnitPrice', 'fulfillmentType' => 'setFulfillmentType'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['productCode' => 'getProductCode', 'productName' => 'getProductName', 'productSku' => 'getProductSku', 'taxAmount' => 'getTaxAmount', 'quantity' => 'getQuantity', 'unitPrice' => 'getUnitPrice', 'fulfillmentType' => 'getFulfillmentType'];
    ...
    /**
     * Sets unitPrice
     * @param string $unitPrice Per-item price of the product. This value cannot be negative. You can include a decimal point (.), but you cannot include any other special characters. CyberSource truncates the amount to the correct number of decimal places.
     * @return $this
     */

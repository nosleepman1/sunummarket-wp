...
use ArrayAccess;
/**
 * Ptsv2billingagreementsPaymentInformationCard Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Ptsv2billingagreementsPaymentInformationCard implements ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'ptsv2billingagreements_paymentInformation_card';
    /**
     * Array of property to type mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerTypes = ['expirationMonth' => 'string', 'expirationYear' => 'string', 'number' => 'string', 'securityCode' => 'string', 'type' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['expirationMonth' => null, 'expirationYear' => null, 'number' => null, 'securityCode' => null, 'type' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['expirationMonth' => 'expirationMonth', 'expirationYear' => 'expirationYear', 'number' => 'number', 'securityCode' => 'securityCode', 'type' => 'type'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['expirationMonth' => 'setExpirationMonth', 'expirationYear' => 'setExpirationYear', 'number' => 'setNumber', 'securityCode' => 'setSecurityCode', 'type' => 'setType'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['expirationMonth' => 'getExpirationMonth', 'expirationYear' => 'getExpirationYear', 'number' => 'getNumber', 'securityCode' => 'getSecurityCode', 'type' => 'getType'];

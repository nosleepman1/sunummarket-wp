...
use ArrayAccess;
/**
 * Ptsv2paymentsidrefundsTravelInformationTransitAirlineAncillaryInformation Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Ptsv2paymentsidrefundsTravelInformationTransitAirlineAncillaryInformation implements ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'ptsv2paymentsidrefunds_travelInformation_transit_airline_ancillaryInformation';
    /**
     * Array of property to type mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerTypes = ['ticketNumber' => 'string', 'passengerName' => 'string', 'connectedTicketNumber' => 'string', 'creditReasonIndicator' => 'string', 'service' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsidrefundsTravelInformationTransitAirlineAncillaryInformationService[]'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['ticketNumber' => null, 'passengerName' => null, 'connectedTicketNumber' => null, 'creditReasonIndicator' => null, 'service' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['ticketNumber' => 'ticketNumber', 'passengerName' => 'passengerName', 'connectedTicketNumber' => 'connectedTicketNumber', 'creditReasonIndicator' => 'creditReasonIndicator', 'service' => 'service'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['ticketNumber' => 'setTicketNumber', 'passengerName' => 'setPassengerName', 'connectedTicketNumber' => 'setConnectedTicketNumber', 'creditReasonIndicator' => 'setCreditReasonIndicator', 'service' => 'setService'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['ticketNumber' => 'getTicketNumber', 'passengerName' => 'getPassengerName', 'connectedTicketNumber' => 'getConnectedTicketNumber', 'creditReasonIndicator' => 'getCreditReasonIndicator', 'service' => 'getService'];
    ...
    /**
     * Gets service
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsidrefundsTravelInformationTransitAirlineAncillaryInformationService[]
     */
    ...
    /**
     * Sets service
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsidrefundsTravelInformationTransitAirlineAncillaryInformationService[] $service
     * @return $this
     */

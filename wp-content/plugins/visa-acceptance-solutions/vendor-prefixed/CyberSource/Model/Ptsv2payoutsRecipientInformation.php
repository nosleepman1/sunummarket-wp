...
class Ptsv2payoutsRecipientInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['firstName' => 'string', 'middleName' => 'string', 'lastName' => 'string', 'address1' => 'string', 'locality' => 'string', 'administrativeArea' => 'string', 'country' => 'string', 'postalCode' => 'string', 'phoneNumber' => 'string', 'aliasName' => 'string', 'nationality' => 'string', 'countryOfBirth' => 'string', 'occupation' => 'string', 'email' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['firstName' => null, 'middleName' => null, 'lastName' => null, 'address1' => null, 'locality' => null, 'administrativeArea' => null, 'country' => null, 'postalCode' => null, 'phoneNumber' => null, 'aliasName' => null, 'nationality' => null, 'countryOfBirth' => null, 'occupation' => null, 'email' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['firstName' => 'firstName', 'middleName' => 'middleName', 'lastName' => 'lastName', 'address1' => 'address1', 'locality' => 'locality', 'administrativeArea' => 'administrativeArea', 'country' => 'country', 'postalCode' => 'postalCode', 'phoneNumber' => 'phoneNumber', 'aliasName' => 'aliasName', 'nationality' => 'nationality', 'countryOfBirth' => 'countryOfBirth', 'occupation' => 'occupation', 'email' => 'email'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['firstName' => 'setFirstName', 'middleName' => 'setMiddleName', 'lastName' => 'setLastName', 'address1' => 'setAddress1', 'locality' => 'setLocality', 'administrativeArea' => 'setAdministrativeArea', 'country' => 'setCountry', 'postalCode' => 'setPostalCode', 'phoneNumber' => 'setPhoneNumber', 'aliasName' => 'setAliasName', 'nationality' => 'setNationality', 'countryOfBirth' => 'setCountryOfBirth', 'occupation' => 'setOccupation', 'email' => 'setEmail'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['firstName' => 'getFirstName', 'middleName' => 'getMiddleName', 'lastName' => 'getLastName', 'address1' => 'getAddress1', 'locality' => 'getLocality', 'administrativeArea' => 'getAdministrativeArea', 'country' => 'getCountry', 'postalCode' => 'getPostalCode', 'phoneNumber' => 'getPhoneNumber', 'aliasName' => 'getAliasName', 'nationality' => 'getNationality', 'countryOfBirth' => 'getCountryOfBirth', 'occupation' => 'getOccupation', 'email' => 'getEmail'];

...
class CardProcessingConfigCommon implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['processors' => 'map[string,\Pymt_Vas\Dependencies\CyberSource\Model\CardProcessingConfigCommonProcessors]', 'amexVendorCode' => 'string', 'defaultAuthTypeCode' => 'string', 'masterCardAssignedId' => 'string', 'enablePartialAuth' => 'bool', 'merchantCategoryCode' => 'string', 'sicCode' => 'string', 'foodAndConsumerServiceId' => 'string', 'enableSplitShipment' => 'bool', 'enableInterchangeOptimization' => 'bool', 'visaDelegatedAuthenticationId' => 'string', 'creditCardRefundLimitPercent' => 'string', 'businessCenterCreditCardRefundLimitPercent' => 'string', 'allowCapturesGreaterThanAuthorizations' => 'bool', 'enableDuplicateMerchantReferenceNumberBlocking' => 'bool', 'domesticMerchantId' => 'bool', 'processLevel3Data' => 'string', 'subMerchantId' => 'string', 'subMerchantBusinessName' => 'string', 'preferCobadgedSecondaryBrand' => 'bool', 'merchantDescriptorInformation' => '\Pymt_Vas\Dependencies\CyberSource\Model\CardProcessingConfigCommonMerchantDescriptorInformation', 'acquirerAgreement' => '\Pymt_Vas\Dependencies\CyberSource\Model\CardProcessingConfigCommonAcquirerAgreement', 'governmentControlled' => 'bool', 'dropBillingInfo' => 'bool'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['processors' => null, 'amexVendorCode' => null, 'defaultAuthTypeCode' => null, 'masterCardAssignedId' => null, 'enablePartialAuth' => null, 'merchantCategoryCode' => null, 'sicCode' => null, 'foodAndConsumerServiceId' => null, 'enableSplitShipment' => null, 'enableInterchangeOptimization' => null, 'visaDelegatedAuthenticationId' => null, 'creditCardRefundLimitPercent' => null, 'businessCenterCreditCardRefundLimitPercent' => null, 'allowCapturesGreaterThanAuthorizations' => null, 'enableDuplicateMerchantReferenceNumberBlocking' => null, 'domesticMerchantId' => null, 'processLevel3Data' => null, 'subMerchantId' => null, 'subMerchantBusinessName' => null, 'preferCobadgedSecondaryBrand' => null, 'merchantDescriptorInformation' => null, 'acquirerAgreement' => null, 'governmentControlled' => null, 'dropBillingInfo' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['processors' => 'processors', 'amexVendorCode' => 'amexVendorCode', 'defaultAuthTypeCode' => 'defaultAuthTypeCode', 'masterCardAssignedId' => 'masterCardAssignedId', 'enablePartialAuth' => 'enablePartialAuth', 'merchantCategoryCode' => 'merchantCategoryCode', 'sicCode' => 'sicCode', 'foodAndConsumerServiceId' => 'foodAndConsumerServiceId', 'enableSplitShipment' => 'enableSplitShipment', 'enableInterchangeOptimization' => 'enableInterchangeOptimization', 'visaDelegatedAuthenticationId' => 'visaDelegatedAuthenticationId', 'creditCardRefundLimitPercent' => 'creditCardRefundLimitPercent', 'businessCenterCreditCardRefundLimitPercent' => 'businessCenterCreditCardRefundLimitPercent', 'allowCapturesGreaterThanAuthorizations' => 'allowCapturesGreaterThanAuthorizations', 'enableDuplicateMerchantReferenceNumberBlocking' => 'enableDuplicateMerchantReferenceNumberBlocking', 'domesticMerchantId' => 'domesticMerchantId', 'processLevel3Data' => 'processLevel3Data', 'subMerchantId' => 'subMerchantId', 'subMerchantBusinessName' => 'subMerchantBusinessName', 'preferCobadgedSecondaryBrand' => 'preferCobadgedSecondaryBrand', 'merchantDescriptorInformation' => 'merchantDescriptorInformation', 'acquirerAgreement' => 'acquirerAgreement', 'governmentControlled' => 'governmentControlled', 'dropBillingInfo' => 'dropBillingInfo'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['processors' => 'setProcessors', 'amexVendorCode' => 'setAmexVendorCode', 'defaultAuthTypeCode' => 'setDefaultAuthTypeCode', 'masterCardAssignedId' => 'setMasterCardAssignedId', 'enablePartialAuth' => 'setEnablePartialAuth', 'merchantCategoryCode' => 'setMerchantCategoryCode', 'sicCode' => 'setSicCode', 'foodAndConsumerServiceId' => 'setFoodAndConsumerServiceId', 'enableSplitShipment' => 'setEnableSplitShipment', 'enableInterchangeOptimization' => 'setEnableInterchangeOptimization', 'visaDelegatedAuthenticationId' => 'setVisaDelegatedAuthenticationId', 'creditCardRefundLimitPercent' => 'setCreditCardRefundLimitPercent', 'businessCenterCreditCardRefundLimitPercent' => 'setBusinessCenterCreditCardRefundLimitPercent', 'allowCapturesGreaterThanAuthorizations' => 'setAllowCapturesGreaterThanAuthorizations', 'enableDuplicateMerchantReferenceNumberBlocking' => 'setEnableDuplicateMerchantReferenceNumberBlocking', 'domesticMerchantId' => 'setDomesticMerchantId', 'processLevel3Data' => 'setProcessLevel3Data', 'subMerchantId' => 'setSubMerchantId', 'subMerchantBusinessName' => 'setSubMerchantBusinessName', 'preferCobadgedSecondaryBrand' => 'setPreferCobadgedSecondaryBrand', 'merchantDescriptorInformation' => 'setMerchantDescriptorInformation', 'acquirerAgreement' => 'setAcquirerAgreement', 'governmentControlled' => 'setGovernmentControlled', 'dropBillingInfo' => 'setDropBillingInfo'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['processors' => 'getProcessors', 'amexVendorCode' => 'getAmexVendorCode', 'defaultAuthTypeCode' => 'getDefaultAuthTypeCode', 'masterCardAssignedId' => 'getMasterCardAssignedId', 'enablePartialAuth' => 'getEnablePartialAuth', 'merchantCategoryCode' => 'getMerchantCategoryCode', 'sicCode' => 'getSicCode', 'foodAndConsumerServiceId' => 'getFoodAndConsumerServiceId', 'enableSplitShipment' => 'getEnableSplitShipment', 'enableInterchangeOptimization' => 'getEnableInterchangeOptimization', 'visaDelegatedAuthenticationId' => 'getVisaDelegatedAuthenticationId', 'creditCardRefundLimitPercent' => 'getCreditCardRefundLimitPercent', 'businessCenterCreditCardRefundLimitPercent' => 'getBusinessCenterCreditCardRefundLimitPercent', 'allowCapturesGreaterThanAuthorizations' => 'getAllowCapturesGreaterThanAuthorizations', 'enableDuplicateMerchantReferenceNumberBlocking' => 'getEnableDuplicateMerchantReferenceNumberBlocking', 'domesticMerchantId' => 'getDomesticMerchantId', 'processLevel3Data' => 'getProcessLevel3Data', 'subMerchantId' => 'getSubMerchantId', 'subMerchantBusinessName' => 'getSubMerchantBusinessName', 'preferCobadgedSecondaryBrand' => 'getPreferCobadgedSecondaryBrand', 'merchantDescriptorInformation' => 'getMerchantDescriptorInformation', 'acquirerAgreement' => 'getAcquirerAgreement', 'governmentControlled' => 'getGovernmentControlled', 'dropBillingInfo' => 'getDropBillingInfo'];
    ...
    /**
     * Gets processors
     * @return map[string,\Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\CardProcessingConfigCommonProcessors]
     */
    ...
    /**
     * Sets processors
     * @param map[string,\Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\CardProcessingConfigCommonProcessors] $processors e.g. * amexdirect * barclays2 * CUP * EFTPOS * fdiglobal * gpngsapv3 * gpx * smartfdc * tsys * vero * VPC  For VPC, CUP and EFTPOS processors, replace the processor name from VPC or CUP or EFTPOS to the actual processor name in the sample request. e.g. replace VPC with &lt;your vpc processor&gt;
     * @return $this
     */
     ...
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\CardProcessingConfigCommonMerchantDescriptorInformation
     */
     ...
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\CardProcessingConfigCommonMerchantDescriptorInformation $merchantDescriptorInformation
     * @return $this
     */
     ...
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\CardProcessingConfigCommonAcquirerAgreement
     */
     ...
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\CardProcessingConfigCommonAcquirerAgreement $acquirerAgreement
     * @return $this
     */

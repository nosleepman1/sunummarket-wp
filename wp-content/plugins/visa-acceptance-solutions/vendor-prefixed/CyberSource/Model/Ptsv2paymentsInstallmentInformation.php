...
class Ptsv2paymentsInstallmentInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['amount' => 'string', 'frequency' => 'string', 'planType' => 'string', 'sequence' => 'int', 'totalAmount' => 'string', 'totalCount' => 'int', 'firstInstallmentDate' => 'string', 'invoiceData' => 'string', 'paymentType' => 'string', 'eligibilityInquiry' => 'string', 'gracePeriodDuration' => 'string', 'gracePeriodDurationType' => 'string', 'firstInstallmentAmount' => 'string', 'validationIndicator' => 'string', 'identifier' => 'string', 'annualInterestRate' => 'string', 'interestIndicator' => 'string', 'isGovernmentPlan' => 'bool'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['amount' => null, 'frequency' => null, 'planType' => null, 'sequence' => null, 'totalAmount' => null, 'totalCount' => null, 'firstInstallmentDate' => null, 'invoiceData' => null, 'paymentType' => null, 'eligibilityInquiry' => null, 'gracePeriodDuration' => null, 'gracePeriodDurationType' => null, 'firstInstallmentAmount' => null, 'validationIndicator' => null, 'identifier' => null, 'annualInterestRate' => null, 'interestIndicator' => null, 'isGovernmentPlan' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['amount' => 'amount', 'frequency' => 'frequency', 'planType' => 'planType', 'sequence' => 'sequence', 'totalAmount' => 'totalAmount', 'totalCount' => 'totalCount', 'firstInstallmentDate' => 'firstInstallmentDate', 'invoiceData' => 'invoiceData', 'paymentType' => 'paymentType', 'eligibilityInquiry' => 'eligibilityInquiry', 'gracePeriodDuration' => 'gracePeriodDuration', 'gracePeriodDurationType' => 'gracePeriodDurationType', 'firstInstallmentAmount' => 'firstInstallmentAmount', 'validationIndicator' => 'validationIndicator', 'identifier' => 'identifier', 'annualInterestRate' => 'annualInterestRate', 'interestIndicator' => 'interestIndicator', 'isGovernmentPlan' => 'isGovernmentPlan'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['amount' => 'setAmount', 'frequency' => 'setFrequency', 'planType' => 'setPlanType', 'sequence' => 'setSequence', 'totalAmount' => 'setTotalAmount', 'totalCount' => 'setTotalCount', 'firstInstallmentDate' => 'setFirstInstallmentDate', 'invoiceData' => 'setInvoiceData', 'paymentType' => 'setPaymentType', 'eligibilityInquiry' => 'setEligibilityInquiry', 'gracePeriodDuration' => 'setGracePeriodDuration', 'gracePeriodDurationType' => 'setGracePeriodDurationType', 'firstInstallmentAmount' => 'setFirstInstallmentAmount', 'validationIndicator' => 'setValidationIndicator', 'identifier' => 'setIdentifier', 'annualInterestRate' => 'setAnnualInterestRate', 'interestIndicator' => 'setInterestIndicator', 'isGovernmentPlan' => 'setIsGovernmentPlan'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['amount' => 'getAmount', 'frequency' => 'getFrequency', 'planType' => 'getPlanType', 'sequence' => 'getSequence', 'totalAmount' => 'getTotalAmount', 'totalCount' => 'getTotalCount', 'firstInstallmentDate' => 'getFirstInstallmentDate', 'invoiceData' => 'getInvoiceData', 'paymentType' => 'getPaymentType', 'eligibilityInquiry' => 'getEligibilityInquiry', 'gracePeriodDuration' => 'getGracePeriodDuration', 'gracePeriodDurationType' => 'getGracePeriodDurationType', 'firstInstallmentAmount' => 'getFirstInstallmentAmount', 'validationIndicator' => 'getValidationIndicator', 'identifier' => 'getIdentifier', 'annualInterestRate' => 'getAnnualInterestRate', 'interestIndicator' => 'getInterestIndicator', 'isGovernmentPlan' => 'getIsGovernmentPlan'];

...
class PtsV2PaymentsReversalsPost201ResponseReversalAmountDetails implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['reversedAmount' => 'string', 'originalTransactionAmount' => 'string', 'currency' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['reversedAmount' => null, 'originalTransactionAmount' => null, 'currency' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['reversedAmount' => 'reversedAmount', 'originalTransactionAmount' => 'originalTransactionAmount', 'currency' => 'currency'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['reversedAmount' => 'setReversedAmount', 'originalTransactionAmount' => 'setOriginalTransactionAmount', 'currency' => 'setCurrency'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['reversedAmount' => 'getReversedAmount', 'originalTransactionAmount' => 'getOriginalTransactionAmount', 'currency' => 'getCurrency'];

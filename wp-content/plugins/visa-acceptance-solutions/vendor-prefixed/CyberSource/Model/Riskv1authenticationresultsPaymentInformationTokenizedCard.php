...
class Riskv1authenticationresultsPaymentInformationTokenizedCard implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['transactionType' => 'string', 'type' => 'string', 'expirationMonth' => 'string', 'expirationYear' => 'string', 'number' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['transactionType' => null, 'type' => null, 'expirationMonth' => null, 'expirationYear' => null, 'number' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['transactionType' => 'transactionType', 'type' => 'type', 'expirationMonth' => 'expirationMonth', 'expirationYear' => 'expirationYear', 'number' => 'number'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['transactionType' => 'setTransactionType', 'type' => 'setType', 'expirationMonth' => 'setExpirationMonth', 'expirationYear' => 'setExpirationYear', 'number' => 'setNumber'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['transactionType' => 'getTransactionType', 'type' => 'getType', 'expirationMonth' => 'getExpirationMonth', 'expirationYear' => 'getExpirationYear', 'number' => 'getNumber'];

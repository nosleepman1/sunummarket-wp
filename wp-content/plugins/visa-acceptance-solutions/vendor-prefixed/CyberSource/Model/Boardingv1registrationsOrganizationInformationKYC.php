...
class Boardingv1registrationsOrganizationInformationKYC implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['whenIsCustomerCharged' => 'string', 'whenIsCustomerChargedDescription' => 'string', 'offerSubscriptions' => 'bool', 'monthlySubscriptionPercent' => 'float', 'quarterlySubscriptionPercent' => 'float', 'semiAnnualSubscriptionPercent' => 'float', 'annualSubscriptionPercent' => 'float', 'timeToProductDelivery' => 'string', 'estimatedMonthlySales' => 'float', 'averageOrderAmount' => 'float', 'largestExpectedOrderAmount' => 'float', 'depositBankAccount' => '\Pymt_Vas\Dependencies\CyberSource\Model\Boardingv1registrationsOrganizationInformationKYCDepositBankAccount'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['whenIsCustomerCharged' => null, 'whenIsCustomerChargedDescription' => null, 'offerSubscriptions' => null, 'monthlySubscriptionPercent' => 'decimal', 'quarterlySubscriptionPercent' => 'decimal', 'semiAnnualSubscriptionPercent' => 'decimal', 'annualSubscriptionPercent' => 'decimal', 'timeToProductDelivery' => null, 'estimatedMonthlySales' => 'currency', 'averageOrderAmount' => 'currency', 'largestExpectedOrderAmount' => 'currency', 'depositBankAccount' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['whenIsCustomerCharged' => 'whenIsCustomerCharged', 'whenIsCustomerChargedDescription' => 'whenIsCustomerChargedDescription', 'offerSubscriptions' => 'offerSubscriptions', 'monthlySubscriptionPercent' => 'monthlySubscriptionPercent', 'quarterlySubscriptionPercent' => 'quarterlySubscriptionPercent', 'semiAnnualSubscriptionPercent' => 'semiAnnualSubscriptionPercent', 'annualSubscriptionPercent' => 'annualSubscriptionPercent', 'timeToProductDelivery' => 'timeToProductDelivery', 'estimatedMonthlySales' => 'estimatedMonthlySales', 'averageOrderAmount' => 'averageOrderAmount', 'largestExpectedOrderAmount' => 'largestExpectedOrderAmount', 'depositBankAccount' => 'depositBankAccount'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['whenIsCustomerCharged' => 'setWhenIsCustomerCharged', 'whenIsCustomerChargedDescription' => 'setWhenIsCustomerChargedDescription', 'offerSubscriptions' => 'setOfferSubscriptions', 'monthlySubscriptionPercent' => 'setMonthlySubscriptionPercent', 'quarterlySubscriptionPercent' => 'setQuarterlySubscriptionPercent', 'semiAnnualSubscriptionPercent' => 'setSemiAnnualSubscriptionPercent', 'annualSubscriptionPercent' => 'setAnnualSubscriptionPercent', 'timeToProductDelivery' => 'setTimeToProductDelivery', 'estimatedMonthlySales' => 'setEstimatedMonthlySales', 'averageOrderAmount' => 'setAverageOrderAmount', 'largestExpectedOrderAmount' => 'setLargestExpectedOrderAmount', 'depositBankAccount' => 'setDepositBankAccount'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['whenIsCustomerCharged' => 'getWhenIsCustomerCharged', 'whenIsCustomerChargedDescription' => 'getWhenIsCustomerChargedDescription', 'offerSubscriptions' => 'getOfferSubscriptions', 'monthlySubscriptionPercent' => 'getMonthlySubscriptionPercent', 'quarterlySubscriptionPercent' => 'getQuarterlySubscriptionPercent', 'semiAnnualSubscriptionPercent' => 'getSemiAnnualSubscriptionPercent', 'annualSubscriptionPercent' => 'getAnnualSubscriptionPercent', 'timeToProductDelivery' => 'getTimeToProductDelivery', 'estimatedMonthlySales' => 'getEstimatedMonthlySales', 'averageOrderAmount' => 'getAverageOrderAmount', 'largestExpectedOrderAmount' => 'getLargestExpectedOrderAmount', 'depositBankAccount' => 'getDepositBankAccount'];
     ...
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Boardingv1registrationsOrganizationInformationKYCDepositBankAccount
     */
     ...
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Boardingv1registrationsOrganizationInformationKYCDepositBankAccount $depositBankAccount
     * @return $this
     */

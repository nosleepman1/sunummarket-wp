...
class Kmsegressv2keysasymKeyInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['provider' => 'string', 'tenant' => 'string', 'keyType' => 'string', 'organizationId' => 'string', 'pub' => 'string', 'keyId' => 'string', 'pvt' => 'string', 'status' => 'string', 'expiryDuration' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['provider' => null, 'tenant' => null, 'keyType' => null, 'organizationId' => null, 'pub' => null, 'keyId' => null, 'pvt' => null, 'status' => null, 'expiryDuration' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['provider' => 'provider', 'tenant' => 'tenant', 'keyType' => 'keyType', 'organizationId' => 'organizationId', 'pub' => 'pub', 'keyId' => 'keyId', 'pvt' => 'pvt', 'status' => 'status', 'expiryDuration' => 'expiryDuration'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['provider' => 'setProvider', 'tenant' => 'setTenant', 'keyType' => 'setKeyType', 'organizationId' => 'setOrganizationId', 'pub' => 'setPub', 'keyId' => 'setKeyId', 'pvt' => 'setPvt', 'status' => 'setStatus', 'expiryDuration' => 'setExpiryDuration'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['provider' => 'getProvider', 'tenant' => 'getTenant', 'keyType' => 'getKeyType', 'organizationId' => 'getOrganizationId', 'pub' => 'getPub', 'keyId' => 'getKeyId', 'pvt' => 'getPvt', 'status' => 'getStatus', 'expiryDuration' => 'getExpiryDuration'];

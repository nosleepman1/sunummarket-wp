...
class TssV2TransactionsPost201ResponseEmbeddedRiskInformationProvidersFingerprint implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['trueIpaddress' => 'string', 'hash' => 'string', 'smartId' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['trueIpaddress' => null, 'hash' => null, 'smartId' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['trueIpaddress' => 'true_ipaddress', 'hash' => 'hash', 'smartId' => 'smartId'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['trueIpaddress' => 'setTrueIpaddress', 'hash' => 'setHash', 'smartId' => 'setSmartId'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['trueIpaddress' => 'getTrueIpaddress', 'hash' => 'getHash', 'smartId' => 'getSmartId'];

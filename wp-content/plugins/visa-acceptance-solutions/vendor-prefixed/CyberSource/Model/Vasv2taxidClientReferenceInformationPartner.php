...
use ArrayAccess;
/**
 * Vasv2taxidClientReferenceInformationPartner Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Vasv2taxidClientReferenceInformationPartner implements ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'vasv2taxid_clientReferenceInformation_partner';
    /**
     * Array of property to type mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerTypes = ['solutionId' => 'string', 'developerId' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['solutionId' => null, 'developerId' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['solutionId' => 'solutionId', 'developerId' => 'developerId'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['solutionId' => 'setSolutionId', 'developerId' => 'setDeveloperId'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['solutionId' => 'getSolutionId', 'developerId' => 'getDeveloperId'];

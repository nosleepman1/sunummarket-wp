...
class Binv1binlookupClientReferenceInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['partner' => '\Pymt_Vas\Dependencies\CyberSource\Model\Riskv1decisionsClientReferenceInformationPartner', 'applicationName' => 'string', 'applicationVersion' => 'string', 'applicationUser' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['partner' => null, 'applicationName' => null, 'applicationVersion' => null, 'applicationUser' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['partner' => 'partner', 'applicationName' => 'applicationName', 'applicationVersion' => 'applicationVersion', 'applicationUser' => 'applicationUser'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['partner' => 'setPartner', 'applicationName' => 'setApplicationName', 'applicationVersion' => 'setApplicationVersion', 'applicationUser' => 'setApplicationUser'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['partner' => 'getPartner', 'applicationName' => 'getApplicationName', 'applicationVersion' => 'getApplicationVersion', 'applicationUser' => 'getApplicationUser'];

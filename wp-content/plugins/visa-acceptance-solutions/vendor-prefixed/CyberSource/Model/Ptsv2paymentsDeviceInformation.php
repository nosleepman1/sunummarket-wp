...
class Ptsv2paymentsDeviceInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['id' => 'string', 'hostName' => 'string', 'ipAddress' => 'string', 'userAgent' => 'string', 'fingerprintSessionId' => 'string', 'useRawFingerprintSessionId' => 'bool', 'deviceType' => 'string', 'appUrl' => 'string', 'metadata' => 'string', 'rawData' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsDeviceInformationRawData[]', 'httpAcceptBrowserValue' => 'string', 'httpAcceptContent' => 'string', 'httpBrowserEmail' => 'string', 'httpBrowserLanguage' => 'string', 'httpBrowserJavaEnabled' => 'bool', 'httpBrowserJavaScriptEnabled' => 'bool', 'httpBrowserColorDepth' => 'string', 'httpBrowserScreenHeight' => 'string', 'httpBrowserScreenWidth' => 'string', 'httpBrowserTimeDifference' => 'string', 'userAgentBrowserValue' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['id' => null, 'hostName' => null, 'ipAddress' => null, 'userAgent' => null, 'fingerprintSessionId' => null, 'useRawFingerprintSessionId' => null, 'deviceType' => null, 'appUrl' => null, 'metadata' => null, 'rawData' => null, 'httpAcceptBrowserValue' => null, 'httpAcceptContent' => null, 'httpBrowserEmail' => null, 'httpBrowserLanguage' => null, 'httpBrowserJavaEnabled' => null, 'httpBrowserJavaScriptEnabled' => null, 'httpBrowserColorDepth' => null, 'httpBrowserScreenHeight' => null, 'httpBrowserScreenWidth' => null, 'httpBrowserTimeDifference' => null, 'userAgentBrowserValue' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['id' => 'id', 'hostName' => 'hostName', 'ipAddress' => 'ipAddress', 'userAgent' => 'userAgent', 'fingerprintSessionId' => 'fingerprintSessionId', 'useRawFingerprintSessionId' => 'useRawFingerprintSessionId', 'deviceType' => 'deviceType', 'appUrl' => 'appUrl', 'metadata' => 'metadata', 'rawData' => 'rawData', 'httpAcceptBrowserValue' => 'httpAcceptBrowserValue', 'httpAcceptContent' => 'httpAcceptContent', 'httpBrowserEmail' => 'httpBrowserEmail', 'httpBrowserLanguage' => 'httpBrowserLanguage', 'httpBrowserJavaEnabled' => 'httpBrowserJavaEnabled', 'httpBrowserJavaScriptEnabled' => 'httpBrowserJavaScriptEnabled', 'httpBrowserColorDepth' => 'httpBrowserColorDepth', 'httpBrowserScreenHeight' => 'httpBrowserScreenHeight', 'httpBrowserScreenWidth' => 'httpBrowserScreenWidth', 'httpBrowserTimeDifference' => 'httpBrowserTimeDifference', 'userAgentBrowserValue' => 'userAgentBrowserValue'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['id' => 'setId', 'hostName' => 'setHostName', 'ipAddress' => 'setIpAddress', 'userAgent' => 'setUserAgent', 'fingerprintSessionId' => 'setFingerprintSessionId', 'useRawFingerprintSessionId' => 'setUseRawFingerprintSessionId', 'deviceType' => 'setDeviceType', 'appUrl' => 'setAppUrl', 'metadata' => 'setMetadata', 'rawData' => 'setRawData', 'httpAcceptBrowserValue' => 'setHttpAcceptBrowserValue', 'httpAcceptContent' => 'setHttpAcceptContent', 'httpBrowserEmail' => 'setHttpBrowserEmail', 'httpBrowserLanguage' => 'setHttpBrowserLanguage', 'httpBrowserJavaEnabled' => 'setHttpBrowserJavaEnabled', 'httpBrowserJavaScriptEnabled' => 'setHttpBrowserJavaScriptEnabled', 'httpBrowserColorDepth' => 'setHttpBrowserColorDepth', 'httpBrowserScreenHeight' => 'setHttpBrowserScreenHeight', 'httpBrowserScreenWidth' => 'setHttpBrowserScreenWidth', 'httpBrowserTimeDifference' => 'setHttpBrowserTimeDifference', 'userAgentBrowserValue' => 'setUserAgentBrowserValue'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['id' => 'getId', 'hostName' => 'getHostName', 'ipAddress' => 'getIpAddress', 'userAgent' => 'getUserAgent', 'fingerprintSessionId' => 'getFingerprintSessionId', 'useRawFingerprintSessionId' => 'getUseRawFingerprintSessionId', 'deviceType' => 'getDeviceType', 'appUrl' => 'getAppUrl', 'metadata' => 'getMetadata', 'rawData' => 'getRawData', 'httpAcceptBrowserValue' => 'getHttpAcceptBrowserValue', 'httpAcceptContent' => 'getHttpAcceptContent', 'httpBrowserEmail' => 'getHttpBrowserEmail', 'httpBrowserLanguage' => 'getHttpBrowserLanguage', 'httpBrowserJavaEnabled' => 'getHttpBrowserJavaEnabled', 'httpBrowserJavaScriptEnabled' => 'getHttpBrowserJavaScriptEnabled', 'httpBrowserColorDepth' => 'getHttpBrowserColorDepth', 'httpBrowserScreenHeight' => 'getHttpBrowserScreenHeight', 'httpBrowserScreenWidth' => 'getHttpBrowserScreenWidth', 'httpBrowserTimeDifference' => 'getHttpBrowserTimeDifference', 'userAgentBrowserValue' => 'getUserAgentBrowserValue'];
    ...
    /**
     * Gets rawData
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsDeviceInformationRawData[]
     */
    ...
    /**
     * Sets rawData
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsDeviceInformationRawData[] $rawData
     * @return $this
     */

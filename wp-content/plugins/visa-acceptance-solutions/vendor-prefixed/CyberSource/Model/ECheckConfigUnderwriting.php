...
class ECheckConfigUnderwriting implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['standardEntryClassCodes' => 'string', 'enableHold' => 'bool', 'monthlyTotalTransactionAmountLimit' => 'float', 'holdingDays' => 'float', 'enableCredits' => 'bool', 'transactionAmountLimit' => 'float', 'riskReserveMethod' => 'string', 'riskReserveRate' => 'float', 'riskReserveTargetAmount' => 'float', 'solutionOrganizationId' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['standardEntryClassCodes' => null, 'enableHold' => null, 'monthlyTotalTransactionAmountLimit' => 'currency', 'holdingDays' => 'integer', 'enableCredits' => null, 'transactionAmountLimit' => 'currency', 'riskReserveMethod' => null, 'riskReserveRate' => 'decimal', 'riskReserveTargetAmount' => 'currency', 'solutionOrganizationId' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['standardEntryClassCodes' => 'standardEntryClassCodes', 'enableHold' => 'enableHold', 'monthlyTotalTransactionAmountLimit' => 'monthlyTotalTransactionAmountLimit', 'holdingDays' => 'holdingDays', 'enableCredits' => 'enableCredits', 'transactionAmountLimit' => 'transactionAmountLimit', 'riskReserveMethod' => 'riskReserveMethod', 'riskReserveRate' => 'riskReserveRate', 'riskReserveTargetAmount' => 'riskReserveTargetAmount', 'solutionOrganizationId' => 'solutionOrganizationId'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['standardEntryClassCodes' => 'setStandardEntryClassCodes', 'enableHold' => 'setEnableHold', 'monthlyTotalTransactionAmountLimit' => 'setMonthlyTotalTransactionAmountLimit', 'holdingDays' => 'setHoldingDays', 'enableCredits' => 'setEnableCredits', 'transactionAmountLimit' => 'setTransactionAmountLimit', 'riskReserveMethod' => 'setRiskReserveMethod', 'riskReserveRate' => 'setRiskReserveRate', 'riskReserveTargetAmount' => 'setRiskReserveTargetAmount', 'solutionOrganizationId' => 'setSolutionOrganizationId'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['standardEntryClassCodes' => 'getStandardEntryClassCodes', 'enableHold' => 'getEnableHold', 'monthlyTotalTransactionAmountLimit' => 'getMonthlyTotalTransactionAmountLimit', 'holdingDays' => 'getHoldingDays', 'enableCredits' => 'getEnableCredits', 'transactionAmountLimit' => 'getTransactionAmountLimit', 'riskReserveMethod' => 'getRiskReserveMethod', 'riskReserveRate' => 'getRiskReserveRate', 'riskReserveTargetAmount' => 'getRiskReserveTargetAmount', 'solutionOrganizationId' => 'getSolutionOrganizationId'];

...
use ArrayAccess;
/**
 * PtsV2PaymentsPost201ResponseRiskInformationProfile Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PtsV2PaymentsPost201ResponseRiskInformationProfile implements ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'ptsV2PaymentsPost201Response_riskInformation_profile';
    /**
     * Array of property to type mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerTypes = ['name' => 'string', 'desinationQueue' => 'string', 'selectorRule' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['name' => null, 'desinationQueue' => null, 'selectorRule' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['name' => 'name', 'desinationQueue' => 'desinationQueue', 'selectorRule' => 'selectorRule'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['name' => 'setName', 'desinationQueue' => 'setDesinationQueue', 'selectorRule' => 'setSelectorRule'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['name' => 'getName', 'desinationQueue' => 'getDesinationQueue', 'selectorRule' => 'getSelectorRule'];

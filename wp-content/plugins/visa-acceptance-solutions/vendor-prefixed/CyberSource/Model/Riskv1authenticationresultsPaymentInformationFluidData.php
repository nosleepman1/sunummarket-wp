...
class Riskv1authenticationresultsPaymentInformationFluidData implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['value' => 'string', 'keySerialNumber' => 'string', 'descriptor' => 'string', 'encoding' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['value' => null, 'keySerialNumber' => null, 'descriptor' => null, 'encoding' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['value' => 'value', 'keySerialNumber' => 'keySerialNumber', 'descriptor' => 'descriptor', 'encoding' => 'encoding'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['value' => 'setValue', 'keySerialNumber' => 'setKeySerialNumber', 'descriptor' => 'setDescriptor', 'encoding' => 'setEncoding'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['value' => 'getValue', 'keySerialNumber' => 'getKeySerialNumber', 'descriptor' => 'getDescriptor', 'encoding' => 'getEncoding'];

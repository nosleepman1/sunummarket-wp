...
class Ptsv2paymentsidreversalsPointOfSaleInformationEmv implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['tags' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['tags' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['tags' => 'tags'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['tags' => 'setTags'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['tags' => 'getTags'];

...
class Ptsv2paymentsRecurringPaymentInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['endDate' => 'string', 'frequency' => 'int', 'numberOfPayments' => 'int', 'originalPurchaseDate' => 'string', 'sequenceNumber' => 'int', 'type' => 'string', 'occurrence' => 'string', 'validationIndicator' => 'string', 'amountType' => 'string', 'maximumAmount' => 'string', 'referenceNumber' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['endDate' => null, 'frequency' => null, 'numberOfPayments' => null, 'originalPurchaseDate' => null, 'sequenceNumber' => null, 'type' => null, 'occurrence' => null, 'validationIndicator' => null, 'amountType' => null, 'maximumAmount' => null, 'referenceNumber' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['endDate' => 'endDate', 'frequency' => 'frequency', 'numberOfPayments' => 'numberOfPayments', 'originalPurchaseDate' => 'originalPurchaseDate', 'sequenceNumber' => 'sequenceNumber', 'type' => 'type', 'occurrence' => 'occurrence', 'validationIndicator' => 'validationIndicator', 'amountType' => 'amountType', 'maximumAmount' => 'maximumAmount', 'referenceNumber' => 'referenceNumber'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['endDate' => 'setEndDate', 'frequency' => 'setFrequency', 'numberOfPayments' => 'setNumberOfPayments', 'originalPurchaseDate' => 'setOriginalPurchaseDate', 'sequenceNumber' => 'setSequenceNumber', 'type' => 'setType', 'occurrence' => 'setOccurrence', 'validationIndicator' => 'setValidationIndicator', 'amountType' => 'setAmountType', 'maximumAmount' => 'setMaximumAmount', 'referenceNumber' => 'setReferenceNumber'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['endDate' => 'getEndDate', 'frequency' => 'getFrequency', 'numberOfPayments' => 'getNumberOfPayments', 'originalPurchaseDate' => 'getOriginalPurchaseDate', 'sequenceNumber' => 'getSequenceNumber', 'type' => 'getType', 'occurrence' => 'getOccurrence', 'validationIndicator' => 'getValidationIndicator', 'amountType' => 'getAmountType', 'maximumAmount' => 'getMaximumAmount', 'referenceNumber' => 'getReferenceNumber'];

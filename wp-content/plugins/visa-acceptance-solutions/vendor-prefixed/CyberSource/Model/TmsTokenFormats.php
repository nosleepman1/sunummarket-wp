...
class TmsTokenFormats implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['customer' => 'string', 'paymentInstrument' => 'string', 'instrumentIdentifierCard' => 'string', 'instrumentIdentifierBankAccount' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['customer' => null, 'paymentInstrument' => null, 'instrumentIdentifierCard' => null, 'instrumentIdentifierBankAccount' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['customer' => 'customer', 'paymentInstrument' => 'paymentInstrument', 'instrumentIdentifierCard' => 'instrumentIdentifierCard', 'instrumentIdentifierBankAccount' => 'instrumentIdentifierBankAccount'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['customer' => 'setCustomer', 'paymentInstrument' => 'setPaymentInstrument', 'instrumentIdentifierCard' => 'setInstrumentIdentifierCard', 'instrumentIdentifierBankAccount' => 'setInstrumentIdentifierBankAccount'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['customer' => 'getCustomer', 'paymentInstrument' => 'getPaymentInstrument', 'instrumentIdentifierCard' => 'getInstrumentIdentifierCard', 'instrumentIdentifierBankAccount' => 'getInstrumentIdentifierBankAccount'];

...
class TssV2TransactionsGet200ResponsePaymentInformationBankMandate implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['referenceNumber' => 'string', 'recurringType' => 'string', 'id' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['referenceNumber' => null, 'recurringType' => null, 'id' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['referenceNumber' => 'referenceNumber', 'recurringType' => 'recurringType', 'id' => 'id'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['referenceNumber' => 'setReferenceNumber', 'recurringType' => 'setRecurringType', 'id' => 'setId'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['referenceNumber' => 'getReferenceNumber', 'recurringType' => 'getRecurringType', 'id' => 'getId'];

...
class Ptsv2paymentsConsumerAuthenticationInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['cavv' => 'string', 'transactionFlowIndicator' => 'string', 'cavvAlgorithm' => 'string', 'eciRaw' => 'string', 'paresStatus' => 'string', 'veresEnrolled' => 'string', 'xid' => 'string', 'ucafCollectionIndicator' => 'string', 'ucafAuthenticationData' => 'string', 'strongAuthentication' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsConsumerAuthenticationInformationStrongAuthentication', 'directoryServerTransactionId' => 'string', 'paSpecificationVersion' => 'string', 'authenticationType' => 'string', 'responseAccessToken' => 'string', 'acsTransactionId' => 'string', 'acsWindowSize' => 'string', 'alternateAuthenticationData' => 'string', 'alternateAuthenticationDate' => 'string', 'alternateAuthenticationMethod' => 'string', 'authenticationDate' => 'string', 'authenticationTransactionId' => 'string', 'challengeCancelCode' => 'string', 'challengeCode' => 'string', 'challengeStatus' => 'string', 'customerCardAlias' => 'string', 'decoupledAuthenticationIndicator' => 'string', 'decoupledAuthenticationMaxTime' => 'string', 'defaultCard' => 'bool', 'deviceChannel' => 'string', 'installmentTotalCount' => 'int', 'merchantFraudRate' => 'string', 'marketingOptIn' => 'bool', 'marketingSource' => 'string', 'mcc' => 'string', 'merchantScore' => 'int', 'messageCategory' => 'string', 'networkScore' => 'string', 'npaCode' => 'string', 'overridePaymentMethod' => 'string', 'overrideCountryCode' => 'string', 'priorAuthenticationData' => 'string', 'priorAuthenticationMethod' => 'string', 'priorAuthenticationReferenceId' => 'string', 'priorAuthenticationTime' => 'string', 'productCode' => 'string', 'returnUrl' => 'string', 'requestorId' => 'string', 'requestorInitiatedAuthenticationIndicator' => 'string', 'requestorName' => 'string', 'referenceId' => 'string', 'sdkMaxTimeout' => 'string', 'secureCorporatePaymentIndicator' => 'string', 'transactionMode' => 'string', 'whiteListStatus' => 'string', 'authenticationBrand' => 'string', 'effectiveAuthenticationType' => 'string', 'signedParesStatusReason' => 'string', 'signedPares' => 'string', 'acsReferenceNumber' => 'string', 'dsReferenceNumber' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['cavv' => null, 'transactionFlowIndicator' => null, 'cavvAlgorithm' => null, 'eciRaw' => null, 'paresStatus' => null, 'veresEnrolled' => null, 'xid' => null, 'ucafCollectionIndicator' => null, 'ucafAuthenticationData' => null, 'strongAuthentication' => null, 'directoryServerTransactionId' => null, 'paSpecificationVersion' => null, 'authenticationType' => null, 'responseAccessToken' => null, 'acsTransactionId' => null, 'acsWindowSize' => null, 'alternateAuthenticationData' => null, 'alternateAuthenticationDate' => null, 'alternateAuthenticationMethod' => null, 'authenticationDate' => null, 'authenticationTransactionId' => null, 'challengeCancelCode' => null, 'challengeCode' => null, 'challengeStatus' => null, 'customerCardAlias' => null, 'decoupledAuthenticationIndicator' => null, 'decoupledAuthenticationMaxTime' => null, 'defaultCard' => null, 'deviceChannel' => null, 'installmentTotalCount' => null, 'merchantFraudRate' => null, 'marketingOptIn' => null, 'marketingSource' => null, 'mcc' => null, 'merchantScore' => null, 'messageCategory' => null, 'networkScore' => null, 'npaCode' => null, 'overridePaymentMethod' => null, 'overrideCountryCode' => null, 'priorAuthenticationData' => null, 'priorAuthenticationMethod' => null, 'priorAuthenticationReferenceId' => null, 'priorAuthenticationTime' => null, 'productCode' => null, 'returnUrl' => null, 'requestorId' => null, 'requestorInitiatedAuthenticationIndicator' => null, 'requestorName' => null, 'referenceId' => null, 'sdkMaxTimeout' => null, 'secureCorporatePaymentIndicator' => null, 'transactionMode' => null, 'whiteListStatus' => null, 'authenticationBrand' => null, 'effectiveAuthenticationType' => null, 'signedParesStatusReason' => null, 'signedPares' => null, 'acsReferenceNumber' => null, 'dsReferenceNumber' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['cavv' => 'cavv', 'transactionFlowIndicator' => 'transactionFlowIndicator', 'cavvAlgorithm' => 'cavvAlgorithm', 'eciRaw' => 'eciRaw', 'paresStatus' => 'paresStatus', 'veresEnrolled' => 'veresEnrolled', 'xid' => 'xid', 'ucafCollectionIndicator' => 'ucafCollectionIndicator', 'ucafAuthenticationData' => 'ucafAuthenticationData', 'strongAuthentication' => 'strongAuthentication', 'directoryServerTransactionId' => 'directoryServerTransactionId', 'paSpecificationVersion' => 'paSpecificationVersion', 'authenticationType' => 'authenticationType', 'responseAccessToken' => 'responseAccessToken', 'acsTransactionId' => 'acsTransactionId', 'acsWindowSize' => 'acsWindowSize', 'alternateAuthenticationData' => 'alternateAuthenticationData', 'alternateAuthenticationDate' => 'alternateAuthenticationDate', 'alternateAuthenticationMethod' => 'alternateAuthenticationMethod', 'authenticationDate' => 'authenticationDate', 'authenticationTransactionId' => 'authenticationTransactionId', 'challengeCancelCode' => 'challengeCancelCode', 'challengeCode' => 'challengeCode', 'challengeStatus' => 'challengeStatus', 'customerCardAlias' => 'customerCardAlias', 'decoupledAuthenticationIndicator' => 'decoupledAuthenticationIndicator', 'decoupledAuthenticationMaxTime' => 'decoupledAuthenticationMaxTime', 'defaultCard' => 'defaultCard', 'deviceChannel' => 'deviceChannel', 'installmentTotalCount' => 'installmentTotalCount', 'merchantFraudRate' => 'merchantFraudRate', 'marketingOptIn' => 'marketingOptIn', 'marketingSource' => 'marketingSource', 'mcc' => 'mcc', 'merchantScore' => 'merchantScore', 'messageCategory' => 'messageCategory', 'networkScore' => 'networkScore', 'npaCode' => 'npaCode', 'overridePaymentMethod' => 'overridePaymentMethod', 'overrideCountryCode' => 'overrideCountryCode', 'priorAuthenticationData' => 'priorAuthenticationData', 'priorAuthenticationMethod' => 'priorAuthenticationMethod', 'priorAuthenticationReferenceId' => 'priorAuthenticationReferenceId', 'priorAuthenticationTime' => 'priorAuthenticationTime', 'productCode' => 'productCode', 'returnUrl' => 'returnUrl', 'requestorId' => 'requestorId', 'requestorInitiatedAuthenticationIndicator' => 'requestorInitiatedAuthenticationIndicator', 'requestorName' => 'requestorName', 'referenceId' => 'referenceId', 'sdkMaxTimeout' => 'sdkMaxTimeout', 'secureCorporatePaymentIndicator' => 'secureCorporatePaymentIndicator', 'transactionMode' => 'transactionMode', 'whiteListStatus' => 'whiteListStatus', 'authenticationBrand' => 'authenticationBrand', 'effectiveAuthenticationType' => 'effectiveAuthenticationType', 'signedParesStatusReason' => 'signedParesStatusReason', 'signedPares' => 'signedPares', 'acsReferenceNumber' => 'acsReferenceNumber', 'dsReferenceNumber' => 'dsReferenceNumber'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['cavv' => 'setCavv', 'transactionFlowIndicator' => 'setTransactionFlowIndicator', 'cavvAlgorithm' => 'setCavvAlgorithm', 'eciRaw' => 'setEciRaw', 'paresStatus' => 'setParesStatus', 'veresEnrolled' => 'setVeresEnrolled', 'xid' => 'setXid', 'ucafCollectionIndicator' => 'setUcafCollectionIndicator', 'ucafAuthenticationData' => 'setUcafAuthenticationData', 'strongAuthentication' => 'setStrongAuthentication', 'directoryServerTransactionId' => 'setDirectoryServerTransactionId', 'paSpecificationVersion' => 'setPaSpecificationVersion', 'authenticationType' => 'setAuthenticationType', 'responseAccessToken' => 'setResponseAccessToken', 'acsTransactionId' => 'setAcsTransactionId', 'acsWindowSize' => 'setAcsWindowSize', 'alternateAuthenticationData' => 'setAlternateAuthenticationData', 'alternateAuthenticationDate' => 'setAlternateAuthenticationDate', 'alternateAuthenticationMethod' => 'setAlternateAuthenticationMethod', 'authenticationDate' => 'setAuthenticationDate', 'authenticationTransactionId' => 'setAuthenticationTransactionId', 'challengeCancelCode' => 'setChallengeCancelCode', 'challengeCode' => 'setChallengeCode', 'challengeStatus' => 'setChallengeStatus', 'customerCardAlias' => 'setCustomerCardAlias', 'decoupledAuthenticationIndicator' => 'setDecoupledAuthenticationIndicator', 'decoupledAuthenticationMaxTime' => 'setDecoupledAuthenticationMaxTime', 'defaultCard' => 'setDefaultCard', 'deviceChannel' => 'setDeviceChannel', 'installmentTotalCount' => 'setInstallmentTotalCount', 'merchantFraudRate' => 'setMerchantFraudRate', 'marketingOptIn' => 'setMarketingOptIn', 'marketingSource' => 'setMarketingSource', 'mcc' => 'setMcc', 'merchantScore' => 'setMerchantScore', 'messageCategory' => 'setMessageCategory', 'networkScore' => 'setNetworkScore', 'npaCode' => 'setNpaCode', 'overridePaymentMethod' => 'setOverridePaymentMethod', 'overrideCountryCode' => 'setOverrideCountryCode', 'priorAuthenticationData' => 'setPriorAuthenticationData', 'priorAuthenticationMethod' => 'setPriorAuthenticationMethod', 'priorAuthenticationReferenceId' => 'setPriorAuthenticationReferenceId', 'priorAuthenticationTime' => 'setPriorAuthenticationTime', 'productCode' => 'setProductCode', 'returnUrl' => 'setReturnUrl', 'requestorId' => 'setRequestorId', 'requestorInitiatedAuthenticationIndicator' => 'setRequestorInitiatedAuthenticationIndicator', 'requestorName' => 'setRequestorName', 'referenceId' => 'setReferenceId', 'sdkMaxTimeout' => 'setSdkMaxTimeout', 'secureCorporatePaymentIndicator' => 'setSecureCorporatePaymentIndicator', 'transactionMode' => 'setTransactionMode', 'whiteListStatus' => 'setWhiteListStatus', 'authenticationBrand' => 'setAuthenticationBrand', 'effectiveAuthenticationType' => 'setEffectiveAuthenticationType', 'signedParesStatusReason' => 'setSignedParesStatusReason', 'signedPares' => 'setSignedPares', 'acsReferenceNumber' => 'setAcsReferenceNumber', 'dsReferenceNumber' => 'setDsReferenceNumber'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['cavv' => 'getCavv', 'transactionFlowIndicator' => 'getTransactionFlowIndicator', 'cavvAlgorithm' => 'getCavvAlgorithm', 'eciRaw' => 'getEciRaw', 'paresStatus' => 'getParesStatus', 'veresEnrolled' => 'getVeresEnrolled', 'xid' => 'getXid', 'ucafCollectionIndicator' => 'getUcafCollectionIndicator', 'ucafAuthenticationData' => 'getUcafAuthenticationData', 'strongAuthentication' => 'getStrongAuthentication', 'directoryServerTransactionId' => 'getDirectoryServerTransactionId', 'paSpecificationVersion' => 'getPaSpecificationVersion', 'authenticationType' => 'getAuthenticationType', 'responseAccessToken' => 'getResponseAccessToken', 'acsTransactionId' => 'getAcsTransactionId', 'acsWindowSize' => 'getAcsWindowSize', 'alternateAuthenticationData' => 'getAlternateAuthenticationData', 'alternateAuthenticationDate' => 'getAlternateAuthenticationDate', 'alternateAuthenticationMethod' => 'getAlternateAuthenticationMethod', 'authenticationDate' => 'getAuthenticationDate', 'authenticationTransactionId' => 'getAuthenticationTransactionId', 'challengeCancelCode' => 'getChallengeCancelCode', 'challengeCode' => 'getChallengeCode', 'challengeStatus' => 'getChallengeStatus', 'customerCardAlias' => 'getCustomerCardAlias', 'decoupledAuthenticationIndicator' => 'getDecoupledAuthenticationIndicator', 'decoupledAuthenticationMaxTime' => 'getDecoupledAuthenticationMaxTime', 'defaultCard' => 'getDefaultCard', 'deviceChannel' => 'getDeviceChannel', 'installmentTotalCount' => 'getInstallmentTotalCount', 'merchantFraudRate' => 'getMerchantFraudRate', 'marketingOptIn' => 'getMarketingOptIn', 'marketingSource' => 'getMarketingSource', 'mcc' => 'getMcc', 'merchantScore' => 'getMerchantScore', 'messageCategory' => 'getMessageCategory', 'networkScore' => 'getNetworkScore', 'npaCode' => 'getNpaCode', 'overridePaymentMethod' => 'getOverridePaymentMethod', 'overrideCountryCode' => 'getOverrideCountryCode', 'priorAuthenticationData' => 'getPriorAuthenticationData', 'priorAuthenticationMethod' => 'getPriorAuthenticationMethod', 'priorAuthenticationReferenceId' => 'getPriorAuthenticationReferenceId', 'priorAuthenticationTime' => 'getPriorAuthenticationTime', 'productCode' => 'getProductCode', 'returnUrl' => 'getReturnUrl', 'requestorId' => 'getRequestorId', 'requestorInitiatedAuthenticationIndicator' => 'getRequestorInitiatedAuthenticationIndicator', 'requestorName' => 'getRequestorName', 'referenceId' => 'getReferenceId', 'sdkMaxTimeout' => 'getSdkMaxTimeout', 'secureCorporatePaymentIndicator' => 'getSecureCorporatePaymentIndicator', 'transactionMode' => 'getTransactionMode', 'whiteListStatus' => 'getWhiteListStatus', 'authenticationBrand' => 'getAuthenticationBrand', 'effectiveAuthenticationType' => 'getEffectiveAuthenticationType', 'signedParesStatusReason' => 'getSignedParesStatusReason', 'signedPares' => 'getSignedPares', 'acsReferenceNumber' => 'getAcsReferenceNumber', 'dsReferenceNumber' => 'getDsReferenceNumber'];
     ...
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsConsumerAuthenticationInformationStrongAuthentication
     */
     ...
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsConsumerAuthenticationInformationStrongAuthentication $strongAuthentication
     * @return $this
     */

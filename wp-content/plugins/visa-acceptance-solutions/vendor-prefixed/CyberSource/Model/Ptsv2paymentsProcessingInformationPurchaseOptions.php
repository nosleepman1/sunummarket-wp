...
class Ptsv2paymentsProcessingInformationPurchaseOptions implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['isElectronicBenefitsTransfer' => 'bool', 'type' => 'string', 'eligibilityIndicator' => 'string', 'benefitAmount' => 'string', 'benefitType' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['isElectronicBenefitsTransfer' => null, 'type' => null, 'eligibilityIndicator' => null, 'benefitAmount' => null, 'benefitType' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['isElectronicBenefitsTransfer' => 'isElectronicBenefitsTransfer', 'type' => 'type', 'eligibilityIndicator' => 'eligibilityIndicator', 'benefitAmount' => 'benefitAmount', 'benefitType' => 'benefitType'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['isElectronicBenefitsTransfer' => 'setIsElectronicBenefitsTransfer', 'type' => 'setType', 'eligibilityIndicator' => 'setEligibilityIndicator', 'benefitAmount' => 'setBenefitAmount', 'benefitType' => 'setBenefitType'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['isElectronicBenefitsTransfer' => 'getIsElectronicBenefitsTransfer', 'type' => 'getType', 'eligibilityIndicator' => 'getEligibilityIndicator', 'benefitAmount' => 'getBenefitAmount', 'benefitType' => 'getBenefitType'];

...
class TssV2TransactionsGet200ResponseOrderInformationAmountDetails implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['totalAmount' => 'string', 'currency' => 'string', 'taxAmount' => 'string', 'authorizedAmount' => 'string', 'settlementAmount' => 'string', 'settlementCurrency' => 'string', 'refundBalance' => 'string', 'surcharge' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2payoutsOrderInformationAmountDetailsSurcharge'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['totalAmount' => null, 'currency' => null, 'taxAmount' => null, 'authorizedAmount' => null, 'settlementAmount' => null, 'settlementCurrency' => null, 'refundBalance' => null, 'surcharge' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['totalAmount' => 'totalAmount', 'currency' => 'currency', 'taxAmount' => 'taxAmount', 'authorizedAmount' => 'authorizedAmount', 'settlementAmount' => 'settlementAmount', 'settlementCurrency' => 'settlementCurrency', 'refundBalance' => 'refundBalance', 'surcharge' => 'surcharge'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['totalAmount' => 'setTotalAmount', 'currency' => 'setCurrency', 'taxAmount' => 'setTaxAmount', 'authorizedAmount' => 'setAuthorizedAmount', 'settlementAmount' => 'setSettlementAmount', 'settlementCurrency' => 'setSettlementCurrency', 'refundBalance' => 'setRefundBalance', 'surcharge' => 'setSurcharge'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['totalAmount' => 'getTotalAmount', 'currency' => 'getCurrency', 'taxAmount' => 'getTaxAmount', 'authorizedAmount' => 'getAuthorizedAmount', 'settlementAmount' => 'getSettlementAmount', 'settlementCurrency' => 'getSettlementCurrency', 'refundBalance' => 'getRefundBalance', 'surcharge' => 'getSurcharge'];
    ...
    /**
     * Gets surcharge
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2payoutsOrderInformationAmountDetailsSurcharge
     */
    ...
    /**
     * Sets surcharge
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2payoutsOrderInformationAmountDetailsSurcharge $surcharge
     * @return $this
     */

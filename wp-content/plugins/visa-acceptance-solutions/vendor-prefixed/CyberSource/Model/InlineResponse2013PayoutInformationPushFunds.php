...
use ArrayAccess;
/**
 * InlineResponse2013PayoutInformationPushFunds Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse2013PayoutInformationPushFunds implements ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'inline_response_201_3_payoutInformation_pushFunds';
    /**
     * Array of property to type mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerTypes = ['moneyTransferFastFundsCrossBorder' => 'string', 'moneyTransferFastFundsDomestic' => 'string', 'moneyTransferCrossBorder' => 'string', 'moneyTransferDomestic' => 'string', 'nonMoneyTransferFastFundsCrossBorder' => 'string', 'nonMoneyTransferFastFundsDomestic' => 'string', 'nonMoneyTransferCrossBorder' => 'string', 'nonMoneyTransferDomestic' => 'string', 'onlineGamblingFastFundsCrossBorder' => 'string', 'onlineGamblingFastFundsDomestic' => 'string', 'onlineGamblingCrossBorder' => 'string', 'onlineGamblingDomestic' => 'string', 'domesticParticipant' => 'string', 'crossBorderParticipant' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['moneyTransferFastFundsCrossBorder' => null, 'moneyTransferFastFundsDomestic' => null, 'moneyTransferCrossBorder' => null, 'moneyTransferDomestic' => null, 'nonMoneyTransferFastFundsCrossBorder' => null, 'nonMoneyTransferFastFundsDomestic' => null, 'nonMoneyTransferCrossBorder' => null, 'nonMoneyTransferDomestic' => null, 'onlineGamblingFastFundsCrossBorder' => null, 'onlineGamblingFastFundsDomestic' => null, 'onlineGamblingCrossBorder' => null, 'onlineGamblingDomestic' => null, 'domesticParticipant' => null, 'crossBorderParticipant' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['moneyTransferFastFundsCrossBorder' => 'moneyTransferFastFundsCrossBorder', 'moneyTransferFastFundsDomestic' => 'moneyTransferFastFundsDomestic', 'moneyTransferCrossBorder' => 'moneyTransferCrossBorder', 'moneyTransferDomestic' => 'moneyTransferDomestic', 'nonMoneyTransferFastFundsCrossBorder' => 'nonMoneyTransferFastFundsCrossBorder', 'nonMoneyTransferFastFundsDomestic' => 'nonMoneyTransferFastFundsDomestic', 'nonMoneyTransferCrossBorder' => 'nonMoneyTransferCrossBorder', 'nonMoneyTransferDomestic' => 'nonMoneyTransferDomestic', 'onlineGamblingFastFundsCrossBorder' => 'onlineGamblingFastFundsCrossBorder', 'onlineGamblingFastFundsDomestic' => 'onlineGamblingFastFundsDomestic', 'onlineGamblingCrossBorder' => 'onlineGamblingCrossBorder', 'onlineGamblingDomestic' => 'onlineGamblingDomestic', 'domesticParticipant' => 'domesticParticipant', 'crossBorderParticipant' => 'crossBorderParticipant'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['moneyTransferFastFundsCrossBorder' => 'setMoneyTransferFastFundsCrossBorder', 'moneyTransferFastFundsDomestic' => 'setMoneyTransferFastFundsDomestic', 'moneyTransferCrossBorder' => 'setMoneyTransferCrossBorder', 'moneyTransferDomestic' => 'setMoneyTransferDomestic', 'nonMoneyTransferFastFundsCrossBorder' => 'setNonMoneyTransferFastFundsCrossBorder', 'nonMoneyTransferFastFundsDomestic' => 'setNonMoneyTransferFastFundsDomestic', 'nonMoneyTransferCrossBorder' => 'setNonMoneyTransferCrossBorder', 'nonMoneyTransferDomestic' => 'setNonMoneyTransferDomestic', 'onlineGamblingFastFundsCrossBorder' => 'setOnlineGamblingFastFundsCrossBorder', 'onlineGamblingFastFundsDomestic' => 'setOnlineGamblingFastFundsDomestic', 'onlineGamblingCrossBorder' => 'setOnlineGamblingCrossBorder', 'onlineGamblingDomestic' => 'setOnlineGamblingDomestic', 'domesticParticipant' => 'setDomesticParticipant', 'crossBorderParticipant' => 'setCrossBorderParticipant'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['moneyTransferFastFundsCrossBorder' => 'getMoneyTransferFastFundsCrossBorder', 'moneyTransferFastFundsDomestic' => 'getMoneyTransferFastFundsDomestic', 'moneyTransferCrossBorder' => 'getMoneyTransferCrossBorder', 'moneyTransferDomestic' => 'getMoneyTransferDomestic', 'nonMoneyTransferFastFundsCrossBorder' => 'getNonMoneyTransferFastFundsCrossBorder', 'nonMoneyTransferFastFundsDomestic' => 'getNonMoneyTransferFastFundsDomestic', 'nonMoneyTransferCrossBorder' => 'getNonMoneyTransferCrossBorder', 'nonMoneyTransferDomestic' => 'getNonMoneyTransferDomestic', 'onlineGamblingFastFundsCrossBorder' => 'getOnlineGamblingFastFundsCrossBorder', 'onlineGamblingFastFundsDomestic' => 'getOnlineGamblingFastFundsDomestic', 'onlineGamblingCrossBorder' => 'getOnlineGamblingCrossBorder', 'onlineGamblingDomestic' => 'getOnlineGamblingDomestic', 'domesticParticipant' => 'getDomesticParticipant', 'crossBorderParticipant' => 'getCrossBorderParticipant'];
     ...
     * @param string $domesticParticipant This field indicates if domestic OCTs (push funds) are allowed. Possible values:   - `true`   - `false`
     * @return $this
     */
     ...
     * @param string $crossBorderParticipant This field indicates if cross-border OCTs (push funds) are allowed. Possible values:   - `true`   - `false`
     * @return $this
     */

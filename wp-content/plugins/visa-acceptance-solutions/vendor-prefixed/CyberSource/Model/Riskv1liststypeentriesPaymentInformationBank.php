...
class Riskv1liststypeentriesPaymentInformationBank implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['accountNumber' => 'string', 'code' => 'string', 'country' => 'string', 'iban' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['accountNumber' => null, 'code' => null, 'country' => null, 'iban' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['accountNumber' => 'accountNumber', 'code' => 'code', 'country' => 'country', 'iban' => 'iban'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['accountNumber' => 'setAccountNumber', 'code' => 'setCode', 'country' => 'setCountry', 'iban' => 'setIban'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['accountNumber' => 'getAccountNumber', 'code' => 'getCode', 'country' => 'getCountry', 'iban' => 'getIban'];

...
class RiskV1DecisionsPost201ResponseConsumerAuthenticationInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['accessToken' => 'string', 'acsRenderingType' => 'string', 'acsTransactionId' => 'string', 'acsUrl' => 'string', 'authenticationPath' => 'string', 'authorizationPayload' => 'string', 'authenticationType' => 'string', 'authenticationTransactionId' => 'string', 'authenticationTransactionContextId' => 'string', 'validityPeriod' => 'int', 'cardholderMessage' => 'string', 'cavv' => 'string', 'cavvAlgorithm' => 'string', 'challengeCancelCode' => 'string', 'challengeRequired' => 'string', 'decoupledAuthenticationIndicator' => 'string', 'directoryServerErrorCode' => 'string', 'directoryServerErrorDescription' => 'string', 'ecommerceIndicator' => 'string', 'eci' => 'string', 'eciRaw' => 'string', 'effectiveAuthenticationType' => 'string', 'exemptionDataRaw' => 'string', 'ivr' => '\Pymt_Vas\Dependencies\CyberSource\Model\PtsV2PaymentsPost201ResponseConsumerAuthenticationInformationIvr', 'networkScore' => 'string', 'pareq' => 'string', 'paresStatus' => 'string', 'proofXml' => 'string', 'proxyPan' => 'string', 'sdkTransactionId' => 'string', 'signedParesStatusReason' => 'string', 'specificationVersion' => 'string', 'stepUpUrl' => 'string', 'threeDSServerTransactionId' => 'string', 'ucafAuthenticationData' => 'string', 'ucafCollectionIndicator' => 'string', 'veresEnrolled' => 'string', 'whiteListStatusSource' => 'string', 'xid' => 'string', 'directoryServerTransactionId' => 'string', 'acsOperatorID' => 'string', 'acsReferenceNumber' => 'string', 'idciDecision' => 'string', 'idciReasonCode1' => 'string', 'idciReasonCode2' => 'string', 'idciScore' => 'int'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['accessToken' => null, 'acsRenderingType' => null, 'acsTransactionId' => null, 'acsUrl' => null, 'authenticationPath' => null, 'authorizationPayload' => null, 'authenticationType' => null, 'authenticationTransactionId' => null, 'authenticationTransactionContextId' => null, 'validityPeriod' => null, 'cardholderMessage' => null, 'cavv' => null, 'cavvAlgorithm' => null, 'challengeCancelCode' => null, 'challengeRequired' => null, 'decoupledAuthenticationIndicator' => null, 'directoryServerErrorCode' => null, 'directoryServerErrorDescription' => null, 'ecommerceIndicator' => null, 'eci' => null, 'eciRaw' => null, 'effectiveAuthenticationType' => null, 'exemptionDataRaw' => null, 'ivr' => null, 'networkScore' => null, 'pareq' => null, 'paresStatus' => null, 'proofXml' => null, 'proxyPan' => null, 'sdkTransactionId' => null, 'signedParesStatusReason' => null, 'specificationVersion' => null, 'stepUpUrl' => null, 'threeDSServerTransactionId' => null, 'ucafAuthenticationData' => null, 'ucafCollectionIndicator' => null, 'veresEnrolled' => null, 'whiteListStatusSource' => null, 'xid' => null, 'directoryServerTransactionId' => null, 'acsOperatorID' => null, 'acsReferenceNumber' => null, 'idciDecision' => null, 'idciReasonCode1' => null, 'idciReasonCode2' => null, 'idciScore' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['accessToken' => 'accessToken', 'acsRenderingType' => 'acsRenderingType', 'acsTransactionId' => 'acsTransactionId', 'acsUrl' => 'acsUrl', 'authenticationPath' => 'authenticationPath', 'authorizationPayload' => 'authorizationPayload', 'authenticationType' => 'authenticationType', 'authenticationTransactionId' => 'authenticationTransactionId', 'authenticationTransactionContextId' => 'authenticationTransactionContextId', 'validityPeriod' => 'validityPeriod', 'cardholderMessage' => 'cardholderMessage', 'cavv' => 'cavv', 'cavvAlgorithm' => 'cavvAlgorithm', 'challengeCancelCode' => 'challengeCancelCode', 'challengeRequired' => 'challengeRequired', 'decoupledAuthenticationIndicator' => 'decoupledAuthenticationIndicator', 'directoryServerErrorCode' => 'directoryServerErrorCode', 'directoryServerErrorDescription' => 'directoryServerErrorDescription', 'ecommerceIndicator' => 'ecommerceIndicator', 'eci' => 'eci', 'eciRaw' => 'eciRaw', 'effectiveAuthenticationType' => 'effectiveAuthenticationType', 'exemptionDataRaw' => 'exemptionDataRaw', 'ivr' => 'ivr', 'networkScore' => 'networkScore', 'pareq' => 'pareq', 'paresStatus' => 'paresStatus', 'proofXml' => 'proofXml', 'proxyPan' => 'proxyPan', 'sdkTransactionId' => 'sdkTransactionId', 'signedParesStatusReason' => 'signedParesStatusReason', 'specificationVersion' => 'specificationVersion', 'stepUpUrl' => 'stepUpUrl', 'threeDSServerTransactionId' => 'threeDSServerTransactionId', 'ucafAuthenticationData' => 'ucafAuthenticationData', 'ucafCollectionIndicator' => 'ucafCollectionIndicator', 'veresEnrolled' => 'veresEnrolled', 'whiteListStatusSource' => 'whiteListStatusSource', 'xid' => 'xid', 'directoryServerTransactionId' => 'directoryServerTransactionId', 'acsOperatorID' => 'acsOperatorID', 'acsReferenceNumber' => 'acsReferenceNumber', 'idciDecision' => 'idciDecision', 'idciReasonCode1' => 'idciReasonCode1', 'idciReasonCode2' => 'idciReasonCode2', 'idciScore' => 'idciScore'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['accessToken' => 'setAccessToken', 'acsRenderingType' => 'setAcsRenderingType', 'acsTransactionId' => 'setAcsTransactionId', 'acsUrl' => 'setAcsUrl', 'authenticationPath' => 'setAuthenticationPath', 'authorizationPayload' => 'setAuthorizationPayload', 'authenticationType' => 'setAuthenticationType', 'authenticationTransactionId' => 'setAuthenticationTransactionId', 'authenticationTransactionContextId' => 'setAuthenticationTransactionContextId', 'validityPeriod' => 'setValidityPeriod', 'cardholderMessage' => 'setCardholderMessage', 'cavv' => 'setCavv', 'cavvAlgorithm' => 'setCavvAlgorithm', 'challengeCancelCode' => 'setChallengeCancelCode', 'challengeRequired' => 'setChallengeRequired', 'decoupledAuthenticationIndicator' => 'setDecoupledAuthenticationIndicator', 'directoryServerErrorCode' => 'setDirectoryServerErrorCode', 'directoryServerErrorDescription' => 'setDirectoryServerErrorDescription', 'ecommerceIndicator' => 'setEcommerceIndicator', 'eci' => 'setEci', 'eciRaw' => 'setEciRaw', 'effectiveAuthenticationType' => 'setEffectiveAuthenticationType', 'exemptionDataRaw' => 'setExemptionDataRaw', 'ivr' => 'setIvr', 'networkScore' => 'setNetworkScore', 'pareq' => 'setPareq', 'paresStatus' => 'setParesStatus', 'proofXml' => 'setProofXml', 'proxyPan' => 'setProxyPan', 'sdkTransactionId' => 'setSdkTransactionId', 'signedParesStatusReason' => 'setSignedParesStatusReason', 'specificationVersion' => 'setSpecificationVersion', 'stepUpUrl' => 'setStepUpUrl', 'threeDSServerTransactionId' => 'setThreeDSServerTransactionId', 'ucafAuthenticationData' => 'setUcafAuthenticationData', 'ucafCollectionIndicator' => 'setUcafCollectionIndicator', 'veresEnrolled' => 'setVeresEnrolled', 'whiteListStatusSource' => 'setWhiteListStatusSource', 'xid' => 'setXid', 'directoryServerTransactionId' => 'setDirectoryServerTransactionId', 'acsOperatorID' => 'setAcsOperatorID', 'acsReferenceNumber' => 'setAcsReferenceNumber', 'idciDecision' => 'setIdciDecision', 'idciReasonCode1' => 'setIdciReasonCode1', 'idciReasonCode2' => 'setIdciReasonCode2', 'idciScore' => 'setIdciScore'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['accessToken' => 'getAccessToken', 'acsRenderingType' => 'getAcsRenderingType', 'acsTransactionId' => 'getAcsTransactionId', 'acsUrl' => 'getAcsUrl', 'authenticationPath' => 'getAuthenticationPath', 'authorizationPayload' => 'getAuthorizationPayload', 'authenticationType' => 'getAuthenticationType', 'authenticationTransactionId' => 'getAuthenticationTransactionId', 'authenticationTransactionContextId' => 'getAuthenticationTransactionContextId', 'validityPeriod' => 'getValidityPeriod', 'cardholderMessage' => 'getCardholderMessage', 'cavv' => 'getCavv', 'cavvAlgorithm' => 'getCavvAlgorithm', 'challengeCancelCode' => 'getChallengeCancelCode', 'challengeRequired' => 'getChallengeRequired', 'decoupledAuthenticationIndicator' => 'getDecoupledAuthenticationIndicator', 'directoryServerErrorCode' => 'getDirectoryServerErrorCode', 'directoryServerErrorDescription' => 'getDirectoryServerErrorDescription', 'ecommerceIndicator' => 'getEcommerceIndicator', 'eci' => 'getEci', 'eciRaw' => 'getEciRaw', 'effectiveAuthenticationType' => 'getEffectiveAuthenticationType', 'exemptionDataRaw' => 'getExemptionDataRaw', 'ivr' => 'getIvr', 'networkScore' => 'getNetworkScore', 'pareq' => 'getPareq', 'paresStatus' => 'getParesStatus', 'proofXml' => 'getProofXml', 'proxyPan' => 'getProxyPan', 'sdkTransactionId' => 'getSdkTransactionId', 'signedParesStatusReason' => 'getSignedParesStatusReason', 'specificationVersion' => 'getSpecificationVersion', 'stepUpUrl' => 'getStepUpUrl', 'threeDSServerTransactionId' => 'getThreeDSServerTransactionId', 'ucafAuthenticationData' => 'getUcafAuthenticationData', 'ucafCollectionIndicator' => 'getUcafCollectionIndicator', 'veresEnrolled' => 'getVeresEnrolled', 'whiteListStatusSource' => 'getWhiteListStatusSource', 'xid' => 'getXid', 'directoryServerTransactionId' => 'getDirectoryServerTransactionId', 'acsOperatorID' => 'getAcsOperatorID', 'acsReferenceNumber' => 'getAcsReferenceNumber', 'idciDecision' => 'getIdciDecision', 'idciReasonCode1' => 'getIdciReasonCode1', 'idciReasonCode2' => 'getIdciReasonCode2', 'idciScore' => 'getIdciScore'];

...
class PtsV2PaymentsPost201ResponseOrderInformationRewardPointsDetails implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['pointsBeforeRedemption' => 'string', 'pointsValueBeforeRedemption' => 'string', 'pointsRedeemed' => 'string', 'pointsValueRedeemed' => 'string', 'pointsAfterRedemption' => 'string', 'pointsValueAfterRedemption' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['pointsBeforeRedemption' => null, 'pointsValueBeforeRedemption' => null, 'pointsRedeemed' => null, 'pointsValueRedeemed' => null, 'pointsAfterRedemption' => null, 'pointsValueAfterRedemption' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['pointsBeforeRedemption' => 'pointsBeforeRedemption', 'pointsValueBeforeRedemption' => 'pointsValueBeforeRedemption', 'pointsRedeemed' => 'pointsRedeemed', 'pointsValueRedeemed' => 'pointsValueRedeemed', 'pointsAfterRedemption' => 'pointsAfterRedemption', 'pointsValueAfterRedemption' => 'pointsValueAfterRedemption'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['pointsBeforeRedemption' => 'setPointsBeforeRedemption', 'pointsValueBeforeRedemption' => 'setPointsValueBeforeRedemption', 'pointsRedeemed' => 'setPointsRedeemed', 'pointsValueRedeemed' => 'setPointsValueRedeemed', 'pointsAfterRedemption' => 'setPointsAfterRedemption', 'pointsValueAfterRedemption' => 'setPointsValueAfterRedemption'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['pointsBeforeRedemption' => 'getPointsBeforeRedemption', 'pointsValueBeforeRedemption' => 'getPointsValueBeforeRedemption', 'pointsRedeemed' => 'getPointsRedeemed', 'pointsValueRedeemed' => 'getPointsValueRedeemed', 'pointsAfterRedemption' => 'getPointsAfterRedemption', 'pointsValueAfterRedemption' => 'getPointsValueAfterRedemption'];

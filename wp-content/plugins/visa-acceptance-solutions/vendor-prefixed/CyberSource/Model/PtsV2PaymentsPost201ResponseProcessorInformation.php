...
class PtsV2PaymentsPost201ResponseProcessorInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['authIndicator' => 'string', 'approvalCode' => 'string', 'cardReferenceData' => 'string', 'transactionId' => 'string', 'networkTransactionId' => 'string', 'responseCode' => 'string', 'responseCodeSource' => 'string', 'responseDetails' => 'string', 'responseCategoryCode' => 'string', 'responseSourceCode' => 'string', 'forwardedAcquirerCode' => 'string', 'settlementDate' => 'string', 'sequenceNumber' => 'string', 'avs' => '\Pymt_Vas\Dependencies\CyberSource\Model\PtsV2PaymentsPost201ResponseProcessorInformationAvs', 'cardVerification' => '\Pymt_Vas\Dependencies\CyberSource\Model\PtsV2PaymentsPost201ResponseProcessorInformationCardVerification', 'merchantAdvice' => '\Pymt_Vas\Dependencies\CyberSource\Model\PtsV2PaymentsPost201ResponseProcessorInformationMerchantAdvice', 'electronicVerificationResults' => '\Pymt_Vas\Dependencies\CyberSource\Model\PtsV2PaymentsPost201ResponseProcessorInformationElectronicVerificationResults', 'achVerification' => '\Pymt_Vas\Dependencies\CyberSource\Model\PtsV2PaymentsPost201ResponseProcessorInformationAchVerification', 'customer' => '\Pymt_Vas\Dependencies\CyberSource\Model\PtsV2PaymentsPost201ResponseProcessorInformationCustomer', 'consumerAuthenticationResponse' => '\Pymt_Vas\Dependencies\CyberSource\Model\PtsV2PaymentsPost201ResponseProcessorInformationConsumerAuthenticationResponse', 'systemTraceAuditNumber' => 'string', 'paymentAccountReferenceNumber' => 'string', 'transactionIntegrityCode' => 'string', 'amexVerbalAuthReferenceNumber' => 'string', 'masterCardServiceCode' => 'string', 'masterCardServiceReplyCode' => 'string', 'masterCardAuthenticationType' => 'string', 'name' => 'string', 'routing' => '\Pymt_Vas\Dependencies\CyberSource\Model\PtsV2PaymentsPost201ResponseProcessorInformationRouting', 'merchantNumber' => 'string', 'retrievalReferenceNumber' => 'string', 'paymentUrl' => 'string', 'completeUrl' => 'string', 'signature' => 'string', 'publicKey' => 'string', 'sellerProtection' => '\Pymt_Vas\Dependencies\CyberSource\Model\PtsV2PaymentsPost201ResponseProcessorInformationSellerProtection', 'transactionExpiryDate' => 'string', 'customUrl' => 'string', 'schemeAssignedId' => 'string', 'deviceUrl' => 'string', 'disbursementMode' => 'string', 'updateTimeUtc' => 'string', 'expirationTimeUtc' => 'string', 'orderId' => 'string', 'orderStatus' => 'string', 'merchantRiskPrediction' => 'string', 'network' => '\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsProcessorInformationReversalNetwork'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['authIndicator' => null, 'approvalCode' => null, 'cardReferenceData' => null, 'transactionId' => null, 'networkTransactionId' => null, 'responseCode' => null, 'responseCodeSource' => null, 'responseDetails' => null, 'responseCategoryCode' => null, 'responseSourceCode' => null, 'forwardedAcquirerCode' => null, 'settlementDate' => null, 'sequenceNumber' => null, 'avs' => null, 'cardVerification' => null, 'merchantAdvice' => null, 'electronicVerificationResults' => null, 'achVerification' => null, 'customer' => null, 'consumerAuthenticationResponse' => null, 'systemTraceAuditNumber' => null, 'paymentAccountReferenceNumber' => null, 'transactionIntegrityCode' => null, 'amexVerbalAuthReferenceNumber' => null, 'masterCardServiceCode' => null, 'masterCardServiceReplyCode' => null, 'masterCardAuthenticationType' => null, 'name' => null, 'routing' => null, 'merchantNumber' => null, 'retrievalReferenceNumber' => null, 'paymentUrl' => null, 'completeUrl' => null, 'signature' => null, 'publicKey' => null, 'sellerProtection' => null, 'transactionExpiryDate' => null, 'customUrl' => null, 'schemeAssignedId' => null, 'deviceUrl' => null, 'disbursementMode' => null, 'updateTimeUtc' => null, 'expirationTimeUtc' => null, 'orderId' => null, 'orderStatus' => null, 'merchantRiskPrediction' => null, 'network' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['authIndicator' => 'authIndicator', 'approvalCode' => 'approvalCode', 'cardReferenceData' => 'cardReferenceData', 'transactionId' => 'transactionId', 'networkTransactionId' => 'networkTransactionId', 'responseCode' => 'responseCode', 'responseCodeSource' => 'responseCodeSource', 'responseDetails' => 'responseDetails', 'responseCategoryCode' => 'responseCategoryCode', 'responseSourceCode' => 'responseSourceCode', 'forwardedAcquirerCode' => 'forwardedAcquirerCode', 'settlementDate' => 'settlementDate', 'sequenceNumber' => 'sequenceNumber', 'avs' => 'avs', 'cardVerification' => 'cardVerification', 'merchantAdvice' => 'merchantAdvice', 'electronicVerificationResults' => 'electronicVerificationResults', 'achVerification' => 'achVerification', 'customer' => 'customer', 'consumerAuthenticationResponse' => 'consumerAuthenticationResponse', 'systemTraceAuditNumber' => 'systemTraceAuditNumber', 'paymentAccountReferenceNumber' => 'paymentAccountReferenceNumber', 'transactionIntegrityCode' => 'transactionIntegrityCode', 'amexVerbalAuthReferenceNumber' => 'amexVerbalAuthReferenceNumber', 'masterCardServiceCode' => 'masterCardServiceCode', 'masterCardServiceReplyCode' => 'masterCardServiceReplyCode', 'masterCardAuthenticationType' => 'masterCardAuthenticationType', 'name' => 'name', 'routing' => 'routing', 'merchantNumber' => 'merchantNumber', 'retrievalReferenceNumber' => 'retrievalReferenceNumber', 'paymentUrl' => 'paymentUrl', 'completeUrl' => 'completeUrl', 'signature' => 'signature', 'publicKey' => 'publicKey', 'sellerProtection' => 'sellerProtection', 'transactionExpiryDate' => 'transactionExpiryDate', 'customUrl' => 'customUrl', 'schemeAssignedId' => 'schemeAssignedId', 'deviceUrl' => 'deviceUrl', 'disbursementMode' => 'disbursementMode', 'updateTimeUtc' => 'updateTimeUtc', 'expirationTimeUtc' => 'expirationTimeUtc', 'orderId' => 'orderId', 'orderStatus' => 'orderStatus', 'merchantRiskPrediction' => 'merchantRiskPrediction', 'network' => 'network'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['authIndicator' => 'setAuthIndicator', 'approvalCode' => 'setApprovalCode', 'cardReferenceData' => 'setCardReferenceData', 'transactionId' => 'setTransactionId', 'networkTransactionId' => 'setNetworkTransactionId', 'responseCode' => 'setResponseCode', 'responseCodeSource' => 'setResponseCodeSource', 'responseDetails' => 'setResponseDetails', 'responseCategoryCode' => 'setResponseCategoryCode', 'responseSourceCode' => 'setResponseSourceCode', 'forwardedAcquirerCode' => 'setForwardedAcquirerCode', 'settlementDate' => 'setSettlementDate', 'sequenceNumber' => 'setSequenceNumber', 'avs' => 'setAvs', 'cardVerification' => 'setCardVerification', 'merchantAdvice' => 'setMerchantAdvice', 'electronicVerificationResults' => 'setElectronicVerificationResults', 'achVerification' => 'setAchVerification', 'customer' => 'setCustomer', 'consumerAuthenticationResponse' => 'setConsumerAuthenticationResponse', 'systemTraceAuditNumber' => 'setSystemTraceAuditNumber', 'paymentAccountReferenceNumber' => 'setPaymentAccountReferenceNumber', 'transactionIntegrityCode' => 'setTransactionIntegrityCode', 'amexVerbalAuthReferenceNumber' => 'setAmexVerbalAuthReferenceNumber', 'masterCardServiceCode' => 'setMasterCardServiceCode', 'masterCardServiceReplyCode' => 'setMasterCardServiceReplyCode', 'masterCardAuthenticationType' => 'setMasterCardAuthenticationType', 'name' => 'setName', 'routing' => 'setRouting', 'merchantNumber' => 'setMerchantNumber', 'retrievalReferenceNumber' => 'setRetrievalReferenceNumber', 'paymentUrl' => 'setPaymentUrl', 'completeUrl' => 'setCompleteUrl', 'signature' => 'setSignature', 'publicKey' => 'setPublicKey', 'sellerProtection' => 'setSellerProtection', 'transactionExpiryDate' => 'setTransactionExpiryDate', 'customUrl' => 'setCustomUrl', 'schemeAssignedId' => 'setSchemeAssignedId', 'deviceUrl' => 'setDeviceUrl', 'disbursementMode' => 'setDisbursementMode', 'updateTimeUtc' => 'setUpdateTimeUtc', 'expirationTimeUtc' => 'setExpirationTimeUtc', 'orderId' => 'setOrderId', 'orderStatus' => 'setOrderStatus', 'merchantRiskPrediction' => 'setMerchantRiskPrediction', 'network' => 'setNetwork'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['authIndicator' => 'getAuthIndicator', 'approvalCode' => 'getApprovalCode', 'cardReferenceData' => 'getCardReferenceData', 'transactionId' => 'getTransactionId', 'networkTransactionId' => 'getNetworkTransactionId', 'responseCode' => 'getResponseCode', 'responseCodeSource' => 'getResponseCodeSource', 'responseDetails' => 'getResponseDetails', 'responseCategoryCode' => 'getResponseCategoryCode', 'responseSourceCode' => 'getResponseSourceCode', 'forwardedAcquirerCode' => 'getForwardedAcquirerCode', 'settlementDate' => 'getSettlementDate', 'sequenceNumber' => 'getSequenceNumber', 'avs' => 'getAvs', 'cardVerification' => 'getCardVerification', 'merchantAdvice' => 'getMerchantAdvice', 'electronicVerificationResults' => 'getElectronicVerificationResults', 'achVerification' => 'getAchVerification', 'customer' => 'getCustomer', 'consumerAuthenticationResponse' => 'getConsumerAuthenticationResponse', 'systemTraceAuditNumber' => 'getSystemTraceAuditNumber', 'paymentAccountReferenceNumber' => 'getPaymentAccountReferenceNumber', 'transactionIntegrityCode' => 'getTransactionIntegrityCode', 'amexVerbalAuthReferenceNumber' => 'getAmexVerbalAuthReferenceNumber', 'masterCardServiceCode' => 'getMasterCardServiceCode', 'masterCardServiceReplyCode' => 'getMasterCardServiceReplyCode', 'masterCardAuthenticationType' => 'getMasterCardAuthenticationType', 'name' => 'getName', 'routing' => 'getRouting', 'merchantNumber' => 'getMerchantNumber', 'retrievalReferenceNumber' => 'getRetrievalReferenceNumber', 'paymentUrl' => 'getPaymentUrl', 'completeUrl' => 'getCompleteUrl', 'signature' => 'getSignature', 'publicKey' => 'getPublicKey', 'sellerProtection' => 'getSellerProtection', 'transactionExpiryDate' => 'getTransactionExpiryDate', 'customUrl' => 'getCustomUrl', 'schemeAssignedId' => 'getSchemeAssignedId', 'deviceUrl' => 'getDeviceUrl', 'disbursementMode' => 'getDisbursementMode', 'updateTimeUtc' => 'getUpdateTimeUtc', 'expirationTimeUtc' => 'getExpirationTimeUtc', 'orderId' => 'getOrderId', 'orderStatus' => 'getOrderStatus', 'merchantRiskPrediction' => 'getMerchantRiskPrediction', 'network' => 'getNetwork'];
    ...
    /**
     * Gets avs
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\PtsV2PaymentsPost201ResponseProcessorInformationAvs
     */
    ...
    /**
     * Sets avs
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\PtsV2PaymentsPost201ResponseProcessorInformationAvs $avs
     * @return $this
     */
     ...
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\PtsV2PaymentsPost201ResponseProcessorInformationCardVerification
     */
     ...
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\PtsV2PaymentsPost201ResponseProcessorInformationCardVerification $cardVerification
     * @return $this
     */
    ...
    /**
     * Gets merchantAdvice
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\PtsV2PaymentsPost201ResponseProcessorInformationMerchantAdvice
     */
    ...
    /**
     * Sets merchantAdvice
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\PtsV2PaymentsPost201ResponseProcessorInformationMerchantAdvice $merchantAdvice
     * @return $this
     */
     ...
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\PtsV2PaymentsPost201ResponseProcessorInformationElectronicVerificationResults
     */
     ...
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\PtsV2PaymentsPost201ResponseProcessorInformationElectronicVerificationResults $electronicVerificationResults
     * @return $this
     */
     ...
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\PtsV2PaymentsPost201ResponseProcessorInformationAchVerification
     */
     ...
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\PtsV2PaymentsPost201ResponseProcessorInformationAchVerification $achVerification
     * @return $this
     */
    ...
    /**
     * Gets customer
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\PtsV2PaymentsPost201ResponseProcessorInformationCustomer
     */
    ...
    /**
     * Sets customer
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\PtsV2PaymentsPost201ResponseProcessorInformationCustomer $customer
     * @return $this
     */
     ...
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\PtsV2PaymentsPost201ResponseProcessorInformationConsumerAuthenticationResponse
     */
     ...
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\PtsV2PaymentsPost201ResponseProcessorInformationConsumerAuthenticationResponse $consumerAuthenticationResponse
     * @return $this
     */
    ...
    /**
     * Gets routing
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\PtsV2PaymentsPost201ResponseProcessorInformationRouting
     */
    ...
    /**
     * Sets routing
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\PtsV2PaymentsPost201ResponseProcessorInformationRouting $routing
     * @return $this
     */
     ...
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\PtsV2PaymentsPost201ResponseProcessorInformationSellerProtection
     */
     ...
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\PtsV2PaymentsPost201ResponseProcessorInformationSellerProtection $sellerProtection
     * @return $this
     */
    ...
    /**
     * Gets network
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsProcessorInformationReversalNetwork
     */
    ...
    /**
     * Sets network
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Ptsv2paymentsProcessorInformationReversalNetwork $network
     * @return $this
     */

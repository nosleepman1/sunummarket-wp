...
class ReportingV3ChargebackDetailsGet200ResponseChargebackDetails implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['processorMerchantId' => 'string', 'merchantName' => 'string', 'transactionReferenceNumber' => 'string', 'merchantReferenceNumber' => 'string', 'natureOfDispute' => 'string', 'alertType' => 'string', 'amount' => 'string', 'sign' => 'string', 'action' => 'string', 'cardType' => 'string', 'originalSettlementTime' => '\DateTime', 'trackingNumber' => 'string', 'currencyCode' => 'string', 'requestId' => 'string', 'responseDueTime' => '\DateTime', 'time' => '\DateTime', 'actionDescription' => 'string', 'customerId' => 'string', 'reasonCode' => 'string', 'representmentCPTime' => '\DateTime', 'applications' => 'string', 'eventRequestedTime' => '\DateTime', 'preDisputeFlag' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['processorMerchantId' => null, 'merchantName' => null, 'transactionReferenceNumber' => null, 'merchantReferenceNumber' => null, 'natureOfDispute' => null, 'alertType' => null, 'amount' => null, 'sign' => null, 'action' => null, 'cardType' => null, 'originalSettlementTime' => 'date-time', 'trackingNumber' => null, 'currencyCode' => null, 'requestId' => null, 'responseDueTime' => 'date-time', 'time' => 'date-time', 'actionDescription' => null, 'customerId' => null, 'reasonCode' => null, 'representmentCPTime' => 'date-time', 'applications' => null, 'eventRequestedTime' => 'date-time', 'preDisputeFlag' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['processorMerchantId' => 'processorMerchantId', 'merchantName' => 'merchantName', 'transactionReferenceNumber' => 'transactionReferenceNumber', 'merchantReferenceNumber' => 'merchantReferenceNumber', 'natureOfDispute' => 'natureOfDispute', 'alertType' => 'alertType', 'amount' => 'amount', 'sign' => 'sign', 'action' => 'action', 'cardType' => 'cardType', 'originalSettlementTime' => 'originalSettlementTime', 'trackingNumber' => 'trackingNumber', 'currencyCode' => 'currencyCode', 'requestId' => 'requestId', 'responseDueTime' => 'responseDueTime', 'time' => 'time', 'actionDescription' => 'actionDescription', 'customerId' => 'customerId', 'reasonCode' => 'reasonCode', 'representmentCPTime' => 'representmentCPTime', 'applications' => 'applications', 'eventRequestedTime' => 'eventRequestedTime', 'preDisputeFlag' => 'preDisputeFlag'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['processorMerchantId' => 'setProcessorMerchantId', 'merchantName' => 'setMerchantName', 'transactionReferenceNumber' => 'setTransactionReferenceNumber', 'merchantReferenceNumber' => 'setMerchantReferenceNumber', 'natureOfDispute' => 'setNatureOfDispute', 'alertType' => 'setAlertType', 'amount' => 'setAmount', 'sign' => 'setSign', 'action' => 'setAction', 'cardType' => 'setCardType', 'originalSettlementTime' => 'setOriginalSettlementTime', 'trackingNumber' => 'setTrackingNumber', 'currencyCode' => 'setCurrencyCode', 'requestId' => 'setRequestId', 'responseDueTime' => 'setResponseDueTime', 'time' => 'setTime', 'actionDescription' => 'setActionDescription', 'customerId' => 'setCustomerId', 'reasonCode' => 'setReasonCode', 'representmentCPTime' => 'setRepresentmentCPTime', 'applications' => 'setApplications', 'eventRequestedTime' => 'setEventRequestedTime', 'preDisputeFlag' => 'setPreDisputeFlag'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['processorMerchantId' => 'getProcessorMerchantId', 'merchantName' => 'getMerchantName', 'transactionReferenceNumber' => 'getTransactionReferenceNumber', 'merchantReferenceNumber' => 'getMerchantReferenceNumber', 'natureOfDispute' => 'getNatureOfDispute', 'alertType' => 'getAlertType', 'amount' => 'getAmount', 'sign' => 'getSign', 'action' => 'getAction', 'cardType' => 'getCardType', 'originalSettlementTime' => 'getOriginalSettlementTime', 'trackingNumber' => 'getTrackingNumber', 'currencyCode' => 'getCurrencyCode', 'requestId' => 'getRequestId', 'responseDueTime' => 'getResponseDueTime', 'time' => 'getTime', 'actionDescription' => 'getActionDescription', 'customerId' => 'getCustomerId', 'reasonCode' => 'getReasonCode', 'representmentCPTime' => 'getRepresentmentCPTime', 'applications' => 'getApplications', 'eventRequestedTime' => 'getEventRequestedTime', 'preDisputeFlag' => 'getPreDisputeFlag'];

...
class PaymentsProductsAlternativePaymentMethodsConfigurationInformationConfigurationsPaymentMethods implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['merchantId' => 'string', 'logoUrl' => 'string', 'redirectSuccessUrl' => 'string', 'redirectCancelUrl' => 'string', 'redirectFailureUrl' => 'string', 'underwriting' => '\Pymt_Vas\Dependencies\CyberSource\Model\UnderwritingConfiguration', 'additionalConfigurations' => '\Pymt_Vas\Dependencies\CyberSource\Model\PaymentsProductsAlternativePaymentMethodsConfigurationInformationConfigurationsAdditionalConfigurations[]'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['merchantId' => null, 'logoUrl' => null, 'redirectSuccessUrl' => null, 'redirectCancelUrl' => null, 'redirectFailureUrl' => null, 'underwriting' => null, 'additionalConfigurations' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['merchantId' => 'merchantId', 'logoUrl' => 'logoUrl', 'redirectSuccessUrl' => 'redirectSuccessUrl', 'redirectCancelUrl' => 'redirectCancelUrl', 'redirectFailureUrl' => 'redirectFailureUrl', 'underwriting' => 'underwriting', 'additionalConfigurations' => 'additionalConfigurations'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['merchantId' => 'setMerchantId', 'logoUrl' => 'setLogoUrl', 'redirectSuccessUrl' => 'setRedirectSuccessUrl', 'redirectCancelUrl' => 'setRedirectCancelUrl', 'redirectFailureUrl' => 'setRedirectFailureUrl', 'underwriting' => 'setUnderwriting', 'additionalConfigurations' => 'setAdditionalConfigurations'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['merchantId' => 'getMerchantId', 'logoUrl' => 'getLogoUrl', 'redirectSuccessUrl' => 'getRedirectSuccessUrl', 'redirectCancelUrl' => 'getRedirectCancelUrl', 'redirectFailureUrl' => 'getRedirectFailureUrl', 'underwriting' => 'getUnderwriting', 'additionalConfigurations' => 'getAdditionalConfigurations'];
    ...
    /**
     * Gets underwriting
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\UnderwritingConfiguration
     */
    ...
    /**
     * Sets underwriting
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\UnderwritingConfiguration $underwriting
     * @return $this
     */
     ...
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\PaymentsProductsAlternativePaymentMethodsConfigurationInformationConfigurationsAdditionalConfigurations[]
     */
     ...
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\PaymentsProductsAlternativePaymentMethodsConfigurationInformationConfigurationsAdditionalConfigurations[] $additionalConfigurations Additional configurations for the payment method. This can include various settings specific to the payment method.
     * @return $this
     */

...
class CreateAdhocReportRequest implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['organizationId' => 'string', 'reportDefinitionName' => 'string', 'reportFields' => 'string[]', 'reportMimeType' => 'string', 'reportName' => 'string', 'timezone' => 'string', 'reportStartTime' => '\DateTime', 'reportEndTime' => '\DateTime', 'reportFilters' => '\Pymt_Vas\Dependencies\CyberSource\Model\Reportingv3reportsReportFilters', 'reportPreferences' => '\Pymt_Vas\Dependencies\CyberSource\Model\Reportingv3reportsReportPreferences', 'groupName' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['organizationId' => null, 'reportDefinitionName' => null, 'reportFields' => null, 'reportMimeType' => null, 'reportName' => null, 'timezone' => null, 'reportStartTime' => 'date-time', 'reportEndTime' => 'date-time', 'reportFilters' => null, 'reportPreferences' => null, 'groupName' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['organizationId' => 'organizationId', 'reportDefinitionName' => 'reportDefinitionName', 'reportFields' => 'reportFields', 'reportMimeType' => 'reportMimeType', 'reportName' => 'reportName', 'timezone' => 'timezone', 'reportStartTime' => 'reportStartTime', 'reportEndTime' => 'reportEndTime', 'reportFilters' => 'reportFilters', 'reportPreferences' => 'reportPreferences', 'groupName' => 'groupName'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['organizationId' => 'setOrganizationId', 'reportDefinitionName' => 'setReportDefinitionName', 'reportFields' => 'setReportFields', 'reportMimeType' => 'setReportMimeType', 'reportName' => 'setReportName', 'timezone' => 'setTimezone', 'reportStartTime' => 'setReportStartTime', 'reportEndTime' => 'setReportEndTime', 'reportFilters' => 'setReportFilters', 'reportPreferences' => 'setReportPreferences', 'groupName' => 'setGroupName'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['organizationId' => 'getOrganizationId', 'reportDefinitionName' => 'getReportDefinitionName', 'reportFields' => 'getReportFields', 'reportMimeType' => 'getReportMimeType', 'reportName' => 'getReportName', 'timezone' => 'getTimezone', 'reportStartTime' => 'getReportStartTime', 'reportEndTime' => 'getReportEndTime', 'reportFilters' => 'getReportFilters', 'reportPreferences' => 'getReportPreferences', 'groupName' => 'getGroupName'];
    ...
    /**
     * Gets reportFilters
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Reportingv3reportsReportFilters
     */
    ...
    /**
     * Sets reportFilters
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Reportingv3reportsReportFilters $reportFilters
     * @return $this
     */

...
class CardProcessingConfigFeaturesCardNotPresentPayouts implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['reimbursementCode' => 'string', 'acquiringInstitutionId' => 'string', 'businessApplicationId' => 'string', 'financialInstitutionId' => 'string', 'merchantAbaNumber' => 'string', 'networkOrder' => 'string', 'currencies' => 'map[string,\Pymt_Vas\Dependencies\CyberSource\Model\CardProcessingConfigFeaturesCardNotPresentPayoutsCurrencies]', 'merchantId' => 'string', 'terminalId' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['reimbursementCode' => null, 'acquiringInstitutionId' => null, 'businessApplicationId' => null, 'financialInstitutionId' => null, 'merchantAbaNumber' => null, 'networkOrder' => null, 'currencies' => null, 'merchantId' => null, 'terminalId' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['reimbursementCode' => 'reimbursementCode', 'acquiringInstitutionId' => 'acquiringInstitutionId', 'businessApplicationId' => 'businessApplicationId', 'financialInstitutionId' => 'financialInstitutionId', 'merchantAbaNumber' => 'merchantAbaNumber', 'networkOrder' => 'networkOrder', 'currencies' => 'currencies', 'merchantId' => 'merchantId', 'terminalId' => 'terminalId'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['reimbursementCode' => 'setReimbursementCode', 'acquiringInstitutionId' => 'setAcquiringInstitutionId', 'businessApplicationId' => 'setBusinessApplicationId', 'financialInstitutionId' => 'setFinancialInstitutionId', 'merchantAbaNumber' => 'setMerchantAbaNumber', 'networkOrder' => 'setNetworkOrder', 'currencies' => 'setCurrencies', 'merchantId' => 'setMerchantId', 'terminalId' => 'setTerminalId'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['reimbursementCode' => 'getReimbursementCode', 'acquiringInstitutionId' => 'getAcquiringInstitutionId', 'businessApplicationId' => 'getBusinessApplicationId', 'financialInstitutionId' => 'getFinancialInstitutionId', 'merchantAbaNumber' => 'getMerchantAbaNumber', 'networkOrder' => 'getNetworkOrder', 'currencies' => 'getCurrencies', 'merchantId' => 'getMerchantId', 'terminalId' => 'getTerminalId'];
    ...
    /**
     * Gets currencies
     * @return map[string,\Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\CardProcessingConfigFeaturesCardNotPresentPayoutsCurrencies]
     */
    ...
    /**
     * Sets currencies
     * @param map[string,\Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\CardProcessingConfigFeaturesCardNotPresentPayoutsCurrencies] $currencies Three-character [ISO 4217 ALPHA-3 Standard Currency Codes.](http://apps.cybersource.com/library/documentation/sbc/quickref/currencies.pdf)
     * @return $this
     */

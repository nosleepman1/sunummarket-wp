...
class TssV2TransactionsGet200ResponseProcessorInformation implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['processor' => '\Pymt_Vas\Dependencies\CyberSource\Model\TssV2TransactionsGet200ResponseProcessorInformationProcessor', 'multiProcessorRouting' => '\Pymt_Vas\Dependencies\CyberSource\Model\TssV2TransactionsGet200ResponseProcessorInformationMultiProcessorRouting[]', 'transactionId' => 'string', 'networkTransactionId' => 'string', 'retrievalReferenceNumber' => 'string', 'responseId' => 'string', 'approvalCode' => 'string', 'responseCode' => 'string', 'avs' => '\Pymt_Vas\Dependencies\CyberSource\Model\PtsV2PaymentsPost201ResponseProcessorInformationAvs', 'cardVerification' => '\Pymt_Vas\Dependencies\CyberSource\Model\Riskv1decisionsProcessorInformationCardVerification', 'achVerification' => '\Pymt_Vas\Dependencies\CyberSource\Model\PtsV2PaymentsPost201ResponseProcessorInformationAchVerification', 'electronicVerificationResults' => '\Pymt_Vas\Dependencies\CyberSource\Model\TssV2TransactionsGet200ResponseProcessorInformationElectronicVerificationResults', 'issuerInformation' => '\Pymt_Vas\Dependencies\CyberSource\Model\PtsV2PaymentsPost201Response1IssuerInformation', 'eventStatus' => 'string', 'systemTraceAuditNumber' => 'string', 'responseCodeSource' => 'string', 'paymentAccountReferenceNumber' => 'string', 'responseDetails' => 'string', 'rawResponseLocal' => 'string', 'rawResponse' => 'string', 'routing' => '\Pymt_Vas\Dependencies\CyberSource\Model\PtsV2PaymentsPost201ResponseProcessorInformationRouting'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['processor' => null, 'multiProcessorRouting' => null, 'transactionId' => null, 'networkTransactionId' => null, 'retrievalReferenceNumber' => null, 'responseId' => null, 'approvalCode' => null, 'responseCode' => null, 'avs' => null, 'cardVerification' => null, 'achVerification' => null, 'electronicVerificationResults' => null, 'issuerInformation' => null, 'eventStatus' => null, 'systemTraceAuditNumber' => null, 'responseCodeSource' => null, 'paymentAccountReferenceNumber' => null, 'responseDetails' => null, 'rawResponseLocal' => null, 'rawResponse' => null, 'routing' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['processor' => 'processor', 'multiProcessorRouting' => 'multiProcessorRouting', 'transactionId' => 'transactionId', 'networkTransactionId' => 'networkTransactionId', 'retrievalReferenceNumber' => 'retrievalReferenceNumber', 'responseId' => 'responseId', 'approvalCode' => 'approvalCode', 'responseCode' => 'responseCode', 'avs' => 'avs', 'cardVerification' => 'cardVerification', 'achVerification' => 'achVerification', 'electronicVerificationResults' => 'electronicVerificationResults', 'issuerInformation' => 'issuerInformation', 'eventStatus' => 'eventStatus', 'systemTraceAuditNumber' => 'systemTraceAuditNumber', 'responseCodeSource' => 'responseCodeSource', 'paymentAccountReferenceNumber' => 'paymentAccountReferenceNumber', 'responseDetails' => 'responseDetails', 'rawResponseLocal' => 'rawResponseLocal', 'rawResponse' => 'rawResponse', 'routing' => 'routing'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['processor' => 'setProcessor', 'multiProcessorRouting' => 'setMultiProcessorRouting', 'transactionId' => 'setTransactionId', 'networkTransactionId' => 'setNetworkTransactionId', 'retrievalReferenceNumber' => 'setRetrievalReferenceNumber', 'responseId' => 'setResponseId', 'approvalCode' => 'setApprovalCode', 'responseCode' => 'setResponseCode', 'avs' => 'setAvs', 'cardVerification' => 'setCardVerification', 'achVerification' => 'setAchVerification', 'electronicVerificationResults' => 'setElectronicVerificationResults', 'issuerInformation' => 'setIssuerInformation', 'eventStatus' => 'setEventStatus', 'systemTraceAuditNumber' => 'setSystemTraceAuditNumber', 'responseCodeSource' => 'setResponseCodeSource', 'paymentAccountReferenceNumber' => 'setPaymentAccountReferenceNumber', 'responseDetails' => 'setResponseDetails', 'rawResponseLocal' => 'setRawResponseLocal', 'rawResponse' => 'setRawResponse', 'routing' => 'setRouting'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['processor' => 'getProcessor', 'multiProcessorRouting' => 'getMultiProcessorRouting', 'transactionId' => 'getTransactionId', 'networkTransactionId' => 'getNetworkTransactionId', 'retrievalReferenceNumber' => 'getRetrievalReferenceNumber', 'responseId' => 'getResponseId', 'approvalCode' => 'getApprovalCode', 'responseCode' => 'getResponseCode', 'avs' => 'getAvs', 'cardVerification' => 'getCardVerification', 'achVerification' => 'getAchVerification', 'electronicVerificationResults' => 'getElectronicVerificationResults', 'issuerInformation' => 'getIssuerInformation', 'eventStatus' => 'getEventStatus', 'systemTraceAuditNumber' => 'getSystemTraceAuditNumber', 'responseCodeSource' => 'getResponseCodeSource', 'paymentAccountReferenceNumber' => 'getPaymentAccountReferenceNumber', 'responseDetails' => 'getResponseDetails', 'rawResponseLocal' => 'getRawResponseLocal', 'rawResponse' => 'getRawResponse', 'routing' => 'getRouting'];
    ...
    /**
     * Gets processor
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\TssV2TransactionsGet200ResponseProcessorInformationProcessor
     */
    ...
    /**
     * Sets processor
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\TssV2TransactionsGet200ResponseProcessorInformationProcessor $processor
     * @return $this
     */
     ...
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\TssV2TransactionsGet200ResponseProcessorInformationMultiProcessorRouting[]
     */
     ...
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\TssV2TransactionsGet200ResponseProcessorInformationMultiProcessorRouting[] $multiProcessorRouting An array of object that contains the list of acquirer response codes & reasons if a transaction is routed to multiple acquirers.
     * @return $this
     */
     ...
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Riskv1decisionsProcessorInformationCardVerification
     */
     ...
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\Riskv1decisionsProcessorInformationCardVerification $cardVerification
     * @return $this
     */
     ...
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\TssV2TransactionsGet200ResponseProcessorInformationElectronicVerificationResults
     */
     ...
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\TssV2TransactionsGet200ResponseProcessorInformationElectronicVerificationResults $electronicVerificationResults
     * @return $this
     */
     ...
     * @return \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\PtsV2PaymentsPost201Response1IssuerInformation
     */
     ...
     * @param \Pymt_Vas\Dependencies\Pymt_Vas\Dependencies\CyberSource\Model\PtsV2PaymentsPost201Response1IssuerInformation $issuerInformation
     * @return $this
     */

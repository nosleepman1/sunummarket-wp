...
class Ptsv2paymentsPaymentInformationCustomer implements ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['customerId' => 'string', 'id' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['customerId' => null, 'id' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['customerId' => 'customerId', 'id' => 'id'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['customerId' => 'setCustomerId', 'id' => 'setId'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['customerId' => 'getCustomerId', 'id' => 'getId'];

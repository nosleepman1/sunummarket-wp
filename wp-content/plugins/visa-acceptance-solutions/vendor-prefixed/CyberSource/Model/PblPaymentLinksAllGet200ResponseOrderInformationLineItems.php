...
use ArrayAccess;
/**
 * PblPaymentLinksAllGet200ResponseOrderInformationLineItems Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PblPaymentLinksAllGet200ResponseOrderInformationLineItems implements ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'pblPaymentLinksAllGet200Response_orderInformation_lineItems';
    /**
     * Array of property to type mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerTypes = ['productName' => 'string', 'unitPrice' => 'string', 'productDescription' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     * @var string[]
     */
    protected static $swaggerFormats = ['productName' => null, 'unitPrice' => null, 'productDescription' => null];
     ...
     * @var string[]
     */
    protected static $attributeMap = ['productName' => 'productName', 'unitPrice' => 'unitPrice', 'productDescription' => 'productDescription'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     * @var string[]
     */
    protected static $setters = ['productName' => 'setProductName', 'unitPrice' => 'setUnitPrice', 'productDescription' => 'setProductDescription'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     * @var string[]
     */
    protected static $getters = ['productName' => 'getProductName', 'unitPrice' => 'getUnitPrice', 'productDescription' => 'getProductDescription'];

...
*/
namespace Pymt_Vas\Dependencies\CyberSource\Authentication\Http;
...
class HttpSignatureGenerator implements TokenGenerator
{
    ...
    protected function accessTokenHeader($signatureString, $headerString, $merchantConfig)
    {
        ...
        $signatureHeader = array('keyid="' . $merchantConfig->getApiKeyID() . '"', 'algorithm="' . GlobalParameter::HMACSHA256 . '"', 'headers="' . $headerString . '"', 'signature="' . $signature . '"');

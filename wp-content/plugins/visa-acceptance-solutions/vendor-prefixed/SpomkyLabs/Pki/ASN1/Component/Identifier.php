...
namespace Pymt_Vas\Dependencies\SpomkyLabs\Pki\ASN1\Component;

use function array_key_exists;
use Pymt_Vas\Dependencies\Brick\Math\BigInteger;
use function mb_strlen;
use function ord;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\ASN1\Exception\DecodeException;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\ASN1\Feature\Encodable;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\ASN1\Util\BigInt;
/**
 * Class to represent BER/DER identifier octets.
 * @see \Pymt_Vas\Dependencies\SpomkyLabs\Pki\Test\ASN1\Component\IdentifierTest
 */

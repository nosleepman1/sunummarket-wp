...
namespace Pymt_Vas\Dependencies\SpomkyLabs\Pki\ASN1;
...
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\ASN1\Type\Constructed;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\ASN1\Type\Constructed\ConstructedString;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\ASN1\Type\Constructed\Sequence;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\ASN1\Type\Constructed\Set;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\ASN1\Type\Primitive\BitString;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\ASN1\Type\Primitive\BMPString;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\ASN1\Type\Primitive\Boolean;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\ASN1\Type\Primitive\CharacterString;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\ASN1\Type\Primitive\Enumerated;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\ASN1\Type\Primitive\EOC;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\ASN1\Type\Primitive\GeneralizedTime;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\ASN1\Type\Primitive\GeneralString;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\ASN1\Type\Primitive\GraphicString;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\ASN1\Type\Primitive\IA5String;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\ASN1\Type\Primitive\Integer;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\ASN1\Type\Primitive\NullType;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\ASN1\Type\Primitive\NumericString;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\ASN1\Type\Primitive\ObjectDescriptor;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\ASN1\Type\Primitive\ObjectIdentifier;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\ASN1\Type\Primitive\OctetString;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\ASN1\Type\Primitive\PrintableString;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\ASN1\Type\Primitive\Real;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\ASN1\Type\Primitive\RelativeOID;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\ASN1\Type\Primitive\T61String;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\ASN1\Type\Primitive\UniversalString;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\ASN1\Type\Primitive\UTCTime;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\ASN1\Type\Primitive\UTF8String;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\ASN1\Type\Primitive\VideotexString;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\ASN1\Type\Primitive\VisibleString;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\ASN1\Type\StringType;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\ASN1\Type\Tagged\ApplicationType;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\ASN1\Type\Tagged\ContextSpecificType;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\ASN1\Type\Tagged\PrivateType;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\ASN1\Type\TaggedType;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\ASN1\Type\TimeType;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\ASN1\Type\UnspecifiedType;
use function sprintf;
use UnexpectedValueException;
/**
 * Base class for all ASN.1 type elements.
 * @see \Pymt_Vas\Dependencies\SpomkyLabs\Pki\Test\ASN1\ElementTest
 */

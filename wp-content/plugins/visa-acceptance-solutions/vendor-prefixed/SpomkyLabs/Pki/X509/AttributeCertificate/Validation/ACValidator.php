...
namespace Pymt_Vas\Dependencies\SpomkyLabs\Pki\X509\AttributeCertificate\Validation;

use function count;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\CryptoBridge\Crypto;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\X509\AttributeCertificate\AttributeCertificate;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\X509\AttributeCertificate\Validation\Exception\ACValidationException;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\X509\Certificate\Certificate;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\X509\Certificate\Extension\Extension;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\X509\Certificate\Extension\Target\Targets;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\X509\Certificate\Extension\TargetInformationExtension;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\X509\CertificationPath\Exception\PathValidationException;
use Pymt_Vas\Dependencies\SpomkyLabs\Pki\X509\CertificationPath\PathValidation\PathValidationConfig;
/**

 ...
 */
namespace Pymt_Vas\Dependencies\Symfony\Component\HttpFoundation\Session\Storage;

use Pymt_Vas\Dependencies\Symfony\Component\HttpFoundation\Session\SessionBagInterface;
use Pymt_Vas\Dependencies\Symfony\Component\HttpFoundation\Session\Storage\Handler\StrictSessionHandler;
use Pymt_Vas\Dependencies\Symfony\Component\HttpFoundation\Session\Storage\Proxy\AbstractProxy;
use Pymt_Vas\Dependencies\Symfony\Component\HttpFoundation\Session\Storage\Proxy\SessionHandlerProxy;
    ...
    public function setOptions(array $options): void
    {
        ...
        foreach ($options as $key => $value) {
            if (\in_array($key, ['referer_check', 'use_only_cookies', 'use_trans_sid', 'trans_sid_hosts', 'trans_sid_tags', 'sid_length', 'sid_bits_per_character'], true)) {
                pymt_vas_trigger_deprecation('symfony/http-foundation', '7.2', 'NativeSessionStorage\'s "%s" option is deprecated and will be ignored in Symfony 8.0.', $key);
            }

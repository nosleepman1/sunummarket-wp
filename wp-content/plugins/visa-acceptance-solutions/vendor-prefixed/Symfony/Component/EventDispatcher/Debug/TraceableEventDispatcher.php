 ...
 */
namespace Pymt_Vas\Dependencies\Symfony\Component\EventDispatcher\Debug;

use Pymt_Vas\Dependencies\Psr\EventDispatcher\StoppableEventInterface;
use Psr\Log\LoggerInterface;
use Pymt_Vas\Dependencies\Symfony\Component\EventDispatcher\EventDispatcher;
use Pymt_Vas\Dependencies\Symfony\Component\EventDispatcher\EventDispatcherInterface;
...
class TraceableEventDispatcher implements EventDispatcherInterface, ResetInterface
{
    ...
    public function __construct(private EventDispatcherInterface $dispatcher, protected Stopwatch $stopwatch, protected ?LoggerInterface $logger = null, private ?RequestStack $requestStack = null, protected readonly ?\Closure $disabled = null)
    {
    }

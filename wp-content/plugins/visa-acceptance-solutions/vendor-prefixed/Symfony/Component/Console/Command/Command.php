 ...
 */
namespace Pymt_Vas\Dependencies\Symfony\Component\Console\Command;

use Pymt_Vas\Dependencies\Symfony\Component\Console\Application;
...
use Pymt_Vas\Dependencies\Symfony\Component\Console\Helper\HelperInterface;
...
class Command implements SignalableCommandInterface
{
    ...
    {
        pymt_vas_trigger_deprecation('symfony/console', '7.3', 'Method "%s()" is deprecated and will be removed in Symfony 8.0, use the #[AsCommand] attribute instead.', __METHOD__);
    ...
    public function __construct(?string $name = null, ?callable $code = null)
    {
        ...
        if (null === $name) {
            if (self::class !== (new \ReflectionMethod($this, 'getDefaultName'))->class) {
                pymt_vas_trigger_deprecation('symfony/console', '7.3', 'Overriding "Command::getDefaultName()" in "%s" is deprecated and will be removed in Symfony 8.0, use the #[AsCommand] attribute instead.', static::class);
        ...
        if ('' === $this->description) {
            if (self::class !== (new \ReflectionMethod($this, 'getDefaultDescription'))->class) {
                pymt_vas_trigger_deprecation('symfony/console', '7.3', 'Overriding "Command::getDefaultDescription()" in "%s" is deprecated and will be removed in Symfony 8.0, use the #[AsCommand] attribute instead.', static::class);

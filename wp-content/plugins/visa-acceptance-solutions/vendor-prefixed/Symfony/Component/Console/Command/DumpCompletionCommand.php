...
final class DumpCompletionCommand extends Command
{
    ...
    protected function configure(): void
    {
        ...
        EOH)->addArgument('shell', InputArgument::OPTIONAL, 'The shell type (e.g. "bash"), the value of the "$SHELL" env var will be used if this is not given', null, $this->getSupportedShells(...))->addOption('debug', null, InputOption::VALUE_NONE, 'Tail the completion debug log');
    }

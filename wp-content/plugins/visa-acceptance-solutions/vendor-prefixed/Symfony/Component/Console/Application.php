 ...
 */
namespace Pymt_Vas\Dependencies\Symfony\Component\Console;

use Pymt_Vas\Dependencies\Symfony\Component\Console\Command\Command;
use Pymt_Vas\Dependencies\Symfony\Component\Console\Command\CompleteCommand;
use Pymt_Vas\Dependencies\Symfony\Component\Console\Command\DumpCompletionCommand;
use Pymt_Vas\Dependencies\Symfony\Component\Console\Command\HelpCommand;
use Pymt_Vas\Dependencies\Symfony\Component\Console\Command\LazyCommand;
use Pymt_Vas\Dependencies\Symfony\Component\Console\Command\ListCommand;
use Pymt_Vas\Dependencies\Symfony\Component\Console\CommandLoader\CommandLoaderInterface;
use Pymt_Vas\Dependencies\Symfony\Component\Console\Completion\CompletionInput;
use Pymt_Vas\Dependencies\Symfony\Component\Console\Completion\CompletionSuggestions;
use Pymt_Vas\Dependencies\Symfony\Component\Console\Completion\Suggestion;
use Pymt_Vas\Dependencies\Symfony\Component\Console\Event\ConsoleAlarmEvent;
use Pymt_Vas\Dependencies\Symfony\Component\Console\Event\ConsoleCommandEvent;
use Pymt_Vas\Dependencies\Symfony\Component\Console\Event\ConsoleErrorEvent;
use Pymt_Vas\Dependencies\Symfony\Component\Console\Event\ConsoleSignalEvent;
use Pymt_Vas\Dependencies\Symfony\Component\Console\Event\ConsoleTerminateEvent;
use Pymt_Vas\Dependencies\Symfony\Component\Console\Exception\CommandNotFoundException;
use Pymt_Vas\Dependencies\Symfony\Component\Console\Exception\ExceptionInterface;
use Pymt_Vas\Dependencies\Symfony\Component\Console\Exception\LogicException;
use Pymt_Vas\Dependencies\Symfony\Component\Console\Exception\NamespaceNotFoundException;
use Pymt_Vas\Dependencies\Symfony\Component\Console\Exception\RuntimeException;
use Pymt_Vas\Dependencies\Symfony\Component\Console\Formatter\OutputFormatter;
use Pymt_Vas\Dependencies\Symfony\Component\Console\Helper\DebugFormatterHelper;
use Pymt_Vas\Dependencies\Symfony\Component\Console\Helper\DescriptorHelper;
use Pymt_Vas\Dependencies\Symfony\Component\Console\Helper\FormatterHelper;
use Pymt_Vas\Dependencies\Symfony\Component\Console\Helper\Helper;
use Pymt_Vas\Dependencies\Symfony\Component\Console\Helper\HelperSet;
use Pymt_Vas\Dependencies\Symfony\Component\Console\Helper\ProcessHelper;
use Pymt_Vas\Dependencies\Symfony\Component\Console\Helper\QuestionHelper;
use Pymt_Vas\Dependencies\Symfony\Component\Console\Input\ArgvInput;
use Pymt_Vas\Dependencies\Symfony\Component\Console\Input\ArrayInput;
use Pymt_Vas\Dependencies\Symfony\Component\Console\Input\InputArgument;
use Pymt_Vas\Dependencies\Symfony\Component\Console\Input\InputAwareInterface;
use Pymt_Vas\Dependencies\Symfony\Component\Console\Input\InputDefinition;
...
use Pymt_Vas\Dependencies\Symfony\Component\Console\Output\ConsoleOutput;
use Pymt_Vas\Dependencies\Symfony\Component\Console\Output\ConsoleOutputInterface;
use Pymt_Vas\Dependencies\Symfony\Component\Console\Output\OutputInterface;
use Pymt_Vas\Dependencies\Symfony\Component\Console\SignalRegistry\SignalRegistry;
use Pymt_Vas\Dependencies\Symfony\Component\Console\Style\SymfonyStyle;
...
class Application implements ResetInterface
{
    ...
    {
        pymt_vas_trigger_deprecation('symfony/console', '7.4', 'The "%s()" method is deprecated and will be removed in Symfony 8.0, use "%s::addCommand()" instead.', __METHOD__, self::class);

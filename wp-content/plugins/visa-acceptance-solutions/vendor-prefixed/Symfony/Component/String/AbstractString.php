...
use Pymt_Vas\Dependencies\Symfony\Component\String\Exception\RuntimeException;
/**
...
abstract class AbstractString implements \Stringable, \JsonSerializable
{
    ...
    public function __serialize(): array
    {
        ...
        pymt_vas_trigger_deprecation('symfony/string', '7.4', 'Implementing "%s::__sleep()" is deprecated, use "__serialize()" instead.', get_debug_type($this));
        $data = [];
    ...
    {
        pymt_vas_trigger_deprecation('symfony/string', '7.4', 'Calling "%s::__sleep()" is deprecated, use "__serialize()" instead.', get_debug_type($this));
        return ['string'];
    }

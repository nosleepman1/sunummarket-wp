 ...
 */
namespace Pymt_Vas\Dependencies\Symfony\Component\ErrorHandler\ErrorRenderer;
...
class HtmlErrorRenderer implements ErrorRendererInterface
{
     ...
     */
    public function __construct(bool|callable $debug = false, ?string $charset = null, string|FileLinkFormatter|null $fileLinkFormat = null, private ?string $projectDir = null, string|callable $outputBuffer = '', private ?LoggerInterface $logger = null)
    {

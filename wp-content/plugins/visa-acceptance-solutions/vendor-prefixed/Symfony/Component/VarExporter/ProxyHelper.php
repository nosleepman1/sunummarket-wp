 ...
 */
namespace Pymt_Vas\Dependencies\Symfony\Component\VarExporter;

use Pymt_Vas\Dependencies\Symfony\Component\VarExporter\Exception\LogicException;
use Pymt_Vas\Dependencies\Symfony\Component\VarExporter\Internal\Hydrator;
use Pymt_Vas\Dependencies\Symfony\Component\VarExporter\Internal\LazyDecoratorTrait;
use Pymt_Vas\Dependencies\Symfony\Component\VarExporter\Internal\LazyObjectRegistry;
/**
...
final class ProxyHelper
{
    ...
    public static function generateLazyGhost(\ReflectionClass $class): string
    {
        if (\PHP_VERSION_ID >= 80400) {
            pymt_vas_trigger_deprecation('symfony/var-exporter', '7.3', 'Using ProxyHelper::generateLazyGhost() is deprecated, use native lazy objects instead.');
        }
    ...
    public static function generateLazyProxy(?\ReflectionClass $class, array $interfaces = []): string
    {
        ...
        if ($class && !$class->isAbstract()) {
            ...
            if (!$extendsInternalClass) {
                pymt_vas_trigger_deprecation('symfony/var-exporter', '7.3', 'Generating lazy proxy for class "%s" is deprecated; leverage native lazy objects instead.', $class->name);

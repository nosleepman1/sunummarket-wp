 ...
 */
namespace Pymt_Vas\Dependencies\Symfony\Component\VarExporter\Internal;
...
trait LazyDecoratorTrait
{
    ...
    public static function createLazyProxy(\Closure $initializer, ?object $instance = null): static
    {
        ...
        $instance ??= (Registry::$classReflectors[$class] ??= ($r = new \ReflectionClass($class))->hasProperty('lazyObjectState') ? $r : throw new \LogicException('Cannot create a lazy proxy for a non-decorator object.'))->newInstanceWithoutConstructor();

...
use Pymt_Vas\Dependencies\Symfony\Component\VarExporter\Exception\ClassNotFoundException;
/**
...
class Hydrator
{
    ...
    public function __construct(public readonly Registry $registry, public readonly ?Values $values, public readonly array $properties, public readonly mixed $value, public readonly array $wakeups)
    {
    }

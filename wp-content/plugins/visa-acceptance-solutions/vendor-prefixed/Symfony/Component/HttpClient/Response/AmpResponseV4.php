...
use Pymt_Vas\Dependencies\Symfony\Component\HttpClient\Exception\InvalidArgumentException;
use Pymt_Vas\Dependencies\Symfony\Component\HttpClient\Exception\TransportException;
use Pymt_Vas\Dependencies\Symfony\Component\HttpClient\HttpClientTrait;
use Pymt_Vas\Dependencies\Symfony\Component\HttpClient\Internal\AmpBodyV4;
use Pymt_Vas\Dependencies\Symfony\Component\HttpClient\Internal\AmpClientStateV4;
...
final class AmpResponseV4 implements ResponseInterface, StreamableInterface
{
    ...
    {
        $timeout += hrtime(true) / 1000000000.0;
        self::$delay = Loop::defer(static function () use ($timeout) {
            if (0 < $timeout -= hrtime(true) / 1000000000.0) {

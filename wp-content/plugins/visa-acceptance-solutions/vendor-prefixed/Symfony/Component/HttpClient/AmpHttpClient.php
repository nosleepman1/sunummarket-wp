...
use Pymt_Vas\Dependencies\Psr\Log\LoggerAwareInterface;
use Pymt_Vas\Dependencies\Psr\Log\LoggerAwareTrait;
...
use Pymt_Vas\Dependencies\Symfony\Component\HttpClient\Response\AmpResponseV4;
use Pymt_Vas\Dependencies\Symfony\Component\HttpClient\Response\AmpResponseV5;
    ...
    public function __construct(array $defaultOptions = [], ?callable $clientConfigurator = null, int $maxHostConnections = 6, int $maxPendingPushes = 50)
    {
        ...
        if (is_subclass_of(Request::class, HttpMessage::class)) {
            ...
            if (\PHP_VERSION_ID >= 80400) {
                pymt_vas_trigger_deprecation('symfony/http-client', '7.4', 'Using amphp/http-client < 5 is deprecated. Try running "composer require amphp/http-client:^5".');
            }

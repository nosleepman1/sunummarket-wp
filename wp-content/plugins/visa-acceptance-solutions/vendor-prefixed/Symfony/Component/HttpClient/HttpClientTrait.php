...
use Pymt_Vas\Dependencies\Symfony\Component\HttpClient\Response\StreamableInterface;
use Pymt_Vas\Dependencies\Symfony\Component\HttpClient\Response\StreamWrapper;
...
trait HttpClientTrait
{
    ...
    private static function prepareRequest(?string $method, ?string $url, array $options, array $defaultOptions = [], bool $allowExtraOptions = false): array
    {
        ...
        if (isset($options['crypto_method']) && !\in_array($options['crypto_method'], [\STREAM_CRYPTO_METHOD_TLSv1_0_CLIENT, \STREAM_CRYPTO_METHOD_TLSv1_1_CLIENT, \STREAM_CRYPTO_METHOD_TLSv1_2_CLIENT, \STREAM_CRYPTO_METHOD_TLSv1_3_CLIENT], true)) {

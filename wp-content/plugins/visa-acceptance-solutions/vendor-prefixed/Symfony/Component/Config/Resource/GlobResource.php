 ...
 */
namespace Pymt_Vas\Dependencies\Symfony\Component\Config\Resource;
...
class GlobResource implements \IteratorAggregate, SelfCheckingResourceInterface
{
     ...
     */
    public function __construct(string $prefix, private string $pattern, private bool $recursive, private bool $forExclusion = false, array $excludedPrefixes = [])
    {

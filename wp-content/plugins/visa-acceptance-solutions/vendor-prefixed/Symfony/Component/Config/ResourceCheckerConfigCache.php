...
use Pymt_Vas\Dependencies\Symfony\Component\Filesystem\Exception\IOException;
use Pymt_Vas\Dependencies\Symfony\Component\Filesystem\Filesystem;
/**
...
class ResourceCheckerConfigCache implements ConfigCacheInterface
{
     ...
     */
    public function __construct(private string $file, private iterable $resourceCheckers = [], ?string $metaFile = null)
    {

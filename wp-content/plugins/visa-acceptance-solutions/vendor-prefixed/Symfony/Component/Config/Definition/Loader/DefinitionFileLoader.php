 ...
 */
namespace Pymt_Vas\Dependencies\Symfony\Component\Config\Definition\Loader;

use Pymt_Vas\Dependencies\Symfony\Component\Config\Definition\Builder\TreeBuilder;
use Pymt_Vas\Dependencies\Symfony\Component\Config\Definition\Configurator\DefinitionConfigurator;
use Pymt_Vas\Dependencies\Symfony\Component\Config\FileLocatorInterface;
use Pymt_Vas\Dependencies\Symfony\Component\Config\Loader\FileLoader;
...
class DefinitionFileLoader extends FileLoader
{
    ...
    public function load(mixed $resource, ?string $type = null): mixed
    {
        ...
        try {
            ...
            $callback = $load($path);
            pymt_vas_trigger_deprecation('symfony/config', '7.4', 'Accessing the internal scope of the loader in config files is deprecated, use only its public API instead in "%s" on line %d.', $e->getFile(), $e->getLine());
        }

...
class NodeBuilder implements NodeParentInterface
{
    ...
    public function __construct()
    {
        ...
        $this->nodeMapping = ['array' => ArrayNodeDefinition::class, 'variable' => VariableNodeDefinition::class, 'scalar' => ScalarNodeDefinition::class, 'string' => StringNodeDefinition::class, 'boolean' => BooleanNodeDefinition::class, 'integer' => IntegerNodeDefinition::class, 'float' => FloatNodeDefinition::class, 'enum' => EnumNodeDefinition::class];
    }
    /**
     * Set the parent node.
     *

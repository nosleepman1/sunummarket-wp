 ...
 */
namespace Pymt_Vas\Dependencies\Symfony\Component\HttpKernel\CacheWarmer;
...
class CacheWarmerAggregate implements CacheWarmerInterface
{
     ...
     */
    public function __construct(private iterable $warmers = [], private bool $debug = false, private ?string $deprecationLogsFilepath = null)
    {
    }

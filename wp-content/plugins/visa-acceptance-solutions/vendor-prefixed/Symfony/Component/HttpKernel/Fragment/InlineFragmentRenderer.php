...
use Pymt_Vas\Dependencies\Symfony\Component\HttpKernel\HttpCache\SubRequestHandler;
...
{
    public function __construct(private HttpKernelInterface $kernel, private ?EventDispatcherInterface $dispatcher = null)
    {
    }
    /**

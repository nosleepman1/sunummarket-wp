 ...
 */
namespace Pymt_Vas\Dependencies\Symfony\Component\HttpKernel\Profiler;
...
use Pymt_Vas\Dependencies\Symfony\Component\HttpKernel\DataCollector\DataCollectorInterface;
use Pymt_Vas\Dependencies\Symfony\Component\HttpKernel\DataCollector\LateDataCollectorInterface;
...
class Profiler implements ResetInterface
{
    ...
    public function __construct(private ProfilerStorageInterface $storage, private ?LoggerInterface $logger = null, private bool $enabled = true)
    {

...
use Pymt_Vas\Dependencies\Symfony\Component\HttpFoundation\File\UploadedFile;
use Pymt_Vas\Dependencies\Symfony\Component\HttpFoundation\Request;
use Pymt_Vas\Dependencies\Symfony\Component\HttpKernel\Attribute\MapQueryString;
use Pymt_Vas\Dependencies\Symfony\Component\HttpKernel\Attribute\MapRequestPayload;
use Pymt_Vas\Dependencies\Symfony\Component\HttpKernel\Attribute\MapUploadedFile;
...
use Pymt_Vas\Dependencies\Symfony\Component\HttpKernel\Exception\UnsupportedMediaTypeHttpException;
...
class RequestPayloadValueResolver implements ValueResolverInterface, EventSubscriberInterface
{
    ...
    public function __construct(private readonly SerializerInterface&DenormalizerInterface $serializer, private readonly ?ValidatorInterface $validator = null, private readonly ?TranslatorInterface $translator = null, private string $translationDomain = 'validators')
    {
    }

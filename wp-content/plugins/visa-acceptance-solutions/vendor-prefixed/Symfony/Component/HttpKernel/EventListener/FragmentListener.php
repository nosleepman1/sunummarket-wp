...
use Pymt_Vas\Dependencies\Symfony\Component\HttpFoundation\UriSigner;
use Pymt_Vas\Dependencies\Symfony\Component\HttpKernel\Event\RequestEvent;
use Pymt_Vas\Dependencies\Symfony\Component\HttpKernel\Exception\AccessDeniedHttpException;
...
class FragmentListener implements EventSubscriberInterface
{
     ...
     */
    public function __construct(private UriSigner $signer, private string $fragmentPath = '/_fragment')
    {
    }
    /**

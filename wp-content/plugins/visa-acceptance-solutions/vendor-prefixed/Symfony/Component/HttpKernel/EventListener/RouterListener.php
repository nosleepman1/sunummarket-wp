...
use Pymt_Vas\Dependencies\Symfony\Component\HttpKernel\Exception\MethodNotAllowedHttpException;
use Pymt_Vas\Dependencies\Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Pymt_Vas\Dependencies\Symfony\Component\HttpKernel\Kernel;
...
class RouterListener implements EventSubscriberInterface
{
     ...
     */
    public function __construct(private UrlMatcherInterface|RequestMatcherInterface $matcher, private RequestStack $requestStack, ?RequestContext $context = null, private ?LoggerInterface $logger = null, private ?string $projectDir = null, private bool $debug = true)
    {

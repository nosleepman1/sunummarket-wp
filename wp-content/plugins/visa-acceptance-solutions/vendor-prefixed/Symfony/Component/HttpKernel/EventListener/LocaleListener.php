...
use Pymt_Vas\Dependencies\Symfony\Component\HttpKernel\Event\KernelEvent;
...
{
    public function __construct(private RequestStack $requestStack, private string $defaultLocale = 'en', private ?RequestContextAwareInterface $router = null, private bool $useAcceptLanguageHeader = false, private array $enabledLocales = [])
    {

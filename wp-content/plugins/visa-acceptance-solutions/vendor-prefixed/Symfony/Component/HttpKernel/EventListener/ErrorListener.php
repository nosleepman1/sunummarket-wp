...
use Pymt_Vas\Dependencies\Psr\Log\LoggerInterface;
use Pymt_Vas\Dependencies\Psr\Log\LogLevel;
use Pymt_Vas\Dependencies\Symfony\Component\ErrorHandler\ErrorHandler;
use Pymt_Vas\Dependencies\Symfony\Component\ErrorHandler\Exception\FlattenException;
...
use Pymt_Vas\Dependencies\Symfony\Component\HttpKernel\Attribute\WithHttpStatus;
use Pymt_Vas\Dependencies\Symfony\Component\HttpKernel\Attribute\WithLogLevel;
...
use Pymt_Vas\Dependencies\Symfony\Component\HttpKernel\Exception\HttpException;
use Pymt_Vas\Dependencies\Symfony\Component\HttpKernel\Exception\HttpExceptionInterface;
use Pymt_Vas\Dependencies\Symfony\Component\HttpKernel\HttpKernelInterface;
use Pymt_Vas\Dependencies\Symfony\Component\HttpKernel\KernelEvents;
use Pymt_Vas\Dependencies\Symfony\Component\HttpKernel\Log\DebugLoggerConfigurator;
/**
...
class ErrorListener implements EventSubscriberInterface
{
     ...
     */
    public function __construct(protected string|object|array|null $controller, protected ?LoggerInterface $logger = null, protected bool $debug = false, protected array $exceptionsMapping = [], protected array $loggers = [])
    {
    }
    ...
    {
        $attributes = ['_controller' => $this->controller, 'exception' => $exception, 'logger' => DebugLoggerConfigurator::getDebugLogger($this->getLogger($this->resolveLogChannel($exception)))];

...
use Pymt_Vas\Dependencies\Symfony\Component\HttpFoundation\Cookie;
...
use Pymt_Vas\Dependencies\Symfony\Component\HttpFoundation\Session\SessionUtils;
...
use Pymt_Vas\Dependencies\Symfony\Component\HttpKernel\Exception\UnexpectedSessionUsageException;
...
abstract class AbstractSessionListener implements EventSubscriberInterface, ResetInterface
{
     ...
     * @internal
     */
    public function __construct(private ?ContainerInterface $container = null, private bool $debug = false, private array $sessionOptions = [])
    {
    }
    /**
     * @internal

 ...
 */
namespace Pymt_Vas\Dependencies\Symfony\Component\HttpKernel\Debug;
...
class ErrorHandlerConfigurator
{
     ...
     */
    public function __construct(private ?LoggerInterface $logger = null, array|int|null $levels = \E_ALL, ?int $throwAt = \E_ALL, private bool $scream = true, private bool $scope = true, private ?LoggerInterface $deprecationLogger = null)
    {

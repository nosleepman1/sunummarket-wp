 ...
 */
namespace Pymt_Vas\Dependencies\Symfony\Component\HttpKernel\HttpCache;
...
use Pymt_Vas\Dependencies\Symfony\Component\HttpKernel\TerminableInterface;
/**
...
class HttpCache implements HttpKernelInterface, TerminableInterface
{
    ...
    public function __construct(private HttpKernelInterface $kernel, private StoreInterface $store, private ?SurrogateInterface $surrogate = null, array $options = [])
    {
        ...
        $this->options = array_merge(['debug' => false, 'default_ttl' => 0, 'private_headers' => ['Authorization', 'Cookie'], 'skip_response_headers' => ['Set-Cookie'], 'allow_reload' => false, 'allow_revalidate' => false, 'stale_while_revalidate' => 2, 'stale_if_error' => 60, 'trace_level' => 'none', 'trace_header' => 'X-Symfony-Cache'], $options);
    ...
    protected function forward(Request $request, bool $catch = false, ?Response $entry = null): Response
    {
         ...
         */
        if (null !== $entry && \in_array($response->getStatusCode(), [500, 502, 503, 504], true) && !$entry->headers->hasCacheControlDirective('no-cache') && !$entry->mustRevalidate()) {

 ...
 */
namespace Pymt_Vas\Dependencies\Symfony\Component\VarDumper;
...
use Pymt_Vas\Dependencies\Symfony\Component\VarDumper\Dumper\CliDumper;
use Pymt_Vas\Dependencies\Symfony\Component\VarDumper\Dumper\ContextProvider\CliContextProvider;
use Pymt_Vas\Dependencies\Symfony\Component\VarDumper\Dumper\ContextProvider\RequestContextProvider;
use Pymt_Vas\Dependencies\Symfony\Component\VarDumper\Dumper\ContextProvider\SourceContextProvider;
use Pymt_Vas\Dependencies\Symfony\Component\VarDumper\Dumper\ContextualizedDumper;
use Pymt_Vas\Dependencies\Symfony\Component\VarDumper\Dumper\DataDumperInterface;
use Pymt_Vas\Dependencies\Symfony\Component\VarDumper\Dumper\HtmlDumper;
use Pymt_Vas\Dependencies\Symfony\Component\VarDumper\Dumper\ServerDumper;
...
class VarDumper
{
    ...
    private static function register(): void
    {
        ...
        $dumper = match ($format) {
            ...
            default => self::selectDumperForAccept($format && 'tcp' === parse_url($format, \PHP_URL_SCHEME) ? $format : null),
        };

...
class XmlFileLoader extends FileLoader
{
    ...
    {
        pymt_vas_trigger_deprecation('symfony/dependency-injection', '7.4', 'XML configuration format is deprecated, use YAML or PHP instead.');
        ...
        foreach ($this->getChildren($node, $name) as $arg) {
            ...
            switch ($type = $arg->getAttribute('type')) {
                ...
                case 'service_locator':
                    ...
                    break;
                case 'tagged':
                    pymt_vas_trigger_deprecation('symfony/dependency-injection', '7.2', 'Type "tagged" is deprecated for tag <%s>, use "tagged_iterator" instead in "%s".', $name, $file);
                // no break

...
use Pymt_Vas\Dependencies\Symfony\Component\DependencyInjection\Attribute\AsAlias;
use Pymt_Vas\Dependencies\Symfony\Component\DependencyInjection\Attribute\Exclude;
...
use Pymt_Vas\Dependencies\Symfony\Component\DependencyInjection\Compiler\RegisterAutoconfigureAttributesPass;
...
abstract class FileLoader extends BaseFileLoader
{
     ...
     */
    public function __construct(protected ContainerBuilder $container, FileLocatorInterface $locator, ?string $env = null, protected bool $prepend = false)
    {
    ...
    public function registerClasses(Definition $prototype, string $namespace, string $resource, string|array|null $exclude = null, ?string $source = null): void
    {
        ...
        foreach ($classes as $class => $errorMessage) {
            ...
            if ($abstract) {
                ...
                $definition->setAbstract(true)->addTag('container.excluded', ['source' => 'because the class is abstract']);
                continue;
            }
            $interfaces = [];
    ...
    private function addContainerExcludedTag(string $class, ?string $source): void
    {
        ...
        $this->container->register($class, $class)->setAbstract(true)->addTag('container.excluded', null !== $source ? $attributes[$source] : []);
    }
}
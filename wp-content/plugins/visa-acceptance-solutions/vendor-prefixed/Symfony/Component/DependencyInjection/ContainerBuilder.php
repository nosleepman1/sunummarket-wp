 ...
 */
namespace Pymt_Vas\Dependencies\Symfony\Component\DependencyInjection;
...
use Pymt_Vas\Dependencies\Symfony\Component\DependencyInjection\Argument\AbstractArgument;
use Pymt_Vas\Dependencies\Symfony\Component\DependencyInjection\Argument\IteratorArgument;
use Pymt_Vas\Dependencies\Symfony\Component\DependencyInjection\Argument\LazyClosure;
use Pymt_Vas\Dependencies\Symfony\Component\DependencyInjection\Argument\RewindableGenerator;
use Pymt_Vas\Dependencies\Symfony\Component\DependencyInjection\Argument\ServiceClosureArgument;
use Pymt_Vas\Dependencies\Symfony\Component\DependencyInjection\Argument\ServiceLocator;
use Pymt_Vas\Dependencies\Symfony\Component\DependencyInjection\Argument\ServiceLocatorArgument;
use Pymt_Vas\Dependencies\Symfony\Component\DependencyInjection\Attribute\Target;
use Pymt_Vas\Dependencies\Symfony\Component\DependencyInjection\Compiler\Compiler;
...
use Pymt_Vas\Dependencies\Symfony\Component\DependencyInjection\Compiler\ResolveEnvPlaceholdersPass;
use Pymt_Vas\Dependencies\Symfony\Component\DependencyInjection\Exception\BadMethodCallException;
use Pymt_Vas\Dependencies\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException;
use Pymt_Vas\Dependencies\Symfony\Component\DependencyInjection\Exception\LogicException;
use Pymt_Vas\Dependencies\Symfony\Component\DependencyInjection\Exception\ParameterNotFoundException;
use Pymt_Vas\Dependencies\Symfony\Component\DependencyInjection\Exception\RuntimeException;
use Pymt_Vas\Dependencies\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException;
use Pymt_Vas\Dependencies\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException;
use Pymt_Vas\Dependencies\Symfony\Component\DependencyInjection\Extension\ExtensionInterface;
use Pymt_Vas\Dependencies\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\InstantiatorInterface;
use Pymt_Vas\Dependencies\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\LazyServiceInstantiator;
use Pymt_Vas\Dependencies\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\RealServiceInstantiator;
use Pymt_Vas\Dependencies\Symfony\Component\DependencyInjection\ParameterBag\EnvPlaceholderParameterBag;
use Pymt_Vas\Dependencies\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag;
use Pymt_Vas\Dependencies\Symfony\Component\DependencyInjection\ParameterBag\ParameterBagInterface;
...
class ContainerBuilder extends Container implements TaggedContainerInterface
{
    ...
    private function doGet(string $id, int $invalidBehavior = ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE, ?array &$inlineServices = null, bool $isConstructorArgument = false): mixed
    {
        ...
        if (!isset($this->definitions[$id]) && isset($this->aliasDefinitions[$id])) {
            ...
            if ($alias->isDeprecated()) {
                ...
                pymt_vas_trigger_deprecation($deprecation['package'], $deprecation['version'], $deprecation['message']);
            }
    ...
    public function merge(self $container): void
    {
        ...
        foreach ($container->getAttributeAutoconfigurators() as $attribute => $configurators) {
            $this->autoconfiguredAttributes[$attribute] = array_merge($this->autoconfiguredAttributes[$attribute] ?? [], $configurators);
        }
    }
    /**
    ...
    private function createService(Definition $definition, array &$inlineServices, bool $isConstructorArgument = false, ?string $id = null, bool|object $tryProxy = true): mixed
    {
        ...
        if (true === $tryProxy && $definition->isLazy() && ['Closure', 'fromCallable'] !== $definition->getFactory() && !$tryProxy = !($proxy = $this->proxyInstantiator ??= new LazyServiceInstantiator()) || $proxy instanceof RealServiceInstantiator) {
        ...
        if (null !== $factory) {
            ...
            if (!$definition->isDeprecated() && \is_array($factory) && \is_string($factory[0])) {
                ...
                if (str_contains($r->getDocComment() ?: '', "\n * @deprecated ")) {
                    pymt_vas_trigger_deprecation('', '', 'The "%s" service relies on the deprecated "%s" factory class. It should either be deprecated or its factory upgraded.', $id, $r->name);
                }
            }
        } else {
            ...
            if (!$definition->isDeprecated() && str_contains($r->getDocComment() ?: '', "\n * @deprecated ")) {
                pymt_vas_trigger_deprecation('', '', 'The "%s" service relies on the deprecated "%s" class. It should either be deprecated or its implementation upgraded.', $id, $r->name);
            }
        }
    ...
    {
        pymt_vas_trigger_deprecation('symfony/dependency-injection', '7.3', 'The "%s()" method is deprecated, use "getAttributeAutoconfigurators()" instead.', __METHOD__);

...
class ParameterNotFoundException extends InvalidArgumentException implements NotFoundExceptionInterface
{
     ...
     */
    public function __construct(private string $key, private ?string $sourceId = null, private ?string $sourceKey = null, ?\Throwable $previous = null, private array $alternatives = [], private ?string $nonNestedAlternative = null, private ?string $sourceExtensionName = null, private ?string $extraMessage = null)
    {

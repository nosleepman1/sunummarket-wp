...
final class AttributeAutoconfigurationPass extends AbstractRecursivePass
{
    ...
    {
        if (!$value instanceof Definition || !$value->isAutoconfigured() || $value->isAbstract() && !$value->hasTag('container.excluded') || $value->hasTag('container.ignore_attributes') || !$classReflector = $this->container->getReflectionClass($value->getClass(), false)) {

 ...
 */
namespace Pymt_Vas\Dependencies\Symfony\Component\DependencyInjection\ParameterBag;

use Pymt_Vas\Dependencies\Symfony\Component\DependencyInjection\Exception\EmptyParameterValueException;
...
class ParameterBag implements ParameterBagInterface
{
    ...
    public function get(string $name): array|bool|string|int|float|\UnitEnum|null
    {
        ...
        if (isset($this->deprecatedParameters[$name])) {
            pymt_vas_trigger_deprecation(...$this->deprecatedParameters[$name]);
        }

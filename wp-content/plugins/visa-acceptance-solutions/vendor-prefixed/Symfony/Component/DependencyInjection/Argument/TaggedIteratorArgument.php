 ...
 */
namespace Pymt_Vas\Dependencies\Symfony\Component\DependencyInjection\Argument;
...
class TaggedIteratorArgument extends IteratorArgument
{
     ...
     */
    public function __construct(private string $tag, ?string $indexAttribute = null, ?string $defaultIndexMethod = null, private bool $needsIndexes = false, ?string $defaultPriorityMethod = null, private array $exclude = [], private bool $excludeSelf = true)
    {
        parent::__construct([]);

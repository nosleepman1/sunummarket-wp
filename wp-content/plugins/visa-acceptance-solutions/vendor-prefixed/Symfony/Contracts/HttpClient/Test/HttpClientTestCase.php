 ...
 */
namespace Pymt_Vas\Dependencies\Symfony\Contracts\HttpClient\Test;
...
use Pymt_Vas\Dependencies\Symfony\Contracts\HttpClient\Exception\TimeoutExceptionInterface;
...
abstract class HttpClientTestCase extends TestCase
{
    ...
    public function testRedirects(array $headers = [])
    {
        ...
        $body = $response->toArray();
        $this->assertSame('GET', $body['REQUEST_METHOD']);
        $this->assertSame('', $body['HTTP_AUTHORIZATION']);

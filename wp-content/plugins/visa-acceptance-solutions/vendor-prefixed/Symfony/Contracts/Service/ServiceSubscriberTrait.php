 ...
 */
namespace Pymt_Vas\Dependencies\Symfony\Contracts\Service;

use Pymt_Vas\Dependencies\Psr\Container\ContainerInterface;
...
pymt_vas_trigger_deprecation('symfony/contracts', 'v3.5', '"%s" is deprecated, use "ServiceMethodsSubscriberTrait" instead.', ServiceSubscriberTrait::class);
/**

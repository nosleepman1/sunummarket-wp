 ...
 * <code>
 * <?php
 *    $a = new \Pymt_Vas\Dependencies\phpseclib3\Math\BigInteger(2);
 *    $b = new \Pymt_Vas\Dependencies\phpseclib3\Math\BigInteger(3);
 *
 *    $c = $a->add($b);
 *
 ...
 */
namespace Pymt_Vas\Dependencies\phpseclib3\Math;

use Pymt_Vas\Dependencies\phpseclib3\Exception\BadConfigurationException;
use Pymt_Vas\Dependencies\phpseclib3\Math\BigInteger\Engines\Engine;
/**
...
class BigInteger implements \JsonSerializable
{
     ...
     * <code>
     * <?php
     *    $a = new \Pymt_Vas\Dependencies\phpseclib3\Math\BigInteger('10');
     *    $b = new \Pymt_Vas\Dependencies\phpseclib3\Math\BigInteger('20');
     *

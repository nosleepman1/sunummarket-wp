 ...
 */
namespace Pymt_Vas\Dependencies\phpseclib3\Math\BigInteger\Engines\PHP;

use Pymt_Vas\Dependencies\phpseclib3\Math\BigInteger\Engines\Engine;
use Pymt_Vas\Dependencies\phpseclib3\Math\BigInteger\Engines\PHP;
use Pymt_Vas\Dependencies\phpseclib3\Math\BigInteger\Engines\PHP\Reductions\PowerOfTwo;
/**
 * PHP Montgomery Modular Exponentiation Engine
 *
 * @author  Jim Wigginton <terrafrost@php.net>

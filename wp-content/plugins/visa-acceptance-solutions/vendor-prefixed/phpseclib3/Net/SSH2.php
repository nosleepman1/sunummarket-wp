 ...
 *
 *    $ssh = new \Pymt_Vas\Dependencies\phpseclib3\Net\SSH2('www.domain.tld');
 ...
 *    include 'vendor/autoload.php';
 *
 *    $key = \Pymt_Vas\Dependencies\phpseclib3\Crypt\PublicKeyLoader::load('...', '(optional) password');
 *
 *    $ssh = new \Pymt_Vas\Dependencies\phpseclib3\Net\SSH2('www.domain.tld');
 ...
 */
namespace Pymt_Vas\Dependencies\phpseclib3\Net;

use Pymt_Vas\Dependencies\phpseclib3\Common\Functions\Strings;
use Pymt_Vas\Dependencies\phpseclib3\Crypt\Blowfish;
use Pymt_Vas\Dependencies\phpseclib3\Crypt\ChaCha20;
use Pymt_Vas\Dependencies\phpseclib3\Crypt\Common\AsymmetricKey;
use Pymt_Vas\Dependencies\phpseclib3\Crypt\Common\PrivateKey;
use Pymt_Vas\Dependencies\phpseclib3\Crypt\Common\PublicKey;
use Pymt_Vas\Dependencies\phpseclib3\Crypt\Common\SymmetricKey;
use Pymt_Vas\Dependencies\phpseclib3\Crypt\DH;
use Pymt_Vas\Dependencies\phpseclib3\Crypt\DSA;
use Pymt_Vas\Dependencies\phpseclib3\Crypt\EC;
use Pymt_Vas\Dependencies\phpseclib3\Crypt\Hash;
use Pymt_Vas\Dependencies\phpseclib3\Crypt\Random;
use Pymt_Vas\Dependencies\phpseclib3\Crypt\RC4;
use Pymt_Vas\Dependencies\phpseclib3\Crypt\Rijndael;
use Pymt_Vas\Dependencies\phpseclib3\Crypt\RSA;
use Pymt_Vas\Dependencies\phpseclib3\Crypt\TripleDES;
// Used to do Diffie-Hellman key exchange and DSA/RSA signature verification.
use Pymt_Vas\Dependencies\phpseclib3\Crypt\Twofish;
use Pymt_Vas\Dependencies\phpseclib3\Exception\ConnectionClosedException;
use Pymt_Vas\Dependencies\phpseclib3\Exception\InsufficientSetupException;
use Pymt_Vas\Dependencies\phpseclib3\Exception\InvalidPacketLengthException;
use Pymt_Vas\Dependencies\phpseclib3\Exception\NoSupportedAlgorithmsException;
use Pymt_Vas\Dependencies\phpseclib3\Exception\TimeoutException;
use Pymt_Vas\Dependencies\phpseclib3\Exception\UnableToConnectException;
use Pymt_Vas\Dependencies\phpseclib3\Exception\UnsupportedAlgorithmException;
use Pymt_Vas\Dependencies\phpseclib3\Exception\UnsupportedCurveException;
use Pymt_Vas\Dependencies\phpseclib3\Math\BigInteger;
use Pymt_Vas\Dependencies\phpseclib3\System\SSH\Agent;
/**
 * Pure-PHP implementation of SSHv2.
 *
 * @author  Jim Wigginton <terrafrost@php.net>
...
class SSH2
{
     ...
     *
     * @see \Pymt_Vas\Dependencies\phpseclib3\Net\SSH2::getLog()
     */
    const LOG_SIMPLE = 1;
    /**
     ...
     *
     * @see \Pymt_Vas\Dependencies\phpseclib3\Net\SSH2::read()
     */
    const READ_SIMPLE = 1;
    /**
     ...
     * \Pymt_Vas\Dependencies\phpseclib3\Crypt\Common\SymmetricKey.
     *
     * @param string $algorithm Name of the encryption algorithm
    ...
    /**
     * Maps an encryption algorithm name to an instance of a subclass of
     * \Pymt_Vas\Dependencies\phpseclib3\Crypt\Hash.
     *
     * @param string $algorithm Name of the encryption algorithm
     ...
     * Login
     *
     * The $password parameter can be a plaintext password, a \Pymt_Vas\Dependencies\phpseclib3\Crypt\RSA|EC|DSA object, a \Pymt_Vas\Dependencies\phpseclib3\System\SSH\Agent object or an array
     *
     ...
     * Execute Command
     *
     * If $callback is set to false then \Pymt_Vas\Dependencies\phpseclib3\Net\SSH2::get_channel_packet(self::CHANNEL_EXEC) will need to be called manually.
    ...
    public function openShell()
    {
        ...
        $packet = Strings::packSSH2('CNsb', NET_SSH2_MSG_CHANNEL_REQUEST, $this->server_channels[self::CHANNEL_SHELL], 'shell', true);
        $this->send_binary_packet($packet);
     ...
     *
     * \Pymt_Vas\Dependencies\phpseclib3\Net\SSH2 doesn't properly close most channels.  For exec() channels are normally closed by the server

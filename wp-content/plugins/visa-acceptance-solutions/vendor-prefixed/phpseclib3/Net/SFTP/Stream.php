 ...
 */
namespace Pymt_Vas\Dependencies\phpseclib3\Net\SFTP;

use Pymt_Vas\Dependencies\phpseclib3\Crypt\Common\PrivateKey;
use Pymt_Vas\Dependencies\phpseclib3\Net\SFTP;
...
class Stream
{
     ...
     * If newname exists, it will be overwritten.  This is a departure from what \Pymt_Vas\Dependencies\phpseclib3\Net\SFTP
     * does.
     *
     ...
     * Flushes the output
     *
     * See <http://php.net/fflush>. Always returns true because \Pymt_Vas\Dependencies\phpseclib3\Net\SFTP doesn't cache stuff before writing
     *
     * @return bool
     */
     ...
     *
     * Ignores the STREAM_URL_STAT_QUIET flag because the entirety of \Pymt_Vas\Dependencies\phpseclib3\Net\SFTP\Stream is quiet by default
     ...
     * The other two aren't supported because of limitations in \Pymt_Vas\Dependencies\phpseclib3\Net\SFTP.
     *
     * @param int $option
     * @param int $arg1
     * @param int $arg2

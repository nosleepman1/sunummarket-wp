 ...
 *
 *    $sftp = new \Pymt_Vas\Dependencies\phpseclib3\Net\SFTP('www.domain.tld');
...
use Pymt_Vas\Dependencies\phpseclib3\Exception\FileNotFoundException;
/**
...
class SFTP extends SSH2
{
     ...
     *
     * \Pymt_Vas\Dependencies\phpseclib3\Net\SSH2::exec() uses 0 and \Pymt_Vas\Dependencies\phpseclib3\Net\SSH2::read() / \Pymt_Vas\Dependencies\phpseclib3\Net\SSH2::write() use 1.
     *
     * @see \Pymt_Vas\Dependencies\phpseclib3\Net\SSH2::send_channel_packet()
     * @see \Pymt_Vas\Dependencies\phpseclib3\Net\SSH2::get_channel_packet()
     */
    const CHANNEL = 0x100;
    /**
     * Reads data from a local file.
     *
     * @see \Pymt_Vas\Dependencies\phpseclib3\Net\SFTP::put()
     */
    ...
    private function partial_init_sftp_connection()
    {
        ...
        $packet = Strings::packSSH2('CNsbs', NET_SSH2_MSG_CHANNEL_REQUEST, $this->server_channels[self::CHANNEL], 'subsystem', true, 'sftp');
     ...
     * Returns general information about a file or symbolic link
     *
     * Determines information without calling \Pymt_Vas\Dependencies\phpseclib3\Net\SFTP::realpath().
     ...
     *
     * By default, \Pymt_Vas\Dependencies\phpseclib3\Net\SFTP::put() does not read from the local filesystem.  $data is dumped directly into $remote_file.
     * So, for example, if you set $data to 'filename.ext' and then do \Pymt_Vas\Dependencies\phpseclib3\Net\SFTP::get(), you will get a file, twelve bytes
     ...
     *
     * {@internal ASCII mode for SFTPv4/5/6 can be supported by adding a new function - \Pymt_Vas\Dependencies\phpseclib3\Net\SFTP::setMode().}
     *
    ...
    {
        return !$recursive || $this->filetype($path) != 'dir' ? $this->get_stat_cache_prop($path, 'size') : self::recursiveFilesize($this->rawlist($path, true));
    }
    /**
     * Gets file type
     *

 ...
 */
namespace Pymt_Vas\Dependencies\phpseclib3\System\SSH\Agent;
...
use Pymt_Vas\Dependencies\phpseclib3\System\SSH\Common\Traits\ReadBytes;
/**
 * Pure-PHP ssh-agent client identity object
 *
 * Instantiation should only be performed by \Pymt_Vas\Dependencies\phpseclib3\System\SSH\Agent class.
 * This could be thought of as implementing an interface that Pymt_Vas\Dependencies\phpseclib3\Crypt\RSA
...
class Identity implements PrivateKey
{
     ...
     * Set Public Key
     *
     * Called by \Pymt_Vas\Dependencies\phpseclib3\System\SSH\Agent::requestIdentities()
     *
     * @param PublicKey $key
     */
     ...
     * Set Public Key
     *
     * Called by \Pymt_Vas\Dependencies\phpseclib3\System\SSH\Agent::requestIdentities(). The key blob could be extracted from $this->key

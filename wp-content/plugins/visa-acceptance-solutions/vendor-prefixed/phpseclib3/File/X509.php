 ...
 */
namespace Pymt_Vas\Dependencies\phpseclib3\File;
...
use Pymt_Vas\Dependencies\phpseclib3\Crypt\PublicKeyLoader;
use Pymt_Vas\Dependencies\phpseclib3\Crypt\Random;
use Pymt_Vas\Dependencies\phpseclib3\Crypt\RSA;
use Pymt_Vas\Dependencies\phpseclib3\Crypt\RSA\Formats\Keys\PSS;
use Pymt_Vas\Dependencies\phpseclib3\Exception\UnsupportedAlgorithmException;
use Pymt_Vas\Dependencies\phpseclib3\File\ASN1\Element;
use Pymt_Vas\Dependencies\phpseclib3\File\ASN1\Maps;
...
class X509
{
     ...
     *
     * @see \Pymt_Vas\Dependencies\phpseclib3\File\X509::getDN()
     */
    const DN_ARRAY = 0;
    /**
     * Return string
     ...
     *
     * @see \Pymt_Vas\Dependencies\phpseclib3\File\X509::saveX509()
     * @see \Pymt_Vas\Dependencies\phpseclib3\File\X509::saveCSR()
     * @see \Pymt_Vas\Dependencies\phpseclib3\File\X509::saveCRL()
     */
    const FORMAT_PEM = 0;
    /**
     * Save as DER
     ...
     *
     * There's no guarantee \Pymt_Vas\Dependencies\phpseclib3\File\X509 is going to re-encode an X.509 cert in the same way it was originally
     ...
     * Set public key
     *
     * Key needs to be a \Pymt_Vas\Dependencies\phpseclib3\Crypt\RSA object
     *
     * @param PublicKey $key
     * @return void
     */
     ...
     * Gets the public key
     *
     * Returns a \Pymt_Vas\Dependencies\phpseclib3\Crypt\RSA object or a false.
     *
     * @return mixed
     */
    ...
    public function sign(X509 $issuer, X509 $subject)
    {
        ...
        if ($this->caFlag) {
            ...
            $this->setExtension('id-ce-basicConstraints', array_merge(['cA' => true], $basicConstraints), true);
            if (!isset($subject->currentKeyIdentifier)) {
     ...
     * - Key object
     * - \Pymt_Vas\Dependencies\phpseclib3\File\X509 object with public or private key defined
     * - Certificate or CSR array
     * - \Pymt_Vas\Dependencies\phpseclib3\File\ASN1\Element object
     * - PEM or DER string
     *

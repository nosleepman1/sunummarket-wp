 ...
 *
 *    $des = new \Pymt_Vas\Dependencies\phpseclib3\Crypt\DES('ctr');
 *
 *    $des->setKey('abcdefgh');
 *
 *    $size = 10 * 1024;
...
class DES extends BlockCipher
{
     ...
     *
     * @see \Pymt_Vas\Dependencies\phpseclib3\Crypt\DES::setupKey()
     * @see \Pymt_Vas\Dependencies\phpseclib3\Crypt\DES::processBlock()
     */
    const ENCRYPT = 0;
    /**

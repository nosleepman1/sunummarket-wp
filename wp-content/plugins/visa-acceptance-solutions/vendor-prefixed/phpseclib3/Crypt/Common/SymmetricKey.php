...
/**
 * Base Class for all \Pymt_Vas\Dependencies\phpseclib3\Crypt\* cipher classes
 *
 * PHP version 5
 *
 ...
 *
 *  - The new \Pymt_Vas\Dependencies\phpseclib3\Crypt\* cipher class should extend \Pymt_Vas\Dependencies\phpseclib3\Crypt\Common\SymmetricKey
 *
 ...
 *
 *  - Look at the source code of the current ciphers how they extend \Pymt_Vas\Dependencies\phpseclib3\Crypt\Common\SymmetricKey
 ...
 */
namespace Pymt_Vas\Dependencies\phpseclib3\Crypt\Common;
...
use Pymt_Vas\Dependencies\phpseclib3\Exception\BadDecryptionException;
use Pymt_Vas\Dependencies\phpseclib3\Exception\BadModeException;
use Pymt_Vas\Dependencies\phpseclib3\Exception\InconsistentSetupException;
...
use Pymt_Vas\Dependencies\phpseclib3\Math\BinaryField;
use Pymt_Vas\Dependencies\phpseclib3\Math\PrimeField;
/**
 * Base Class for all \Pymt_Vas\Dependencies\phpseclib3\Crypt\* cipher classes
 *
 * @author  Jim Wigginton <terrafrost@php.net>
...
abstract class SymmetricKey
{
     ...
     * @see \Pymt_Vas\Dependencies\phpseclib3\Crypt\Common\SymmetricKey::encrypt()
     * @see \Pymt_Vas\Dependencies\phpseclib3\Crypt\Common\SymmetricKey::decrypt()
     */
    const MODE_CTR = -1;
    /**
     ...
     * Mode Map
     *
     * @see \Pymt_Vas\Dependencies\phpseclib3\Crypt\Common\SymmetricKey::__construct()
     */
     ...
     * Engine Reverse Map
     *
     * @see \Pymt_Vas\Dependencies\phpseclib3\Crypt\Common\SymmetricKey::getEngine()
     */
     ...
     *
     * @see \Pymt_Vas\Dependencies\phpseclib3\Crypt\Twofish::setKey()
     * @see \Pymt_Vas\Dependencies\phpseclib3\Crypt\Twofish::setIV()
     * @var bool
     */
     ...
     *
     * Put another way, when the continuous buffer is enabled, the state of the \Pymt_Vas\Dependencies\phpseclib3\Crypt\*() object changes after each
     ...
     * Encrypts a block
     *
     * Note: Must be extended by the child \Pymt_Vas\Dependencies\phpseclib3\Crypt\* class
     *
     * @param string $in
     * @return string
     */
     ...
     *
     * Note: Must extend by the child \Pymt_Vas\Dependencies\phpseclib3\Crypt\* class
     *
     * @see self::setup()
     */
     ...
     *    </code>
     *
     *    See also the \Pymt_Vas\Dependencies\phpseclib3\Crypt\*::_setupInlineCrypt()'s for

 ...
 */
namespace Pymt_Vas\Dependencies\phpseclib3\Crypt\EC;

use Pymt_Vas\Dependencies\phpseclib3\Common\Functions\Strings;
use Pymt_Vas\Dependencies\phpseclib3\Crypt\Common;
...
use Pymt_Vas\Dependencies\phpseclib3\Crypt\EC\Formats\Signature\ASN1 as ASN1Signature;
...
final class PrivateKey extends EC implements Common\PrivateKey
{
    ...
    public function multiply($coordinates)
    {
        ...
        return "\x04" . $point[0]->toBytes(true) . $point[1]->toBytes(true);
    }
    /**
     * Create a signature
     *

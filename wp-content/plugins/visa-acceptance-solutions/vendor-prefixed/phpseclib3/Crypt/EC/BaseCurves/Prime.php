 ...
 */
namespace Pymt_Vas\Dependencies\phpseclib3\Crypt\EC\BaseCurves;
...
use Pymt_Vas\Dependencies\phpseclib3\Math\PrimeField\Integer as PrimeInteger;
/**
 * Curves over y^2 = x^3 + a*x + b
 *
 * @author  Jim Wigginton <terrafrost@php.net>
...
class Prime extends Base
{
     ...
     *
     * @var \Pymt_Vas\Dependencies\phpseclib3\Math\PrimeFields
     */
    protected $factory;
    /**
     * Cofficient for x^1

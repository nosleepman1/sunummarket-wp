 ...
 *
 *    $rc4 = new \Pymt_Vas\Dependencies\phpseclib3\Crypt\RC4();
 *
 *    $rc4->setKey('abcdefgh');
 *
 *    $size = 10 * 1024;
...
{
    /**
     * @see \Pymt_Vas\Dependencies\phpseclib3\Crypt\RC4::_crypt()
     */
    const ENCRYPT = 0;
    /**
     * @see \Pymt_Vas\Dependencies\phpseclib3\Crypt\RC4::_crypt()
     ...
     * Key Length (in bytes)
     *
     * @see \Pymt_Vas\Dependencies\phpseclib3\Crypt\RC4::setKeyLength()
     * @var int
     */

 ...
 *
 *    $des = new \Pymt_Vas\Dependencies\phpseclib3\Crypt\TripleDES('ctr');
 *
...
class TripleDES extends DES
{
     ...
     *
     * Outer chaining is used by SSH-2 and when the mode is set to \Pymt_Vas\Dependencies\phpseclib3\Crypt\Common\BlockCipher::MODE_CBC.
     */
    const MODE_CBC3 = self::MODE_CBC;
    /**
     * Key Length (in bytes)
     *
     * @see \Pymt_Vas\Dependencies\phpseclib3\Crypt\TripleDES::setKeyLength()
     * @var int
     */
    ...
    private $mode_3cbc;
    /**
     * The \Pymt_Vas\Dependencies\phpseclib3\Crypt\DES objects
     *
     ...
     *
     * SetIV is not required when \Pymt_Vas\Dependencies\phpseclib3\Crypt\Common\SymmetricKey::MODE_ECB is being used.
     *
     ...
     *
     * Put another way, when the continuous buffer is enabled, the state of the \Pymt_Vas\Dependencies\phpseclib3\Crypt\DES() object changes after each

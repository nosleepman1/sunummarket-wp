 ...
 *
 *    $rc2 = new \Pymt_Vas\Dependencies\phpseclib3\Crypt\RC2('ctr');
 *
 *    $rc2->setKey('abcdefgh');
 *
...
class RC2 extends BlockCipher
{
     ...
     * Key Length (in bytes)
     *
     * @see \Pymt_Vas\Dependencies\phpseclib3\Crypt\RC2::setKeyLength()
     * @var int
     */
     ...
     *  \Pymt_Vas\Dependencies\phpseclib3\Crypt\RC2::setKey() call.
     *
     ...
     * Encrypts a message.
     *
     * Mostly a wrapper for \Pymt_Vas\Dependencies\phpseclib3\Crypt\Common\SymmetricKey::encrypt, with some additional OpenSSL handling code
     *
     * @see self::decrypt()
     ...
     * Decrypts a message.
     *
     * Mostly a wrapper for \Pymt_Vas\Dependencies\phpseclib3\Crypt\Common\SymmetricKey::decrypt, with some additional OpenSSL handling code
     *
     * @see self::encrypt()

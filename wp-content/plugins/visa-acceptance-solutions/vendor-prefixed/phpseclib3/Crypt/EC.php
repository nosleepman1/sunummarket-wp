 ...
 *
 * $private = \Pymt_Vas\Dependencies\phpseclib3\Crypt\EC::createKey('secp256k1');
 ...
 */
namespace Pymt_Vas\Dependencies\phpseclib3\Crypt;

use Pymt_Vas\Dependencies\phpseclib3\Crypt\Common\AsymmetricKey;
use Pymt_Vas\Dependencies\phpseclib3\Crypt\EC\BaseCurves\Montgomery as MontgomeryCurve;
use Pymt_Vas\Dependencies\phpseclib3\Crypt\EC\BaseCurves\TwistedEdwards as TwistedEdwardsCurve;
use Pymt_Vas\Dependencies\phpseclib3\Crypt\EC\Curves\Curve25519;
use Pymt_Vas\Dependencies\phpseclib3\Crypt\EC\Curves\Curve448;
use Pymt_Vas\Dependencies\phpseclib3\Crypt\EC\Curves\Ed25519;
use Pymt_Vas\Dependencies\phpseclib3\Crypt\EC\Curves\Ed448;
use Pymt_Vas\Dependencies\phpseclib3\Crypt\EC\Formats\Keys\PKCS1;
use Pymt_Vas\Dependencies\phpseclib3\Crypt\EC\Formats\Keys\PKCS8;
use Pymt_Vas\Dependencies\phpseclib3\Crypt\EC\Parameters;
use Pymt_Vas\Dependencies\phpseclib3\Crypt\EC\PrivateKey;
use Pymt_Vas\Dependencies\phpseclib3\Crypt\EC\PublicKey;
use Pymt_Vas\Dependencies\phpseclib3\Exception\BadConfigurationException;
...
use Pymt_Vas\Dependencies\phpseclib3\Exception\UnsupportedOperationException;
use Pymt_Vas\Dependencies\phpseclib3\File\ASN1;
use Pymt_Vas\Dependencies\phpseclib3\File\ASN1\Maps\ECParameters;
...
abstract class EC extends AsymmetricKey
{
    ...
    public function getEncodedCoordinates()
    {
        ...
        return "\x04" . $this->QA[0]->toBytes(true) . $this->QA[1]->toBytes(true);
    }
    /**

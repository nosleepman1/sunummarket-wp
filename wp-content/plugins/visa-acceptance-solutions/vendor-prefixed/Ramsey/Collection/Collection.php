 ...
 *
 * ```
 * $collection = new \Pymt_Vas\Dependencies\Ramsey\Collection\Collection('My\\Foo');
 ...
 * namespace My\Foo;
 *
 * class FooCollection extends \Pymt_Vas\Dependencies\Ramsey\Collection\AbstractCollection
 * {

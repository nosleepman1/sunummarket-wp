...
final class CompactSerializer extends Serializer
{
    ...
    public function serialize(JWS $jws, ?int $signatureIndex = null): string
    {
        ...
        return sprintf('%s.%s.%s', $signature->getEncodedProtectedHeader(), $jws->getEncodedPayload(), Base64UrlSafe::encodeUnpadded($signature->getSignature()));
    }
    public function unserialize(string $input): JWS
    {
        ...
        try {
            ...
            if (!$hasPayload) {
                ...
                $payload = $this->isPayloadEncoded($protectedHeader) ? Base64UrlSafe::decodeNoPadding($encodedPayload) : $encodedPayload;
            }

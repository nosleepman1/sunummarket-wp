...
/**
 * @see \Pymt_Vas\Dependencies\Jose\Tests\Component\Checker\IsEqualCheckerTest
 */
final class IsEqualChecker implements ClaimChecker, HeaderChecker
{
     ...
     */
    public function __construct(private readonly string $key, private readonly mixed $value, private readonly bool $protectedHeaderOnly = true)
    {
    }

...
final class NotBeforeChecker implements ClaimChecker, HeaderChecker
{
    ...
    public function __construct(private readonly int $allowedTimeDrift = 0, private readonly bool $protectedHeaderOnly = false, ?ClockInterface $clock = null)
    {
        if ($clock === null) {
            pymt_vas_trigger_deprecation('web-token/jwt-library', '3.3.0', 'The parameter "$clock" will become mandatory in 4.0.0. Please set a valid PSR Clock implementation instead of "null".');

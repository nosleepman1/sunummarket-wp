...
final class X5ULoaderCommand extends ObjectOutputCommand
{
    ...
    public function __construct(private readonly X5UFactory $x5uFactory, ?string $name = null)
    {
    ...
    {
        parent::configure();
        $this->setHelp('This command will try to get a key set from an URL. The distant key set is list of X.509 certificates.')->addArgument('url', InputArgument::REQUIRED, 'The URL');
    }

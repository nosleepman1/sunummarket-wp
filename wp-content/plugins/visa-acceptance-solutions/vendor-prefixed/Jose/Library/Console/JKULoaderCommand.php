...
final class JKULoaderCommand extends ObjectOutputCommand
{
    ...
    public function __construct(private readonly JKUFactory $jkuFactory, ?string $name = null)
    {
    ...
    {
        parent::configure();
        $this->setHelp('This command will try to get a key set from an URL. The distant key set is a JWKSet.')->addArgument('url', InputArgument::REQUIRED, 'The URL');
    }

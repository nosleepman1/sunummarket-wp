...
final class KeysetAnalyzerCommand extends Command
{
    ...
    public function __construct(private readonly KeysetAnalyzerManager $keysetAnalyzerManager, private readonly KeyAnalyzerManager $keyAnalyzerManager, ?string $name = null)
    {
    ...
    {
        parent::configure();
        $this->setHelp('This command will analyze a JWKSet object and find security issues.')->addArgument('jwkset', InputArgument::REQUIRED, 'The JWKSet object');
    }

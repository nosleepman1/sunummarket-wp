...
final class JSONGeneralSerializer implements JWESerializer
{
    ...
    public function unserialize(string $input): JWE
    {
        ...
        return new JWE($ciphertext, $iv, $tag, $aad, $sharedHeader, $sharedProtectedHeader, $encodedSharedProtectedHeader, $recipients);
    }
    ...
    {
        $encryptedKey = array_key_exists('encrypted_key', $recipient) ? Base64UrlSafe::decodeNoPadding($recipient['encrypted_key']) : null;

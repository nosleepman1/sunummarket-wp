...
class JWEDecrypter
{
    ...
    public function __construct(AlgorithmManager $algorithmManager, null|AlgorithmManager $contentEncryptionAlgorithmManager, private readonly null|CompressionMethodManager $compressionMethodManager = null)
    {
        if ($compressionMethodManager !== null) {
            pymt_vas_trigger_deprecation('web-token/jwt-library', '3.3.0', 'The parameter "$compressionMethodManager" is deprecated and will be removed in 4.0.0. Compression is not recommended for JWE. Please set "null" instead.');
        }

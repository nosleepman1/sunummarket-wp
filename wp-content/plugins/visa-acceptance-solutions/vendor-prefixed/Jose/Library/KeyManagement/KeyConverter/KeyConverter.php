...
use Pymt_Vas\Dependencies\ParagonIE\Sodium\Core\Ed25519;
        ...
        try {
            ...
            switch ($key->algorithmIdentifier()->oid()) {
                ...
                case AlgorithmIdentifier::OID_X448:
                    ...
                    $values = ['kty' => 'OKP', 'crv' => $curve, 'd' => Base64UrlSafe::encodeUnpadded($key->privateKeyData())];
    ...
    private static function loadPublicKey(PEM $pem): array
    {
        ...
        switch ($key->algorithmIdentifier()->oid()) {
            ...
            case AlgorithmIdentifier::OID_X448:
                ...
                return ['kty' => 'OKP', 'crv' => $curve, 'x' => Base64UrlSafe::encodeUnpadded((string) $key->subjectPublicKey())];
            default:
                throw new InvalidArgumentException('Unsupported key type');
        }
    }

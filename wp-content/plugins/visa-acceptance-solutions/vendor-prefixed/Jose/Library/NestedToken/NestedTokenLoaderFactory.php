...
namespace Pymt_Vas\Dependencies\Jose\Component\NestedToken;

use Pymt_Vas\Dependencies\Jose\Component\Encryption\JWELoaderFactory;
use Pymt_Vas\Dependencies\Jose\Component\Signature\JWSLoaderFactory;
class NestedTokenLoaderFactory
{
    public function __construct(private readonly JWELoaderFactory $jweLoaderFactory, private readonly JWSLoaderFactory $jwsLoaderFactory)
    {
    }
    /**
     ...
     */
    public function create(array $jweSerializers, array $keyEncryptionAlgorithms, null|array $contentEncryptionAlgorithms, null|array $compressionMethods, array $jweHeaderCheckers, array $jwsSerializers, array $signatureAlgorithms, array $jwsHeaderCheckers): NestedTokenLoader
    {

...
{
    public function __construct(private readonly JWELoader $jweLoader, private readonly JWSLoader $jwsLoader)
    {
    }
    /**
    ...
    private function checkContentTypeHeader(JWE $jwe, int $recipient): void
    {
        $cty = match (true) {
            ...
            $jwe->getRecipient($recipient)->hasHeaderParameter('cty') => $jwe->getRecipient($recipient)->getHeaderParameter('cty'),

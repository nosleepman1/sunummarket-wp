...
abstract class AbstractEncryptionSource implements Source
{
    ...
    {
        $node->children()->arrayNode($this->name())->useAttributeAsKey('name')->arrayPrototype()->beforeNormalization()->ifTrue(static fn(array $v) => isset($v['key_encryption_algorithms']) || isset($v['content_encryption_algorithms']))->then(static function (array $v) {

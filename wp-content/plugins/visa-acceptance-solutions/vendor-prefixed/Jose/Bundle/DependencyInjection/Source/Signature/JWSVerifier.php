...
use Pymt_Vas\Dependencies\Jose\Component\Signature\JWSVerifier as JWSVerifierService;
...
class JWSVerifier extends AbstractSignatureSource
{
    ...
    public function load(array $configs, ContainerBuilder $container): void
    {
        foreach ($configs[$this->name()] as $name => $itemConfig) {
            ...
            $definition->setFactory([new Reference(JWSVerifierFactory::class), 'create'])->setArguments([$itemConfig['signature_algorithms']])->addTag('jose.jws_verifier')->setPublic($itemConfig['is_public']);

...
final class JWEDecrypterFactory
{
     ...
     */
    public function create(array $encryptionAlgorithms, null|array $contentEncryptionAlgorithms = null, null|array $compressionMethods = null): JWEDecrypter
    {
        if ($contentEncryptionAlgorithms !== null) {
            pymt_vas_trigger_deprecation('web-token/jwt-library', '3.3.0', 'The parameter "$contentEncryptionAlgorithms" is deprecated and will be removed in 4.0.0. Please set all algorithms in the first argument and set "null" instead.');
        ...
        return new JWEDecrypter($encryptionAlgorithmManager, null, $compressionMethodManager, $this->eventDispatcher);
    }
}
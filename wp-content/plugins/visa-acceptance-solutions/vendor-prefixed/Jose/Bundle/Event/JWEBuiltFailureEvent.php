...
{
    public function __construct(private readonly ?string $payload, private readonly array $recipients, private readonly array $sharedProtectedHeader, private readonly array $sharedHeader, private readonly ?string $aad, private readonly Throwable $throwable)
    {
    }

...
class JWECollector implements Collector, EventSubscriberInterface
{
    ...
    public function __construct(private readonly ?CompressionMethodManagerFactory $compressionMethodManagerFactory = null, private readonly ?JWESerializerManagerFactory $jweSerializerManagerFactory = null)
    {
    }
    /**
    ...
    {
        return [JWEDecryptionSuccessEvent::class => ['catchJweDecryptionSuccess'], JWEDecryptionFailureEvent::class => ['catchJweDecryptionFailure'], JWEBuiltSuccessEvent::class => ['catchJweBuiltSuccess'], JWEBuiltFailureEvent::class => ['catchJweBuiltFailure']];
    }

...
final class AlgorithmCollector implements Collector
{
    ...
    public function collect(array &$data, Request $request, Response $response, ?Throwable $exception = null): void
    {
        ...
        $data['algorithm'] = ['messages' => $this->getAlgorithmMessages(), 'algorithms' => []];
        ...
        $data['algorithm']['types'] = ['signature' => $signatureAlgorithms, 'mac' => $macAlgorithms, 'key_encryption' => $keyEncryptionAlgorithms, 'content_encryption' => $contentEncryptionAlgorithms];
    }
